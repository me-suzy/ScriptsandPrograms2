...
require("../access.inc.php");
    ...
    $result = mysql_query("UPDATE ".$conf['tbl']['projecttable']." SET imagename='$basename'
...
exit;
    ...
    $result = mysql_query("UPDATE ".$conf['tbl']['projecttable']." SET imagename=''
        WHERE ID='$HTTP_POST_VARS[ID]'") or die(mysql_error());
...
ELSE {
?>
<HTML><HEAD><TITLE>Change Image</TITLE>
<LINK REL ="stylesheet" HREF="../style.css" TYPE="text/css">
<?
include("../header1.php");
echo "<form ENCTYPE='multipart/form-data' action=projectimage.php method=POST>";
