<?php
/* $Id: bosnian-windows-1250.inc.php,v 2.69 2005/06/12 10:09:56 swix Exp $ */
...
$strAccessDeniedExplanation = 'phpMyAdmin je pokuao da se povee na MySQL server, ali je server odbio povezivanje. Provjerite naziv hosta, korisnièko ime i lozinku u config.inc.php i uvjerite se da odgovaraju podacima koje ste dobili od administratora MySQL servera.';
$strAction = 'Akcija';
...
$strBookmarkDeleted = 'Obiljeivaè je upravo obrisan.';
...
$strBzError = 'phpMyAdmin nije mogao da kompresuje sadraj baze zbog neispravne BZ2 ekstenzije u ovoj verziji PHP-a. Preporuèuje se da podesite <code>$cfg[\'BZipDump\']</code> direktivu u vaem phpMyAdmin konfiguracionom fajlu na <code>FALSE</code>. Ako elite da koristite moguænosti BZ2 kompresije, trebalo bi da preðete na noviju verziju PHP-a. Vidite PHP izvetaj o grekama %s za detalje.';
$strBzip = '"bzip-ovano"';
...
$strConfigFileError = 'phpMyAdmin nije mogao da proèita va konfiguracioni fajl!<br />Ovo se moe destiti ako PHP naðe greku u procesiranju ili ne moe da pronaðe fajl.<br />Pozovite konfiguracioni fajl direktno koristeæi donji link u proèitajte poruke o greci koje dobijate. U veæini sluèajeve negde nedostaje navodnik ili taèka-zarez.<br />Ako dobijete praznu stranu, sve je u redu.';
...
$strDatabases = 'Baze';
$strDatabasesDropped = '%s baza je uspjeno odbaèena.';
$strDatabasesStats = 'Statistika baze';
$strDatabasesStatsDisable = 'Iskljuèi statistike';
$strDatabasesStatsEnable = 'Ukljuèi statistike';
$strDatabasesStatsHeavyTraffic = 'Napomena: ukljuèivanje statistika moe prouzrokovati veliki protok podataka izmeðu web i MySQL servera.';
...
$strDumpSaved = 'Sadraj baze je saèuvan u fajl %s.';
...
$strFixed = 'uraðeno';
$strFlushPrivilegesNote = 'Napomena: phpMyAdmin uzima privilegije korisnika direktno iz MySQL tabela privilegija. Sadraj ove tabele moe se razlikovati od privilegija koje server koristi ako su izvrene ruène izmjene. U tom sluèaju %sponovo uèitajte privilegije%s pre nego to nastavite.';
...
$strLoadExplanation = 'Najbolji metod je veæ izabran, ali ga moete promijeniti ako ne radi.';
...
$strOverwriteExisting = 'Prepii postojeæe fajlove';

$strPHP40203 = 'Koristite PHP 4.2.3, koji ima ozbiljnu gresku sa viebajtnim stringovima (mbstring). Pogledajte izvjetaj o greci br. 19404. Ova verzija PHP-a se ne preporuèuje za koriæenje sa phpMyAdmin.';
...
$strSQLParserBugMessage = 'Postoji moguænost da ste pronali gresku u SQL parseru. Molimo ispitajte svoj upit paljivo, i provjerite da su navodnici ispravni i da ne nedostaju. Ostali moguæi razlozi greke mogu biti da ste poslali binarni fajl van oblasti za obièan tekst. Moete probati svoj upit u MySQL interfejsu komandne linije. Donja poruka o greci MySQL servera, ako je ima, moe vam pomoæi u otkrivanju problema. Ako i dalje imate probleme ili ako parser ne uspjeva tamo gde uspeva interfejs komandne linije, svedite svoj SQL upit na jedan jedini upit koji stvara probleme i poaljite nam izvjetaj o greci sa delom koda u donjoj REZ sekciji:';
...
$strSearchNeedle = 'Rijeèi ili vrednosti koje se trae (doker: "%"):';
...
$strTransformation_text_plain__substr = 'Pokazuje samo deo stringa. Prva opcija je ofset koji definie gde poèinje izlaz vaeg teksta (podrazumevano 0). Druga opcija je ofset koji pokazuje koliko æe teksta biti prikazano. Ako je nema, sav preostali tekst æe biti prikazan. Treæa opcija odreðuje koji æe znaci biti dodati izlazu kada se prikae podstring (podrazumevano: ...) .';
...
$strWildcard = 'Doker';
$strWindowNotFound = 'Odredinji prozor pretraivaèa nije mogao da bude auriran. Moda ste zatvorili matièni prozor, ili va preraivaè onemoguæava auriranje meðu prozorima zbog sigurnosnih podeavanja';
...
$strWrongUser = 'Pogreno korisnièko ime/lozinka. Ulaz nije dozvoljen.';
