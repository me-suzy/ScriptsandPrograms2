...
//                                www.solmetra.com
// ================================================
// $Revision: 1.1 $, $Date: 2004/04/08 22:40:53 $
// ================================================
...
<head>
  ...
  <!--
    function selectClick()
    {
      ...
      {
        window.returnValue = '<?php echo $_ENGINE['main_url'].'/images/site_images/'?>'+ document.libbrowser.imglist.options[document.libbrowser.imglist.selectedIndex].value;
        window.close();
      }
      else
      {
...
<tr>
  ...
  <select name="imglist" size="15" class="input" style="width: 150px;" 
    onchange="if (this.selectedIndex &gt;=0) imgpreview.location.href = '<?php echo $_ENGINE['main_url'].'/images/site_images/'?>' + this.options[this.selectedIndex].value;" ondblclick="selectClick();">
  <?php 
    if ($d) 
    {
	  echo $imglib;
