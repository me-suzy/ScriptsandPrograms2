...
define('SORT_UP','<IMG ALT="' . STR_SORT_UP . '" TITLE="' . STR_SORT_UP . '" SRC="images/sort_up.gif" BORDER=0>');
define('SORT_DN','<IMG ALT="' . STR_SORT_DN . '" TITLE="' . STR_SORT_DN . '" SRC="images/sort_dn.gif" BORDER=0>');
