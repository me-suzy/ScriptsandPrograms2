...
// FSGuide release: 0.7
//
// Last update: 2005.04.24 (update for version 0.7)
// German translation by Christopher Kramer
// Contact: crazy4chrissi@yahoo.de
// Viel Spaß!

define('STR_RENAME_REMOVE_CHARS',     'Entferne diese Zeichen aus Dateinamen:');
define('STR_RENAME_REMOVE_BUTTON',    'Entfernen');

define('STR_RENAME_REMOVENUMBER', 'Entferne' );
define('STR_RENAME_REMOVENUMBER_FROM', 'Zeichen' );
define('STR_RENAME_FROM_BEGINNING', 'am Anfang' );
define('STR_RENAME_FROM_END', 'am Schluss' );
define('STR_RENAME_FROM_POSITION', 'ab folgender Position' );

define('STR_RENAME_ADD', 'F&uuml;ge die Zeichenkette' );
define('STR_RENAME_TO', 'am ' );
define('STR_RENAME_TO_BEGINNING', 'Anfang' );
define('STR_RENAME_TO_END', 'Schluss' );
define('STR_RENAME_TO_POSITION', 'ab folgender Position' );
define('STR_RENAME_ADD_BUTTON', 'Hinzuf&uuml;gen' );

define('STR_RENAME_REGEXP', 'Wende den Regul&auml;ren Ausdruck' );
define('STR_RENAME_REPLACE_GLOBAL', 'global' );
define('STR_RENAME_REPLACE_IGNORE_CASE', 'Gro&szlig;-/Kleinschr. ign.' );
define('STR_RENAME_REGEXP_TO', 'an und ersetze durch:' );
define('STR_RENAME_REPLACE', 'Ersetzen' );

define('STR_RENAME_CASE_CONVERSION','Umwandlung in');
define('STR_RENAME_CCLOWER','Kleinbuchstaben');
define('STR_RENAME_CCUPPER','Großbuchstaben');
define('STR_RENAME_CONVERT','Umwandeln');

define('STR_RENAME_RESET', 'Zur&uuml;cksetzen' );

define('STR_SORT_UP', 'Sortiere nach %s, aufsteigend');
define('STR_SORT_DN', 'Sortiere nach %s, absteigend');
define('STR_PANEL_CREATED', 'erstellt' );
define('STR_PANEL_LASTACCESS', 'letzter Zugriff' );

define('STR_DO_YOU_WANT_TO_DELETE', 'Sollen die ausgew&auml;hlten Objekte / das ausgew&auml;hlte Objekt wirklich entfernt werden?');

define('STR_COMPARE',             'Vergleichen');
define('STR_COMPARE_OK',          'OK');
define('STR_COMPARE_CLOSEWINDOW', 'Fenster schlie&szlig;en');
define('STR_COMPARE_OPTIONS',     'Optionen');
define('STR_COMPARE_SELECT_DIFFERENT',   'unterschiedliche Dateien ausw&auml;hlen');
define('STR_COMPARE_DESELECT_DIFFERENT', 'unterschiedliche Dateien nicht ausw&auml;hlen');
define('STR_COMPARE_ONLY_FILES_IN_BOTH_PANEL', 'nur Dateien vergleichen, die auf beiden Seiten existieren');
define('STR_COMPARE_BY_SIZE', 'vergleiche Dateigr&ouml;&szlig;e');
define('STR_COMPARE_BY_TIME', 'vergleiche letzte &Auml;nderung');

define('STR_JUMP_TO',            'Gehe zu:');
define('STR_DOWNLOAD',           'Download');

define('STR_LOGIN_INFO',         'Gebe den Login-Namen und das Passwort ein, das du von deinem Administrator erhalten hast, um FSGuide zu nutzen.');
define('STR_LOGIN_ERROR',        'Der Login-Name oder das Passwort ist falsch.');
define('STR_LOGIN_LOGIN',        'Dein Login-Name');
define('STR_LOGIN_PASSWORD',     'Dein Passwort');
define('STR_LOGIN_BUTTON',       'Login');
define('STR_LOGIN_LOGGEDINAS',   'Du bist momentan als %s angemeldet.');
define('STR_LOGIN_LOGOUT',       'Hier klicken um sich abzumelden.');
define('STR_LOGIN_DEFAULT_USER', 'Du bist nicht angemeldet');
...
define('STR_ACCESS_DENIED',         'Der Zugriff auf diesen Ordner ist dir nicht gestattet');
define('STR_ACCESS_COPY_DENIED',    'Dir fehlt die Berechtigung, in diesem Ordner zu Kopieren');
define('STR_ACCESS_DELETE_DENIED',  'Dir fehlt die Berechtigung, in diesem Ordner zu L&ouml;schen');
define('STR_ACCESS_RENAME_DENIED',  'Dir fehlt die Berechtigung, in diesem Ordner Dateien umzubenennen');
define('STR_ACCESS_MOVEFROM_DENIED','Dir fehlt die Berechtigung, Dateien aus diesem Ordner zu verschieben');
define('STR_ACCESS_MOVETO_DENIED',  'Dir fehlt die Berechtigung, Dateien in diesen Ordner zu verschieben');
define('STR_ACCESS_MKDIR_DENIED',   'Dir fehlt die Berechtigung, in diesem Ordner neue Ordner zu erstellen');
define('STR_ACCESS_MODIFY_DENIED',  'Dir fehlt die Berechtigung, Dateien in diesem Ordner zu ver&auml;ndern.');
define('STR_ACCESS_UPLOAD_DENIED',  'Dir fehlt die Berechtigung, dateien in diesen Ordner hochzuladen.');
define('STR_ACCESS_FILELIST_DENIED','Dir fehlt die Berechtigung, eine Dateiliste dieses Ordners zusammenzusetzen.');
...
define('STR_SUM', '<B>%s</B> Byte in <B>%s</B> Objekten');
...
define('STR_EDITOR_SAVE_ERROR_WRONG_VALUE','W&auml;hrend dem &Auml;ndern der Datei <I>%s</I>, hast du folgenden Wert f&uuml;r Byteposition #%s angegeben: %s.');
define('STR_EDITOR_SAVE_ERROR_HEX_VALUE_NEEDED','Laut Einstellungen musst du einen postiven Hexadecimal-Wert zwischen 00 und FF angeben.');
define('STR_EDITOR_SAVE_ERROR_DEC_VALUE_NEEDED','Laut Einstellungen musst du einen ganzen, positiven Dezimalwert zwischen 0 und 255 angeben.');
...
define('STR_FILE_UPLOAD_DESC','W&auml;hle die Dateien, die du hochladen m&ouml;chtest, und evtl. eine Aktion die nach dem Upload erfolgen soll.');
...
define('JS_MAXDATE_PARSE_ERROR',		'Das maximale Datum / die maximale Zeit ist im falschen Format angegeben worden (verwende folgendes Format: YYYY-MM-DD HH:MM:SS). Mit Benutzung der maximalen Zeit aus dem Datei-Panel weiter machen?');
define('JS_MINDATE_PARSE_ERROR',		'Das minimale Datum / die minimale Zeit ist im falschen Format angegeben worden (verwende folgendes Format: YYYY-MM-DD HH:MM:SS). Mit Benutzung der maximalen Zeit aus dem Datei-Panel weiter machen?');
