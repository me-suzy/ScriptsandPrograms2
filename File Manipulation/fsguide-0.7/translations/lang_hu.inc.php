...
define('STR_RENAME_REMOVE_CHARS',     'Ezen karakterek eltávolítása:');
define('STR_RENAME_REMOVE_BUTTON',    'Eltávolítás');

define('STR_RENAME_REMOVENUMBER', 'Eltávolít' );
define('STR_RENAME_REMOVENUMBER_FROM', 'darab karaktert' );
define('STR_RENAME_FROM_BEGINNING', 'az elejérõl' );
define('STR_RENAME_FROM_END', 'a végérõl' );
define('STR_RENAME_FROM_POSITION', 'pozícióról' ); 

define('STR_RENAME_ADD', 'Hozzáadni ezt' ); 
define('STR_RENAME_TO', 'az állománynév' ); 
define('STR_RENAME_TO_BEGINNING', 'elejére' );
define('STR_RENAME_TO_END', 'végére' );
define('STR_RENAME_TO_POSITION', 'pozícióra' ); 
define('STR_RENAME_ADD_BUTTON', 'Hozzáadás' ); 

define('STR_RENAME_REGEXP', 'Reguláris kifejezéses csere errõl' ); 
define('STR_RENAME_REPLACE', 'Csere' ); 
define('STR_RENAME_REPLACE_GLOBAL', 'globálisan' ); 
define('STR_RENAME_REPLACE_IGNORE_CASE', 'kis/nagybetûre érzéketlenül' ); 
define('STR_RENAME_REGEXP_TO', 'erre:' ); 

define('STR_RENAME_CASE_CONVERSION','Átalakítás');
define('STR_RENAME_CCLOWER','kisbetûsre');
define('STR_RENAME_CCUPPER','nagybetûsre');
define('STR_RENAME_CONVERT','Átalakítás');

define('STR_RENAME_RESET', 'ûrlap alaphelyzet' );

define('STR_SORT_UP', 'rendezés %s szerint, növekvõ sorrend');
define('STR_SORT_DN', 'rendezés %s szerint, csökkenõ sorrend');
define('STR_PANEL_CREATED', 'létrehozva' );
define('STR_PANEL_LASTACCESS', 'utolsó hozzáférés' );

define('STR_JUMP_TO',          'ugrás:');
define('STR_DOWNLOAD',         'letöltés');

define('STR_DO_YOU_WANT_TO_DELETE', 'Valóban törölni akarja a kiválasztott állományokat?');

define('STR_COMPARE',             'hasonlítás');
define('STR_COMPARE_OK',          'rendben');
define('STR_COMPARE_CLOSEWINDOW', 'ablak bezárása');
define('STR_COMPARE_OPTIONS',     'opciók');
define('STR_COMPARE_SELECT_DIFFERENT',   'a különbözõ állományok kiválasztása');
define('STR_COMPARE_DESELECT_DIFFERENT', 'a különbözõ állományok kiválasztásának megszüntetése');
define('STR_COMPARE_ONLY_FILES_IN_BOTH_PANEL', 'csak azokat az állományokat, amik mindkét panelen léteznek');
define('STR_COMPARE_BY_SIZE', 'állomány méretének hasonlítása');
define('STR_COMPARE_BY_TIME', 'állomány utolsó módosítási idejének hasonlítása');
