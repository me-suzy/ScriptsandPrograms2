...
?>
	<div style="text-align: center;">
		...
		<div id="theCrop"></div>
		<img src="crea_imaxe.php?cal=<?php echo $ucal; ?>&amp;dir=<?php echo $dir; ?>&amp;ancho=<?php echo $datos[0]; ?>&amp;alto=<?php echo $datos[1]; ?>&amp;<?php echo session_name().'='.session_id(); ?>" width="<?php echo $datos[0]; ?>" height="<?php echo $datos[1]; ?>" alt="<?php echo $vars->get('cal'); ?>" id="theImage" />
