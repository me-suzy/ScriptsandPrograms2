...
return array(
	...
	// Directorio de hojas de estilos e imágenes
	// Stylesheet and images folder
	'estilo' => 'estilos/pfn/',
	...
	// ver : Accede al fichero directamente igual que si escribe su url
	// Default option to download method when click in a file
	// descargar : Force download file to hard disk
	// ver : Go to the URL's file and open it with the default application
	...
	'info' => array(
		...
		//	 to access from web
		'capas' => array('descricion','formulario','enlaces','protexer'),
	),
	...
	'inc' => array(
		...
		'peso' => 1024*1024*100,
		// Prefijo para el nombre de los ficheros de informacion adicional
		// Prefix to the aditional information files name
		'pre_ext' => '.',
		// Sufijo para el nombre de los ficheros de informacion adicional
		// Sufix to the aditional information files name
		'suf_ext' => 'INC',
		...
		'url' => array(),
		// Permitir indexar el contenido de los INC
		// Allow indexed the INC data
		'indexar' => true,
		// Campos a indexar
		// Fields to indexed
