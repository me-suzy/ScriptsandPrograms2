...
return array(
	...
	'Xtraduccion_intro' => 'Desde aqu&iacute; puedes traducir o cambiar los textos de traducci&oacute;n que necesites. Solo tienes que escoger un idioma de origen y uno de destino e ir traduciendo los campos que van apareciendo.<br /><br />Los pasos a seguir son los siguientes:<br /><br /><strong>1) Escoge el juego de caracteres.</strong><br /><strong>2) Escoge si listar todo o solo lo que est&aacute; sin traducir.</strong><br /><strong>3) Escoge el fichero a traducir.</strong><br /><strong>4) Escoge el idioma de origen.</strong><br /><strong>5) Escoge el idioma de destino.</strong><br /><br />Ten en cuenta que en algunos casos existir&aacute; c&oacute;digo PHP en el medio del texto. Lo que debes hacer en estos casos es utilizar los <strong>"[*"</strong> para el inicio del c&oacute;digo y <strong>"*]"</strong> para el final, y <strong>nunca</strong> traducir el contenido del c&oacute;digo PHP. Por ejemplo:<br /><strong>[*</strong><strong>$this->t("texto")</strong><strong>*]</strong><br /><br /><strong>IMPORTANTE: </strong>Dado que la sesi&oacute;n tiene una duraci&oacute;n limitada debes guardar cada cierto tiempo para que no te caduque la sesi&oacute;n y te expulse fuera perdiendo todo lo traducido!!!!.',
	'Xarquivo' => 'Fichero',
	'Xclave' => 'Clave',
	'Xsub_clave' => 'Subclave',
