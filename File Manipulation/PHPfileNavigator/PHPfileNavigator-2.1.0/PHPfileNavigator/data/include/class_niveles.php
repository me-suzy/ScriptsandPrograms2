...
class PFN_Niveles {
	...
	*/
	...
	/**
	* function get_contido (string $nivel, string $orde, string $pos)
	...
	* return array
	*/
	function get_contido ($nivel, $orde='nome', $pos='ASC') {
		$lista = &$this->carga_contido($nivel);
	...
	*/
	function posicion ($pos=0) {
		$this->posicion = ($pos <= 0)?0:intval($pos);
	}
