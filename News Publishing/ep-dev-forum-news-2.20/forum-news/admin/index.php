...
class EP_Dev_Forum_News_Admin
{
	...
	function page_FAQ()
	{
		...
		$answers[] = "This is possible by using the <font color='#0000FF'>Edit Templates</font> link. You must rename your images to numbers that reflect their corresponding category ids. For example, if you wanted an image for a category id of 3, then you would have to rename your category image to 3.gif or 3.jpg and place the following somewhere in your <font color='#FF0000'>Post</font> template (NOTE: this is just an example, you will have to ensure you put in the real url to your category images):<br>
			<textarea style='width: 500px; height: 75px;'><img src=\"http://www.mysite.com/cat_images/!!THREADID!!.gif\"></textarea>";
	...
	function page_NewsSettings()
	{
		...
		$content .= "<input type='hidden' name='adminpanel_filename' value='../config/config.php:::NEWS__recycle_time,NEWS__post_num,NEWS__headline_num,NEWS__character_limit,NEWS__page_break_keyword,NEWS__format_urls,NEWS__bbcode,NEWS__author_image,NEWS__fix_linebreaks,SCRIPT__absolute_path:::../news.php:::absolute_path'>\n";
		...
		$name = "Absolute Path";
		$description = "The absolute path to the folder of this script. (<a href=\"javascript:load_AbsPath();\">auto-detect</a>) <br><font color='blue'>Example:<br>/home/user/pubic_html/forum-news/</font><br>\n";
		$varType = "text";
