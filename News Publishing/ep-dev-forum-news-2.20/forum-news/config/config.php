...
// |                                           
// | Copyright (c) 2002-2005 EP-Dev.com :           
...
class EP_Dev_Forum_News_Config
{
	...
	function EP_Dev_Forum_News_Config()
	{
		...
		$this->FORUM[0]['url'] = "http://localhost/scripts/notmine/1p3Final_NEW/forum/";
		...
		$this->FORUM[3]['type'] = "Invision_Power_Board_2";
