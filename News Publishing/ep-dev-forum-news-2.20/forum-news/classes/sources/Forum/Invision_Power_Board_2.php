...
/* ------------------------------------------------------------------ */
//	Forum Module: Invision Power Board 2.x
//		module version: 1.0
//		forum versions: 2.x
//		10/16/2004
/* ------------------------------------------------------------------ */
...
class EP_Dev_Forum_News_Invision_Power_Board_2_Access
{
	var $SMILIES;
	var $POSTS;
	...
	function EP_Dev_Forum_News_Invision_Power_Board_2_Access(&$DB_access, &$forum_conf, &$error_handle)
	{
