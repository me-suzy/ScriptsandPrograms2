...
function print_debuglink() {
	...
	if ($Cfg['debug'] == 1) {
		...
		$link = "javascript:void(debugwin = window.open('includes/module_debug.php#bottom', 'debugwin', 'status=yes, scrollbars=yes, resizable=yes, width=600, height=300'))";
		echo "<small><a href=\"$link\">debug</a></small>";
	} else {
