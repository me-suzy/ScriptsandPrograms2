...
var TinyMCE_pivot_foreColor = "#000000";
...
function TinyMCE_advanced_getEditorTemplate(settings, editorId)
{
	...
	switch(layoutManager)
	{
		case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
			...
			var defVals = {
				theme_advanced_buttons1 : "undo,redo,separator,bold,italic," + 
 					"underline,strikethrough,link,unlink,pivot_image,pivot_popup,pivot_download,separator," +
 					"bullist,numlist,outdent,indent,justifyleft,justifycenter,justifyright,separator,"+
 					"formatselect,hr,removeformat,charmap,cleanup,code", 
