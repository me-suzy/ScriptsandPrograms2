...
function ip_ban($ip)
{
	...
	{
		$ipdata = $ipdata."\n".$ip;
		mysql_query("UPDATE vsns_config SET config_value = '$ipdata' WHERE config_name = 'banned_ip'") or die(mysql_error());
...
<div class="vsns_form">
	...
	<span class="vsns_label" style="display: block;clear: both; text-align: center;">
		<label for="ip">Banned IP Addresses:</label>
One per line.
	</span>
	<span class="vsns_field" style="display: block;text-align: center;">
...
function ip_update()
{
	...
	mysql_query("UPDATE vsns_config SET config_value = '$ip' WHERE config_name = 'banned_ip'") or die(mysql_error());
