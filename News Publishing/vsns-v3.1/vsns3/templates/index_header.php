...
*	Description: Default header file
****************************************************************************
*	Build Date: October 14, 2005
*	Author: Tachyon
...
<head>
	<title>VSNS Lemon <?php echo $version;?></title>

	<meta http-equiv="Content-Style-Type" content="text/css" />
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />

	<link rel="alternate" type="application/rss+xml" href="<?php echo $path;?>rss.xml" />
...
<div id="top">
	<a href="<?php echo $path;?>index.php">
		<img src="<?php echo $path."images/logo.png";?>" alt="VSNS Lemon <?php echo $version;?>" id="logo" />
	</a>
</div>
