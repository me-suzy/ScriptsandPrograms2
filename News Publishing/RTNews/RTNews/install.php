...
$query = "CREATE TABLE RTNews (id INT (5) UNSIGNED not null AUTO_INCREMENT, _author VARCHAR (50) not null, _mail VARCHAR (50),  _date VARCHAR(10) , _title VARCHAR(20), _text TEXT not null , PRIMARY KEY (id))";
