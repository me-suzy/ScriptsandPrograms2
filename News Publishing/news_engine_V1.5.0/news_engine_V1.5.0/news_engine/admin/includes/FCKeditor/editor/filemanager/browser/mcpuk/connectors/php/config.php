...
$fckphp_config['basedir'] = "c:/inetpub/wwwroot" ;
/*==============================================================================*/
...
/*==============================================================================*/
$fckphp_engine_path = str_replace("/admin/includes/FCKeditor/editor/filemanager/browser/mcpuk/connectors/php","",$_SERVER['PHP_SELF']);
$fckphp_engine_path = str_replace("testme.php","",$fckphp_engine_path);
...
/*------------------------------------------------------------------------------*/
$fckphp_config['ResourceTypes'] = array('','Image','Flash','Media');
