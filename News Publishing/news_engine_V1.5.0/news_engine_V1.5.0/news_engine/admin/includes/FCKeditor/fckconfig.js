...
FCKConfig.CustomConfigurationsPath = '../engine.config.js.php' ;
...
FCKConfig.ToolbarSets["Engine"] = [
	['Bold','Italic','Underline','-','Subscript','Superscript','OrderedList','UnorderedList','-','Link','Unlink','-','Rule','OrderedList','UnorderedList','-','Image','-','About']
] ;
...
// Original     // FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Connector=connectors/asp/connector.asp' ;
...
FCKConfig.LinkBrowserURL = '../../../../../browser.php?type=links';
FCKConfig.LinkBrowserWindowWidth	= 600 ;	// 70%
FCKConfig.LinkBrowserWindowHeight	= 550 ;	// 70%

FCKConfig.ImageBrowser = true ;
// Original     // FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/asp/connector.asp' ;
...
FCKConfig.ImageBrowserURL = '../../../../../browser.php?type=images';
FCKConfig.ImageBrowserWindowWidth  =600 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = 750 ;	// 70% ;

FCKConfig.FlashBrowser = true ;
// Original     // FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Flash&Connector=connectors/asp/connector.asp' ;
...
FCKConfig.FlashBrowserURL = '../../../../../browser.php?type=flash';
...
//FCKConfig.SmileyPath	= FCKConfig.EngineSmileyPath ;
