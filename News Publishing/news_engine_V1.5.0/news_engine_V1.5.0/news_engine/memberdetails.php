...
|
|	> $Id: memberdetails.php 2 2005-10-08 09:40:29Z alex $
|
+--------------------------------------------------------------------------
*/
...
if(!$_GET['page']) {
    ...
    $tpl->register('breadcrumb', buildBreadCrumb(array($lang['php_overall_home'] => $config['mainurl'], $lang['title_engine'] => $sess->url('index.php'), $lang['profile_profile'] => definedBoardUrls("changeaccount"), $lang['profile_general_option'] => '')));
    ...
    $tpl->register('breadcrumb', buildBreadCrumb(array($lang['php_overall_home'] => $config['mainurl'], $lang['title_engine'] => $sess->url('index.php'), $lang['profile_profile'] => definedBoardUrls("changeaccount"), $lang['profile_email_option'] => '')));
} elseif($_GET['page'] == 'password') {
    $tpl->loadFile('main', 'profile_password.html'); 
    $tpl->register('breadcrumb', buildBreadCrumb(array($lang['php_overall_home'] => $config['mainurl'], $lang['title_engine'] => $sess->url('index.php'), $lang['profile_profile'] => definedBoardUrls("changeaccount"), $lang['profile_password_option'] => '')));    
    $tpl->register(array(
    ...
    $tpl->register('breadcrumb', buildBreadCrumb(array($lang['php_overall_home'] => $config['mainurl'], $lang['title_engine'] => $sess->url('index.php'), $lang['profile_profile'] => definedBoardUrls("changeaccount"), $lang['profile_avatar_option'] => '')));
    $tpl->register(array(
