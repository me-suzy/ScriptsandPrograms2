...
if(isset($mode))
{
	...
	$sql="select * from ".$tableprefix."_announce where entrynr='$announcenr'";
	...
	do_emaillog($sendresult,$receivermail,"anmail.php");
	echo "<tr bgcolor=\"$contentbgcolor\" align=\"center\">";
	echo "<td><font face=\"$contentfont\" size=\"$contentfontsize\" color=\"$contentfontcolor\">";
	echo $l_entrymailed;
	echo "</font></td></tr>";
...
else
{
	...
	echo "<input type=\"hidden\" name=\"announcenr\" value=\"$announcenr\">";
