...
if(isset($download))
{
	...
	header('Content-Disposition: filename="newsscroller_'.$act_lang.'.ht"');
}
if(!isset($scrolltype))
...
$datasourceurl="$url_simpnews/newsscroller2.php?limitentries=$limitentries&limitdays=$limitdays&scrolltype=$scrolltype&$langvar=$act_lang&layout=$layout&category=$category";
