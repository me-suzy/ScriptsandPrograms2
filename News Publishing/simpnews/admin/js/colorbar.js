...
function rgb(pas,w,h,text1,text2,inputfield,formname){
for (j=0;j<6+1;j++){
    for (i=0;i<pas+1;i++)
	{
  ...
  codehex = r + '' + g + '' + b;
  document.write('		<td class=\"colorbar\" bgColor=\"' + RGB2Hexa(r,g,b) + '\" onClick=\"colorThis(this.bgColor,inputfield,formname);lightCase(this);\" onmouseover=\"lightCase1(this);\" title=\"'+text1+ RGB2Hexa(r,g,b) + ']'+text2+'color]\" width=\"'+w+'\" height=\"'+h+'\"><IMG height='+h+' src="gfx/space.gif" width='+w+' border=0></TD>\n');
	}}}
