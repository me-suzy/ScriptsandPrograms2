...
$page_title="$l_rebuildsearch ($l_announcements)";
...
$sql = "delete from ".$tableprefix."_ansearch";
if(!$result = mysql_query($sql, $db))
{
	echo "<tr class=\"errorrow\"><td align=\"center\">";
    die("Could not connect to the database.");
}
$sql = "select * from ".$tableprefix."_announce";
if(!$result = mysql_query($sql, $db))
{
	echo "<tr class=\"errorrow\"><td align=\"center\">";
    die("Could not connect to the database.");
...
while($myrow=mysql_fetch_array($result))
{
	...
	{
		$sql2 = "insert into ".$tableprefix."_ansearch (annr, text) values (".$myrow["entrynr"].", '$searchtext')";
