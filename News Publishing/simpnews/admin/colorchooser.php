...
<!-- Modifed for SimpNews by Boesch IT-Consulting -->
...
{
	var mywin=parent.window.opener;
	var colorcode=(document.colorform.hexval.value);
	var fieldname=mywin.document.layoutform.colorfield.value;
	var field=mywin.document.getElementById(fieldname);
	field.value=colorcode;
<?php
	if(!is_opera())
	{
		echo "	var prevfield=mywin.document.getElementById(fieldname+'prev');\n";
...
<TD class="headingrow" ALIGN="CENTER" VALIGN="MIDDLE" width="98%"><h3><?php echo $l_colors?></h3></td>
...
<a><img usemap="#colmap" src="gfx/colortable.gif" border=0 width=289 height=67></a></td></tr>
<tr><td colspan="2" align="center" class="displayrow"><?php echo $l_colorchoosertext?></td></tr>
<tr><td align="center" colspan="2" class="displayrow"><input class=sninput type=text name=hexval size=10 readonly></td></tr>
<tr><td align="center" colspan="2" class="actionrow"><input onclick="choosecolor();" type=button class="snbutton" value="<?php echo $l_transfer?>"></td></tr>
</form>
</table></body></html>
