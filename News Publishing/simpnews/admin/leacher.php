...
?>
<tr class="inputrow"><td align="right" width="30%"><?php echo $l_useragent?>:</td><td><input class="sninput" type="text" name="useragent" size="30" maxlength="80"></td></tr>
<tr class="inputrow"><td align="right" valign="top"><?php echo $l_description?>:</td><td>
<textarea class="sninput" name="description" rows="5" cols="30"></textarea></td></tr>
...
<?php
		...
		if($errors==0)
		{
			...
			if(!$result = mysql_query($sql, $db))
			    die("<tr class=\"errorrow\"><td>Unable to add entry to database.");
...
<tr class="inputrow"><td align="right" width="30%"><?php echo $l_useragent?>:</td><td><input class="sninput" type="text" name="useragent" size="30" maxlength="80" value="<?php echo do_htmlentities($myrow["useragent"])?>"></td></tr>
<tr class="inputrow"><td align="right" valign="top"><?php echo $l_description?>:</td><td>
<textarea class="sninput" name="description" rows="5" cols="30"><?php echo do_htmlentities($myrow["description"])?></textarea></td></tr>
...
<?php
		...
		if($errors==0)
		{
			...
			if(!$result = mysql_query($sql, $db))
			    die("<tr class=\"errorow\"><td>Unable to update the database.");
			echo "<tr class=\"displayrow\" align=\"center\"><td>";
...
$sql = "select * from ".$leacherprefix."_leachers order by useragent asc";
if(!$result = mysql_query($sql, $db)) {
