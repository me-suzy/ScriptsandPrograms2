...
<input class="sninput" type="text" name="badword" size="30" maxlength="100" value="<?php echo $badword?>"></td>
<td align="center">
<input class="sninput" type="text" name="replacement" size="30" maxlength="100" value="<?php echo $replacement?>"></td>
<td><input class="snbutton" type="submit" value="<?php echo $l_add?>"></td></tr></form>
<tr class="headingrow"><td align="center" colspan="3">
...
<?php
		do {
			...
			echo "<input class=\"sninput\" type=\"text\" name=\"badword\" value=\"".do_htmlentities($myrow["word"])."\" size=\"30\" maxlength=\"100\"></td>";
			echo "<td align=\"center\">";
			echo "<input class=\"sninput\" type=\"text\" name=\"replacement\" value=\"".$myrow["replacement"]."\" size=\"30\" maxlength=\"100\"></td>";
			echo "<td>";
			echo "<input class=\"snbutton\" type=\"submit\" name=\"delete\" value=\"$l_delete\">";
			echo "&nbsp;&nbsp;";
			echo "<input class=\"snbutton\" type=\"submit\" name=\"update\" value=\"$l_update\">";
			echo "</td></tr></form>";
