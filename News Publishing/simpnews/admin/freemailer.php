...
?>
<tr class="inputrow"><td align="right" width="30%"><?php echo $l_freemaileradr?>:</td><td><input class="sninput" type="text" name="address" size="30" maxlength="100"></td></tr>
...
<tr class="inputrow"><td align="right" width="30%"><?php echo $l_freemaileradr?>:</td><td><input class="sninput" type="text" name="address" size="30" maxlength="100" value="<?php echo do_htmlentities($myrow["address"])?>"></td></tr>
