...
if(strlen($myrow["poster"])>0)
{
	...
	echo "$l_poster: ".display_encoded($myrow["poster"]);
	echo "</td></tr>";
}
$attachsql="select f.filename, f.filesize, f.mimetype from ".$tableprefix."_events_attachs eva, ".$tableprefix."_files f where f.entrynr=eva.attachnr and eva.eventnr=".$myrow["eventnr"];
