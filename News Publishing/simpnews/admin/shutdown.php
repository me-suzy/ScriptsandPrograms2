...
?>
<input class="snbutton" type="submit" name="submit" value="<?php echo $l_update?>">&nbsp;&nbsp;
...
<td><textarea class="sninput" name="shutdowntext" cols="50" rows="10"><?php echo $shutdowntext?></textarea><br>
<?php display_bbcode_buttons($l_bbbuttons,"shutdowntext",false,false) ?>
</td></tr>
...
<input class="snbutton" type="submit" name="submit" value="<?php echo $l_update?>">
&nbsp;&nbsp;<input class="snbutton" type="submit" name="preview" value="<?php echo $l_preview?>">
</td></form></tr>
<tr class="actionrow"><td align="center" colspan="2">
<a href="<?php echo do_url_session("$act_script_url?$langvar=$act_lang&newshutdown=1&submit=1&new=$new")?>"><?php echo $l_shutdown?></a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="<?php echo do_url_session("$act_script_url?$langvar=$act_lang&newshutdown=0&submit=1&new=$new")?>"><?php echo $l_restart?></a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="<?php echo do_url_session("$act_script_url?$langvar=$act_lang&newshutdown=2&submit=1&new=$new")?>"><?php echo $l_adminshutdown?></a>
</td></tr>
</table></td></tr></table>
<?php
include('./trailer.php');
