...
echo "$l_announcements - $l_preview";
echo "</title>";
...
<tr><td align="CENTER" class="pagetitlerow"><h2><?php echo $l_announcements." - ".$l_preview?></h2></td></tr>
</table>
<?php
...
if($mode=="add")
{
	...
	if(!isset($announcetext) || !$announcetext)
		echo "<tr class=\"errorrow\"><td>$l_noannouncetext</td></tr>";
	else
	{
