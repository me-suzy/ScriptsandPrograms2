...
****************************************************************************************************************************
	*/
	...
	if ($_POST['submitted']=="true"){
		...
		$query="INSERT INTO cartcategories (name) VALUES ('".$_POST['name']."')";
		$result=mysql_query($query);
		$catID=mysql_insert_id();
		
		$query2="INSERT INTO cartcategories_to_sites (sitesID, cartCategoriesID) VALUES ('".$_POST['siteID']."', '".$catID."')";
		$result2=mysql_query($query2);
		
		if ($result){
			header ("location: /update/shopping_cart/categories.php?siteID=".$_POST['siteID']);
		}
	}
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="82%" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="1%">&nbsp;</td>
                <td width="99%"><span class="style12">Add Category To <?php echo $site['name']; ?><br> 
                  </span><br>
                  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="96%"><form name="form1" method="post" action="">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="33%"><div align="right"><span class="style1">Category Name: </span></div></td>
                            <td width="3%">&nbsp;</td>
                            <td width="64%"><input name="name" type="text" id="name"></td>
                          </tr>
                          <tr>
