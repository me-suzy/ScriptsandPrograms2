...
****************************************************************************************************************************
	*/
	...
	$query="DELETE FROM sites WHERE id='".$_GET['siteID']."'";
	$result=mysql_query($query);
	
	$query3="SELECT * FROM cartcategories_to_sites WHERE sitesID='".$_GET['siteID']."'";
	$result3=mysql_query($query3);
	while ($row3=mysql_fetch_array($result3)){
		$query4="DELETE FROM cartcategories WHERE id='".$row3['cartCategoriesID']."'";
		$result4=mysql_query($query4);
		echo "yehaw";
	}
	
	$query2="DELETE FROM cartcategories_to_sites WHERE sitesID='".$_GET['siteID']."'";
