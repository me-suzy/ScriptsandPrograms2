...
****************************************************************************************************************************
	*/
	...
	$query="DELETE FROM cartitems WHERE id='".$_GET['productID']."'";
	$result=mysql_query($query);
	
	$query="DELETE FROM cartitems_to_cartcategories WHERE cartItemsID='".$_GET['productID']."'";
	$result=mysql_query($query);
	
	unlink ("$DOCUMENT_ROOT/images/cart/".$_GET['productID'].".jpg");
