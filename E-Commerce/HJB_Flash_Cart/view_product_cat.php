...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div align="left"><br>
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="20%" valign="top"><div align="left"><img src="images/catalog.gif" width="166" height="194"><br>
                  <br>
              </div>
                <ul>
                <span class="style1">
                ...
                <li class="style1">
                  <div align="left"><?php echo "<a href=\"view_all_products_cat.php?catID=".$row['id']."\">".$row['name']."</a>"; 
				  ...
				  ?>
                      <ul>
                        <li><?php echo "<a href=\"view_product_cat.php?productID=".$row2['id']."\">".$row2['name']."</a>"; ?></li>
                      </ul>
                  </div>
                </li>
                <div align="left">
                  ...
                  <?php }}}?>
			  				...
			  				$query3="SELECT * FROM cartitems WHERE id='".$_GET['productID']."'";
							$result3=mysql_query($query3);
							$row3=mysql_fetch_array($result3);
			  ?>
              <td width="80%" valign="top" class="style1"><p>Our catalog allows you to view and print information about our high quality products. To buy these products online, please visit our <a href="cart.php" class="style10">online shopping cart</a>. </p>                
                <span class="style12"><?php echo $row3['name']; ?> </span><br>                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="1%" valign="top"><img src="images/cart/<?php echo $row3['id']; ?>large.jpg" ></td>
                    <td width="2%" valign="top">&nbsp;</td>
                    <td width="97%" valign="top"><?php echo $row3['description']; ?><br>
                      <span class="style13"><br>
                    $<?php echo $row3['price']; ?></span></td>
                  </tr>
                </table>
                <p><br>
                  <br>
