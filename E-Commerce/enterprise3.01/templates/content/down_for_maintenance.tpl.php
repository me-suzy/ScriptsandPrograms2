    ...
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="right" class="main"><br>
            <?php echo DOWN_FOR_MAINTENANCE_STATUS_TEXT . '<br><br>' . '<a href="' . escs_href_link(FILENAME_DEFAULT) . '">' . escs_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
        </tr>
      </table></td>
  </tr>
</table>
