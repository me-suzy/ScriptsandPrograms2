<table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main" colspan="4"><?php echo TEXT_AFFILIATE_HEADER . ' ' . escs_db_num_rows(escs_db_query($affiliate_payment_raw)); ?></td>
          </tr>
          <tr>
            <td colspan="4"><?php echo escs_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
          </tr>
          <tr>
...
<?php
  if ($affiliate_payment_split->number_of_rows > 0) {
    $affiliate_payment_values = escs_db_query($affiliate_payment_split->sql_query);
    $number_of_payment = 0;
    while ($affiliate_payment = escs_db_fetch_array($affiliate_payment_values)) {
      $number_of_payment++;
...
?>
            ...
            <td class="smallText" align="center"><?php echo escs_date_short($affiliate_payment['affiliate_payment_date']); ?></td>
          ...
          <tr>
            <td colspan="4"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td align="right" class="smallText"><?php echo TEXT_RESULT_PAGE; ?> <?php echo $affiliate_payment_split->display_links(MAX_DISPLAY_PAGE_LINKS, escs_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></td>
              </tr>
            </table></td>
          </tr>
<?php
  }
  $affiliate_payment_values = escs_db_query("select sum(affiliate_payment_total) as total from " . TABLE_AFFILIATE_PAYMENT . " where affiliate_id = '" . $affiliate_id . "'");
  $affiliate_payment = escs_db_fetch_array($affiliate_payment_values);
?>
          <tr>
