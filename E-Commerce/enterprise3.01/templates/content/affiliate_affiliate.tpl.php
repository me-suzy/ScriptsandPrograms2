...
?>
      <tr>
        <td><?php echo escs_draw_form('login', escs_href_link(FILENAME_AFFILIATE, 'action=process', 'SSL')); ?><table border="0" width="100%" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td width="50%" align="left" valign="top"><?php echo '<a href="' . escs_href_link(FILENAME_AFFILIATE_SIGNUP, '', 'SSL') . '">' . escs_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
