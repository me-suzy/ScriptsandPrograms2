<table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main" colspan="5"><?php echo TEXT_AFFILIATE_HEADER . ' ' . escs_db_num_rows(escs_db_query($affiliate_sales_raw)); ?></td>
          </tr>
          <tr>
            <td colspan="5"><?php echo escs_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
          </tr>
          <tr>
...
<?php
  if ($affiliate_sales_split->number_of_rows > 0) {
    $affiliate_sales_values = escs_db_query($affiliate_sales_split->sql_query);
    $number_of_sales = 0;
    $sum_of_earnings = 0;
...
?>
            <td class="smallText" align="center"><?php echo escs_date_short($affiliate_sales['affiliate_date']); ?></td>
...
?>
          <tr>
            <td colspan="5"><?php echo escs_draw_separator(); ?></td>
          </tr>
<?php
  if ($affiliate_sales_split->number_of_rows > 0) {
?>
          <tr>
            <td colspan="5"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td class="smallText" align="right"><?php echo TEXT_RESULT_PAGE; ?> <?php echo $affiliate_sales_split->display_links(MAX_DISPLAY_PAGE_LINKS, escs_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></td>
              </tr>
            </table></td>
          </tr>
          <tr>
