...
// Define the project version
  define('PROJECT_VERSION', 'Enterprise Shopping Cart Software 1.0');
...
// default open navigation box
  if (!escs_session_is_registered('selected_box')) {
    escs_session_register('selected_box');
...
// include giftvoucher
  ...
  // begin database maintenance mod
