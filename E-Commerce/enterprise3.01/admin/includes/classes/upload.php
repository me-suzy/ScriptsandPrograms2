...
*/
  ...
  class upload {
    ...
    function upload($file = '', $destination = '', $permissions = '777', $extensions = '') {
      ...
      if (escs_not_null($this->file) && escs_not_null($this->destination)) {
...
// self destruct
    ...
    function parse() {
      ...
      if ( escs_not_null($file['tmp_name']) && ($file['tmp_name'] != 'none') && is_uploaded_file($file['tmp_name']) ) {
        ...
        /* removed for 10 image support - was unneccessary and getting in the way
        if ($this->message_location == 'direct') {
