 ...
 */
    ...
    function add_text($text = '') {
      $this->text = escs_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
    }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      $this->html = escs_convert_linefeeds(array("\r\n", "\n", "\r"), '<br>', $html);
      $this->html_text = escs_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if (escs_not_null($this->html_images)) {
      ...
      $null = NULL;
      $attachments = ((escs_not_null($this->attachments)) ? true : false);
      $html_images = ((escs_not_null($this->html_images)) ? true : false);
      $html = ((escs_not_null($this->html)) ? true : false);
      $text = ((escs_not_null($this->text)) ? true : false);
...
//          $message =& $this->add_mixed_part();
        ...
        case (($html == true) && ($attachments == false) && ($html_images == false)):
          if (escs_not_null($this->html_text)) {
/* HPDL PHP3 */
