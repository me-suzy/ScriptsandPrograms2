	...
	showOnClick, sepItems, isMainMenu, hasAnimations, animationType, hasShadow, sOffX, sOffY, shadowColor)
{
	...
	{
		this.main.style.height = size + margin;
		if (sepItems)
	...
	else
	{
		...
		this.main.style.width = size + margin;
	}
	if (isMainMenu)
...
function item(link, iSize, alignment, content, menuToShow)
{
	...
	{
		if (this.orientation == "horizontal")
			this.main.style.width = this.main.offsetWidth + iSize + this.borderSize + this.margin;
		else
			this.main.style.height = this.main.offsetHeight + iSize + this.borderSize + this.margin;
		this.position += iSize + this.borderSize + this.margin;
	}
	else
	{
		if (this.orientation == "horizontal")
			this.main.style.width = this.main.offsetWidth + iSize + this.margin;
		else
			this.main.style.height = this.main.offsetHeight + iSize + this.margin;
		this.position += iSize + this.margin;
	}
