...
function showMenu(num, pNum, iNum, offsetX, offsetY)
{
	...
	if (cMenu.main.style.visibility != "visible")
	{
		...
		if (showX + cMenu.main.offsetWidth > document.body.clientWidth + document.body.scrollLeft)
			showX -= (showX + cMenu.main.offsetWidth) - (document.body.clientWidth + 
				document.body.scrollLeft);
		if (showY + cMenu.main.offsetHeight > document.body.clientHeight + document.body.scrollTop)
