...
function item(link, iSize, alignment, content, menuToShow)
{
	...
	{
		temp.document.write('<tr><td align="' + alignment + '" width="80%"><font face="' + this.fontFace + 
	...
	if (contentFunctionOver == "")
	{
		outContent += '<tr><td align="' + alignment + '" width="80%"><font face="' + this.fontFace + 
			'" point-size="' + this.fontSize + '" color="' + this.textColorOut + '">' + fontStyleBeg + content 
			+ fontStyleEnd + '</font></td>';
	...
	if (contentFunctionOver == "")
	{
		overContent += '<tr><td align="' + alignment + '" width="80%"><font face="' + this.fontFace + 
