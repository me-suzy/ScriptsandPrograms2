...
if ($HTTP_GET_VARS['origin'] == FILENAME_CHECKOUT_PAYMENT) {
  ...
  define('TEXT_Sescs_BY_STEP', 'We\'ll walk you through the process, step by step.');
} else {
  define('NAVBAR_TITLE', 'Login');
  define('HEADING_TITLE', 'Welcome, Please Sign In');
  define('TEXT_Sescs_BY_STEP', ''); // should be empty
}
...
define('TEXT_FORGOTTEN_FAIL', 'You have tried to login unsuccessfully over 3 times. For security reasons, please contact your Web Administrator to get new password.<br>&nbsp;<br>&nbsp;');
