...
define('TEXT_DISPLAY_NUMBER_OF_PAYPALIPN_TRANSACTIONS', 'Viendo del <b>%d</b> al <b>%d</b> (de <b>%d</b> transacciones)'); // PAYPALIPN

define('BOX_HEADING_PAYPALIPN_ADMIN', 'Paypal IPN'); // PAYPALIPN
define('BOX_PAYPALIPN_ADMIN_TRANSACTIONS', 'Transacciones'); // PAYPALIPN
define('BOX_PAYPALIPN_ADMIN_TESTS', 'Enviar IPN de Prueba'); // PAYPALIPN
