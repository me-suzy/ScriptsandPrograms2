    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo "Edit Affiliate Terms"; ?></td>
...
<form action="affiliate_edit_terms.php" method="POST">
...
{
	$new_file = fopen(DIR_FS_CATALOG . DIR_WS_INCLUDES . "editable_affiliate_terms.php", 'w');
    $file_contents = stripslashes($HTTP_POST_VARS['file_contents']);
    fwrite($new_file, $file_contents, strlen($file_contents));
    fclose($new_file);
    echo('<div class="helpText">Affiliate Terms Saved!</div><br>');
}
...
<?php
    ...
    $header_path = DIR_FS_CATALOG . DIR_WS_INCLUDES . "editable_affiliate_terms.php";
