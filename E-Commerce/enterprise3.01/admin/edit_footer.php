    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo "Edit Footer"; ?></td>
...
{
	$new_file = fopen(DIR_FS_CATALOG . DIR_WS_INCLUDES . "editable_footer.php", 'w');
    $file_contents = stripslashes($HTTP_POST_VARS['file_contents']);
    fwrite($new_file, $file_contents, strlen($file_contents));
    fclose($new_file);
    echo('<div class="helpText">Footer Saved!</div><br>');
}
...
<?php
    ...
    $footer_path = DIR_FS_CATALOG . DIR_WS_INCLUDES . "editable_footer.php";
    $file = fopen($footer_path, "r");
	$file_contents = fread($file, filesize($footer_path));
    fclose($file);
