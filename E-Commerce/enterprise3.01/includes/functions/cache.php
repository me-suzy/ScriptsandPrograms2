...
// Cache the categories box
  function escs_cache_categories_box($auto_expire = false, $refresh = false) {
...
// Cache the manufacturers box
  function escs_cache_manufacturers_box($auto_expire = false, $refresh = false) {
    global $HTTP_GET_VARS, $language;

    $manufacturers_id = '';
    if (isset($HTTP_GET_VARS['manufactuers_id']) && escs_not_null($HTTP_GET_VARS['manufacturers_id'])) {
...
// Cache the also purchased module
  function escs_cache_also_purchased($auto_expire = false, $refresh = false) {
