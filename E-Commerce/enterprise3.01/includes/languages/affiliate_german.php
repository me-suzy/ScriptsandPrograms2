...
define('ENTRY_AFFILIATE_ACCEPT_AGB', 'Bitte best&auml;tigen Sie, dass Sie mit unseren <a target="_new" href="' . escs_href_link(FILENAME_AFFILIATE_TERMS, '', 'SSL') . '">AGB\'s</a> einverstanden sind.');
