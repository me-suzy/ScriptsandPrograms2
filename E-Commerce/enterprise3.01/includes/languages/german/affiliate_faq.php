...
define('TEXT_INFORMATION', '' . STORE_NAME . ' hat diese FAQ geschrieben, um Ihnen die h&auml;ufigsten Fragen zu unserem Partnerprogramm schnell beantworten zu k&ouml;nnen.<br>
 Falls Sie weitere Fragen haben <a href="' . escs_href_link(FILENAME_AFFILIATE_CONTACT). '"> <u>kontaktieren</u></a> Sie uns bitte f&uuml;r weitere Informationen.<br>
<ul>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#1">Frage 1?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#2">Frage 2?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#3">Frage 3?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#4">Frage 4?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#5">Frage 5?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#6">Frage 6?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#7">Frage 7?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#8">Frage 8?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#9">Frage 9?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#10">Frage 10?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#11">Frage 11?</a>
<li><a href="' . escs_href_link('affiliate_faq.php') . '#12">Frage 12?</a>
</ul>
<hr width ="90%">
<br>
