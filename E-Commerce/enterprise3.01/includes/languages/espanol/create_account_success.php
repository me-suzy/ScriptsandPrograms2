...
define('TEXT_ACCOUNT_CREATED', 'Enhorabuena! Su cuenta ha sido creada con &eacute;xito! Ahora puede disfrutar de las ventajas de disponer de una cuenta para mejorar su navegaci&oacute;n en nuestro catalogo. Si tiene <small><b>CUALQUIER</b></small> pregunta sobre el funcionamiento del catalogo, por favor comuniquela al <a href="' . escs_href_link(FILENAME_CONTACT_US) . '">encargado</a>.<br><br>Se ha enviado una confirmaci&oacute;n a la direcci&oacute;n de correo que nos ha proporcionado. Si no lo ha recibido en 1 hora pongase en contacto con <a href="' . escs_href_link(FILENAME_CONTACT_US) . '">nosotros</a>.');
?>