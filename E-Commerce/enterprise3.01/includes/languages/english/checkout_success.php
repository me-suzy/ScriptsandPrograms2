...
define('TEXT_SEE_ORDERS', 'You can view your order history by going to the <a href="' . escs_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">\'My Account\'</a> page and by clicking on <a href="' . escs_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">\'History\'</a>.');
define('TEXT_CONTACT_STORE_OWNER', 'Please direct any questions you have to the <a href="' . escs_href_link(FILENAME_CONTACT_US) . '">store owner</a>.');
