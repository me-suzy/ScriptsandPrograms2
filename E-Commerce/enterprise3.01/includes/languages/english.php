...
function escs_date_raw($date, $reverse = false) {
  if ($reverse) {
...
// constants for use in escs_prev_next_display function
...
define('IMAGE_LIVE_SUPPORT_AVAILABLE', 'Live Support Available');
define('IMAGE_LIVE_SUPPORT_NOT_AVAILABLE', 'Live Support not Available');
// end live support mod
...
define('ERROR_escs_MAIL', '<font face="Verdana, Arial" size="2" color="#ff0000"><b><small>TEP ERROR:</small> Cannot send the email through the specified SMTP server. Please check your php.ini setting and correct the SMTP server if necessary.</b></font>');
...
define('WARNING_SESSION_DIRECTORY_NON_EXISTENT', 'Warning: The sessions directory does not exist: ' . escs_session_save_path() . '. Sessions will not work until this directory is created.');
define('WARNING_SESSION_DIRECTORY_NOT_WRITEABLE', 'Warning: I am not able to write to the sessions directory: ' . escs_session_save_path() . '. Sessions will not work until the right user permissions are set.');
...
/*
  ...
  If you remove this link, we will most likely not
  be able to answer support questions for your store.
*/

define('FOOTER_TEXT_BODY', '<p align="center" class="smallText"><br>This shopping cart uses <a href="http://www.enterprisecart.com">Enterprise Shopping Cart Software</a></p>');

define('HEADER_DIRECT_ACCESS', '<font color="#FFFFFF"><b>&laquo;&nbsp;&nbsp;</b></font><font color="#000000"><b>:Direct Link&nbsp;&nbsp;</b></font>');
define('IMAGE_BUTTON_SITE_MAP', 'View All Products');
define('IMAGE_BUTTON_ALL_PRODUCTS', 'View All Products');
