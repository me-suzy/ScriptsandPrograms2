 ...
 ****************************************************************************/
	...
	if (!strcmp($sub, "new_orders"))
	{
		...
		$q = db_query("SELECT orderID, order_time, cust_firstname, cust_lastname, cust_email, cust_country, cust_zip, cust_state, cust_city, cust_address, cust_phone FROM ".ORDERS_TABLE." order by order_time") or die (db_error());
		$result = array(); $i=0;
