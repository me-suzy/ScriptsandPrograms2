...
define('EVALUATION_VERSION_WARNING', '<font color=brown class=faq><b><u>Sorry, this facility is not available in Shop-Script FREE</u></b></font>
<p>This feature is supported in Shop-Script PRO and Shop-Script PREMIUM packages only.<br>For more information please refer to<br>
<a href="http://www.shop-script.com" class=cat>www.shop-script.com</a>
');

//miscellanious: buttons and links
define('LINK_TO_HOMEPAGE', 'Home');
define('PRODUCTS_BEST_CHOISE', 'Best choice');
define('MORE_INFO_ON_PRODUCT', 'more info...');
define('ENLARGE_PICTURE', 'enlarge...');
define('DISCUSS_ITEM_LINK', 'discuss');
define('POSTS_FOR_ITEM_STRING', 'post(s)');
...
define('CHANGE_CURRENCY_LINK', 'Change currency');
define('LOGOUT_LINK', 'Logout');
define('ADVANCED_SEARCH_LINK', 'advanced search');
define('FORGOT_PASSWORD_LINK', 'forgot password?');
define('ADMINISTRATE_LINK', '>> ADMINISTRATE <<');

define('ANSWER_YES', 'yes');
define('ANSWER_NO', 'no');
define('POST_BUTTON', 'Post');
define('OK_BUTTON', 'OK');
...
define('FIND_BUTTON', 'Find!');

//misc strings
define('STRING_BACK_TO_SHOPPING', 'Back to shopping');
define('STRING_BEFORE', 'before');
define('STRING_AFTER', 'after');
...
define('STRING_UNIVERSAL_CURRENCY', 'USD');
define('STRING_EMPTY_CATEGORY', 'no products');
define('STRING_NO_ORDERS', 'no orders');
define('STRING_EMPTY_LIST', 'empty list');
define('STRING_SEARCH', 'Search:');
define('STRING_SEARCH_IN_RESULTS', 'search in results');
define('STRING_LANGUAGE', 'Language');
define('STRING_THANK_YOU', 'Thank you!');
define('STRING_PRICELIST', 'Price list');
define('STRING_GREETINGS', '<h1>Hello and welcome to Shop-Script FREE!</h1>
<p>Shop-Script FREE is a free open source PHP shopping cart software.<br>Shop-Script FREE is complete turnkey ecommerce shopping cart solution that will help you to create your own search engine friendly online ecommerce store for free.
<p>Please view/download <a href="http://www.shop-script.com/documentation/shop-script-free.pdf">Shop-Script FREE User Guide (PDF)</a> before using this software. 
<p>For more information about available Shop-Script packages please refer to<br><a href="http://www.shop-script.com" class=cat>www.shop-script.com</a>');
define('STRING_FOUND', 'Found ');
define('STRING_NO_MATCHES_FOUND', 'No matches found');
define('STRING_PRODUCTS', 'product(s)');
define('STRING_CATEGORIES', 'category(ies)');
define('STRING_ORDER_ID', 'Order ID');
define('STRING_CHECK_YOUR_ORDER', 'Please verify your order');
define('STRING_TAX', 'Tax');
define('STRING_SHIPPING_TYPE', 'Shipping');
define('STRING_PAYMENT_TYPE', 'Payment');
define('STRING_ORDER_PLACED', 'Thank you for you order!<br>Our manager will contact you in the nearest time');
define('STRING_YOUR_ORDER', 'Your order');
define('STRING_PLACE_ORDER', 'Place order!');
define('STRING_NEXT', 'next');
define('STRING_PREVIOUS', 'prev');
define('STRING_SHOWALL', 'show all');
define('STRING_TURNED_OFF', 'unavailable in <nobr>Shop-Script FREE</nobr>');
...
define('ADMIN_PRODUCT_OPTIONS', 'Product extra options');
define('ADMIN_SETTINGS', 'Configuration');
define('ADMIN_SETTINGS_GENERAL', 'General settings');
define('ADMIN_SETTINGS_APPEARENCE', 'Appearence');
define('ADMIN_REPORTS', 'Reports');
define('ADMIN_CUSTOMERS', 'Customers');
define('ADMIN_CUSTOMERS_AND_ORDERS', 'Customers and orders');
define('ADMIN_VOTING', 'Poll');
define('ADMIN_SHIPPING_PAYMENT', 'Shipping and payment types');
define('ADMIN_CC_PROCESSING', 'Credit card processing');
define('ADMIN_IMPORT_FROM_EXCEL', 'Import from Excel');
define('ADMIN_NEWS', 'News');
define('ADMIN_ABOUT_PAGE', 'About page');
define('ADMIN_SHIPPING_PAGE', 'Shipping and delivery page');
define('ADMIN_SYNCHRONIZE_TOOLS', 'Synchronization tools');
define('ADMIN_AUX_INFO', 'Auxiliary information');
define('ADMIN_DB_TOOLS', 'DB tools');
define('ADMIN_MODULES', 'Modules');
...
define('ADMIN_ABOUT_PRICES', '<font class=small>// prices are actual for the time of order and shown without taxes //</font>');
define('ADMIN_NEWS_SUBSCRIBERS', 'Newsletter subscribers');
define('ADMIN_SHOP_NAME', 'Shop name');
define('ADMIN_SHOP_URL', 'Shop URL');
define('ADMIN_SHOP_EMAIL', 'General email');
define('ADMIN_ORDERS_EMAIL', 'Order notification email');
define('ADMIN_CHECK_STOCK', 'Perform stock level checking and alteration');
define('ADMIN_SHOW_CART_IN_NEW_WINDOW', 'Open new window when adding product to the shopping cart');
define('ADMIN_UPDATE_GCV', 'Update products count value for categories automatically');
define('ADMIN_CHECKSTOCK_DISABLED', 'Stock level control is disabled');
define('ADMIN_SHOW_ADD2CART', 'Show "Add to cart" button');
define('ADMIN_SHOW_BESTCHOICE', 'Show "Best choice"-products in empty categories');
...
define('ADMIN_MAIN_COLORS', 'Three main colors used for table drawing:');
define('ADMIN_COLOR', 'Color');
define('ADMIN_DEFAULT_CURRENCY', 'Default currency');
define('ADMIN_POPULAR_PRODUCTS', 'The most popular products');
define('ADMIN_SALABLE_PRODUCTS', 'Bestsellers');
define('ADMIN_OUT_OF_STOCK', 'Out of stock!');
define('ADMIN_SPECIAL_OFFERS', 'Special offers');
define('ADMIN_CURRENCY_TYPES', 'Currency types');
...
define('ADMIN_PRODUCT_PARENT', 'Parent');
...
define('ADMIN_RELATED_PRODUCTS_SELECT', 'Please, select a product');
define('ADMIN_SELECTED_PRODUCTS', 'Selected products:');
...
define('ERROR_CANT_FIND_REQUIRED_PAGE', 'Sorry, but requested page wasn`t found of the server');
define('ERROR_INPUT_EMAIL', 'Please input email address');
...
define('ERROR_INPUT_ADDRESS', 'Please input your address');
define('ERROR_INPUT_PHONE', 'Please input your phone number');
define('ERROR_FILL_FORM', 'Please fill all fields in the form');
define('ERROR_WRONG_PASSWORD', 'Wrong current password');
...
define('EMAIL_OUR_MANAGER_WILL_CONTACT_YOU', 'Our manager will contact you very soon.');
...
define('WARNING_MAGIC_QUOTES_GPC', '<b>magic_quotes_gpc</b> is set to <b>Off</b> on your PHP settings. You should turn <b>magic_quotes_gpc = On</b> for proper Shop-Script work<br>');
define('WARNING_WRONG_CHMOD', 'Wrong file access permissions for folder cfg, it\'s content and folders products_pictures, templates_c (or these folers does not exist). Please set (enable) write permissions for these folders and files to make them rewritable (usually proper permissions value is 775).');
