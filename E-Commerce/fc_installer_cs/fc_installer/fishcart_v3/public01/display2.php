...
<tr>
 <td align="center" height="20">
  ...
  $countcats->query("select count(*) as cnt from CATTABLE where catunder=$cat");
  ...
  "PRODTABLE.prodprice,prodlsku from CATTABLE,".
  "PRODTABLE,PRODLANG,PRODCATTABLE where ".
  ...
  "from CATTABLE,PRODTABLE,PRODLANG,PRODCATTABLE ".
  "where ".
  "catval=$cat and ".
  "pcatval=$cat and ".
  "catval=pcatval and ".
...
if ($subcattot) {
 ...
 $cats_across="1";
 $subcats = new FC_SQL;
 $subcats->query("select catval,catdescr,catmast,catlogo from CATTABLE ".
