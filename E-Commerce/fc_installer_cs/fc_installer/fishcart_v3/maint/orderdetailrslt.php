...
$notfound = 0;
if( $ototal ){
 $fcohead->query("select * from ORDERHEAD where orderid='$orderid'");
...
if( $notfound ){
 ...
 $fccust->query("select * from CUSTTABLE where custid=$purchid");
 ...
 $fcoline->query("select * from ORDERLINE where orderid='$orderid'");
