...
if ($act=="update") {
   ...
   $fcv->query("update VENDORTABLE set ".
 ...
 if( $databaseeng=='odbc' && $dialect=='solid' ){
	$fcv->query("call vendor_INSID ($zoneid,".
	...
	$fcv->query("insert into VENDORTABLE (vendzid,".
   ...
   $fcv->query("delete from VENDORTABLE where vendid=$vendid");
}
