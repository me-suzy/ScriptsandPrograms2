...
<?php 
$fcz->query("select * from ZONETABLE where zoneid=$zoneid"); 
$fcz->next_record();
?>
...
$fcl->query("select count(*) as cnt from LANGTABLE where langid=$zoneid");
$fcl->next_record();
$lt=(int)$fcl->f("cnt");
$fcl->free_result();
?>
...
<?php
$fcl->query("select langid,langdescr from LANGTABLE ".
