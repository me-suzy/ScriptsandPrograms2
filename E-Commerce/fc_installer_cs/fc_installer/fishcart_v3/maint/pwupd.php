...
if ($action=="A") {
	...
	$fcpw->query("insert into PASSWORDTABLE ".
	...
	$fcpw->query("update PASSWORDTABLE set ".
	...
	$send_pw=0;
	$fcpw->query("delete from PASSWORDTABLE where pwuid='$pwuid'");
...
if( $send_pw && $pwactive ){
	mail("$pwemail",
		 "COMPANY Catalog User Password Update",
		 "\n".
		 "Your new COMPANY catalog username and password are below.\n\n".
		 "   username: $pwuid\n".
		 "   password: $pwpw\n",
		 "From: ORDERCONF");
}
