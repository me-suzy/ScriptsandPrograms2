...
$fcm->query("select zoneid from MASTERTABLE"); 
$fcm->next_record();
?>
...
$fcz->query("select count(*) as cnt from ZONETABLE");
$fcz->next_record();
$zt=(int)$fcz->f('cnt');
$fcz->free_result();
...
$fcl->query("select count(*) as cnt from LANGTABLE where langid=$currz");
$fcl->next_record();
$lt=(int)$fcl->f("cnt");
$fcl->free_result();

$fcl->query(
"select langid,langdescr from LANGTABLE where langzid=$currz order by langid"); 
?>
