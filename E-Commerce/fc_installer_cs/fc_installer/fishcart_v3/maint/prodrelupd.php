...
if ($act == 'insert') {
    ...
    $fcpb = new FC_SQL;
        ...
        $fcpa->query("select prodzid from PRODTABLE where prodsku='$relsku' ".
                     "and prodzid=$zoneid");
        if (!$fcpa->next_record()){
        ...
        $fcpb->query("select prodzid from PRODTABLE where prodsku='$relprod' ".
                     "and prodzid=$zoneid");
        if (!$fcpb->next_record()){
...
*/
$fccb = new FC_SQL;
$fccb -> query("select prodflag1 from PRODTABLE where prodsku='$relsku' ".
              "and prodzid='$zoneid'");
$fccb  -> next_record();
...
$fccr = new FC_SQL;
$fccr -> query("update PRODTABLE set prodflag1=$flag1 where prodsku='$relsku'".
              " and prodzid=$zoneid");
$fccr -> commit();
