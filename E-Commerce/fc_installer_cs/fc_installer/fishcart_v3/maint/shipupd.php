...
if($act=="update"){
 ...
 $fcs->query("update SHIPTABLE set ".
 ...
 $shipid=$fcs->insert_id("shipid","SHIPTABLE","shipdescr='$shipdescr'");
 ...
 $fcs->query("delete from SHIPTABLE where shipid=$shipid");
 $fcs->query("delete from SHIPTHRESH where shipid=$shipid");
 $fcs->query("delete from WEIGHTTHRESH where shipid=$shipid");
}
