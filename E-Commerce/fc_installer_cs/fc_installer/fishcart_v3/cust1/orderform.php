...
if(($onoff!="on")&&($onoff!="off")){
	...
	echo "select either the Online or Offline order method.  Thank you.</b>\n";
	exit;
}
...
$tph=ereg_replace("\(","",$billing_phone);
$tph=ereg_replace("\)","",$tph);
$tph=ereg_replace("-","",$tph);
$tph=ereg_replace("/","",$tph);
$tph=ereg_replace("\.","",$tph);
$tph=ereg_replace(" ","",$tph);
$billing_phone=ereg_replace(" ","",$tph);

$tph=ereg_replace("\(","",$shipping_phone);
$tph=ereg_replace("\)","",$tph);
$tph=ereg_replace("-","",$tph);
$tph=ereg_replace("/","",$tph);
$tph=ereg_replace("\.","",$tph);
$tph=ereg_replace(" ","",$tph);
$shipping_phone=ereg_replace(" ","",$tph);

$billing_zip=ereg_replace("-","",$billing_zip);
$billing_zip=ereg_replace("_","",$billing_zip);
$billing_zip=ereg_replace(" ","",$billing_zip);
$shipping_zip=ereg_replace("-","",$shipping_zip);
$shipping_zip=ereg_replace("_","",$shipping_zip);
$shipping_zip=ereg_replace(" ","",$shipping_zip);
