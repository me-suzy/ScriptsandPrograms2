...
-- MSSQL tables for FishCartSQL
-- 
-- sequences are done via integer not null identity(1,1) primary key
-- the primary key is used so the last inserted id can be fetched
...
grant select,insert on MASTERTABLE to fishcart;
grant all on MASTERTABLE to fishcart;
...
create table ASSOCIATETABLE (
	ascid integer not null identity(1,1) primary key,
	asczid  integer,
	asclid  integer,
	ascwebid integer,
	ascdesc varchar(255),
	ascname varchar(255),
	ascaddr1  varchar(255),
	ascaddr2  varchar(255),
	asccity   varchar(255),
	ascstate  varchar(255),
	asczip    varchar(255),
	ascnatl   varchar(255),
	ascphone  varchar(255),
	ascfax    varchar(255),
	ascemail  varchar(255),
	ascsvcname   varchar(255),
	ascsvcaddr1  varchar(255),
	ascsvcaddr2  varchar(255),
	ascsvccity   varchar(255),
	ascsvcstate  varchar(255),
	ascsvczip    varchar(255),
	ascsvcnatl   varchar(255),
	ascsvcphone  varchar(255),
	ascsvcfax    varchar(255),
	ascsvcemail  varchar(255),
	asconline varchar(255),
	ascofline varchar(255),
	ascoemail varchar(255),
	ascconfirm varchar(255),
	ascactive integer
...
create table LANGTABLE ( 
	langid    integer not null identity(1,1) primary key,
	langzid   integer,
	langdef   integer,
	-- ISO 639/2 code
	langiso   char(3),
	langdescr varchar(255),
	langtmpl  varchar(255),
	langtdsp  varchar(255),
	langterr  varchar(255),
	langshow  varchar(255),
	langgeo   varchar(255),
	langordr  varchar(255),
	langproc  varchar(255),
	langfinl  varchar(255),
	langstmpl varchar(255),
...
insert into LANGTABLE
    ...
    values
    (1,'eng','English','','','','showcart.php','showgeo.php',
...
create table CATTABLE ( 
	catval   integer not null identity(1,1) primary key,
	catzid   integer,
	catlid   integer,
	catlogo  varchar(255),
	catlogoh integer,
	catlogow integer,
    catbutton  varchar(255),
	catbuttonh integer,
	catbuttonw integer,
	...
	catbg    varchar(255),
	catlink  varchar(255),
	catvlink varchar(255),
	catalink varchar(255),
	catbanr  varchar(255),
	catbanrh integer,
	catbanrw integer,
	catsku   varchar(255),
	cattext  varchar(255),
	catmast  varchar(8000),
	cattmpl  varchar(255),
	catsort  varchar(255),
	catfree  varchar(255),
	catunder integer, 
...
insert into CATTABLE
        (catzid, catlid, catlogo, catlogoh, catlogow, 
        ...
        values 
        (1,1,'',0,0,'',0,0,'Front Page Promotions','','','','','','',0,0,'','','','','prodsku','',0,0,':1:',5,1,0);
insert into CATTABLE
        (catzid, catlid, catlogo, catlogoh, catlogow, 
         catbutton, catbuttonh, catbuttonw, catdescr, catback,
         catbg, catlink, catvlink, catalink, catbanr, catbanrh, catbanrw,
         ...
         catact, catunder, catpath, catprodpage,catcols,catseq)
        values 
        (1,1,'',0,0,'',0,0,'Suggested Items','','','','','','',0,0,'','','','','prodsku','',0,0,':2:',5,1,0);
insert into CATTABLE
        (catzid, catlid, catlogo, catlogoh, catlogow, 
         catbutton, catbuttonh, catbuttonw, catdescr, catback,
         catbg, catlink, catvlink, catalink, catbanr, catbanrh, catbanrw,
         ...
         catact, catunder, catpath, catprodpage,catcols,catseq)
        values 
        (1,1,'',0,0,'',0,0,'Default Category','','','','','','',0,0,'','','','','prodsku','',1,0,':3:',5,1,0);
...
grant all on PRODTABLE to USERID;
...
create table PRODLANG (
	prodlid      integer,
	prodlzid     integer,
	prodlsku     varchar(255),
	prodpic      varchar(255),
	prodpich     integer,
	prodpicw     integer,
	prodtpic     varchar(255),
	prodtpich    integer,
	prodtpicw    integer,
	prodbanr     varchar(255),
	prodbanrh    integer,
	prodbanrw    integer,
	prodaudio    varchar(255),
	prodvideo    varchar(255),
	prodsplash   varchar(255),
	...
	proddescr    text,
	installinst  text,
	prodoffer    varchar(255),
	prodstyle    varchar(255),
	-- product download link
	proddload    varchar(255),
	-- artist/author name
	prodauth     varchar(255),
	-- external URL for this author
	prodauthurl  varchar(255),
	-- external URL for this product
	prodtitleurl varchar(255),
	-- product lead time information
	prodleadtime varchar(255),
...
create table PRODOPT (
	...
	poptid       integer not null identity(1,1) primary key,
	-- zone ID
	poptzid      integer,
	-- language ID
	poptlid      integer,
...
create table ZONETABLE (
	...
	zoneid        integer not null identity(1,1) primary key,
	-- description
	zonedescr     varchar(255),
	-- default currency symbol for this zone
	zonecurrsym   varchar(255),
	-- zone active flag
	zoneact       integer,
	-- bit flags
	zflag1        integer,
...
create table SUBZONETABLE (
	...
	subzid        integer,
	-- unique row ID
	subzsid       integer not null identity(1,1) primary key,
	-- subzone description
	subzdescr     varchar(255),
...
insert into ZONETABLE (zonedescr,zonecurrsym,zoneact,zflag1,zonedeflid) values ('', '$', 1, 17, 1); 
...
create table VENDORTABLE (
  vendid     integer not null identity(1,1) primary key,
  vendzid    integer,
  vendname   varchar(255),
  vendaddr1  varchar(255),
  vendaddr2  varchar(255),
  vendcity   varchar(255),
  vendstate  varchar(255),
  vendzip    varchar(255),
  vendnatl   varchar(255),
  vendphone  varchar(255),
  vendfax    varchar(255),
  vendemail  varchar(255),
  vsvcname   varchar(255),
  vsvcaddr1  varchar(255),
  vsvcaddr2  varchar(255),
  vsvccity   varchar(255),
  vsvcstate  varchar(255),
  vsvczip    varchar(255),
  vsvcnatl   varchar(255),
  vsvcphone  varchar(255),
  vsvcfax    varchar(255),
  vsvcemail  varchar(255),
  vendonline varchar(255),
  vendofline varchar(255),
  vendoemail varchar(255),
  vendconfirm varchar(255),
  vflag1     integer
);
...
create table WEBTABLE (
	webid        integer not null identity(1,1) primary key,
	webzid       integer,
	weblid       integer,
	webdescr     varchar(255),
	realhome     varchar(255),
	carthome     varchar(255),
	...
	webtext      varchar(255),
	weblink      varchar(255),
	webvlink     varchar(255),
	webalink     varchar(255),
	webhdsku     varchar(255),
	webhdtext    varchar(255),
	webhdgraph   varchar(255),
	webhdgraphw  integer,
	webhdgraphh  integer,
	webftsku     varchar(255),
	webfttext    varchar(255),
	webftgraph   varchar(255),
	webftgraphw  integer,
	webftgraphh  integer,
	webdaysinnew integer,
	webnewlogo   varchar(255),
	webnewlogow  integer,
	webnewlogoh  integer,
	webnewmast   varchar(255),
	webnewmastw  integer,
	webnewmasth  integer,
	webspeclogo  varchar(255),
	webspeclogow integer,
	webspeclogoh integer,
	webspecmast  varchar(255),
	webspecmastw integer,
	webspecmasth integer,
	webviewlogo  varchar(255),
...
create table SHIPTABLE (
	...
	shipid        integer not null identity(1,1) primary key,
	shipzid       integer,
	shiplid       integer,
	shipdescr     varchar(255),
...
insert into SHIPTABLE
        (shipzid, shiplid, shipdescr, shipmeth, shippercent,
         ...
         shipaux1, shipaux2, shipsvccode)
        values
        (1,1,'Default Shipping',1,0.0,0.0,0.0,'shipthreshper.php','','','','','','');
...
-- ********** Order Summary Table *************
--
-- MSSQL Server Layout for the FishCart split CC number delivery tables
--
...
create table ESDTABLE (
	-- unique row ID
	esdid		integer not null identity(1,1) primary key,
...
create table AUXLINKTABLE (
	rid		integer not null identity(1,1) primary key,
	seq		integer,
	loc		integer,
	title	varchar(64),
	url		varchar(255)
