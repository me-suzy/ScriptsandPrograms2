...
// retrieve the record for the email address
    $wwkwijt = new FC_SQL;
    $wwkwijt->query("SELECT pwactive,pwemail,pwuid,pwpw from PASSWORDTABLE ".
...
$subject .="Information you requested from COMPANY";
$messages .="Your COMPANY catalog password:\n";
$messages .="username : $login\n";
$messages .="password : $ww\n";
$headers .="From: ORDERCONF>\n";
$headers .="Return-Path: <ORDERCONF>\n";
