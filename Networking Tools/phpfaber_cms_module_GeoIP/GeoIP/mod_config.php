...
$_MOD = array(
  'name'  => 'GeoIP DB',
  'descr' => 'GeoIP module lookups the country by IP address. It uses in some places of the phpFaber CMS now. So, you are able to see country flag near IP address. It can be as necessary feature somtimes.',
);
