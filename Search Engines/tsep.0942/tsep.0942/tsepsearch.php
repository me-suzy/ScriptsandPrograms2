...
<link href="/<?php echo $tsep_config['Path'];?>/css/tsep.css" rel="stylesheet" type="text/css" />

</head>
<body>

<?php require( $tsep_config["absPath"]."/search.php" ); ?>

<div class="tsepProject">

<div class="poweredby">
    <a href="http://tsep.sourceforge.net/" title="<?php echo $tsep_lng['help_copyright']; ?>" target="_blank"><img src="/<?php echo $tsep_config["Path"] ?>/graphics/poweredbytsep.gif" alt="<?php echo $tsep_lng['powered_by'];?> <?php echo $tsep_lng['tsep'];?>"></a>
</div>
