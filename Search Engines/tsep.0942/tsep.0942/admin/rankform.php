...
$db_tablename   = $db_table_prefix."ranksymbols";
$modify_percent = "";
...
$result_dis = mysql_query($sql_dis, $tsepdbconnection) or die(mysql_error());
...
?>
	<div class="rankBlockOld">		
		...
		while ($line = (mysql_fetch_row($result_dis))) {
			...
			?>		
			<div class="rank_Single_Entry_Block" <?php require($tsep_config["absPath"]."/include/colorswitch.php"); ?>>		
