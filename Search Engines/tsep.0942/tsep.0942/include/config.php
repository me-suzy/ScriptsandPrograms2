...
$tsepconfiguration = mysql_query($query_tsepconfiguration, $tsepdbconnection) or die(mysql_error());
...
$totalRows_tsepconfiguration = mysql_num_rows($tsepconfiguration);
        do
        {
                ...
                // ! ! ! for backwardcompatibility only ! ! !
                   $tsep_config["config_$str"] = $tsep_config["$str"];
                }
...
if ($tsep_config['config_Use_Debug_Print']=="true")
{
        include_once( $tsep_config["absPath"]."/include/debugprint.php");
}
