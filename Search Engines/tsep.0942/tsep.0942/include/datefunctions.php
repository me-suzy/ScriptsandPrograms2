...
*/
function read_indexedit_date($database_tsepdbconnection, $tsepdbconnection)
{
    global $tsep_config, $db_table_prefix, $database_tsepdbconnection;
    
    // === START === to get the date from the database===============================
    //call:
    //      read_indexedit_date($database_tsepdbconnection, $tsepdbconnection);
    ...
    $lastindexedit = mysql_query($query_lastindexedit, $tsepdbconnection) or die(mysql_error());
    ...
    if (!isset($tsep_config['config_Date_Style']))  
    {
            $tsep_config['config_Date_Style'] = "l, F d Y h:i a";
    }
    echo datum($tsep_config['config_Date_Style'],$tsepindexeditlast); // Change to how you wish the stamp to display.
