...
//$tsepindexeditdate = date($tsep_config['config_Date_Style'],time() + $timeadjust); // Change to how you wish the stamp to display.

//use timestamp only!
//$tsepindexeditdate = datum($tsep_config['config_Date_Style'],time() + $timeadjust); // Change to how you wish the stamp to display.
