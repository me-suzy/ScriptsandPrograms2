...
if  ($tsep_config['config_Numbers_Put']=="true")	// output the number of this result
{
	?>
	<div class="resultnumber" title="<?php echo $tsep_lng['page_rank_real'];?>">
		<?php echo $tsep_config['config_Numbers_Put_Before'].($i+1).$tsep_config['config_Numbers_Put_After']; ?>
	</div>
	<?php
}
?>
