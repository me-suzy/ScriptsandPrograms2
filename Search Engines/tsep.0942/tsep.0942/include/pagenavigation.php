...
<div class="SearchBlock">
	<?php require( $tsep_config["absPath"]."/include/searchterm.php"); //use code-recycling whereever possible !?>
	<div class="SearchResultPaging">
	    <?php
		if (((floor($page_count/$tsep_config['config_How_Many_Results'])+1)*$tsep_config['config_How_Many_Results']) == $e)
		{
...
<?php require($tsep_config["absPath"]."/include/timeneeded.php"); //how long did it take to build the page?>
  </div>
</div>
