...
$stopwords = mysql_query($query_stopwords, $tsepdbconnection) or die(mysql_error());
...
&quot;<?php echo $row_stopwords['stopword']; ?>&quot;
  ...
  <?php
require( $tsep_config["absPath"]."/include/copyright.php" ); // Use code-recyling whereever possible			
?>
</div>
</body>
</html>
