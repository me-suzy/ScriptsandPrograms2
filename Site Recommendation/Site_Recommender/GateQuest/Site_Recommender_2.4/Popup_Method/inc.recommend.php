...
$sitename = 'GateQuest';				// Name of your site.

$url = 'http://www.gatequest.net';			// Web address for your site.

$webmasterEmail = 'test@gatequest.net';		// Your email address.
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
    ...
    ?> 
    <tr>
        <td colspan="2">Your Message&nbsp;&nbsp;º <span class="basefontblue">Optional</span> º<br />
