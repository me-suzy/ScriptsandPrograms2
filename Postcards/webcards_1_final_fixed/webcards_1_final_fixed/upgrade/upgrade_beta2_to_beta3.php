...
switch($HTTP_GET_VARS['stage'])
{
	...
	default:
	echo "<span class=\"title\">Upgrade beta 2 to beta 3</span><br /><br />
			This script is <b>ONLY</b> designed for people who currently have beta 2 installed but wish to upgrade to beta 3.<br /><br />
			Some changes were made to the database structure in beta 3. This script will make those changes for you.
			<br /><br />If you do not have beta 2 installed you should <b>NOT</b> run this upgrade script. It will mess up your database.
			<br /><br />
			Click the button below to check you have the correct files uploaded.<br /><br />
			<form action=\"upgrade_beta2.php?stage=perms\" method=\"post\"><input type=\"submit\" value=\"Proceed with instalation\"></form>";
	break;
}
...
function do_upgrade()
{
	...
	$sql[] = "ALTER TABLE `" . $conf['dbprefix'] . "admin` CHANGE `id` `id` INT( 10 ) NOT NULL AUTO_INCREMENT";
	$sql[] = "ALTER TABLE `" . $conf['dbprefix'] . "categories` CHANGE `id` `id` INT( 10 ) NOT NULL AUTO_INCREMENT";
	$sql[] = "ALTER TABLE `" . $conf['dbprefix'] . "email_logs` CHANGE `id` `id` INT( 10 ) NOT NULL AUTO_INCREMENT";
	$sql[] = "ALTER TABLE `" . $conf['dbprefix'] . "images` CHANGE `id` `id` INT( 10 ) NOT NULL AUTO_INCREMENT";
	$sql[] = "ALTER TABLE `" . $conf['dbprefix'] . "images` CHANGE `cat` `cat` INT( 10 ) DEFAULT '0' NOT NULL";
	$sql[] = "ALTER TABLE `" . $conf['dbprefix'] . "macro` CHANGE `id` `id` INT( 10 ) NOT NULL AUTO_INCREMENT";
	$sql[] = "ALTER TABLE `" . $conf['dbprefix'] . "sent_cards` CHANGE `pic` `pic` INT( 10 ) DEFAULT '0' NOT NULL";
	...
	echo "<span class=\"title\">Upgrade Complete</span><br /><br />Your Webcards installation has been sucessfully upgraded to beta 3.<br /><br /><span class=\"warning\">You MUST remove this file immediately.</span> If you do not, your installation is at risk.";
