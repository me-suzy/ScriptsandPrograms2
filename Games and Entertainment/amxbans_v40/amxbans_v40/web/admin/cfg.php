...
?>";
	...
	$now = date("U");
	$add_log	= mysql_query("INSERT INTO $config->logs VALUES ('', '$now', '".$_SERVER['REMOTE_ADDR']."', '".$_SESSION['uid']."', 'AMXBans config', 'Changed AMXBans configuration')") or die (mysql_error());

}


if ($_POST['db'] == " check connection ") {
...
$smarty->assign("checked_dirs",$checked_dirs);
$smarty->assign("doc_root_is_dir",$doc_root_is_dir);
$smarty->assign("path_root_is_dir",$path_root_is_dir);
$smarty->assign("dir_import_is_dir",$dir_import_is_dir);
$smarty->assign("dir_template_is_dir",$dir_template_is_dir);
