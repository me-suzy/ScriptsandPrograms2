...
class HLSERVER_INFOS {
  ...
  // server commands
  var $serv_requestcommand_infos = "\xFF\xFF\xFF\xFFinfo\x00";
  var $serv_requestcommand_rules = "\xFF\xFF\xFF\xFFrules\x00";
  var $serv_requestcommand_players  = "\xFF\xFF\xFF\xFFplayers\x00";
