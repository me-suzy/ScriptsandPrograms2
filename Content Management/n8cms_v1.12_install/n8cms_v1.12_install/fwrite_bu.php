...
if ( (!$db_name)|| (!$db_user)|| (!$db_pass)||(!$db_host)||(!$cms_path) ){
	echo" you must fill in the following info:<font color=red>";
	...
	if (!$cms_path){echo"enter the path to the installation<br>"; }
echo "</font>";
}
else{
