...
$userdata['user_id'] = $gBitUser->mUserId;
...
$maxTopics = ( $gBitSystem->getPreference( 'maxRecords', 20 ) );
...
$template->assign_vars(array(
	...
	'U_POST_NEW_TOPIC' => PHPBB_PKG_URL.append_sid("posting.$phpEx?mode=newtopic&amp;" . POST_FORUM_URL . "=$forum_id"),

	'S_SELECT_TOPIC_DAYS' => $select_topic_days,
	'S_POST_DAYS_ACTION' => PHPBB_PKG_URL.append_sid("viewforum.$phpEx?" . POST_FORUM_URL . "=" . $forum_id . "&amp;start=$start"))
);
...
$template->assign_vars(array(
	...
	'U_VIEW_FORUM' => PHPBB_PKG_URL.append_sid("viewforum.$phpEx?" . POST_FORUM_URL ."=$forum_id"),

	'U_MARK_READ' => PHPBB_PKG_URL.append_sid("viewforum.$phpEx?" . POST_FORUM_URL . "=$forum_id&amp;mark=topics"))
);
//
// End header
//
...
if( $total_topics )
{
	for($i = 0; $i < $total_topics; $i++)
	{
		...
		$template->assign_block_vars('topicrow', array(
			...
			'U_VIEW_TOPIC' => PHPBB_PKG_URL.$view_topic_url)
		);
	}
