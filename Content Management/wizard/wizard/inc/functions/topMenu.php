...
*   $topMenu[$count][6];  group permission level
*/


// page and menu data 
	$db = new DB();
	$db->query("SELECT * FROM ". DB_PREPEND . "menuData WHERE id=1 ");
	$i = $db->next_record();
...
//iterate through the menu data file
   foreach ($topMenu as $v1) {
	  ...
	  echo "href=\"".CMS_WWW."/pages/". $topMenu[$count][4] . "?id=" . $topMenu[$count][1] . "\">".$topMenu[$count][2]."</a>"; 
