<html>
<head>
	<title>ClanAdmin Tools 1.3.3, 1.3.4pr1 -> 1.3.4 Update wizard</title>
</head>
...
else
{
 if(!empty($error))
 {
  		echo"<h3>Welcome to the ClanAdmin Tools v1.3.4 update wizard</h3>";
  		echo"$error";
  		echo"</td>
                            </tr>
                            <tr>
		 ...
		 echo"<h3>Welcome to the ClanAdmin Tools v1.3.4 update wizard</h3>
                		  	  This wizard will help you update from 1.3.3 & 1.3.4pr1 to 1.3.4
                		  	  <br/><br/>
