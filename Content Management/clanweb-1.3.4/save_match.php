...
**********************************************************/
	  ...
	  require ('_inc/top.inc.php');
				...
				$sql = "INSERT INTO " .$db_prefix. "game (dates, team1, team2, point1, point2, type, map, lineup, report)
					   	VALUES ('$dates', '$team1', '$team2', '$point1', '$point2', '$type', '$map', '$lineup', '$report')";
