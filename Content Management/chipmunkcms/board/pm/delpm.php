...
if (isset($_SESSION['user'])) 
  {
    ...
    print "<tr class='headline'><td><center>Delete PM - <A href='pm.php'><font color='white'>Back to PM main</font></a></center></td></tr>";
    print "<tr class='forumrow'><td>";
    if(isset($_POST['submit']))
    {
       $theid=$_POST['theid'];
       $delmessage="DELETE FROM b_pms where pmID='$theid' and receiver='$getuser3[userID]'";
       mysql_query($delmessage) or die("Could not delete message");
       print "PM deleted, back to <A href='pm.php'>PM Main</a>"; 
    ...
    else
    {
       ...
       print "<input type='hidden' value='$ID' name='theid'>";
