...
if ($selectuser3[status]>="3")
   {
      ...
      {
        print "<tr class='forumrow'><td>$getcats3[categoryname]</td><td><A href='deleteartcat.php?categoryid=$getcats3[categoryid]'>Delete?</td><td><A href='editartcats.php?categoryid=$getcats3[categoryid]'>Edit?</a></td></tr>";
      }         
      print "</td></tr></table>";    
      print "</center>";
