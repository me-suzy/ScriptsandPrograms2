...
if ($selectuser3[status]>="3")
   {
      ...
      print "<tr class='headline'><td>Add Article Category";
      print "</td></tr>";
      print "<tr class='forumrow'><td>";
      if(isset($_POST['submit']))
      {
        ...
        $addcategory="INSERT into b_artcats (categoryname) values('$catname')";
      ...
      {
        print "<form action='addartcat.php' method='post'>Type name of category to add:<br>";
