...
if ($selectuser3[status]>="3")
   {
      ...
      if(isset($_POST['submit']))
      {
         ...
         $deletearts="DELETE from b_pages where pagecat='$parentcat'";
         mysql_query($deletearts) or die("Coudl not delete articles");
         $deletecat="Delete from b_pagecats where pagecatid='$parentcat'";
      ...
      {
          print "Are you sure you want to delete this category and all pages in it?<br><br>";
          $categoryid=$_GET['categoryid'];
          print "<form action='deletepagecat.php' method='post'>";
