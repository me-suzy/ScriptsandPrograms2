...
if ($selectuser3[status]>="3")
   {
      ...
      print "<tr class='headline'><td>Delete Pages";
      print "</td></tr>";
      print "<tr class='forumrow'><td>";
      if(isset($_POST['submit']))
      {
         $pageid=$_POST['pageid'];
         $deletepage="DELETE from b_pages where pageid='$pageid'";
         mysql_query($deletepage) or die("Could not delete page");
         print "Page deleted.";
      ...
      {
         $pageid=$_GET['ID'];
         print "Are you sure you want to delete this page?<br>";
         print "<form action='deletepage.php' method='post'>";
