...
if (($strID != "") && ($strID != "0"))
	...
	$strsql = "SELECT UserID,Password,UserName,EMail,AdminUser,Active FROM cms_t_users" ;
...
?>
	...
	objControl=vfrmForm.chkAdmin ;
	vfrmForm.txtAdmin.value = 'N';
	if (objControl.checked==true) {
		vfrmForm.txtAdmin.value = 'Y';
	}
...
<table border='2' cellspacing='0' cellpadding='6' bordercolor='#C0C0C0'>
	...
	<TR>
		<TD>Admin</TD>
		<TD>
		<INPUT type="checkbox" id=chkAdmin name=chkAdmin value='<?php print $strAdmin ?>' <?php if ($strAdmin=="Y") { print "checked";}?> >
		</TD>
	</TR>
	<TR>
		<TD>Active</TD>
...
<INPUT type="hidden" id=txtAdmin name=txtAdmin value=''>
