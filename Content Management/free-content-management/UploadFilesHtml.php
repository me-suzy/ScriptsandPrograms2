...
<BODY>
<h3><img src="Includes/html.gif" width="36" height="36" alt="Upload HTML Files"> <img src="Includes/upload.gif" alt="upload" width="23" height="26" border="0">Upload HTML Files </h3>
<form method=post
...
if(!empty($_FILES["YourFile"])) { 
    $uploaddir = FileUploadPathRelative;//FileUploadPath; // set this to wherever 
