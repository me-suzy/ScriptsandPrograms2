      ...
      <tr>
        <td height="19"><table width="110" border="0" align="left" cellpadding="0" cellspacing="0" bordercolor="#000000">
          ...
          <table width="290" height="25" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="290" height="21" bgcolor="#FFFFFF"><?php session_destroy(); 
echo "You have been logged out, you will be redirected to the login page in 3 seconds <META HTTP-EQUIV=\"refresh\" CONTENT=\"3; URL=index.php\">";
?>                <br>
                <br>                </td>
            </tr>
          </table>
