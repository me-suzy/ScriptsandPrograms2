<?php
/* $Id: class.lib_indexer_checksearch_phpcms.php,v 1.1.1.1.2.19 2004/07/16 09:01:26 bjmg Exp $ */
/*
   +----------------------------------------------------------------------+
...
// #######################################################################
function search_now() {
	global $DEFAULTS, $session, $formdata, $MESSAGES, $PHPCMS_INCLUDEPATH, $PHP_SELF;
	// Profil ermitteln
	$profiles = read_profiles();
