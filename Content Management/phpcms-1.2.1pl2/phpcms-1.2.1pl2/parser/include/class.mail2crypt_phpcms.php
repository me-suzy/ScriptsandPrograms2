<?php
/* $Id: class.mail2crypt_phpcms.php,v 1.1.2.20 2004/10/22 13:40:50 bjmg Exp $ */
/*
   +----------------------------------------------------------------------+
...
* @version   1.5.3 ($Date: 2004/10/22 13:40:50 $) $Revision: 1.1.2.20 $
* @access    public
*/
class Mail2Crypt {
		...
		if($DEFAULTS->MAIL2CRYPT == 'on') {
			...
			if(!file_exists($js_file)) {
				...
				if($fp) {
					...
					$js_code = htmlentities($mail2crypt_js);
