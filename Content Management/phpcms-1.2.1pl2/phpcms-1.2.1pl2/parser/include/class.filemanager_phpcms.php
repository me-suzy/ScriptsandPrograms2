<?php
/* $Id: class.filemanager_phpcms.php,v 1.2.2.35 2004/10/22 13:40:50 bjmg Exp $ */
/*
   +----------------------------------------------------------------------+
   ...
   | class FILEMANAGER Copyright (c) 2003 Markus Richert
   +----------------------------------------------------------------------+
   ...
   | MA  02111-1307, USA.
   +----------------------------------------------------------------------+
   | Original Author: Markus Richert (e157m369)
   | Contributors:
...
class FILEMANAGER {
	...
	function FILEMANAGER() {
		global $DEFAULTS, $DOCUMENT, $_FILES, $_REQUEST, $PHPCMS_INCLUDEPATH;
...
////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////
	function DisplayDir() {
		global $DEFAULTS, $DOCUMENT, $PHPCMS_INCLUDEPATH, $_REQUEST;
	...
	////////////////////////////////////////////////////////////////////////////////
	function create() {
		global $DEFAULTS, $_REQUEST, $PHPCMS_INCLUDEPATH;
