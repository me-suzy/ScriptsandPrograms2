...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	...
	//		document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'image.gif" width="25" height="24" alt="Add File" title="Add File" onClick="dlgInsertFile(\'' + rte + '\')"></td>');
...
function dlgInsertFile(rte) {
	//function to open/close insert file dialog
	currentRTE = rte;
	InsertFile = popUpWin(includesPath + 'filemanager.php', 'InsertFile', 800, 600, '');
}
