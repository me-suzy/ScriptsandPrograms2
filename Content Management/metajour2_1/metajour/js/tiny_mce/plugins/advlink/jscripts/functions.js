...
function init() {
	...
	document.getElementById('hrefbrowsercontainer').innerHTML = getBrowserHTMLdocument('hrefbrowser','href','file','advlink');
	document.getElementById('filebrowsercontainer').innerHTML = getBrowserHTMLfile('filebrowser', 'href', 'image', 'advlink');
	...
	if (isVisible('hrefbrowser'))
		document.getElementById('href').style.width = '235px';
