...
function showMenuItemIcon() { // Public method
  ...
  var mySetIconClassName = function(className) { // Public method
    this.iconClassName = className;
    this.iconObj.className = this.iconClassName;
  };
  EventManager.AddFunction(this, "setIconClassName", mySetIconClassName);
  var mySetIconClassNameOver = function(classNameOver) { // Public method
    this.iconClassNameOver = classNameOver;
  };
  EventManager.AddFunction(this, "setIconClassNameOver", mySetIconClassNameOver);
}
...
function setSubMenu(menuObj) { // Public method
  ...
  EventManager.AddFunction(this, "arrowObj", arrowElm);
  var mySetArrowClassName = function(className) { // Public method
    this.arrowClassName = className;
    this.arrowObj.className = this.arrowClassName;
  };
  EventManager.AddFunction(this, "setArrowClassName", mySetArrowClassName);
  
  
  var mySetArrowClassNameOver = function(classNameOver) { // Public method
    this.arrowClassNameOver = classNameOver;
  };
  EventManager.AddFunction(this, "setArrowClassNameOver", mySetArrowClassNameOver);
...
function addMenuItem(menuItemObj) { // Public method
  if (menuItemObj.displayText == "-") {
    ...
    //itemElm.parent = this;
    EventManager.AddFunction(itemElm, "parent", this);
    /*itemElm.setClassName = function(className) { // Public method
      this.sepClassName = className;
      this.className = this.sepClassName;
    };*/
    
    var mySetClassName = function(className) { // Public method
      this.sepClassName = className;
      this.className = this.sepClassName;
    }
    EventManager.AddFunction(itemElm, 'setClassName', mySetClassName);
    ...
    EventManager.Add(itemElm, "click", myOnClick);
    
    //itemElm.onmouseover = menuItemOver;
    EventManager.Add(itemElm, "mouseover", menuItemOver);
    
    if (menuItemObj.itemName.length > 0) {
      //this.items[menuItemObj.itemName] = itemElm;
     EventManager.AddFunction(this.items, menuItemObj.itemName, itemElm);
    }
    else {
      //this.items[this.items.length] = itemElm;
      EventManager.AddFunction(this.items, this.items.length, itemElm);
    }
  }
  else {
    var itemElm = createElm("div");
    ...
    var mySetClassNameOver = function(classNameOver) { // Public method
      this.itemClassNameOver = classNameOver;
    };
    EventManager.AddFunction(itemElm, "setClassNameOver", mySetClassNameOver);
    ...
    var mySetDisplayText = function(text) { // Public method
      if (this.childNodes[0].nodeType == 3) {
        this.childNodes[0].nodeValue = text;
      }
      else {
    ...
    EventManager.AddFunction(itemElm, "setDisplayText", mySetDisplayText);
...
function jsDOMenu() { // Public method
  ...
  EventManager.AddFunction(this, "menuObj", menuElm);
  //this.addMenuItem = addMenuItem;
  EventManager.AddFunction(this, "addMenuItem", addMenuItem);
  var mySetClassName = function(className) { // Public method
    this.menuObj.className = className;
  };
  EventManager.AddFunction(this, "setClassName", mySetClassName);
  var mySetMode = function(mode) { // Public method
    switch (mode) {
      case "cursor":
  ...
  EventManager.AddFunction(this, "setMode", mySetMode);
  var mySetAlwaysVisible = function(alwaysVisible) { // Public method
    if (typeof(alwaysVisible) == "boolean") {
      this.menuObj.alwaysVisible = alwaysVisible;
    }
  };
  EventManager.AddFunction(this, "setAlwaysVisible", mySetAlwaysVisible);
  
  var myShow = function() { // Public method
    this.menuObj.style.visibility = "visible";
  };
  
  EventManager.AddFunction(this, "show", myShow);
  
  var myHide = function() { // Public method
  ...
  EventManager.AddFunction(this, "hide", myHide);
  
  var mySetX = function(x) { // Public method
    this.menuObj.initialLeft = x;
    this.menuObj.style.left = x + px;
  };
  EventManager.AddFunction(this, "setX", mySetX);
  
  var mySetY = function(y) { // Public method
    this.menuObj.initialTop = y;
    this.menuObj.style.top = y + px;
  };
  EventManager.AddFunction(this, "setY", mySetY);
  
  var myMoveTo = function(x, y) { // Public method
    this.menuObj.initialLeft = x;
    this.menuObj.initialTop = y;
    this.menuObj.style.left = x + px;
    this.menuObj.style.top = y + px;
  };
  EventManager.AddFunction(this, "moveTo", myMoveTo);
  
  var myMoveBy = function(x, y) { // Public method
  ...
  EventManager.AddFunction(this, "moveBy", myMoveBy);
  
  var mySetAllExceptFilter = function(filter) { // Public method
    this.menuObj.allExceptFilter = filter;
    this.menuObj.noneExceptFilter = new Array();
  };
  EventManager.AddFunction(this, "setAllExceptFiler", mySetAllExceptFilter);
  
  var mySetNoneExceptFilter = function(filter) { // Public method
    this.menuObj.noneExceptFilter = filter;
    this.menuObj.allExceptFilter = new Array();
  };
  EventManager.AddFunction(this, "setNoneExceptFilter", mySetNoneExceptFilter);
  
  var mySetBorderWidth = function(width) { // Public method
    this.menuObj.style.borderWidth = width + px;
  };
  EventManager.AddFunction(this, "setBorderWidth", mySetBorderWidth);  
}
