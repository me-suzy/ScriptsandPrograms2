...
class basic_view_approvepublish extends basic_view {
	
	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_approvepublish');
	}
	...
	function view() {
		...
		<td valign="top">
	    	...
	    	<?php echo $this->returnviewpost('approvepublish'); ?>
			<table border=0 width="100%" style="border: 1px solid #cccccc">
	      	...
	      	<input type="hidden" name="cmd" value="approvepublish">
	    	</form>
		</td>
		<td valign="top">
			<table cellpadding=2>
