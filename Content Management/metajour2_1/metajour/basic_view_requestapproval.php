...
class basic_view_requestapproval extends basic_view {
	
	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_requestapproval');
	}
	...
	function view() {
		...
		<td valign="top">
	    	...
	    	<?php echo $this->returnviewpost('requestapproval'); ?>
			<table border=0 width="100%" style="border: 1px solid #cccccc">
	      	...
	      	<input type="hidden" name="cmd" value="requestapproval">
	    	</form>
		</td>
		<td valign="top">
			<table cellpadding=2>
