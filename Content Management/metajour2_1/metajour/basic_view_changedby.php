...
class basic_view_changedby extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_changedby');
	}
	...
	function view() {
    	...
    	<?php echo $this->returnviewpost('changedby'); ?>
		...
		<?php echo $this->gl('text_1') ?><br><br>
			<table border=0>
				...
				<td><select name="changedby" id="changedby" style="width: 200px">
				<?php
				$field = new basic_field($this);
				echo $field->listallusers($obj->getchangedby());
				?>
				</select>
				</td>
				</tr>
		...
		<td valign="middle" align="left">
      	...
      	<input type="hidden" name="cmd" value="changedby">
    	</form>
		</body>
		</html>
		<?php
