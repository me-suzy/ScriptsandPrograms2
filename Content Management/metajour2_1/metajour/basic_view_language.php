...
class basic_view_language extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_language');
	}
	...
	function view() {
    	...
    	<?php echo $this->returnviewpost('language'); ?>
		...
		<td valign="middle" align="center" width="300">
			...
			echo $field->listalllanguages($obj->getlanguage());
			?>
			</select>
		</td>
		<td valign="middle" align="left">
      	...
      	<input type="hidden" name="cmd" value="language">
    	</form>
		</body>
		</html>
		<?php
