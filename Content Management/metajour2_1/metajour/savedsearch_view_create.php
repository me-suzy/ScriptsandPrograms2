...
class savedsearch_view_create extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('savedsearch_view_create');
	}
	...
	function view() {
    	...
    	<?php echo $this->returnviewpost('create'); ?>
		...
		<?php echo $this->gl('text_1') ?><br><br>
			<table border=0>
				...
				<td><input type="text" name="name" id="name" style="width: 200px">
				</td>
				</tr>
			</table>
		</td>
