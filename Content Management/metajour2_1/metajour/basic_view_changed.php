...
class basic_view_changed extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_changed');
	}
	...
	function view() {
    	...
    	<?php echo $this->returnviewpost('changed'); ?>
		...
		<?php echo $this->gl('text_1') ?><br><br>
			...
			<tr>
				...
				<td>
				<input type="text" name="changed" id="changed" style="width: 200px" value="<?php echo $obj->getchanged() ?>">
				</td>
			</tr>
			</table>
		</td>
		<td valign="middle" align="left">
      	...
      	<input type="hidden" name="cmd" value="changed">
    	</form>
		</body>
		</html>
		<?php
