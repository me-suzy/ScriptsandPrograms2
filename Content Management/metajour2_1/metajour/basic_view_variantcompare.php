...
class basic_view_variantcompare extends basic_view {
	
	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_variantcompare');
	}
	...
	function view() {
    	...
    	<?php echo $this->returnviewpost('variantcompare'); ?>
		<table style="margin: 10px; width: 100%">
		<tr>
		<td valign="middle" align="center" width="300">
			Fremhæv varianter på dette sprog<br><br>
			<?php echo $this->gl('text_2'); ?>
			<select name="language" id="language" style="width: 200px">
			<?php
			$field = new basic_field($this);
			echo $field->listalllanguages($_SESSION['gui'][$this->otype]['variantcompare']);
			?>
			</select>
		</td>
		<td valign="middle" align="left">
      	...
      	<input type="hidden" name="cmd" value="variantcompare">
		</td>
		</tr>
		</table>
    	</form>
