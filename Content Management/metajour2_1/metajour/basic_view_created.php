...
class basic_view_created extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_created');
	}
	...
	function view() {
		...
		<body>
	   	...
	   	<?php echo $this->returnviewpost('created'); ?>
		...
		<?php echo $this->gl('text_1') ?><br><br>
			...
			<tr>
				...
				<td>
				<input type="text" name="created" id="created" style="width: 200px" value="<?php echo $obj->getcreated() ?>">
				</td>
			</tr>
			</table>
		</td>
		<td valign="middle" align="left">
      	...
      	<input type="hidden" name="cmd" value="created">
    	</form>
		</body>
		</html>
		<?php
