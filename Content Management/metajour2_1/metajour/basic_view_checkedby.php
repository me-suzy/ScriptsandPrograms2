...
class basic_view_checkedby extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_checkedby');
	}
	...
	function view() {
    	...
    	<?php echo $this->returnviewpost('checkedby'); ?>
		...
		<?php echo $this->gl('text_1') ?><br><br>
			<table border=0>
				...
				<td><select name="checkedby" id="checkedby" style="width: 200px">
				<?php
				$field = new basic_field($this);
				echo $field->listallusers($obj->getcheckedby());
				?>
				</select>
				</td>
				</tr>
		...
		<td valign="middle" align="left">
      	...
      	<input type="hidden" name="cmd" value="checkedby">
    	</form>
		</body>
		</html>
		<?php
