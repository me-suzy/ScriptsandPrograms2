 ...
 * @subpackage core
 * $Id: erek_compcountryclass.php,v 1.3 2005/02/15 12:22:25 jan Exp $
 */

global $system_path;
require_once($system_path.'core/basicclass.php');

class erek_compcountry extends basic {

	function erek_compcountry() {
		$this->basic();
		$this->setobjecttype('compcountry');
