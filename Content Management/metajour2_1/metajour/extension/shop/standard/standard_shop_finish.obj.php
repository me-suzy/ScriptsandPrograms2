...
$_objoldid = 314147;
function objfile_314147 () {
$obj = owNew('template');
$objdata['name'] = "standard_shop_finish";
$objdata['content'] = "Tak for din bestilling. Din ordre vil blive behandlet snarest muligt.";
$objdata['tpltype'] = "2";
$objdata['htmledit'] = "0";
$objdata['header'] = "";
...
$objdata['param'] = "";
$objdata['setting'] = "";
$objdata['config'] = "text = \"Thank you. Your order is now registered.\"

[DA]
text = \"Tak for din bestilling. Din ordre vil blive behandlet snarest muligt.\"
";
$objdata['doctype'] = "0";
