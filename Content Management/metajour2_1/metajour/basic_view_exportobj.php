...
class basic_view_exportobj extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_exportobj');
	}
	...
	function view() {
		...
		<td valign="top">
	    	...
	    	<?php echo $this->returnviewpost('exportobj'); ?>
			<table border=0 width="100%" style="border: 1px solid #cccccc">
	      	...
	      	<input type="hidden" name="cmd" value="exportobj">
	    	</form>
		</td>
		<td valign="top">
			<table cellpadding=2>
