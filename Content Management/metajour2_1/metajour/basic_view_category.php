...
class basic_view_category extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_category');
	}
	...
	function view() {
		...
		<td valign="top">
	    	...
	    	<?php echo $this->returnviewpost('category'); ?>
			<table border=0 width="100%" style="border: 1px solid #cccccc">
				...
				echo $field->categorySelection($this->objectid[0],'__categories__');
				?>
				</td>
				</tr>
				<tr>
				<td><i><?php echo $this->gl('text_2') ?></i></td>
				</tr>
			</table>
