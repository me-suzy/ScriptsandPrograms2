...
class basic_view_publish extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_publish');
	}
	...
	function view() {
		...
		<body>
	    	...
	    	<?php echo $this->returnviewpost('publish'); ?>
		...
		<td valign="middle" align="center" width="300">
			...
			<tr>
				...
				<td>
				<input type="text" name="publish" id="publish" style="width: 200px" value="<?php echo $obj->getpublish() ?>">
				</td>
			</tr>
			<tr>
				<td><?php echo $this->gl('text_2') ?></td>
				<td>
				<input type="text" name="expire" id="expire" style="width: 200px" value="<?php echo $obj->getexpire() ?>">
				</td>
			</tr>
			</table>
		</td>
