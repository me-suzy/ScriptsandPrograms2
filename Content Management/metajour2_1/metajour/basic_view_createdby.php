...
class basic_view_createdby extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_createdby');
	}
	...
	function view() {
    	...
    	<?php echo $this->returnviewpost('createdby'); ?>
		...
		<?php echo $this->gl('text_1') ?><br><br>
			<table border=0>
				...
				<td><select name="createdby" id="createdby" style="width: 200px">
				<?php
				$field = new basic_field($this);
				echo $field->listallusers($obj->getcreatedby());
				?>
				</select>
				</td>
				</tr>
		...
		<td valign="middle" align="left">
      	...
      	<input type="hidden" name="cmd" value="createdby">
    	</form>
		</body>
		</html>
		<?php
