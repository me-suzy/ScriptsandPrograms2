...
class basic_view_access extends basic_view {

	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_access');
	}
	...
	function view() {
		...
		<td valign="top">
	    	...
	    	<?php echo $this->returnviewpost('access'); ?>
			<table border=0 width="100%" style="border: 1px solid #cccccc">
				<tr>
				<td><strong><?php echo $this->gl('text_1') ?></strong></td>
				</tr>
				<tr>
				<td>		
				<?php
				$field = new basic_field($this);
				echo $field->webAccessSelection($this->objectid[0],'__webaccess__');
				?>
				</td>
				</tr>
				<tr>
				...
				<tr>
				<td><strong><?php echo $this->gl('text_2') ?></strong></td>
				</tr>
				<tr>
				<td>		
				<?php
				$field = new basic_field($this);
				echo $field->sysAccessSelection($this->objectid[0],'__sysaccess__');
				?>
				</td>
				</tr>
				<tr>
				<td><i><?php echo $this->gl('text_3') ?></i></td>
				</tr>
			</table>
