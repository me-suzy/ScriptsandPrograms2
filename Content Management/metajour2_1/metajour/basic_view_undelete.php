...
class basic_view_undelete extends basic_view {
	
	function loadLanguage() {
		parent::loadLanguage();
		$this->loadLangFile('basic_view_undelete');
	}
	...
	function view() {
		...
		<tr>
			<td valign="top">
				...
				<?php echo $this->returnviewpost('undelete'); ?>
				...
				<input type="hidden" name="cmd" value="undelete">
				</form>
			</td>
			<td valign="top">
				<table cellpadding=2>
