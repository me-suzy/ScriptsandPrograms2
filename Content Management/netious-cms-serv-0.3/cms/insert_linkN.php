...
function AddLink() {
	...
	if (oForm.url1.value != '')
	{
	var html = '<a href=\"' + document.linkForm.url1.value + '\" target=\"' + document.linkForm.linkTarget.options[document.linkForm.linkTarget.selectedIndex].value + '\">' + document.linkForm.linkText.value + '</a>';
	} else {var html = '<a href=\"' + document.linkForm.url.value + '\" target=\"' + document.linkForm.linkTarget.options[document.linkForm.linkTarget.selectedIndex].value + '\">' + document.linkForm.linkText.value + '</a>';}
...
<table cellpadding=\"4\" cellspacing=\"0\" border=\"0\">
	...
	<tr>
		...
		echo "<option value=\"../news/$newsid/files/$file\">$file</option>";
