...
function initRTE(imgPath, incPath, css, genXHTML, thepageid) {
	//set browser vars
...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'hyperlink.gif" width="25" height="24" alt="Insert Link" title="Insert Link" onClick="dlgInsertLink(\'' + rte + '\', \'link\',\'' + newsid + '\')"></td>');
			document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'image.gif" width="25" height="24" alt="Add Image" title="Add Image" onClick="addImage(\'' + rte + '\',\'link\',\'' + newsid + '\')"></td>');
	...
	//		document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'redo.gif" width="25" height="24" alt="Redo" title="Redo" onClick="rteCommand(\'' + rte + '\', \'redo\')"></td>');
		...
		if (!readOnly) {
			document.writeln('<textarea name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px; font-family:helvetica,arial,sans-serif;">' + html + '</textarea>');
		} else {
			document.writeln('<textarea name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px; font-family:helvetica,arial,sans-serif;" readonly>' + html + '</textarea>');
		}
	}
}
...
function dlgInsertLink(rte, command, newsid) {
	//function to open/close insert table dialog
	//save current values
	parent.command = command;
	currentRTE = rte;
	InsertLink = popUpWin(includesPath + 'insert_linkN.php?newsid=' + newsid, 'InsertLink', 500, 300, '');
...
function addImage(rte, command, newsid) {
	//function to open/close insert table dialog
	//save current values
	parent.command = command;
	currentRTE = rte;
	InsertLink = popUpWin(includesPath + 'insert_imageN.php?newsid=' + newsid, 'InsertLink', 500, 300, '');
