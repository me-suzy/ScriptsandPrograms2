...
echo "
	...
	<td>
	<center><h2>News Management - news edtion.</h2></center><br /><br />
	<b></b><br />
<br />
	<center>
	<div id=\"formular\">
	<form action='editnewsSelect.php' method='post' name='selectref'>
...
{echo "
	...
	<form action='editnewsEdition.php' method='post'>
...
} else {echo "<td>Warning: no News - type pages, no news, nothing to edit!</td>";}
