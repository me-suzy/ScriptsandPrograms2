...
mysql_query("UPDATE style SET smbgcol='$smbgcol', smborstyle='$smborstyle', smborw='$smborw', smborcol='$smborcol', smfcol='$smfcol' WHERE StyleId='$styleid'") or die (mysql_error());
