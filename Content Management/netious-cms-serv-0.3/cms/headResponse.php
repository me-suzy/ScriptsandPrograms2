...
{if (file_exists("../images/hbgimage.$ext_bg")) unlink ("../images/hbgimage.$ext_bg");
rename("../images/temp_bgimage","../images/hbgimage.$ext_bg");
$hbgim="./images/hbgimage.$ext_bg";
...
mysql_query("UPDATE style SET hsize='$hsize', hcol='$hcol', hbgcol='$hbgcol', hbgim='$hbgim', hbgrep='$hbgrep', hbgpos='$hbgpos' WHERE StyleId='$styleid'") or die (mysql_error());


/* Update the db.php file */

if ($newlogofile!="" && !isset($replace))
{if (file_exists("../images/logo.$ext_logo")) unlink("../images/logo.$ext_logo");

rename("../images/temp_logoimage","../images/logo.$ext_logo");
$new_logoname="logo.$ext_logo";
$new_textlogo="";
$db_cont=file_get_contents("../db.php");
$db_cont=str_replace("logoname=\"$logoname\"","logoname=\"$new_logoname\"",$db_cont);
$db_cont=str_replace("textlogo=\"$textlogo\"","textlogo=\"$new_textlogo\"",$db_cont);
$handle=fopen("../db.php","w");
fwrite($handle,$db_cont);
fclose($handle);
} elseif ($logoname!="" && !isset($replace)) {
if (file_exists("../images/temp_logoimage")) unlink ("../images/temp_logoimage");
}
else {
if (file_exists("../images/temp_logoimage")) unlink ("../images/temp_logoimage");
$new_logoname="";
