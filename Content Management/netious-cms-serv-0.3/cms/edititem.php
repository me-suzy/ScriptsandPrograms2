...
echo "
	...
	<td>
	<center><h2>RSS editor - edit an item.</h2></center><br /><br />
	<b></b><br />
<br />
	<center>
	<div id=\"formular\">
	<form action='edititem.php' method='post' name='selectref'>
...
{echo "
	<td align=\"left\">
	Select the channel the item belongs to:
	</td>
...
} else {echo "<td>Warning: no channels, no items. Nothing to edit!</td>";}
