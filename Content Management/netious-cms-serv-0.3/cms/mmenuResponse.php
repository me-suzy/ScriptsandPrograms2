...
mysql_query("UPDATE style SET mmbgcol='$mmbgcol', mmborstyle='$mmborstyle', mmborw='$mmborw', mmborcol='$mmborcol', mmfcol='$mmfcol' WHERE StyleId='$styleid'") or die (mysql_error());
