...
if ($ext=="php" || $ext=="html" || $ext=="cgi" || $ext=="aps" || $ext=="js") {Header("Location: manageFile.php?action=1&pageid=$pageid");}

else {

$newfile="../sections/"."$pageid"."/"."$direct"."/"."$thefile";
move_uploaded_file($thefile_tmp,$newfile);


Header("Location: manageFile.php?pageid=$pageid"); 
}
