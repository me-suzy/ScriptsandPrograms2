...
if($result=mysql_query("SELECT RssId, Name FROM rsschannel order by RssId DESC")) {$num_rows=mysql_num_rows($result);} else {$num_rows="0";}
...
echo "
	...
	<b>Choose the channel you want to remove</b><br />
<br />
	<center>
	<div id=\"formular\">
	<form enctype=\"multipart/form-data\" action='delchannelConfirm.php' method='post'>
