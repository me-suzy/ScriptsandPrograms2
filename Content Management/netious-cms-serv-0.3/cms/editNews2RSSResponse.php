...
if ($itemtitle=="" && $itemdescription=="") {Header("Location:editNews2RSS.php?action=1&itemtitle=$itemtitle&itemdescription=$itemdescription&author=$author&refid=$refid&nrefid=$nrefid&newsid=$newsid");}
else {
...
/* Prepare the link-variable in appropriate form */
