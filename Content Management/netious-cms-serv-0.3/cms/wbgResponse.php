...
{if (file_exists("../images/bgimage.$ext_bg")) unlink ("../images/bgimage.$ext_bg");
rename("../images/temp_bgimage","../images/bgimage.$ext_bg");
$bgim="./images/bgimage.$ext_bg";
...
mysql_query("UPDATE style SET bgcol='$bgcol', bgim='$bgim', bgrep='$bgrep', bgpos='$bgpos' WHERE StyleId='$styleid'") or die (mysql_error());


/* Update the db.php file */


$db_cont=file_get_contents("../db.php");

$db_cont=str_replace("width=\"$width\"","width=\"$new_width\"",$db_cont);
$db_cont=str_replace("model=\"$model\"","model=\"$new_model\"",$db_cont);
$db_cont=str_replace("bodyposition=\"$bodyposition\"","bodyposition=\"$new_bodyposition\"",$db_cont);
$db_cont=str_replace("title=\"$title\"","title=\"$new_title\"",$db_cont);
$db_cont=str_replace("keywords=\"$keywords\"","keywords=\"$new_keywords\"",$db_cont);
$db_cont=str_replace("description=\"$description\"","description=\"$new_description\"",$db_cont);




$handle=fopen("../db.php","w");
fwrite($handle,$db_cont);
fclose($handle);
