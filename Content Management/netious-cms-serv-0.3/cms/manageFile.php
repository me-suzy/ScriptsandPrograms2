...
$result=mysql_query("SELECT Name FROM pages WHERE PageId='$pageid'");
$row=mysql_fetch_row($result);
$name=$row[0];
...
<!-- Dynamically switch the action of the form between delete/rename -->
	...
	function OnSubmitForm()
	{
	  ...
	  {
	   document.fileform.action =\"delfile.php\";
	  }
	  else
	  if(document.pressed == 'Rename')
	  {
	    document.fileform.action =\"renamefile.php\";
	  }
	  return true;
	}
	</SCRIPT>
	...
	<td align=\"left\">
	<b>Upload image:</b><br />
	<form enctype=\"multipart/form-data\" action='uploadfileResponse.php' method='POST'>
	<input type=\"hidden\" name=\"pageid\" value=\"$pageid\" />
