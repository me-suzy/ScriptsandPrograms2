...
echo "
	...
	<td>
	<center><h2>Control panel - edit a section.</h2></center><br /><br />
	<b>Choose the section</b><br />
<br /><br />
<br />
	<center>
	<div id=\"formular\">
	<form action='editmenuEdition.php' method='post'>
...
while ($row=mysql_fetch_row($result))
	...
	<input type=\"submit\" value=\"Edit the section's properties\" />
	</td>";} else {echo "<td align=\"center\">There are no sections in the DB!</td>";}
