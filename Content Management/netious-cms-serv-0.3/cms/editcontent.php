...
Header( "Location: index.php?action=2");
	...
	$result=mysql_query("SELECT Name, Content FROM pages WHERE PageId='$pageid'");
	$row=mysql_fetch_row($result);
	$name=$row[0];
	$content=$row[1];
...
<!-- START Demo Code -->
<form name=\"RTEDemo\" action=\"editcontentResponse.php\" method=\"post\" onsubmit=\"return submitForm();\">
...
initRTE(\"editimages/\", \"\", \"styleedit.css\", true, $pageid);
//-->
</script>
