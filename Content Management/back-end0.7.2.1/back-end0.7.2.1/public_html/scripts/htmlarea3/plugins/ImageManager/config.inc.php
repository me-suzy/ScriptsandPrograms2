 ...
 * @author $Author: mgifford $
 * @version $Id: config.inc.php,v 1.2 2005/02/03 20:36:08 mgifford Exp $
...
*/
define('IMAGE_TRANSFORM_LIB_PATH', '/usr/sbin/');
...
*/
$IMConfig['default_thumbnail'] = 'scripts/htmlarea3/plugins/ImageManager/img/default.gif';
