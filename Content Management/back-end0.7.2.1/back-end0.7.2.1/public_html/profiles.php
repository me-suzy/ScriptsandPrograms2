<?php
   // $Id: profiles.php,v 1.6 2005/03/27 10:28:35 krabu Exp $
   /**
    * Profiles - General profiles page
    *
    * @package     Back-End
    * @copyright   Copyright (C) 2003 OpenConcept Consulting
    * @version     $Id: profiles.php,v 1.6 2005/03/27 10:28:35 krabu Exp $
    *
   ...
   $content = $bib->mainProfilePage();

   $ary = array();
   $ary['section'] = 'profiles';
