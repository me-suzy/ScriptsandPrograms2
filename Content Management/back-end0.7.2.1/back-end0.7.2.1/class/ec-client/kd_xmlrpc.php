...
function XMLRPC_error($faultCode, $faultString, $server = NULL){
	...
	$thisVar = &$array["methodResponse"]["fault"]["value"]["struct"]["member"];
	$thisVar[0]["name"] = "faultCode";
	$thisVar[0]["value"]["int"] = $faultCode;
	$thisVar[1]["name"] = "faultString";
	$thisVar[1]["value"]["string"] = $faultString;
