<?php
    ...
    /* $Id: file.php,v 1.2 2005/03/21 04:11:31 mgifford Exp $ */
    ...
    function jpcache_restore()
    {
        ...
        $cacheRaw = jpcache_fileread($filename);
        if(!empty($cacheRaw)) {
           $cachedata=unserialize($cacheRaw);
        } else {
           jpcache_debug("No content in $filename");
           return FALSE;
        }
