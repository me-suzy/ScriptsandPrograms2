...
if(!$_POST['role_order']) {
	?><font color="#<?php echo "$col_text" ?>"><?php die('You must enter a number');
	}


$role_order = $_POST['role_order'];
$query="UPDATE roles SET role_order = '$role_order' WHERE role_id = $fileId ";
...
<td width="100%" bgcolor="#<?php echo "$col_table_header"; ?>" align="center">
 <?php  echo "<center>"; echo "<font color='#$col_table_header_text'>"; ?><b>Edit Display Order <?php echo $row["role_title"]; ?></b><br><br>
...
Enter new order value for <?php echo "$role_title" ?>
<br><br>

<input id="role_order" size="3" name="role_order" value="<?php echo "$role_order" ?>"><br>
