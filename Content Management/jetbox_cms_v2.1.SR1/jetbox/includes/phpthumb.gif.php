...
// <bool> = gif_outputAsJpeg(<gif>, filename, [bgcolor]) - [optionally] Requires cjpeg
///////////////////////////////////////////////////////////////////////////////////////////////////
// Modified by Arjen Schat <a.schat@streamdge.com> to work with data string instead of file access - Januari 10, 2003
...
class CGIF {
	...
	function load_data_File($data, $iIndex){
		$this->m_lpData = $data;
		// GET FILE HEADER
		if (!$this->m_gfh->load($this->m_lpData, $len = 0)) {
			return false;
