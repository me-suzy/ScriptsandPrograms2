	 ...
	 switch(command){
		 case "mcePreview":
			 ...
			 if(previewPage){
				 ...
				 tinyMCE.openWindow(template,{editor_id:editor_id,resizable:"yes",scrollbars:"yes",content:tinyMCE.getContent(),content_css:tinyMCE.getParam("content_css"),document_base_url:tinyMCE.getParam("document_base_url")});
			 }
			 else{
