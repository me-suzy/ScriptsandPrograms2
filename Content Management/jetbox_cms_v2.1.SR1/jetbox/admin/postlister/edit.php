...
if ($send) {
	...
	mysql_query("update $mainTable set
...
$kommando = mysql_query("select * from $mainTable where liste = '$liste'");
...
echo "$s28<br>\n";
echo "<textarea name=signatur cols=72 rows=4 wrap=soft>$hentSignatur</textarea><p>\n";
