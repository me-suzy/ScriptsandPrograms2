...
$s32 = "Om je inschrijving op $listeOpret te bevestigen kan je op de link onderaan dit bericht klikken (of deze knippen en plakken in je browser).
		Surf naar www.ebate.nl voor meer informatie over Ebate. Hier kun je ook door discussiëren over bijdragen uit Ebate, stemmen op de stelling en zelf nieuwe discussies starten.
		De redactie
		Klik op de onderstaande link om je abonneren te bevestigen :
		<[SUBSCRIBE_URL]>
		Als je geen aanvraag hebt gedaan om abonnee te worden kan je dit bericht negeren.
		";
...
$s38 = "<i>$epostadresseTilfoej</i> is geen geldig e-mail adres.";
...
$s69 = "Mailing lists";
$s70 = "Aanmelden bij Ebate";
$s71 = "E-mail";
$s72 = "Versie:";
$s73 = "Aanmelden";
$s74 = "Afmelden";
$s75 = "<i>$email</i> is geen geldig e-mail adres. ";
...
$s77 = "Aanmelding $list mailing list";
$s78 = "Afmelding $list mailing list";
$s79 = "Bedankt voor je aanmelding voor de <i>$list</i> mailing list. Voordat je definitief Ebate ontvangt moet je je aanmelding bevestigen. Dit is mogelijk via de e-mail die je over enkele ogenblikken ontvangt.";
$s80 = "Om je afmelding definitief te maken ontvang je over enkele ogenblikken een e-mail om je afmelding te bevestigen.";

# The following variable will go into an email body. Therfore, you need to break all lines after 72 characters.
$s81 = "Om je inschrijving op $listeOpret te bevestigen moet je op de link onderaan dit bericht klikken (of deze knippen en plakken in je browser).
		Surf naar www.ebate.nl voor meer informatie over Ebate. Hier kun je ook door discussiëren over bijdragen uit Ebate, stemmen op de stelling en zelf nieuwe discussies starten.
		De redactie
		Klik op de onderstaande link om je abonneren te bevestigen :
		<[UNSUBSCRIBE_URL]>
...
$s95 = "Je bent toegevoegd aan de <i>$liste</i> mailing list. Vanaf heden ontvang je elke twee weken Ebate.";
$s96 = "Je bent verwijderd van de <i>$liste</i> mailing list. Vanaf heden ontvang je geen Ebate meer.";
$s97 = "out of";
