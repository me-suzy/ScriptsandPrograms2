...
function DeleteContent()
{
   ...
   $strQuery = "DELETE FROM ".$GLOBALS["eztbContents"]." WHERE contentname='".$_GET["ContentName"]."'";
   $result = dbExecute($strQuery,true);

   $strQuery = "DELETE FROM ".$GLOBALS["eztbRatings"]." WHERE contentname='".$_GET["ContentName"]."'";
   $result = dbExecute($strQuery,true);
   dbCommit();
} // function DeleteContent()
