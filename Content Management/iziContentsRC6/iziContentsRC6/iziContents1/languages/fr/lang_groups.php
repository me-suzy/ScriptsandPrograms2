...
// Form Title
$GLOBALS["tFormTitle"]		= 'Gestion des menus';

// List Headings
$GLOBALS["tMenuTitle"]		= 'Titre du Menu';
$GLOBALS["tHomepage"]		= 'Menu Acceuil';
$GLOBALS["tGroupID"]		= 'ID du Menu';

// List Functions
$GLOBALS["tEditMenu"]		= 'Editer le menu';
$GLOBALS["tAddNewMenu"]		= 'Ajouter un nouveau menu';
$GLOBALS["tDeleteMenu"]		= 'Effacer le menu';
...
$GLOBALS["tMenuTitle"]		= 'Titre du Menu';
$GLOBALS["tParentMenu"]		= 'Parent du menu horizontal';
...
$GLOBALS["tDetails"]		 = 'Ce formulaire vous permet d\'éditer ou créer de nouveaux groupes de menu pour naviguer dans le contenu.';
...
$GLOBALS["hParentMenu"]		 = 'Le Parent du Menu Horizontal de ce Menu.';
...
$GLOBALS["hMenuImage1"]		 = 'L\'image qui remplacera le titre du menu. (Doit être inférieure à la largeur de votre de votre menu.)';
$GLOBALS["hMenuImage2"]		 = 'L\'image qui apparaitra lorsque la souris survolera l\'image. ';
$GLOBALS["hMenuImage2"]		.= '(Doit être inférieure à la largeur de votre de votre menu.)';
$GLOBALS["hMenuImage3"]		 = 'The image that will be shown when this menu item is the currently selected menu.<br>';
$GLOBALS["hMenuImage3"]		.= '(It should be less than the width of your left column.)';
