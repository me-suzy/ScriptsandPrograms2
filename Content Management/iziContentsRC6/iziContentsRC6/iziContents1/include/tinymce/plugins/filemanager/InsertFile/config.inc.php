...
*/
$MY_DOCUMENT_ROOT     = $basedir.'/'.$download; //* system path to the directory you want to manage the files and folders

/* MY_BASE_URL  Not used in htmlarea3-plugin version  */
$MY_BASE_URL          = $websiteurl.'/'.$download;
...
*/
$MY_URL_TO_OPEN_FILE  = $websiteurl.'/'.$download; 
...
$MY_LIST_EXTENSIONS  = array('html', 'doc', 'xls', 'txt', 'pdf', 'zip');
/*
 MY_ALLOW_EXTENSIONS
 MY_DENY_EXTENSIONS
...
*/
$MY_ALLOW_EXTENSIONS = array('html', 'doc', 'xls', 'txt', 'zip', 'pdf');
$MY_DENY_EXTENSIONS  = array('php', 'php3', 'php4', 'asp', 'aspx', 'phtml', 'shtml', 'cgi', 'pl', 'scr', 'pif', 'exe');
/*
 $MY_ALLOW_UPLOAD
