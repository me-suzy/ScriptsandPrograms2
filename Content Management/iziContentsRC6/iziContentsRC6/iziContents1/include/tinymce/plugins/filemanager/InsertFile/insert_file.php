...
<html>
        ...
        /*<![CDATA[*/
                ...
                function onOK() {
                         if (window.opener) {
                         var required = {
                         "f_url": "<? echo $MY_MESSAGES['enterurl']; ?>",
                         "f_caption": "<? echo $MY_MESSAGES['entercaption']; ?>"
                         };
               ...
               for (var k in files){
                ...
                if (formObj.f_addicon.checked==true) {
                        icon = '<img align=absmiddle border=0 src="' + f_icon + '" alt="' + f_caption + '">&nbsp;';
                }
...
<body onload="Init();">
      ...
      <table border="0" align="center" cellpadding="2" cellspacing="2">
          <tr>
            <td nowrap><div align="right"><? echo $MY_MESSAGES['url'];?></div></td>
            <td><input name="url" id="f_url" type="text" style="width:20em" size="30"></td>
            <td nowrap><div align="right"><? echo $MY_MESSAGES['caption'];?></div></td>
          ...
          <tr>
            <td>
             <input id="f_addicon" value="f_addicon" type="checkbox">
                                ...
                                <div align="left"><? echo $MY_MESSAGES['inserticon'];?></div>
                        </td>
                       <td>
                               <input id="f_addsize" value="f_addsize" type="checkbox">
            </td><td>
                                <div align="left"><? echo $MY_MESSAGES['insertsize'];?></div>
                        </td>
                       <td>
                               <input id="f_adddate" value="f_adddate" type="checkbox">
            </td><td>
                                <div align="left"><? echo $MY_MESSAGES['insertdate'];?></div>
                        </td>
                  </tr>
      </table>
                    ...
                    <?php
                        ...
                        ?>
                         ...
                         <div style="text-align: right; margin-top:5px;">
                                  <input type="button" name="refresh" value="<? echo $MY_MESSAGES['refresh'];?>" onclick="return refreshPath();">
                                  <input type="button" name="cancel" value="<? echo $MY_MESSAGES['cancel'];?>" onclick="return onCancel();">
                                  <input type="reset" name="reset" value="<? echo $MY_MESSAGES['reset'];?>">
                                  <input type="button" name="ok" value="<? echo $MY_MESSAGES['ok'];?>" onclick="return onOK();">
                     </div>
