...
/***************************************************************************
 ...
 All copyright notices regarding iziContents must remain intact on the
...
$GLOBALS["Version"]			= "Version 1.0 rc6";
$GLOBALS["gsAdminStyle"]		= "iziTHEME";
// Database Configuration
$GLOBALS["dbPersistent"]		= "N";			//	Persistent database connections
								//		'Y'es or 'N'o
$GLOBALS["ezContentsDB"]		= "mysql";		//	Database server type
$GLOBALS["ezContentsDBServer"]		= "localhost";		//	IP Address of the database server
$GLOBALS["ezContentsDBName"]		= "";		//	Database name
$GLOBALS["ezContentsDBLogin"]		= "";		//	Database system login
$GLOBALS["ezContentsDBPassword"]	= "";			//	Database system password
...
$GLOBALS["RECORDS_PER_PAGE"]		= 8;			// number of lines of content on admin list pages
// Tag block controls
$GLOBALS["tqBlock"]			= '[]';
...
$GLOBALS["ftp"]["ezContents_root"]	= '/ezc203';


$imagedir = "/".$GLOBALS["image_home"];
$imageurl = "/".$GLOBALS["image_home"];
$scriptdir = "/include/htmlarea2Modified/popups/";
$scripturl = "/include/htmlarea2Modified/popups/";

$download = "downloads";


// Filesystem == /home/web/www (your web path)
// Site URL and absolute Path
$GLOBALS["websiteurl"] = 'http://localhost/iziContentsRC5';
$GLOBALS["basedir"] = '/Applications/MAMP/htdocs/iziContentsRC5';
$basedir = "/Applications/MAMP/htdocs/iziContentsRC5";
