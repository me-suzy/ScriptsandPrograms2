...
// main 
{
  ...
  if (@is_file($cd."/".$file) && check_file($file))
	...
	$page = "CSS not valid... impossible to eledicss";
    }
  else
    $page = "no file selected...";
...
if ($watt==false)
{
  echo "alert(\"Impossible to record the modifications: the file is write-protected. You must change the rights of the file on the Web server.\");";
}
...
";
  ...
  echo "<a href=\"./eledicss.php?cd=".$cd."\"><img src=\"./eledicss.php?image=dir\" /></a>&nbsp;";
