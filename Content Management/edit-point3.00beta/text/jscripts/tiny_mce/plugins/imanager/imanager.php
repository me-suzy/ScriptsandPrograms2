...
// ============================================================
// = check crop dimensions V 1.0, date: 02/05/2005            =
// ============================================================	
 	function crchkDim(obj) {
		...
		if (obj.type == 'text') {
			...
			if (formObj.cr_width.value > cwidth || formObj.cr_height.value > cheight) {			
				formObj.cr_width.value  = Math.round(cwidth / 2);
				formObj.cr_height.value = Math.round(cheight / 2);
...
// ============================================================
	function updatePreview(action) {		
		...
		if (action == 0) { // refresh clicked			
			...
			var sizes;		
			sizes = resizePreview(formObj.rs_width.value,formObj.rs_height.value,175,175);			
			w = sizes['w'];
			h = sizes['h'];			
            ...
            <div id="inDiv" class="hideit">
              ...
              <div class="floatWrap">
                ...
                <div class="colLeft">
                  ...
                  <div class="rowDiv">
                    <div class="btnRight">
                      <span><img src="images/info_off.gif" onMouseOver="this.src='images/info.gif'; showInfo();" onMouseOut="this.src='images/info_off.gif'; showInfo();" alt="<?php echo $l->m('in_035'); ?>" title="<?php echo $l->m('in_035'); ?>" width="16" height="16" border="0" /><br /><img src="images/dirview_off.gif" onClick="switchList();" onMouseOver="this.src='images/dirview.gif';" onMouseOut="this.src='images/dirview_off.gif';" alt="<?php echo $l->m('in_037'); ?>" title="<?php echo $l->m('in_037'); ?>" width="16" height="16" border="0" /></span>
                    </div>
                    <div id="inSelDiv">
            ...
            <div id="fiDiv" class="hideit">
              ...
              <div id="toDiv" class="hideit">
                ...
                <div id="whitebDiv" class="hideit">
                  <label for="co_type"> <span class="pad30"> <?php echo $l->m('ef_009'); ?> </span> </label>
