<?php
	...
	// File: config.inc.php
	// ================================================
	// Revision: 1.2.1                 Date: 10/07/2005
	// ================================================
...
// ***EDIT-POINT change*** include "/text/config.php"
include $_SERVER['DOCUMENT_ROOT'] . '/text/config.php';
...
/*		array (
	...
	$cfg['ilibs_dir'] 	   = array("/$imagedir/");						   	// image library path with slashes; absolute from root directory  e.g. '/pictures/' - please make sure that the directories have write permissions
	...
	$cfg['ver'] = '1.2.1 - build 10072005';												// iManager version	
