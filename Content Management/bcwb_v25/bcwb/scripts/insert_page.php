...
$root_path = preg_replace("/scripts\/insert_page\.php$/is", "", $GLOBALS["SCRIPT_FILENAME"]);
...
{
	return ( ( event.keyCode < 1040 || event.keyCode > 1181 ) && (event.keyCode != 47) );
}
...
if(mysel.type == "Control")
{
  ...
  var output;
	...
	if(imageString.length>0)
  		output = unescape("%3C")+'a href="<?=eregi_replace("/$", "", $GLOBALS['http_path'])?>' + window.opener.bcwb_form.script_uri.value + document.frmLinkPick.Link.value + '/" target="' + document.frmLinkPick.LinkTarget.value + '" '+unescape("%3E") + imageString +  unescape("%3C") +'/a'+unescape("%3E");   
  	else
  		output = unescape("%3C")+'a href="<?=eregi_replace("/$", "", $GLOBALS['http_path'])?>' + window.opener.bcwb_form.script_uri.value + document.frmLinkPick.Link.value + '/" target="' + document.frmLinkPick.LinkTarget.value + '" '+unescape("%3E") + document.frmLinkPick.Desc.value +  unescape("%3C") +'/a'+unescape("%3E");   
