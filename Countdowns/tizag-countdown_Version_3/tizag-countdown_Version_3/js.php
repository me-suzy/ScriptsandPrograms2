...
function formValidation(form){
	// Graphical or Plain Text
	
	if(form.mode[0].checked){
		if(form.picture[2].checked){
			if(RGBCheck(form, "bg")){
			} else {
				return false;
			}
		...
		if(isChecked(form.border.checked)){
			if(RGBCheck(form, "border")){
			} else {
				return false;
			}
		...
		// Check if the dropshadow is valid
		if(isChecked(form.dropshadow.checked)){
			if(RGBCheck(form, "shadow")){
			} else {
				return false;
			}
		}
		// Check if the textcolor is valid
		if(isChecked(form.dropshadow.checked)){
			if(RGBCheck(form, "txt")){
			} else {
				return false;
			}
		}
...
function plainMode(){
	document.countdown.font_size.disabled = true;
	document.countdown.imgfile.disabled = true;
	document.countdown.imgfile.disabled = true;
	document.countdown.picture[0].disabled = true;
	document.countdown.picture[1].disabled = true;
	document.countdown.picture[2].disabled = true;
	document.countdown.dropshadow.disabled = true;
	document.countdown.border.disabled = true;
	document.countdown.bgred.disabled = true;
	document.countdown.bggreen.disabled = true;
	document.countdown.bgblue.disabled = true;
	document.countdown.txtred.disabled = true;
	document.countdown.txtgreen.disabled = true;
	document.countdown.txtblue.disabled = true;
	document.countdown.shadowred.disabled = true;
	document.countdown.shadowgreen.disabled = true;
	document.countdown.shadowblue.disabled = true;
	document.countdown.borderred.disabled = true;
	document.countdown.bordergreen.disabled = true;
	document.countdown.borderblue.disabled = true;
	document.countdown.xpos.disabled = true;
	document.countdown.ypos.disabled = true;
	document.countdown.xposoff.disabled = true;
	document.countdown.yposoff.disabled = true;
}

function gfxMode(){
	
	document.countdown.font_size.disabled = false;
	document.countdown.imgfile.disabled = false;
	document.countdown.imgfile.disabled = false;
	document.countdown.picture[0].disabled = false;
	document.countdown.picture[1].disabled = false;
	document.countdown.picture[2].disabled = false;
	document.countdown.dropshadow.disabled = false;
	document.countdown.border.disabled = false;
	document.countdown.bgred.disabled = false;
	document.countdown.bggreen.disabled = false;
	document.countdown.bgblue.disabled = false;
	document.countdown.txtred.disabled = false;
	document.countdown.txtgreen.disabled = false;
	document.countdown.txtblue.disabled = false;
	document.countdown.shadowred.disabled = false;
	document.countdown.shadowgreen.disabled = false;
	document.countdown.shadowblue.disabled = false;
	document.countdown.borderred.disabled = false;
	document.countdown.bordergreen.disabled = false;
	document.countdown.borderblue.disabled = false;
	document.countdown.xpos.disabled = false;
	document.countdown.ypos.disabled = false;
	document.countdown.xposoff.disabled = false;
	document.countdown.yposoff.disabled = false;
}

function RGBCheck(form, pre){
	var red = "isColor(form."+pre+"red"+")";
	var green = "isColor(form."+pre+"green"+")";
	var blue = "isColor(form."+pre+"blue"+")";
	if(eval(red)) {
		if(eval(green)){
			if(eval(blue)){
				return true;
...
function isColor(elem){
	...
	if(x <= 255 && x >= 0 && x != ''){
		...
		alert("Please choose a value from 0-255");
		elem.focus();
		return false;
	}
