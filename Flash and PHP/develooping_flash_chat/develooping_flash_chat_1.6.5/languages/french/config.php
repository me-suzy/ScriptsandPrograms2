...
$intro_text .=" Vous pouvez voir les autres utilisateurs connectés et envoyer un message à l'un d'entre eux en particulier, activer ou  désactiver le son ('icône: parleur') et revoir la conversation conversation ('icône: retour).\n";
