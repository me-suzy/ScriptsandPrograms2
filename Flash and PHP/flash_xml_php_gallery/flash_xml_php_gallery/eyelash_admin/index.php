...
$msg["en"]["headlineLogin"] = "";					/* Headline for the login screen. */
...
$global_header="<a href=../gallery.html><img src=../eyelash_files/i/eyelash.gif border=0></a>";
...
if($ses_user != $arr_global["admin_username"] || $ses_pass !=  $arr_global["admin_password"] ) {
	if($action == "login") {
		if ($log_user != $arr_global["admin_username"]|| $log_pass !=  $arr_global["admin_password"]) {
