...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("UPDATE flash_poll SET opt$opt=%s WHERE status=1",
                       GetSQLValueString($_POST['txf'], "text"));

  mysql_select_db($database_poll, $poll);
  $Result1 = mysql_query($insertSQL, $poll) or die(mysql_error());

  $insertGoTo = "epoll.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$qu="UPDATE flash_poll SET question=form.txf WHERE ID=$idf";
?>
...
<p>&nbsp;</p>
<p><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><strong>Edit poll option </strong></p>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form" id="form">
  <p>Edit option<?php echo $opt; ?>: 
     <input name="txf" type="text" id="txf" value="<?php echo $row[2+$opt]; ?>">
</p>
  <p>
