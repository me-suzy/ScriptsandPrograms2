...
<body>
<p><strong>View poll </strong></p>
<p>&nbsp; </p><table>
<?php 
if (mysql_num_rows($Recordset1) > 0) { 
    while($row = mysql_fetch_row($Recordset1)) { echo "<tr>";
        echo  "<td" ?> bgcolor="#DFECF7"><?php echo  "<b>";echo $row[1] ;echo "</b>" ;
		for ($i=3;$i<3+$row[2];$i++) {echo "<tr>";echo  "<td" ?> bgcolor="#DFECF7"><?php echo $row[$i];echo "</td>";
		echo  "<td" ?> bgcolor="#DFECF7"><?php echo $row[$i+8]."</td>"."</tr>";};echo "</tr>";
    } 
} 
