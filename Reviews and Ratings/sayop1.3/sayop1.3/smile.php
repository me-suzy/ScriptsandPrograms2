...
<html>
   <head>
      <title>SayOp - Smilie database</title>
...
<div class='rselect'><a href='newobj.php'>Add new object</a> / <a href='delobj.php'>Delete objects</a> / <a href='index.php'>Add new entries</a> / <a href='del.php'>Delete entries</a> / <a href='ip.php'>IP Control</a> / <b>Smilies</b> / <a href='com/logout.php'>Logout</a></div> 
";
...
<p>Add and remove smilies and emotions</p>
<br />

<form name='smiliefrm' action='com/editsmile.php' method='post'>
<div align='left'>
Smilie code: <input name='code' type='text' size='20' /> <br /><br />
Smilie URL: <input name='url' type='text' size='40' /> Example: http://www.mywebsite.com/comments/smilies/smilie.gif<br /><br />
<input name='addsmilie' type='submit' value='Add smilie' />
</div>
</form>
...
<h4>Available smilies</h4>

";


$ipquery = mysql_query("SELECT * FROM ".$so_prefix."_smilies ORDER BY id ") or die("Sql error:" . mysql_error());
$iprows = mysql_num_rows($ipquery);

if($iprows=='0') {
echo "There are no smilies in the database";
}
else {
echo "<u>Smilie code</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <u>Image</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style='margin-left: 40px;'><br />\n";

while ($irow = mysql_fetch_row($ipquery)) {
echo "$irow[1]&nbsp;&nbsp;&nbsp; => &nbsp;&nbsp;&nbsp; $irow[2] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | <a href='com/editsmile.php?id=$irow[0]'>Remove smilie</a> <br /> \n";
                                      }
echo "</div>";
     }
