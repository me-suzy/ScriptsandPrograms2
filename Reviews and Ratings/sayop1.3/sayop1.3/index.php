...
<div class='rselect'><a href='newobj.php'>Add new object</a> / <a href='delobj.php'>Delete objects</a> / <b>Add new entries</b> / <a href='del.php'>Delete entries</a> / <a href='ip.php'>IP control</a> / <a href='smile.php'>Smilies</a> / <a href='com/logout.php'>Logout</a></div> 
...
margin: 0px auto; text-align: left;'>
  <form name='f1' action='com/add_entry.php' method='post'>
    ...
    <div class='row' style='font-size: 11px;'>
      Email: <input type='text' size='25' name='email' /><span class='small'>(optional)</span>
    </div>
    <div class='row' style='font-size: 11px;'>
      <span class='label'>Comments:</span><span class='formw'>
        <textarea name='comment' cols='35' rows='9' wrap='hard'></textarea>
      </span>
    </div>
   <div class='row'>
...
";
      ...
      if(!$nrows=='0') { echo "<br /><br /><br />Please select an object from the left panel to add new entries."; }
      else { echo "<br /><br /><br />There are no objects available to add entries."; }
     }
