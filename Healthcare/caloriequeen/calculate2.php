...
$sodium = $row['sodium'];
$calories2 = round($calories*$gmwt2/100);
$total_fat2 = round($total_fat*$gmwt2/100);
$saturated_fat2 = round($saturated_fat*$gmwt2/100);
$carbohydrates2 = round($carbohydrates*$gmwt2/100);
$dietary_fiber2 = round($dietary_fiber*$gmwt2/100);
$sugar2 = round($sugar*$gmwt2/100);
$protein2 = round($protein*$gmwt2/100);
$cholesterol2 = round($cholesterol*$gmwt2/100);
$sodium2 = round($sodium*$gmwt2/100);
...
<input type="text" name="id" size="40" /> <input type="submit" name="Submit" value="Search" /></p>
		...
		<table border="0" width="100%" id="table1">
			<tr>
				...
				<p align="center">Serving Size <?php echo "$display_block"; ?><br>
&nbsp;<? echo "$option_block"; ?></p>
...
<table border="0" width="36%" id="table3" cellspacing="0" cellpadding="0" style="border: 2px solid #000000; font-family:Arial; font-size:12pt; color:#FF0000; font-weight:bold">
	...
	<tr>
		...
		<font color="#000000">Serving Size</font><?php echo "$gmwt_desc2"; ?></td>
	</tr>
	<tr>
		<td width="94%" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
