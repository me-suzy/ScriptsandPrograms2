...
$chk_category = "SELECT id FROM $table_name WHERE id = '$_GET[id]'";
$chk_category_res = @mysql_query($chk_category, $connection) or die (mysql_error());
$chk_category_num = mysql_num_rows($chk_category_res);
	if ($chk_category_num != 1) {
...
<table border="0" width="36%" id="table3" cellspacing="0" cellpadding="0" style="border: 2px solid #000000; font-family:Arial; font-size:12pt; color:#FF0000; font-weight:bold">
	...
	<tr>
		...
		<font color="#000000">Serving Size</font><?php echo "$serving_size"; ?></td>
	</tr>
	<tr>
		<td width="94%" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
	...
	<tr>
		...
		<font color="#000000">Calories</font>&nbsp;<? echo "$calories"; ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<font color="#000000">Total Fat</font>&nbsp;<? echo "$total_fat"; ?></td>
	</tr>
	<tr>
		<td width="98%" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
		&nbsp;&nbsp;&nbsp;&nbsp; <font color="#000000">Saturated Fat</font>&nbsp;<? echo "$saturated_fat"; ?></td>
	</tr>
	<tr>
		<td width="98%" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
		<font color="#000000">Cholesterol</font>&nbsp;<? echo "$cholesterol"; ?></td>
	</tr>
	<tr>
		<td width="98%" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
		<font color="#000000">Sodium</font>&nbsp;<? echo "$sodium"; ?></td>
	</tr>
	<tr>
		<td width="98%" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
		<font color="#000000">Total Carbohydrate</font>&nbsp;<? echo "$carbohydrates"; ?></td>
	</tr>
	<tr>
		<td width="98%" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
		&nbsp;&nbsp;&nbsp;&nbsp; <font color="#000000">Dietary Fiber</font>&nbsp;<? echo "$dietary_fiber"; ?></td>
	</tr>
	<tr>
		<td width="98%" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
		&nbsp;&nbsp;&nbsp;&nbsp; <font color="#000000">Sugars</font>&nbsp;<? echo "$sugar"; ?></td>
	</tr>
	<tr>
		<td width="98%" valign="top" style="border-left-width: 1px; border-right-width: 1px; border-top: 1px solid #000000; border-bottom: 1px solid #000000">
		<font color="#000000">Protein</font>&nbsp;<? echo "$protein"; ?></td>
	</tr>
	<tr>
		<td width="84%">
		<img border="0" src="images/labelbottom.gif" width="300" height="19"></td>
