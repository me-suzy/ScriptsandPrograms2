      ...
      <div align="left"> 
        <table width="115" border="0" bgcolor="#009999" bordercolor="#009999" align="center" cellpadding="1" cellspacing="1">
          ...
          <tr bgcolor="#009999" valign="top"> 
			...
			<font color="#FFFFFF">By Name</font></a><font color="#FFFFFF"></font></font></font></b></td>
          </tr>
          <tr bgcolor="#009999" valign="top"> 
            <td height="2" bordercolor="#000000" style="border: 1px solid #000000">
			<b><font face="Arial" size="2">
			<a href="searchbycategory.php"><font color="#FFFFFF">By Category</font></a><font color="#FFFFFF"></font></font></font></b></td>
          </tr>
          <tr bgcolor="#009999" valign="top"> 
...
// Build SQL Query  
$query = "select * from $table_name where food_name like \"%$trimmed%\"  
  order by food_name";  // EDIT HERE and specify your table and field names for the SQL query
...
echo "$count.)&nbsp;<a href=\"nutritionfacts.php?id=$id\">$food_name</a><br>";
  $count++ ; 
