...
$pass=$get_userinfo[adminpass];
	...
	$admininfo=mysql_query("select * from banneradmin where id='$id'");
	$get_admininfo=mysql_fetch_array($admininfo);
	$adminname=$get_admininfo[adminuser];
$delete=mysql_query("delete from banneradmin where id='$id'");

$page = new Page('../template/admin_deladminconf.php');
$page->replace_tags(array(
'session' => "$session",
'css' => "$css",
'baseurl' => "$baseurl",
