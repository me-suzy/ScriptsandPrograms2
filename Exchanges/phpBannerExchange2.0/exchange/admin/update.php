...
$pass=$get_userinfo[adminpass];
	...
	$page = new Page('../template/admin_update.php');
	$page->replace_tags(array(
		'css' => "$css",
		'session' => "$session",
		'baseurl' => "$baseurl",
		'title' => "$exchangename - $LANG_updatemgr_title",
		'instructions' => "$LANG_updatemgr_inst",
		'opt1' => "$LANG_updatemgr_full",
		'opt1desc' => "$LANG_updatemgr_fulldesc",
		'opt2' => "$LANG_updatemgr_refresh",
		'opt2desc' => "$LANG_updatemgr_refreshdesc",
		'opt3' => "$LANG_updatemgr_updonly",
		'opt3desc' => "$LANG_updatemgr_updonlydesc",
