...
$page = new Page('../template/admin_checkbanners.php');
$page->replace_tags(array(
'session' => "$session",
'css' => "$css",
'baseurl' => "$baseurl",
'uid' => "$uid",
'title' => "$exchangename - $LANG_menu_checkbanners",
'shorttitle' => "$LANG_menu_checkbanners",
'description' => "$LANG_checkbanners_description",
