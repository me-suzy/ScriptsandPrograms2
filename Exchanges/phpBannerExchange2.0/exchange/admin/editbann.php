...
$page = new Page('../template/admin_editban.php');
$page->replace_tags(array(
'css' => "$css",
'session' => "$session",
'baseurl' => "$baseurl",
...
'message' => "$LANG_editbann_question1",
'bannerurl' => "$bannerurl",
'message2' => "$LANG_editbann_question2",
'newbanurl' => "$newbanurl",
'warning' => "$LANG_editbann_warning",
'button' => "$LANG_editbann_buttonconf",
'uid' => "$uid",
'bid' => "$bid",
