...
$changecat=mysql_query("update bannerstats set category='$category',approved='0' where uid='$id'");

	$page = new Page('../template/client_cat_changed.php');
	$page->replace_tags(array(
	'css' => "$css",
	'back' => "$LANG_back",
	'baseurl' => "$baseurl",
