...
<tr>
<form method="POST" action="editcatconfirm.php?SID={session}&catid={catid}">
	</td>
       <tr>
      <td width="22%">{catname}:</td>
      <td width="78%"><input type="text" name="newcatname" value="{oldcatname}" size="50"></td></tr>
    <tr>
