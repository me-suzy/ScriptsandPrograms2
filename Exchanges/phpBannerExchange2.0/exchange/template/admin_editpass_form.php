...
<tr>
<form method="POST" action="pwconfirm.php?SID={session}&id={id}">
	</td>
       <tr>
      <td width="22%">{newpass}:</td>
      <td width="78%"><input class="formbox" type="password" name="pass1" size="50"></td></tr>

      <td width="22%">{newpass1}:</td>
      <td width="78%"><input class="formbox" type="password" name="pass2" size="50"></td>
    </tr>
    <tr>
