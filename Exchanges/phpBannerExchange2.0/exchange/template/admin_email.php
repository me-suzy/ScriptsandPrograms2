...
<tr>
<form method="POST" action="emailsend.php?SID={session}">
	</td>
	    <tr>
      <td width="22%">{override}</td>
      <td width="78%"><input class="formbox" type="checkbox" name="override" value="Y"> {override_warning}</td>
    </tr>
		<tr>
      <td width="22%">{category}:</td>
      <td width="78%">
			<select class="formbox"  name="cat">
			<option selected value="0">{allcats}</option>
{categoryselect}
			</select>
			</td>
       <tr>
      <td width="22%">Subject:</td>
      <td width="78%"><input class="formbox" type="text" name="subject" size="55"></td></tr>

      <td width="22%" valign="top">{message}: <br><b>%username%</b><br><b>%login%</b><br><b>%email%</b><br> <b>%statstable%</b>
	  
	  
	  </td>
      <td width="78%"> <textarea class="formbox" rows="15" name="body" cols="55"></textarea></td>
    </tr>
    <tr>
