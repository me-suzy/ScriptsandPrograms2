...
<tr>
<form method="POST" action="process_faq.php?SID={session}{fid}">
	</td>
       <tr>
      <td width="22%">{question_txt}:</td>
      <td width="78%"><input class="formbox" type="text" name="question" size="73" value="{question}"></td></tr>

      <td width="22%" valign="top">{answer_txt}:
	  </td>
      <td width="78%"> <textarea class="formbox" rows="15" name="answer" cols="55">{answer}</textarea></td>
    </tr>
    <tr>
