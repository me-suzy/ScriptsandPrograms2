...
<tr>
<form action="{baseurl}/admin/stats.php" method="post">
<center><hr width="550" size="1"></center>
<table border="0" cellpadding="0" width="200" align="center" cellspacing="0">
<tr><td class="tablehead" colspan="2"><div class="littlehead">{shorttitle}</div></td></tr>
    <tr><td class="tablebody">{login}</td><td class="tablebody"><input class="formbox" type="text" name="login" size="12" maxlength="20"></td></tr>
    <tr><td td class="tablebody">{pass}</td><td class="tablebody"><input class="formbox" type="password" name="pass" size="12" maxlength="20"></td></tr>
    <tr><td colspan=2 class="tablebody"><center>
