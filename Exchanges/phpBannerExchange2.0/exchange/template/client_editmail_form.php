...
<tr>
            <form method="POST" action="infoconfirm.php?SID={session}">
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse"  width="90%">
    <tr>
      <td width="22%">{email_label}</td>
      <td width="78%"><input class="formbox" type="text" name="email" value="{email_old}" size="50"></td>
    </tr>
    <tr>
      <td width="22%">&nbsp;</td>
      <td width="78%"><p><input class="button" type="submit" value=" {submit} " name="submit">
