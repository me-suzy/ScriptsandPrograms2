...
<a href="dbdump.php?SID={session}">{newbuset}</a><p>
<center><form enctype="multipart/form-data" action="dbupload.php" method="post">
<table cellpadding="0" cellspacing="0" width="40%">
    <tr>
      <td width="100%" colspan="2"><center><a class="littleheadplain"><b>{upload}</b></a></td>
    </tr>
    <tr>
      <td width="84%"><CENTER>
		<input class="formbox" name="userfile" type="file"><BR>
			<input class="button" type="submit" value="  {upload_button}  ">
</div>
</td>
</tr>
</table>
