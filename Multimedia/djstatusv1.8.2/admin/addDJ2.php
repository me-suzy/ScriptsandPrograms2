...
$resultID = mysql_query("INSERT INTO currentdj (name, password, address, aim, msn, yim, icq, alias1, alias2, alias3) VALUES ('$newname', '$djpass1', '$newaddress', '$newaim','$newmsn', '$newyim', '$newicq', '$als1', '$als2', '$als3')") or die(mysql_error());
	if ($resultID == TRUE) {
		print "DJ $newname has been successfully added to the database!";
	} else {
		print "Sorry, but DJ $newname was not added to the database. Please check your settings and try again.";
	}
