...
if($HTTP_COOKIE_VARS['loged'] == 'yes') {
   if($HTTP_COOKIE_VARS['user_level'] == '1') {
      $sql = "DELETE FROM ".$prefix."_filter WHERE id='$HTTP_GET_VARS[id]'";
      $result = $db->query($sql);

      if(!$result) {
         include("page_header.php");
         $display = "Could not delete the word.";
         ...
         include("page_header.php");
         $display = "The word has been deleted.";
         $link = "filter.php";
         $template->getFile(array(
