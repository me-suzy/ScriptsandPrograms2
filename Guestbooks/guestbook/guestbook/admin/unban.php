...
if($HTTP_COOKIE_VARS['loged'] == 'yes') {
   if($HTTP_COOKIE_VARS['user_level'] == '1') {
      $sql = "DELETE FROM ".$prefix."_banned WHERE userid='$HTTP_GET_VARS[userid]'";
      $result = $db->query($sql);

      if(!$result) {
         include("page_header.php");
         $display = "Could not unban the user";
         ...
         include("page_header.php");
         $display = "The user has been unbanned.";
         $link = "ban.php";
         $template->getFile(array(
