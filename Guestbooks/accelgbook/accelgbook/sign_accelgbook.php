...
<form action="<?php echo $editFormAction; ?>" method="POST" name="addMessage" id="addMessage">
      ...
      <td><table width="500" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#999999">
        <tr>
          <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="forTableBgRight">
              <tr>
                <td height="25" colspan="2">&nbsp;&nbsp;Sign Guestbook<span class="forText" style="color: #FF3300"></span></td>
              </tr>
          </table></td>
        </tr>
      </table></td>
        ...
        <tr>
          <td><table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
              <tr>
                ...
                <td bgcolor="#F8F8F8" class="forTableBgRight"><input name="firstName" type="text" class="forForm" id="firstName3" size="25">
                    <span class="forText" style="color: #FF3300">*</span></td>
              </tr>
              <tr>
                <td width="120" bgcolor="#F3F3F3" class="forTableBgLeft">Last Name: </td>
                <td bgcolor="#F8F8F8" class="forTableBgRight"><input name="lastName" type="text" class="forForm" id="lastName3" size="25">
                    <span class="forText" style="color: #FF3300">*</span></td>
              </tr>
              <tr>
                <td bgcolor="#F3F3F3" class="forTableBgLeft">Email:</td>
                <td bgcolor="#F8F8F8" class="forTableBgRight"><input name="email" type="text" class="forForm" id="email3" size="25">
                    <span class="forText" style="color: #FF3300">*</span></td>
              </tr>
              <tr>
                <td bgcolor="#F3F3F3" class="forTableBgLeft">Website:</td>
                <td bgcolor="#F8F8F8" class="forTableBgRight"><input name="website" type="text" class="forForm" id="website3" size="25"></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#F8F8F8" class="forTableBgRight"><font face="Arial, Helvetica"><small>
                  <select name="country" class="forForm" id="select2">
                    <option value="Country not Selected" selected>Select Country</option>
              ...
              <tr valign="top">
                ...
                <td bgcolor="#F8F8F8" class="forTableBgRight"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td width="260"><textarea name="comment" cols="50" rows="6" class="forForm" id="textarea3"></textarea></td>
...
<input name="date2" type="hidden" id="date" value="<?php echo $marker ?>"></td>
                <td bgcolor="#F8F8F8" class="forTableBgRight">
                  <table width="100%"  border="0" cellspacing="0" cellpadding="2">
                    <tr>
                      <td><input name="Submit" type="submit" class="forButton" onClick="MM_validateForm('firstName3','','R','lastName3','','R','email3','','RisEmail');tmt_regExpValidator('textarea3','%3C%5B%5E%3E%5D*%3E','-%20Message%20field%20is%20required,%20HTML%20tags%20not%20supported.','!','1');return document.MM_returnValue" value="Submit"></td>
                    </tr>
                </table></td>
              </tr>
          </table></td>
    ...
    <tr>
      <td><table width="500" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#999999">
        <tr>
          <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="forTableBgRight">
              <tr>
                <td height="25" colspan="2" align="center">&nbsp;&nbsp;Required fields are denoted by<span class="forText" style="color: #FF3300">*</span></td>
              </tr>
          </table></td>
        </tr>
      </table></td>
