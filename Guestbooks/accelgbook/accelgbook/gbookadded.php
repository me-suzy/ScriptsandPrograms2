...
$query_rsBook = "SELECT * FROM accelgbook ORDER BY `date` ASC";
$rsBook = mysql_query($query_rsBook, $accelgbook) or die(mysql_error());
...
<table width="500" border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    ...
    <td class="forText"><div align="center">
      ...
      Please go to <a href="gbook.php">View Guestbook</a>  to see your message. </p>
    </div></td>
