...
// LT Diagram Builder 3.3 - PHP version using the gd extension
...
{ var $left, $right, $top, $bottom;
  ...
  { if ($theText!="") $dd=imagefontwidth(abs($this->BFont))*strlen($theText)-2;
    ...
    $ll=$theLeft;
    $rr=$theRight;
    if ((!is_int($ll))&&(is_int($rr))) $ll=$rr-$dd;
    if ((!is_int($rr))&&(is_int($ll))) $rr=$ll+$dd;
    if ($theDrawColor!="")
    { if (($ee=strchr($theDrawColor,"."))!="")
      { if ($ee==".gif") $ii=imagecreatefromgif($theDrawColor); 
        if ($ee==".png") $ii=imagecreatefrompng($theDrawColor); 
  ...
  { if ($theText!="") $dd=imagefontwidth(abs($this->BFont))*strlen($theText)-2;
    ...
    $ll=$theLeft;
    $rr=$theRight;
    if ((!is_int($ll))&&(is_int($rr))) $ll=$rr-$dd-2*$theBorderWidth;
    if ((!is_int($rr))&&(is_int($ll))) $rr=$ll+$dd+2*$theBorderWidth;
    if ($theDrawColor!="")
    { if (($ee=strchr($theDrawColor,"."))!="")
      { if ($ee==".gif") $ii=imagecreatefromgif($theDrawColor); 
        if ($ee==".png") $ii=imagecreatefrompng($theDrawColor); 
