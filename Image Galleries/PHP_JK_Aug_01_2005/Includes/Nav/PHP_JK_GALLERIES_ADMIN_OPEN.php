...
<HEAD>
	...
	<META HTTP-EQUIV='Keywords' Content='www.phpjk.com, message boards, free message board, free message boards, php message board, message board software, free image gallery, php image gallery, image gallery software, free mp3 catalog, www.phpjk.com'>
	<META HTTP-EQUIV='Description' Content='www.phpjk.com, Free message board, php message board, message board software, free image gallery, php image gallery, image gallery software, free mp3 catalog, community website, polls, mailing lists, account management and more! Uses php and MSSQL.'>
...
<BODY onLoad="toForm();" BGCOLOR='#<?=$PageBGColor?>' TEXT='#<?=$TextColor1?>' TOPMARGIN=3 LEFTMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
	...
	<table cellpadding=0 cellspacing=0 border=0 width=<?=$iTableWidth?>>
		<tr><td colspan=10 bgcolor=<?=$BorderColor2?>><img src='<?=$sSiteURL?>/Images/Blank.gif' Width=1></td></tr>
		<tr>
