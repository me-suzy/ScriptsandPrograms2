<?php 
	...
	Function WriteADVForm($sAction)
	{
		...
		<form name='ADVData' action = "index.php" method = "post" class='PageForm'>
			...
			$aVariables[3] = "sAccountUnq";
			$aValues[0] = "New";
			$aValues[1] = $_SERVER["REMOTE_ADDR"];
			$aValues[2] = "1";
			$aValues[3] = $sAccountUnq;
			Echo DOMAIN_Link("P");
			?>
			...
			<table width=<?=$iTableWidth?> cellpadding = 0 cellspacing = 10 border = 0 class='TablePage_Boxed'>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_HomeAddress1", "250", "TEXT", "", "50", "", $PHPJK_HomeAddress1); ?>
					</td>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_HomeAddress2", "250", "TEXT", "", "50", "", $PHPJK_HomeAddress2); ?>
					</td>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_HomeAddress3", "250", "TEXT", "", "50", "", $PHPJK_HomeAddress3); ?>
					</td>
			...
			<table width=<?=$iTableWidth?> cellpadding = 0 cellspacing = 10 border = 0 class='TablePage_Boxed'>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_WorkAddress1", "250", "TEXT", "", "50", "", $PHPJK_WorkAddress1); ?>
					</td>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_WorkAddress2", "250", "TEXT", "", "50", "", $PHPJK_WorkAddress2); ?>
					</td>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_WorkAddress3", "250", "TEXT", "", "50", "", $PHPJK_WorkAddress3); ?>
					</td>
			...
			<table width=<?=$iTableWidth?> cellpadding = 0 cellspacing = 10 border = 0 class='TablePage_Boxed'>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_EmailAddress", "250", "TEXT", "", "50", "", $PHPJK_EmailAddress); ?>
					</td>
				...
				<tr>
					...
					<td>
						<?php Disp_Form_Field("PHPJK_HomepageURL", "250", "TEXT", "", "50", "", $PHPJK_HomepageURL); ?>
					</td>
							...
							<tr>
								...
								<td>
									...
									If ( Trim($aADVArray[1][$x]) == "V" ) {
										...
										Echo "<input type='text' name='" . $aADVArray[0][$x] . "' value=\"" . htmlentities($aADVArray[4][$x]) . "\" size='50' maxlength='255'>";
									}ElseIf ( Trim($aADVArray[1][$x]) == "T" ) {
										If ( Trim($aADVArray[3][$x]) == "Y" ) {
											Echo "<sup>*</sup>";
										}
										Echo "<input type='hidden' name='TEXTAREA_" . $aADVArray[0][$x] . "' value='T'>";
										Echo "<textarea name='" . $aADVArray[0][$x] . "' cols=50 rows=4>" . htmlentities($aADVArray[4][$x]) . "</textarea>";
									}
			...
			<br><br>
			<input type = "submit" value = "Create my new account.">
			<br><br>
		</form>
		<?php 
	}
