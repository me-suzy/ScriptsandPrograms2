...
//Connection Settings @0-45A56F79
...
//Initialize Common Variables @0-CC166E11
...
$CCSLocales->AddLocale("en", Array("en", "US", array("", "", ""), 2, ".", ",", array("Janeiro", "Fevereiro", "Marco", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"), array("Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"), array("Sabado", "Domingo", "Segunda", "Terca", "Quarta", "Quinta", "Sexta"), array("Sab", "Dom", "Seg", "Ter", "Qua", "Qui", "Sex"), array("S", "D", "S", "T", "Q", "Q", "S"), array("d", "/", "m", "/", "yyyy"), array("dddd", ", ", "dd", " ", "mmmm", ", ", "yyyy"), array("h", ":", "nn", " ", "tt"), array("h", ":", "nn", ":", "ss", " ", "tt"), "AM", "PM", 0, false, "", "iso-8859-1", "ISO-8859-1"));
...
//galeriaxq Connection Class @-A221A384
class clsDBgaleriaxq extends DB_MySQL
{
    ...
    function Initialize()
    {
        ...
        $Configuration = $CCConnectionSettings["galeriaxq"];
...
//End galeriaxq Connection Class
    ...
    for($i = 0; $i < sizeof($FormatMask); $i++)
    {
      switch ($FormatMask[$i])
      {
        ...
        case "yyyy": 
          ...
          break;
        case "h":
          $FormattedDate .= $DateToFormat[ccsHour] == 0 ? 12 : $DateToFormat[ccsHour] % 12;
          break;
        case "hh":
          $FormattedDate .= sprintf("%02d", $DateToFormat[ccsHour] == 0 ? 12 : $DateToFormat[ccsHour] % 12);
          break;
        case "H":
...
//CCSelectProjectStyle @0-9B2E41CC
...
//CCSubStr @0-C7353895
function CCSubStr($str, $offset, $length = "", $encoding = false) {
...
//CCLoginUser @0-CD011CF9
function CCLoginUser($login, $password)
{
    $db = new clsDBgaleriaxq();
    $SQL = "SELECT user_id, group_id FROM x_usuarios WHERE x_apelido=" . $db->ToSQL($login, ccsText) . " AND x_senha=" . $db->ToSQL($password, ccsText);
    $db->query($SQL);
