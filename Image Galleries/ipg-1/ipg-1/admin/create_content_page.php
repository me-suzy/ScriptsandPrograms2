...
if($_POST['submit']){
	if($_POST['title'] == '' || strlen($_POST['title']) > 64) { $msg = "Please enter a title of between 1 - 64 characters."; } 
	else {
		if($cid = create_content($_POST)) { $msg = "Content Page: <b>" . $_POST['title'] . "</b> has been created."; } else { $msg = "There was a problem.  Content Page Not Created."; }
	}
}
...
<table border="0" cellpadding="10" width="444">
  <tr> 
    <td> <br>
      <p><span class="admin_section_title">Create Content Page</span></p>
      ...
      <form name="form1" method="post" action="<?php print $PHP_SELF ?>" enctype="multipart/form-data">
        <table width="55%" class="admin_form_box">
          <tr> 
            <td colspan="3" nowrap> 
              <p class="admin_form_header">Create Content</p>
            </td>
          </tr>
          <tr valign="middle"> 
            <td align="left" class="admin_form_label" nowrap>New Content Page: 
            </td>
            ...
            <td align="left" valign="middle" width="46%"> 
              ...
              <input type="submit" name="submit" value="Create Content Page">
            </td>
          </tr>
        </table>
        <br>
