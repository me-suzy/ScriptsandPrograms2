...
*/
$slideshow_backcolor_R = 221;  // for the slideshow are images created which are $small_pic_size x $small_pic_size
...
$slideshow_backcolor_B = 221;  // default is white - the values are the RGB values in decimals!
	$comment_corner_backcolor_R = 221; // new 1.2 this are the colors of the comment corner (RGB value in decimal)
	$comment_corner_backcolor_G = 255;
	$comment_corner_backcolor_B = 221;
?>