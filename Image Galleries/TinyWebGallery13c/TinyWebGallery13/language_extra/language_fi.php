...
$lang_translator = "&nbsp;";
$lang_optionen = "Asetukset";
$lang_menu_titel = "Kuvaus";
$lang_kommentar = "Kommentti";

$lang_titel = "";
$lang_titel_no = "Gallerioita ei viel&auml; ladattuna.";
$lang_select_gallery = "Valitse galleria.";
$lang_help = "Apua";
$lang_new_window = "Uusi ikkuna";
$lang_login = "Kirjaudu";
$lang_logout = "Kirjaudu ulos";
$lang_visitor = "Vierailut:";
$lang_total = "yhteens&auml;:";
$lang_today = "t&auml;n&auml;&auml;n:";
$lang_galleries = "Galleriat";
$lang_picture = "Kuva";
$lang_pictures = "Kuvat";
$lang_of = " ";

$lang_overview = "Takaisin yleiskuvaan";
$lang_forward = "Seuraava";
$lang_back = "Viimeinen";
$lang_rotate_left = "K&auml;&auml;nn&auml; vasemmalle";
$lang_rotate_right = "K&auml;&auml;nn&auml; oikealle";
$lang_start_slideshow = "Aloita kuvashow";
$lang_stop_slideshow = "Lopeta kuvashow";
$lang_thumb_forward = "&gt;"; // = '>'
$lang_thumb_back="&lt;"; // = '<'
$lang_views = " vierailua";

$lang_login_php_enter = "Anna salasana muuttaksesi kirjainkokoa<br />ja poistaaksesi kommentteja.";
$lang_login_php_enter_again = "V&auml;&auml;r&auml; salasana<br />Sy&ouml;t&auml; uudestaan:";

$lang_kommenar_php_both_fields = "T&auml;yt&auml; molemmat kent&auml;t.<br />";
$lang_kommenar_php_enter_name = "Anna nimi<br />(max. 30 merkki&auml;):";
$lang_kommenar_php_enter_comment = "Anna kommentti<br />(max. 150 merkki&auml;):";
$lang_kommenar_php_name = "Nimi:";
$lang_kommenar_php_comment = "Kommentti (max. 150 merkki&auml;):";
$lang_kommenar_php_speichern = "Tallenna";

$lang_privatelogin_php_wrong_password = "V&auml;&auml;r&auml; salasana<br />Sy&ouml;t&auml; uudestaan:";
$lang_privatelogin_php_password = "Anna salasana gallerialle<br />'%s':";
$lang_privatelogin_php_login = "Kirjaudu";

$lang_titel_php_titel = "Anna kuvaus<br />(max. 150 merkki&auml;):";
$lang_titel_php_save = "Tallenna";

$lang_slideshowid_php_loading = "Kuvashow latautumassa ...";

$lang_opionen_php_yes = "Kyll&auml;";
$lang_opionen_php_no = "Ei";
$lang_opionen_php_new_window = "Avaa galleria uudessa ikkunassa";
$lang_opionen_php_opt_slideshow = "Optimoitu kuvashow";
$lang_opionen_php_slideshowintervall = "Kuvashow vaihtoaika (sek.)";
$lang_opionen_php_ok = "OK";
$lang_opionen_php_top_nav = "N&auml;yt&auml; vain yl&auml;navigointi";

$lang_back_topx = "takaisin&nbsp;&nbsp;&nbsp;yl&ouml;s&nbsp;%s";
$lang_topx = "Top&nbsp;%s";
$lang_main_topx = "Takaisin etusivulle";
// new in 1.1
$lang_loading = "ladataan...";
$lang_dhtml_navigation = "K&auml;yt&auml; DHTML navigointia";
$lang_optionen_slideshow = "Kuvashown tyyppi";
$lang_optionen_slideshow_fullscreen = "Koko ruudussa";
$lang_optionen_slideshow_optimized = "H&auml;ivetys";
$lang_optionen_slideshow_normal = "Normaali";
$lang_lowbandwidth = "TinyWebGallery on optimoitu hitaille yhteyksille.";
$lang_highbandwidth = "TinyWebGallery on optimoitu nopeille yhteyksille.";
// new in 1.2
...
$lang_email_subscribemessage = "Thanks you for the registation. A confirmation email is sent to your email address.";
// Subscribemail, will be sent when someone subscribes.
$lang_email_subscribemail = "You were successful added to the notifiction newsletter";
...
// the welcometext
$lang_email_welcomemessage = "You can register and cancel the registation for the email notification.<br/>You get informed by the gallery administrator if new images are added to the gallery.";
...
$lang_email_admin_welcomemessage_send = 'You can inform here all registrered user (%s) about changes of the gallery.';
$lang_email_admin_sorryoddsendermailmessage = "Sorry, The sender email \"%s\" you entered does not look like a valid email adress.";
$lang_email_admin_sendermail = "Sender addresss (your email)";
