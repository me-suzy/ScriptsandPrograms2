...
$lang_translator = " - Translator: Magnus";
$lang_optionen = "Alternativ";
$lang_menu_titel = "Titlar";
$lang_kommentar = "Kommentar";

$lang_titel = "";
$lang_titel_no = "Inga album &ouml;r &ouml;nnu uppladdade";
$lang_select_gallery = "V&auml;lj ett album";
$lang_help = "Hj&auml;lp";
$lang_new_window = "Nytt&nbsp;f&ouml;nster";
$lang_login = "Logga in";
$lang_logout = "Logga ut";
$lang_visitor = "Bes&ouml;k:";
$lang_total = "Totalt:";
$lang_today = "Idag:";
$lang_galleries = "Album";
$lang_picture = "Bild";
$lang_pictures = "Bilder";
$lang_of = "Av";

$lang_overview = "Tillbaka";
$lang_forward = "N&auml;sta bild";
$lang_back = "F&ouml;reg&aring;ende bild";
$lang_rotate_left = "Vrid &aring;t v&auml;nster";
$lang_rotate_right = "Vrid &aring;t h&ouml;ger";
$lang_start_slideshow = "Starta Bildspel";
$lang_stop_slideshow = "Stoppa Bildspel";
$lang_thumb_forward = "&gt;"; // = '>'
$lang_thumb_back="&lt;"; // = '<'
$lang_views = "x";

$lang_login_php_enter = "Ange l&ouml;senord f&ouml;r att kunna &auml;ndra titlar<br />och f&ouml;r att kunna ta bort kommentarer:";
$lang_login_php_enter_again = "Felaktikt l&ouml;senord<br />F&ouml;rs&ouml;k igen:";

$lang_kommenar_php_both_fields = "Fyll i b&aring;da f&auml;lten tack.<br />";
$lang_kommenar_php_enter_name = "Ange ett namn<br />(max. 30 tecken):";
$lang_kommenar_php_enter_comment = "L&auml;mna en kommentar<br />(max. 150 tecken):";
$lang_kommenar_php_name = "Namn:";
$lang_kommenar_php_comment = "Kommentar (max. 150 tecken):";
$lang_kommenar_php_speichern = "Spara";

$lang_privatelogin_php_wrong_password = "Felaktigt L&ouml;senord<br />F&ouml;rs&ouml;k igen:";
$lang_privatelogin_php_password = "Ange l&ouml;senordet f&ouml;r albumet<br />'%s':";
$lang_privatelogin_php_login = "Logga in";

$lang_titel_php_titel = "Ange en titel<br />(max. 150 tecken):";
$lang_titel_php_save = "Spara";

$lang_slideshowid_php_loading = "Bildspelet laddas ...";

$lang_opionen_php_yes = "Ja";
$lang_opionen_php_no = "Nej";
$lang_opionen_php_new_window = "&Ouml;ppna Album i ett eget f&ouml;nster";
$lang_opionen_php_opt_slideshow = "Optimera bildspelet med &ouml;verg&aring;ngseffekter";
$lang_opionen_php_slideshowintervall = "Bildspelsintervall (sek.)";
$lang_opionen_php_ok = "OK";
$lang_opionen_php_top_nav = "Visa endast den &ouml;vre Navigationen";

$lang_back_topx = "tillbaka&nbsp;till&nbsp;b&ouml;rjan&nbsp;%s";
$lang_topx = "B&ouml;rjan&nbsp;%s";
$lang_main_topx = "Tillbaka till albumen";
// new in 1.1
$lang_loading = "laddar...";
$lang_dhtml_navigation = "Anv&auml;nd DHTML navigering";
$lang_optionen_slideshow = "Typ av bildspel";
$lang_optionen_slideshow_fullscreen = "Maximerad";
$lang_optionen_slideshow_optimized = "Crossfade";
$lang_optionen_slideshow_normal = "Normal";
$lang_lowbandwidth = "TinyWebGallery &auml;r optimerad f&ouml;r en l&aring;ngsam uppkoppling.";
$lang_highbandwidth = "TinyWebGallery &auml;r optimerad f&ouml;r en snabb uppkoppling."; 
// new in 1.2
