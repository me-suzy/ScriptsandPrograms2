...
$lang_translator = "&nbsp;";
$lang_optionen = "Opties";
$lang_menu_titel = "Titel";
$lang_kommentar = "Commentaar";

$lang_titel = "";
$lang_titel_no = "Er zijn nog geen galeries ge-upload.";
$lang_select_gallery = "Kies een galerie.";
$lang_help = "Help";
$lang_new_window = "Nieuw&nbsp;venster";
$lang_login = "Inloggen";
$lang_logout = "Uitloggen";
$lang_visitor = "Bezoeken:";
$lang_total = "Totaal:";
$lang_today = "Vandaag:";
$lang_galleries = "galeries";
$lang_picture = "Afbeelding";
$lang_pictures = "Afbeeldingen";
$lang_of = "van";

$lang_overview = "Naar het overzicht";
$lang_forward = "Volgende";
$lang_back = "Laatste";
$lang_rotate_left = "Roteer links";
$lang_rotate_right = "Roteer rechts";
...
$lang_login_php_enter = "Vul alstublieft het wachtwoord in om titels te wijzigen<br />en commentaren te verwijderen.";
$lang_login_php_enter_again = "Onjuist wachtwoord<br />Probeer het nog een keer:";

$lang_kommenar_php_both_fields = "Vul alstublieft beide velden in.<br />";
$lang_kommenar_php_enter_name = "Vul een naam in<br />(max. 30 Tekens):";
$lang_kommenar_php_enter_comment = "Schrijf een bericht<br />(max. 150 tekens):";
$lang_kommenar_php_name = "Naam:";
$lang_kommenar_php_comment = "Bericht (max. 150 tekens):";
$lang_kommenar_php_speichern = "Opslaan";

$lang_privatelogin_php_wrong_password = "Onjuist wachtwoord<br />Probeer het nog eens:";
$lang_privatelogin_php_password = "Vul alstublieft een wachtwoord voor de galerie in voor de galerie<br />'%s':";
$lang_privatelogin_php_login = "Inloggen";

$lang_titel_php_titel = "Geef een titel op<br />(max. 150 tekens):";
$lang_titel_php_save = "Opslaan";

$lang_slideshowid_php_loading = "Slideshow is aan het laden ...";

$lang_opionen_php_yes = "Ja";
$lang_opionen_php_no = "Nee";
$lang_opionen_php_new_window = "Open Galerie in een nieuw venster";
$lang_opionen_php_opt_slideshow = "Geoptimaliseerde slideshow met overgangen";
$lang_opionen_php_slideshowintervall = "Slideshow interval (sec.)";
$lang_opionen_php_ok = "OK";
$lang_opionen_php_top_nav = "Toon alleen top navigatie";

$lang_back_topx = "terug&nbsp;naar&nbsp;de&nbsp;Top&nbsp;%s";
$lang_topx = "Top&nbsp;%s";
$lang_main_topx = "Terug naar de galeries";
// new in 1.1
$lang_loading = "laden...";
$lang_dhtml_navigation = "Gebruik DHTML navigatie";
$lang_optionen_slideshow = "Soort slideshow";
$lang_optionen_slideshow_fullscreen = "Volledig Scherm";
$lang_optionen_slideshow_optimized = "Crossfade";
$lang_optionen_slideshow_normal = "Normaal";
$lang_lowbandwidth = "TinyWebGallery is geoptimaliseerd voor trage verbindingen.";
$lang_highbandwidth = "TinyWebGallery is geoptimaliseerd voor snelle verbindingen.";
// new in 1.2
