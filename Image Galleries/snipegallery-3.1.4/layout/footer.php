...
<br>
	<center>
		<span class="footer">
		<a href="http://www.snipegallery.com" target="_top">Snipe Gallery 
		<?php echo $cfg_program_version ?></a> by 
		<a href="http://www.snipe.net" target="_top" title="Snipe.Net">Snipe.Net</a>
		</span>
	</center>
</center>
</td>
...
<!--
	...
	function my_Submit()
	{
		self.location.href = 'crop.php?crop=1&page=<?php echo $_REQUEST['page']; ?>&gallery_id=<?php echo $gallery_id; ?>&image_id=<?php echo $image_id; ?>&croptype=<?php echo $_REQUEST['croptype']; ?>&sx=' + 
