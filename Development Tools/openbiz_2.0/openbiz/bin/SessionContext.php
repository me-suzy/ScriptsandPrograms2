...
class SessionContext
{
    ...
    **/
	...
	{
	   $key = $objName."_".$varName;
	   $this->m_SessObjArr[$key] = $value;
	}
    ...
    **/
	...
	{
	   if (!$this->m_SessObjArr) return;
	   $key = $objName."_".$varName;
	   if (key_exists($key, $this->m_SessObjArr))
	     $value = $this->m_SessObjArr[$key];
	}
   ...
   public function RetrieveSessionObjects()
	{
	   if (!file_exists($this->m_SessObjFileName))
	      return;
    ...
    * @return void
    **/
	public function ClearSessionObjects()
	{
