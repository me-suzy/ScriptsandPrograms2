		    ...
		    function testStart(){
				...
				function testAddArray(){
				    $test = &new module_reader();
						...
						$check = '$modules[\'module1\']=\'path1\';'."\n";
						$check .= '$modules[\'module2\']=\'path2\';'."\n";
						$check .= '$modules[\'module3\']=\'path3\';'."\n";
				...
				function testFile(){
				    $test = &new module_reader('test_circuits.php');
						...
						$check = '$module[\'module1\']=\'path1\';'."\n";
						$check .= '$module[\'module2\']=\'path2\';'."\n";
						$check .= '$module[\'module3\']=\'path3\';'."\n";
