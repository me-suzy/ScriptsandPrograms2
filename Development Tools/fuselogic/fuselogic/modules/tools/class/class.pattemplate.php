...
*/
	...
	//function setVariable added by eko 23/01/2003
	function setVariable($template,$name,$value = ''){
	  if(is_array($name)) return $this->addVars($template,$name,$value);
		else return $this->addVar($template,$name,$value);	
	}
