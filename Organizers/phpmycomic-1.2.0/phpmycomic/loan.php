...
$tpl->assignInclude("content", "themes/$themes/tpl/loan.tpl");
...
include("./lang/$language/loan.lang.php");
include("menu.php");
...
$row = mysql_fetch_array($data);
  ...
  $tpl->assign("title_id", $name);
  $tpl->assign("loan_date", $dat);
  $tpl->assign("get_form", 'function.php?cmd=loancomic');
