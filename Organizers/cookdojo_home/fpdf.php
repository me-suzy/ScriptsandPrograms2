...
function FPDF($orientation='P',$unit='mm',$format='A4')
{
	...
	if(is_string($format))
	{
		...
		elseif($format=='4x6')
			$format=array(288.05,432.05);
		elseif($format=='5x8')
			$format=array(360.05,576.05);
		else
...
function Output($name='',$dest='',$msg='')
{
	...
	switch($dest)
	{
		...
		case 'F':
			...
			fclose($f);
			if($msg != "") echo "<a title=\"PHPMyReport - Create Your Report easily!\" href=\"http://antonie.revti.net/phpmyreport/\"><img border=0 src=\"images/myreportbesar.gif\" width=210 height=90></a><br><div class=warning>$msg</div><br>";
			break;
		case 'S':
			//Return as a string
			return $this->buffer;
