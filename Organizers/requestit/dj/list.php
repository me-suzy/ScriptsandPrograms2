...
<tr>
	...
	<tr>
		<td class="phpmaker" style="text-indent:5;">Administrate Requests:<p></td>
	</tr>
</table>
...
<?php echo $x_explicit; ?>
		...
		<!-- explicit -->
<td valign=top><span class="phpmaker"><a href="<?php if ($x_id <> "") {echo "delete.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Delete</a></span></td>
	</tr>
<?php
	}
}
