...
switch ($sAction)
{
	...
	case "D": // Delete
		if (DeleteData($sDbWhere,$conn)) {
			$HTTP_SESSION_VARS["ewmsg"] = "The Selected DJ has been Deleted";
			phpmkr_db_close($conn);
			ob_end_clean();
			header("Location: list.php");
			exit();
...
<tr>
	...
	<tr>
		<td class="phpmaker" align="center">ARE YOU SURE YOU WHAT TO DELETE THIS DJ?<p></td>
	</tr>
</table>
...
<table border="0" cellspacing="1" cellpadding="3" width=350>
	<tr bgcolor="c0c0c0">
		...
		<td valign="top"><span class="phpmaker" style="color: ;">password</span></td>
	</tr>
<?php
$nRecCount = 0;
$i = 0;
...
<p>
<input type="submit" name="Action" value="CONFIRM DELETE" style="margin-left:93">
</form>
