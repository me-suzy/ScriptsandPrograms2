...
<tr>
	...
	<tr>
		<td class="phpmaker" align=center>PLEASE SETUP THE SYSTEM ADMINISTRATOR<p></td>
	</tr>
</table>
<form name="reques
<form name="requestadd" id="requestadd" action="install.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
