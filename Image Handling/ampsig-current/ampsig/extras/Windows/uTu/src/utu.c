...
/*
	...
	for example..
		...
		utu cor MyPassword http://corz.org/corz/ampsig/amp.php
...
int main (int argc, char *argv[]) {
	...
	if (argc == 3) {
		...
		fprintf(stderr, "\n  utu.. performs an ampsig uptime update.\n\n");
		...
		fprintf(stderr, "      /exec:(C:\\unix\\bin\\utu.exe) pass http://path/to/amp.php\n\n");
