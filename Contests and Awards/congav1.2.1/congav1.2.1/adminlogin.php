...
<table width="99%"  border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
    <td height="107" align="left" valign="top" bgcolor="#CCCCCC"><p><strong>Please input the administrator password below to enter</strong></p>
<form action="adminlogin2.php" method="post" name="login" id="login">
