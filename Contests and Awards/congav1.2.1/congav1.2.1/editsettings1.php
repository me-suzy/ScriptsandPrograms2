...
<table width="99%"  border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
	...
	<b>Edit settings</b></p>
	  ...
	  <form name="form1" method="post" action="editsettings2.php">
	    <table width="68%"  border="3" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr>
            <td width="14%"><strong>Conga Name </strong></td>
            <td width="86%"><input name="nname" type="text" id="nname" value="<?php echo "$name"; ?>">
            Conga Line </td>
          </tr>
          <tr>
            <td><strong>Conga Info (HTML Permitted) </strong></td>
            <td><textarea name="ninfo" cols="90" rows="10" id="ninfo"><?php echo "$info"; ?></textarea></td>
          </tr>
        </table><input type="hidden" name="password" value="<?php echo "$password"; ?>">
