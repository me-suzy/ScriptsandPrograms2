...
while ($chat = mysql_fetch_array($csel)) {
           if($chat[timem]>$gbacktime){
            print "[$chat[stamp]] <a href=\"index.php?p=view&view=$user[id]\" target=_parent><b>$chat[user]</b></a>: $chat[chat]<br>
            ";
        }else{
           print "[$chat[stamp]] <a href=\"index.php?p=view&view=$user[id]\" target=_parent><font style=\"font: oblique lighter 10px Arial, Helvetica, Sans-Serif;\"><i>$chat[user]</a>: $chat[chat]</i></font><br>
           ";
        }
}
