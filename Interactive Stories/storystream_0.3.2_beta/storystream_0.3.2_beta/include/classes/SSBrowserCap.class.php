<?php
/*******************************************************************************
	$Id: SSBrowserCap.class.php,v 1.21 2003/07/02 23:28:35 epsilon7 Exp $
    
    SSBrowserCap: HTTP_USER_AGENT Client Sniffer for PHP
...
class SSBrowserCap extends SSBrowserCapBase
{   var $_version = '2.1.3';
	/**
     *  Configuration
     *
	...
	var $_browser_features = array(
		 ...
		 *	(see SSBrowserCap.core.php $_feature_set array)
    ...
    function SSBrowserCap($UA='',$settings = true)
