...
<tr><td class='fframe'><%CATNAME%></td><td><input type='text' name='cname' value='<%CATNAME_VAL%>'></td></tr>
<tr><td class='fframe'><%CATDESCRIPTION%></td><td><input type='text' name='cdesc' value='<%CATDESC_VAL%>'></td></tr>
...
<tr><td class='fframe'><%CATCHARACTERS%></td><td><textarea name='cchars'><%CATCHARACTERS_VAL%></textarea></td></tr>
