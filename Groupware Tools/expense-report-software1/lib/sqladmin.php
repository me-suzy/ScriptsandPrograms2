...
/*
	...
	$Id: library.php,v 0.0.1 03/03/2004 17:38:21 Exp $
	slqadmin class
*/
...
//										die;
								...
								case "1":
									//hey, the guy wants to download a heying image
...
//									die;
							...
							if ($_POST[$key . "_temp"] && !$file) {
								...
								if (!is_array($img)) {
									...
									//removing the image, maybe in future return the heyer a proper answer
									//echo "MOHHHHH";
									@unlink($_CONF["path"] . $_CONF["upload"] . "tmp/" . $_POST[$key . "_temp"]);
									$_POST[$key . "_temp"] = "";
									$_POST[$key] = 0;
