...
<html>
<head>
<title>PopScript CSL v5.0</title>
...
<table width="100%" cellpadding="0" cellspacing="0" class="rowpic" border="0">
	<tr>
  		<td class="top"><Img Src="images/cslv5.0.jpg" Border="0" Height="205" Width="780" Name="untitled" UseMap="#untitled1" Alt="CSL Credits"><Map Name="untitled1"><Area Shape=Rect Coords="105,63,331,101" Href="http://www.popscript.com"><Area Shape=Rect Coords="656,140,733,157" Href="index.php"><Area Shape=Rect Coords="641,102,749,119" Href="index.php?resources=1"><Area Shape=Rect Coords="649,63,740,80" Href="index.php?license=1"><Area Shape=Rect Coords="648,25,733,42" Href="index.php?op=credits"></Map></td>
 	</tr>
</table>
<!-- /head -->
...
?>
	...
	<br />
	         <img src="<?=$snippet_theme?>/img/link.gif" alt="+">&nbsp;
	         <a href="mailto:admin@popscript.com">&nbsp;CSL Support</a><br />
	<?
	} else {
	?>
	<br />
