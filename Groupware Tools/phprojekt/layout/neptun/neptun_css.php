...
$cfg_highlight_link_color = '#47CB7F';
$cfg_column_main_color    = '#707070';
 ...
 * PHProjekt CSS-File
 *
 * $Id: neptun_css.php,v 1.26.2.1 2005/09/06 13:00:07 fgraf Exp $
 *
 */
body, td {
...
.button2sel {
    padding-left:20px;
    padding-right:20px;
    background-color: <?php echo $cfg_highlight_link_color; ?>;
    border-width: 2px;
    color: #ffffff;
...
/***************************
      navigation icons
***************************/
#$nav_icons = array('summary', 'calendar', 'contacts', 'chat', 'forum', 'filemanager', 'projects', 'timecard', 'notes', 'helpdesk', 'mail', 'todo',
#                   'links', 'bookmarks', 'votum', 'settings', 'help', 'logout', 'copyright');
#foreach($nav_icons as $icon){
#    echo 'div.nav'.ucfirst($icon).'Icon {
...
li.menuStartStopWork,  li.menuStopWatch {
    display:none;
}
li{
    margin-right:10px;
