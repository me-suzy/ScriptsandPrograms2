...
$cfg_highlight_link_color = '#CC3333';
$cfg_column_main_color    = '#006666';
 ...
 * PHProjekt CSS-File
 *
 * $Id: merkur_css.php,v 1.29.2.1 2005/09/06 13:00:07 fgraf Exp $
 *
 */
li img{
    border:none;
...
$nav_icons = array('summary', 'calendar', 'contacts', 'chat', 'forum', 'filemanager', 'projects', 'timecard', 'notes', 'helpdesk', 'mail', 'todo',
                   'links', 'bookmarks', 'votum', 'settings', 'help', 'logout');
