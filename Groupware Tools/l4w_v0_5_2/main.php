<?php
	...
	/*=====================================================================
    // $Id: main.php,v 1.26 2005/08/01 14:55:12 carsten Exp $
        ...
        <td valign="top" align="center">
          ...
          <form action="check_login.php" name="formular" method='post'>
                ...
                <table width="300" border="0" align="center" cellpadding="10" cellspacing="0">
                  <tr>
                        <td>
                          <font face="Verdana, Arial, Helvetica, sans-serif" size="1">Please provide your login and your password</font>
                        </td>
                  </tr>
                </table>
                  ...
                  <tr>
					...
					?>				          
                          ...
                          foreach ($mandators AS $key => $mandator) {
                            $sel = "";
                            if (isset ($_COOKIE["l4wmandator"]) && $_COOKIE["l4wmandator"] == $mandator['key'])
                                $sel = " selected"; 
                          	echo "<option value='".$mandator['key']."' $sel>".$mandator['name']."</option>";
                          }
                          ?>
                          </select>
				    <?php } ?>      
