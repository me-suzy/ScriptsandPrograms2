 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
	...
	GLOBAL 
		 ...
		 */
		$ADODB_vers = 'V4.23 16 June 2004 (c) 2000-2004 John Lim (jlim#natsoft.com.my). All rights reserved. Released BSD & LGPL.';
	...
	*/
	//function &FetchRow()
	function FetchRow() // cgf wg. http://bugs.php.net/bug.php?id=33558&edit=1
	{
