...
function Attach( $filename, $filetype = "", $disposition = "inline", $show_this_name = "")
{
...
*/
function BuildMail($content_type)
{
...
//	$this->xheaders['To'] = implode( ", ", $this->sendto );
	...
	$this->xheaders["X-Mailer"] = "leads4web/3";
...
function Send($content_type = "text/plain")
{
	...
	echo "to:       ".$this->strTo."<br>";
	echo "headers:  ".$this->xheaders['Subject']."<br>";
