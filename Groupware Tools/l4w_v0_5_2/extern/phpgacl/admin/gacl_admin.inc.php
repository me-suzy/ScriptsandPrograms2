...
// Dont forget to adjust the database settings below when uncommenting
die ("uncomment this if you need the gacl admin tool in <i>".__FILE__."</i>");
...
$gacl_options = array(
								...
								'db_table_prefix' => 'gacl_', //DO NOT USE "_"
								'caching' => FALSE,
