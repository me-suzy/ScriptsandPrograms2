<?php
  ...
  /**
    * $Id: index.php,v 1.5 2005/07/31 09:20:36 carsten Exp $
    *
    * main page for pics management. Each request concerning contacts is build up like
    * modules/pics/index.php?command=XXX
    *
    ...
    */
    ...
    //$logger->set_ident ("pics [User #".$_SESSION['user_id']."]");
    
	// === Inclusion of model and controler ============================
	require_once ("../common/leads4web_model.php");
	require_once ("models/pics_mdl.php");
	require_once ("controlers/pics_ctrl.php");
    ...
    $transistions = array (
        ...
        "add_entry"          => array ("success"        => "views/show_entries.tpl",
                                       "failure"        => "views/pic.tpl",
                                       "close"          => "views/close_window.tpl"),
        "add_pic_att"       => array ("success"        => "views/show_entries.tpl",
                                       "failure"        => "views/pic_as_attachment.tpl",
                                       "close"          => "views/close_window.tpl"),
        "add_entry_view"     => array ("success"        => "views/pic.tpl"),
        "add_folder_view"    => array ("success"        => "../common/views/folder.tpl"),
        "add_pic_att_view"  => array ("success"        => "views/pic_as_attachment.tpl"),
        ...
        "edit_att_pic"      => array ("success"        => "views/pic_as_attachment.tpl"),
        "edit_entry"         => array ("success"        => "views/pic.tpl",
        ...
        "update_att_pic"    => array ("success"        => "views/pic.tpl",
                                       "failure"        => "views/pic_as_attachment.tpl"),
    ...
    // === Execute Easy_Script =========================================
	$myScript = new pics_script($transistions);
	//$myScript->LANG = $LANG;
	$myScript->run("pics_model");
    $myScript->clean_up ();
