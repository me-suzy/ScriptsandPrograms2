<?php
  ...
  /**
    * $Id: index.php,v 1.14 2005/07/31 09:20:36 carsten Exp $
    *
    * main page for contacts. Each request concerning contacts is build up like
    * modules/contacts/index.php?command=XXX
    *
