<?php
    ...
    *
    * @version      $Id: faqs_ctrl.php,v 1.4 2005/05/15 15:31:53 carsten Exp $
    * @author       Carsten Graef <evandor@gmx.de>
    * @copyright    evandor media 2005
    * @package      faqs
    */    
	class faqs_script extends easy_controller {
			...
			switch($this->model->command->get()){
			   ...
			   /* case "add_note_att":
                ...
                case "add_ref_view": 
					...
					break;
			    case "browse":
			        $result = $this->model->browse ($params);
                    //$this->model->show_entries ($params);
			        break;
				case "delete_entry": 
				...
				case "help":
				    ...
				    break;
				default:
					die ("unrecognized command (ctrl:".$this->model->command->get().")");
			} // switch
