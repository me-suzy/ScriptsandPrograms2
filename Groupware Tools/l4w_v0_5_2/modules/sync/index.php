<?php
  ...
  /**
    * $Id: index.php,v 1.6 2005/07/31 09:20:36 carsten Exp $
    *
    * main page for sync management. Each request concerning contacts is build up like
    * modules/sync/index.php?command=XXX
    *
    ...
    */
    ...
    //$logger->set_ident ("sync [User #".$_SESSION['user_id']."]");
    
	// === Inclusion of model and controler ============================
	require_once ("../common/leads4web_model.php");
	require_once ("models/sync_mdl.php");
	require_once ("controlers/sync_ctrl.php");
    ...
    $transistions = array (
    	"show_options"       => array ("success"        => "views/show_options.tpl"),
    	"syncronize"         => array ("success"        => "views/result.tpl",
    	                               "failure"        => "views/show_options.tpl"),
    ...
    // === Execute Easy_Script =========================================
	$myScript = new sync_script($transistions);
	//$myScript->LANG = $LANG;
	$myScript->run("sync_model");
    $myScript->clean_up ();
