<?php
  ...
  /**
    ...
    *
    * main page for development management. Each request concerning contacts is build up like
    * modules/development/index.php?command=XXX
    *
    ...
    */
    ...
    //$logger->set_ident ("development [User #".$_SESSION['user_id']."]");
    
	// === Inclusion of model and controler ============================
	require_once ("../common/leads4web_model.php");
	require_once ("models/development_mdl.php");
	require_once ("controlers/development_ctrl.php");
    ...
    $transistions = array ( 
        "add_module"          => array ("success"        => "views/module.tpl"),
        "create_module"       => array ("success"        => "views/runsql.tpl",
                                        "failure"        => "views/module.tpl"),
        "run_sqls"            => array ("success"        => "views/success.tpl",
                                        "failure"        => "views/runsql.tpl"),
    ...
    // === Execute Easy_Script =========================================
	$myScript = new development_script($transistions);
	$myScript->run("development_model");
    $myScript->clean_up ();
