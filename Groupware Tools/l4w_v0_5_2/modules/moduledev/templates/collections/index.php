<?php
  ...
  /**
    * $Id: index.php,v 1.2 2005/07/31 08:45:17 carsten Exp $
    *
    ...
    */
	...
	// === Inclusion of model and controller ===========================
	require_once ("../common/leads4web_model.php");
	require_once ("models/###name###_mdl.php");
	require_once ("controllers/###name###_ctrl.php");
    ...
    $transistions = array (
        ...
        "add_###name###" => array ("success"       => "views/new_###name###.tpl"),
        ...
        "delete_entry"       => array ("success"        => "views/show_entries.tpl",
                                       "failure"        => "views/show_entries.tpl"),
        "edit_###name###"      => array ("success"        => "views/###name###.tpl"),
        "edit_folder"        => array ("success"        => "views/folder.tpl"),
    	"show_entries"       => array ("success"        => "views/show_entries.tpl"),
        "create_###name###"       => array ("success"        => "views/show_entries.tpl",
                                       "failure"        => "views/new_###name###.tpl"),
        "update_###name###"    => array ("success"        => "views/show_entries.tpl",
