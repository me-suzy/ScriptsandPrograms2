<?php
  ...
  /**
    ...
    *
    * main page for offers management. Each request concerning contacts is build up like
    * modules/offers/index.php?command=XXX
    *
    * @author       Carsten Graef <evandor@gmx.de>
    * @copyright    evandor media 2005
    * @package      simpleOffers
    */
    ...
    $transistions = array (
        ...
        "edit_entry"         => array ("success"        => "views/offer.tpl",
        ...
        "update_att_note"    => array ("success"        => "views/offer.tpl",
                                       "failure"        => "views/note_as_attachment.tpl"),
        "update_entry"       => array ("success"        => "views/show_entries.tpl",
                                       "failure"        => "views/offer.tpl",
                                       "apply"          => "views/offer.tpl"),
        "upload_pics"        => array ("success"        => "views/show_entries.tpl",
                                       "failure"        => "views/add_pics.tpl"),
    ...
    // === Execute Easy_Script =========================================
	$myScript = new offers_script($transistions);
	//$myScript->LANG = $LANG;
	$myScript->run("offers_model");
    $myScript->clean_up ();
