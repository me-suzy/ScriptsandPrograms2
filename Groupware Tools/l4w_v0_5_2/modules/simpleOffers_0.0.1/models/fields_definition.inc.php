<?php
  ...
  /**
    * $Id: fields_definition.inc.php,v 1.2 2005/05/27 08:00:22 carsten Exp $
    *
    ...
    */
	...
	$this->entry['offer_id']         = new easy_integer (null,0);
	...
	$this->entry['description']      = new easy_string  ('');      // holding the next command to execute
...
<tr>
    ...
    <td align=left valign=top>Pic here? Just drag & drop</td>
</tr>
<tr>
    <td colspan=3 height=20>
     info
...
$this->entry['details']          = new easy_string  (
