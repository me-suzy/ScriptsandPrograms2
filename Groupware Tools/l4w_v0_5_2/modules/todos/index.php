<?php
  ...
  /**
    ...
    *
    * main page for todos management. Each request concerning contacts is build up like
    * modules/todos/index.php?command=XXX
    *
    ...
    */
    ...
    //$logger->set_ident ("todos [User #".$_SESSION['user_id']."]");
    
	// === Inclusion of model and controler ============================
	require_once ("../common/leads4web_model.php");
	require_once ("../notes/models/notes_mdl.php");
	require_once ("models/todos_mdl.php");
	require_once ("controlers/todos_ctrl.php");
    ...
    $transistions = array (
        ...
        "edit_entry"         => array ("success"        => "views/todo.tpl",
        ...
        "update_att_note"    => array ("success"        => "views/todo.tpl",
                                       "failure"        => "views/note_as_attachment.tpl"),
        "update_entry"       => array ("success"        => "views/show_entries.tpl",
                                       "failure"        => "views/todo.tpl",
                                       "apply"          => "views/todo.tpl"),
    ...
    // === Execute Easy_Script =========================================
	$myScript = new todos_script($transistions);
	//$myScript->LANG = $LANG;
	$myScript->run("todos_model");
    $myScript->clean_up ();
