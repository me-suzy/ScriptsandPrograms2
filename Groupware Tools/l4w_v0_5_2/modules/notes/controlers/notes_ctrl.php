<?php
    ...
    *
    * @version      $Id: notes_ctrl.php,v 1.19 2005/07/24 12:31:11 carsten Exp $
    * @author       Carsten Graef <evandor@gmx.de>
    * @copyright    evandor media 2005
    * @package      notes
    */    
	class notes_script extends easy_controller {
        ...
        */
        function handleModel() {
			...
			switch($this->model->command->get()){
                ...
                case "add_folder":
	                //$this->model->entry['headline']->set_empty_allowed (false);
        ...
        */
		function add_quicklink (&$model) {
		    ...
		    create_quicklink ('document', 
                              ...
                              'modules/notes/index.php?command=show_note&note_id='.
                              $model->entry['note_id']->get());
        }
