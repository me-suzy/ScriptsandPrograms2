<?php
  ...
  /**
    * $Id: unset_current_view.php,v 1.3 2005/07/31 09:20:36 carsten Exp $
    *
    * unset current view
    *
    ...
    */
    ...
    $affected = l4w_model::unlockEntry ('contact', $_REQUEST['contact_id']);
	
    
?>
unset contact<br><?=$_REQUEST['contact_id']?> (<?=$affected?>)
</body>
</html>
