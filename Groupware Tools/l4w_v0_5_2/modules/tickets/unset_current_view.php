<?php
  ...
  /**
    * $Id: unset_current_view.php,v 1.4 2005/07/31 09:20:36 carsten Exp $
    *
    * unset current view
    *
    ...
    */
    ...
    $affected = l4w_model::unlockEntry ('ticket', $_REQUEST['entry_id']);
	
    
?>
unset ticket<br><?=$_REQUEST['entry_id']?> (<?=$affected?>)
</body>
</html>
