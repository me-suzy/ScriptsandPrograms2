<?php
   	...
   	/*=====================================================================
	// $Id: treemanager_frames.php,v 1.2 2005/04/09 06:07:25 carsten Exp $
...
<head>
    ...
    <frameset cols='201,*,0,0' border=0 id='contentframe'>
			<frame name='l4w_nav'      src='modules/tree/index.php?command=navigation'     marginwidth=0 marginheight=0>
