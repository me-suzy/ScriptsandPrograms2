<?php
/**
 * $Header: /usr/local/cvsroot/leads4web4/inc/easy_framework/classes/extern/pear/Log/Log.php,v 1.3 2005/07/24 12:56:59 carsten Exp $
...
class Log
{
    ...
    {
    	//echo "prio:".$priority." Log::mask: ".Log::MASK($priority).", _mask: ".$this->_mask;
    	//echo "result: ".(Log::MASK($priority) & $this->_mask)."<br>";
