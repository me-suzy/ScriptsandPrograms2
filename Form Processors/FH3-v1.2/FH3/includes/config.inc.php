...
fh_conf('FH_HELP_MASK',
    '<img src="%s" border="0" onmouseover="return overlib(\'%s\', DELAY, \'400\', FGCOLOR, \'#CFE3FF\', BGCOLOR, \'#27699F\', TEXTCOLOR, \'#1F547F\', TEXTFONT, \'Verdana\', TEXTSIZE, \'12px\', CELLPAD, 8, BORDER, 1, CAPTION, \'&nbsp;%s\', CAPTIONSIZE, \'12px\');" onmouseout="return nd();" style="color:333333;cursor:help;">'
);
...
fh_conf('FH_DEFUALT_USEARRAYKEY', true);
...
// The default display of the date fields (use d, m and y)
