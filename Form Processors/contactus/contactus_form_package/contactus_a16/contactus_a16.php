...
if($_SERVER['REQUEST_METHOD']=='POST')
	{
        ...
        <tr>
           ...
           <p align="center">
		   <input name="Submit" type="image" src="submit_a16.gif" border="0" value="Submit">
		   <input type="image" src="reset_a16.gif" name="Submit2" value="Reset" onclick="this.form.reset();return false;">           
           </p>
