 ...
 * The forum on http://www.blue-networks.net or email neil@blue-networks.net
...
$phprecipient ='
	...
	elseif (strtolower($destination)=="persontwo"){
	$demail="person2@email.com";
	}

	elseif (strtolower($destination)=="personthree"){
...
system($emailblockphp);
//end

//ip address blocker start
system($ipcheckphp);
//end
...
mail($demail, $subject, $message, "From: $namefrom <$emailfrom>\n");
