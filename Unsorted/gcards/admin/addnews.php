...
$page->headervalues = getHTMLareaJStop('myForm', 'body', '../');
...
<table align="center" cellpadding="10">
	...
	<tr>
		<td colspan="2">
			<textarea cols="50" rows="8" name="body" wrap="virtual"><? showVar('body'); ?></textarea>
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<? $smileyClass->showSmileys('body'); ?>
		</td>
	</tr>	
	<tr>
		<td colspan="2">
