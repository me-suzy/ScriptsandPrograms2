...
if (isset($_GET['row'])) $row = (int)$_GET['row']; else $row=0;
...
if ($catSearch) $sqlstmt .= " where catid = '$catSearch' order by $orderArg imageid $order"; else $sqlstmt .= " order by $orderArg imageid $order";
