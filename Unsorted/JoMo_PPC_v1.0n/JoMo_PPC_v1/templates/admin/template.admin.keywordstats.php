...
>
	...
	<%section name=ColumnLoop loop=$ss[ItemLoop]%>
     ...
     <TD align="left">
     	<a href="<%$selfURL%>?mode=keywordstats&cmd=delete&year=<%$items[ItemLoop].year%>&month=<%$items[ItemLoop].monthID%>&day=<%$items[ItemLoop].dayID%>&keyword=<%$items[ItemLoop].key%>">delete</a>
     </TD>
