...
<script>
 function onFormSubmit(){
          bannerForm.all["result[status]"].value = bannerForm.all["status"].checked?1:0;
...
<form name="bannerForm" action="<%$selfURL%>" method="post" onsubmit="return onFormSubmit();" ENCTYPE="multipart/form-data">
        ...
        <input type="hidden" name = "memberMode" value="banner">

        <input type="hidden" name = "memberID" value="<%$banner.memberID%>">
