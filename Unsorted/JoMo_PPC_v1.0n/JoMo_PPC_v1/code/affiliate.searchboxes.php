...
*/
	...
	$items = getSearchBoxes();
	$i=0;
	foreach ($items as $item){
		$item["htmlCode"]=translateSearchBox($affiliateID, $item["htmlCode"]);
		$items[$i]=$item;
		$i++;
	}
    ...
    $tpl->assign("items", $items);
		...
		$tpl->assign("smode","affiliate");

        $tpl->display("template.affiliate.searchboxes.php");
?>