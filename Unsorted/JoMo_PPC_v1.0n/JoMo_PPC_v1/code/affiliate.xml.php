...
*/
    ...
    $tpl->assign("xmlformat",getXMLFormat($affiliateID));	
    $tpl->assign("xmlurl",getSampleXMLURL($affiliateID));
		
	$tpl->display("template.affiliate.xml.php");
?>