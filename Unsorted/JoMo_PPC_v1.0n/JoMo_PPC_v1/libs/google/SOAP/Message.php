...
// +----------------------------------------------------------------------+
//
// $Id: Message.php,v 1.13 2002/04/15 06:45:39 shane Exp $
//

require_once __GOOGLE_DIR.'SOAP/globals.php';
require_once __GOOGLE_DIR.'SOAP/Base.php';
require_once __GOOGLE_DIR.'SOAP/Parser.php';
require_once __GOOGLE_DIR.'SOAP/Value.php';
require_once __GOOGLE_DIR.'SOAP/Header.php';
...
*
* @access   public
* @version  $Id: Message.php,v 1.13 2002/04/15 06:45:39 shane Exp $
