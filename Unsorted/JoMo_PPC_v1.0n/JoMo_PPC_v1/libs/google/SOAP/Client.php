...
// +----------------------------------------------------------------------+
//
// $Id: Client.php,v 1.25 2002/04/17 07:42:52 shane Exp $
//

require_once __GOOGLE_DIR.'SOAP/Value.php';
require_once __GOOGLE_DIR.'SOAP/Base.php';
require_once __GOOGLE_DIR.'SOAP/Transport.php';
require_once __GOOGLE_DIR.'SOAP/Message.php';
require_once __GOOGLE_DIR.'SOAP/WSDL.php';
...
*
* @access   public
* @version  $Id: Client.php,v 1.25 2002/04/17 07:42:52 shane Exp $
* @package  SOAP::Client
