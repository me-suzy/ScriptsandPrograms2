...
// +----------------------------------------------------------------------+
//
// $Id: Value.php,v 1.27 2002/04/17 07:42:52 shane Exp $
//
require_once __GOOGLE_DIR.'SOAP/Base.php';
require_once __GOOGLE_DIR.'SOAP/globals.php';
require_once __GOOGLE_DIR.'SOAP/Type/dateTime.php';
require_once __GOOGLE_DIR.'SOAP/Type/hexBinary.php';
...
*
* @access public
* @version $Id: Value.php,v 1.27 2002/04/17 07:42:52 shane Exp $
* @package SOAP::Client
