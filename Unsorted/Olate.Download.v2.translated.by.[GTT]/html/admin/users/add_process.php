...
<tr>
<td><p><?= // Function: Add user to database
admin_users_add($language, $_POST['username'], $_POST['password'], $_POST['master']); ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/users/add.php"><?= $language['link_adduser']; ?></a></li>
