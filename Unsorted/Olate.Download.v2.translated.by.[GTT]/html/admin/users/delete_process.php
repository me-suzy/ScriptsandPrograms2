...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_users_delete']; ?></strong></td>
...
admin_users_delete($language, $_GET['id']); ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/users/delete.php"><?= $language['link_deleteuser']; ?></a></li>
