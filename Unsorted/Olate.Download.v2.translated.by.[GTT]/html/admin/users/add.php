...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_users_add']; ?></strong></td>
...
<tr>
<td><?= $language['description_users_add']; ?><form action="add_process.php" method="post" name="add" id="add">
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
<tr>
<td width="12%"><?= $language['title_username']; ?></td>
<td width="88%"><input name="username" type="text" id="username" size="20"></td>
</tr>
<tr>
<td width="12%"><?= $language['title_password']; ?></td>
<td><input name="password" type="password" id="password" size="20"></td>
</tr>
<tr>
	<td><?= $language['title_master']; ?></td>
	<td><input name="master" type="checkbox" id="master" value="1"></td>
</tr>
</table>
<p>
