...
admin_generalsettings_update($language, $_POST['urlpath'], $_POST['topdownloadslink'], $_POST['alldownloads'], $_POST['searchlink'], $_POST['sorting'], $_POST['ratings'], $_POST['notopdownloads'], $_POST['pages']); ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/config/general.php">
<?= $language['link_languages_viewgenconfig']; ?>
</a></li>
<li><a href="<?= $config['urlpath']; ?>/index.php"  target="_blank">
