...
include('../../languages/'.$config['language'].'/config.php');    
...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_config_language']; ?></strong></td>
...
<tr>
<td><p><?= $language['description_config_language']; ?></p>
<p><strong><?= $language['description_config_language_current']; ?></strong></p>
<p><em><?= $language_config['language']; ?></em></p>
<p><?= $language['description_config_language_created']; ?><a href="<?= $language_config['url']; ?>" target="_blank"><?= $language_config['author']; ?></a><?= $language['description_config_language_on'].$language_config['released'].$language['description_config_language_designed'].$language_config['scriptver']; ?>.</p>
<p><strong><?= $language['title_config_language_available']; ?></strong></p>
<p><?= $language['description_config_language_select']; ?></p>
<form action="languages_process.php" method="post" name="config" id="config">
<p>
<select name="language" id="language">
<option value="<?= $config['language']; ?>"><?= $language['description_config_languagesel']; ?></option>
<?php
// Function: Get available languages
admin_config_language($config);
?>
</select>
<input type="submit" name="Submit" value="<?= $language['button_activate']; ?>">
</p>
</form>
<p><?= $language['description_config_language_new']; ?></p></td>
</tr>
</table></td>
</tr>
<tr>
