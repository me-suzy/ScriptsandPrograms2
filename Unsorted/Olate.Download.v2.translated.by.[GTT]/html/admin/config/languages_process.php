...
admin_languages_update($_POST['language']);
?>
...
<tr>
<td><p><?= $language['description_config_language_activated']; ?></p>
  <ul>
    <li><a href="<?= $config['urlpath']; ?>/admin/config/languages.php"><?= $language['link_languages_viewlangconfig']; ?></a></li>
