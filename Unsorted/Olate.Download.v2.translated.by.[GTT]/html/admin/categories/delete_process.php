...
// Function: Delete selected category
admin_categories_delete($_GET['id']);
?>
...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_categories_delete']; ?></strong></td>
...
<tr>
<td><p><?= $language['description_categories_deleted']; ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/categories/delete.php"><?= $language['link_deletecategory']; ?></a></li>
