...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_categories_add']; ?></strong></td>
...
<tr>
<td><p><?= // Function: Add category to database
admin_categories_add($language, $_POST['name']); ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/categories/add.php"><?= $language['link_addcategory']; ?></a></li>
