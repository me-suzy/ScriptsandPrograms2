...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_other_updates']; ?></strong></td>
...
<tr>
<td><?= $language['description_other_updates']; ?>
<p>
<?php
...
<p><strong><?= $language['title_other_mailinglist']; ?></strong></p>
<p><?= $language['description_other_mailinglist']; ?></p>
<p><strong><?= $language['title_other_changelog']; ?></strong></p>
<p><?= $language['description_other_changelog']; ?></p></td>
</tr>
</table></td>
</tr>
<tr>
