...
// Function: Delete selected file
admin_downloads_delete($_GET['id']);
?>
...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_downloads_delete']; ?></strong></td>
...
<?= $language['description_downloads_deleted']; ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/downloads/delete.php"><?= $language['link_deletedownload']; ?></a></li>
