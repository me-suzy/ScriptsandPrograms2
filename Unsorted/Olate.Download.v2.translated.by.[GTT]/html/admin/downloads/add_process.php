...
<tr>
<td><p><?= // Function: Add download to database
admin_downloads_add($language, $_POST['date'], $_POST['name'], $_POST['location'], $_POST['size'], $_POST['category'], $_POST['description_brief'], $_POST['description_full'], $_POST['custom_1_l'], $_POST['custom_1_v'], $_POST['custom_2_l'], $_POST['custom_2_v'], $_POST['image']); ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/downloads/add.php"><?= $language['link_adddownload']; ?></a></li>
