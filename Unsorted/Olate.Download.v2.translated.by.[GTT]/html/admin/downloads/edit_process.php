...
<tr>
<td><p><?= // Function: Update database
admin_downloads_edit($language, $_POST['id'], $_POST['date'], $_POST['name'], $_POST['location'], $_POST['size'], $_POST['category'], $_POST['description_brief'], $_POST['description_full'], $_POST['custom_1_l'], $_POST['custom_1_v'], $_POST['custom_2_l'], $_POST['custom_2_v'], $_POST['image']); ?></p>
<ul>
<li><a href="<?= $config['urlpath']; ?>/admin/downloads/edit.php"><?= $language['link_editdownload']; ?></a></li>
<li><a href="<?= $config['urlpath']; ?>/index.php"  target="_blank"><?= $language['link_viewmain']; ?></a></li>
<li><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_adminmain']; ?></a></li>
</ul></td>
</tr>
</table></td>
</tr>
