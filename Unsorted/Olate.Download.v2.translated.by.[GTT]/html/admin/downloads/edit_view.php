...
// Function: Get details of selected download
admin_downloads_edit_view($_GET['id']);
?>
...
<tr>
<td width="71%"><strong><a href="<?= $config['urlpath']; ?>/admin/main.php"><?= $language['link_administration']; ?></a><?= $language['title_downloads_edit']; ?></strong></td>
...
<tr>
<td><p><?= $language['description_downloads_edit_view']; ?></p>
<form action="edit_process.php" method="post" name="edit" id="edit">
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
<tr>
<td width="18%"><?= $language['title_downloads_date']; ?></td>
<td width="82%"><input name="date" type="text" id="date" value="<?= stripslashes($row['date']); ?>" size="8" maxlength="8"></td>
</tr>
<tr>
<td width="18%"><?= $language['title_downloads_name']; ?></td>
<td><input name="name" type="text" id="name" value="<?= stripslashes($row['name']); ?>" size="35"></td>
</tr>
<tr>
<td><?= $language['title_downloads_location']; ?></td>
<td><input name="location" type="text" id="location" value="<?= stripslashes($row['location']); ?>" size="60"></td>
</tr>
<tr>
<td><?= $language['title_downloads_size']; ?></td>
<td><input name="size" type="text" id="size" value="<?= stripslashes($row['size']); ?>" size="5">
<?= $language['description_downloads_mb']; ?></td>
</tr>
<tr>
<td><?= $language['title_downloads_category']; ?></td>
<td><select name="category" id="category">
<option value="<?= $row['category']; ?>" selected><?= $language['description_downloads_categorycur'].admin_downloads_edit_view_cat($row['category']); ?></option>
<option><?= $language['description_downloads_categorysel']; ?></option>
<?php
...
<p>&nbsp;</p>
<p>&nbsp;</p></td>
<td><textarea name="description_brief" cols="50" rows="5" id="description_brief"><?= stripslashes($row['description_brief']); ?></textarea></td>
</tr>
<tr>
<td><p><?= $language['title_downloads_description_f']; ?></p>
<p>&nbsp;</p>
<p>&nbsp;</p></td>
<td><textarea name="description_full" cols="50" rows="5" id="description_full"><?= stripslashes($row['description_full']); ?></textarea></td>
</tr>
<tr>
  ...
  <td><table width="100%" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td><input name="custom_1_l" type="text" id="custom_1_l4" value="<?= stripslashes($row['custom_1_l']); ?>" size="9"></td>
      </tr>
      <tr>
        <td width="7%"><?= $language['title_downloads_custom_value']; ?></td>
        <td><input name="custom_1_v" type="text" id="custom_1_v2" value="<?= stripslashes($row['custom_1_v']); ?>" size="35"></td>
      </tr>
  </table></td>
</tr>
<tr>
  ...
  <td><table width="100%" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="7%"><?= $language['title_downloads_custom_label']; ?></td>
        <td><input name="custom_2_l" type="text" id="custom_1_l5" value="<?= stripslashes($row['custom_2_l']); ?>" size="9"></td>
      </tr>
      <tr>
        <td width="7%"><?= $language['title_downloads_custom_value']; ?></td>
        <td><input name="custom_2_v" type="text" id="custom_1_v3" value="<?= stripslashes($row['custom_2_v']); ?>" size="35"></td>
      </tr>
  </table></td>
</tr>
<tr>
<td><?= $language['title_downloads_image']; ?></td>
<td><input name="image" type="text" id="image" value="<?= stripslashes($row['image']); ?>" size="60">
