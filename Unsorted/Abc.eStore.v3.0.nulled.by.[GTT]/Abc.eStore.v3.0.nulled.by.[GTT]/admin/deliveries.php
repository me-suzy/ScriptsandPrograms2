...
if( isset ( $_GET['delete'] ) && !$_SESSION['demo'] ) {
	...
	mysql_query ("delete from ".$prefix."store_delivery where id='$_GET[delete]'");
}

//

$select = mysql_query ("select ".$prefix."store_delivery.* from ".$prefix."store_delivery,".$prefix."store_countries WHERE ".$prefix."store_delivery.country_id=".$prefix."store_countries.country_id order by ".$prefix."store_delivery.category_id, ".$prefix."store_countries.parent_id, ".$prefix."store_countries.country");
...
<td align=\"center\"><b>".$lng[882].",$currency</b></td>
<td align=\"center\"><b>".$lng[903].",$currency</b></td>
...
while ($row = mysql_fetch_array($select)) {
	...
	<td align=\"center\"><a href=\"edit_delivery.php?id=$row[id]\">$lng[349]</a></td>
	<td align=\"center\"><a href=\"javascript:decision('$lng[886]','deliveries.php?delete=$row[id]');\">$lng[350]</a></td>
	</tr>";
