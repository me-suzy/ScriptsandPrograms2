...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#3366CC">
  ...
  <tr>
	...
	<a href="<? echo "detail.php?action=0"?>"><font size=1 face="Verdana, Arial, Helvetica, sans-serif" color='white'>[ Add Items ]</a></td>
  </tr>
</table>
<? 
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#3366CC" >
  <tr> 
    <td>&nbsp;<a href="detail.php?id=<? echo "$row->id" ?>"><font face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#000000"><? echo "$row->item_name" ?></font></b></font></a><br><u>Small Decription:</u><br><font face="Verdana, Arial, Helvetica, sans-serif" size="1">&nbsp;<? echo "$row->item_desc" ?></font>
	  <br>
	  <br><u>Detail Decription:</u><font face="Verdana, Arial, Helvetica, sans-serif" size="1">&nbsp;<? echo "$row->item_descde" ?></font> 
      <br>
