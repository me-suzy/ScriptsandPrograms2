<form method="get" action="<? echo "http://$http_location/"; ?>search.php">
...
<td  nowrap align="center"><font size="-2">Search for:</font><br>
<input type="text" name="key" maxlength="64" size="14">
</td>
</tr>
<tr bgcolor="<? echo $cl_win_tab ?>">
