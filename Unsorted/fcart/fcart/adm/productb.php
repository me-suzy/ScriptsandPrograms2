...
<?
$result = mysql_query("select product,category,price,image,descr,avail,rating,a_date from products where productid='$productid'");
list($product,$category,$price,$image,$descr,$avail,$rating,$a_date) = mysql_fetch_row($result);
...
echo <<<EOT
<br><b>Rating:</b> $rating<br>
<b>Last modified:</b> $a_date
</td></tr>
</table>
</td></tr></table>
