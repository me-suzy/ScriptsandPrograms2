...
//include the header
require("top.php");
if($_SESSION['Uname'] != $ADMINUNAME || $_SESSION['lp'] != 'pl')
{
...
or die(mysql_error());
echo "<br><center>";
echo "Welcome to the admin control panel<br>";
echo "<a href=edit.php>edit the main page</a><br>";
//include the updates link
...
echo "<a href=?action=delete&user=" . $row['Uname'] . "><img src=images/member.gif border=0>" . $row['Uname'] . "</a></td><td>";
