...
<tr><td width="738" height="94" align=left><img src="<?=C_URL.'/templates/'.C_TEMP?>/images/logo.jpg" border="0" height="94" width="130" alt="AzDGDating"></td></tr></table><Table CellSpacing="<?=C_BORDER?>" CellPadding="0" width="<?=C_BWIDTH?>" bgcolor="<?=C_TBCOLOR?>"><Tr><Td>
