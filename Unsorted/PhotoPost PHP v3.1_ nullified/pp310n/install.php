...
function dieWell( $message )  {
    $output = "<title>PhotoPost Installation</title>
        ...
        <tr align=\"center\">
        <td colspan=\"2\" align=\"left\" bgcolor=\"#0059B5\"><font face=\"".$Globals{'mainfonts'}."\"
...
if ($step == "") {
    $output .= "<Br><Br><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" bgcolor=\"#C6DFF7\" width=\"650\" align=\"center\"><tr><td>
        ...
        size=\"1\"><font
        size=\"4\" face=\"".$Globals{'mainfonts'}."\">Welcome to PhotoPost Install&nbsp;&nbsp;<font size=2 face=Arial >Nullified by CyKuH [WTN]</font>
        </font></td></tr>
        <Tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">
...
if ($step == "1") {
    ...
    $output="<Br><Br><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" bgcolor=\"#C6DFF7\" width=\"650\" align=\"center\"><tr><td>
        ...
        <td colspan=\"6\" align=\"left\" bgcolor=\"#0059B5\"><font face=\"\" color=\"#ffffff\"
        size=\"1\"><font
        size=\"4\" face=\"".$Globals{'mainfonts'}."\">Checking Your Server&nbsp;&nbsp;<font size=2 face=Arial >Nullified by CyKuH [WTN]</font>
        </font></td></tr>
        <Tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">";
    ...
    $output.="If you get WARNING's be sure the commands are in your server's path or are properly set to the executables;
        ...
        <Div align=\"right\"><a href=\"install.php?step=2UPGRADE\">Click here to UPGRADE your v2.5X database &raquo;&raquo;</a><br>
...
if ($step == "2") {
    $output = "<Br><Br><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" bgcolor=\"#C6DFF7\" width=\"650\" align=\"center\"><tr><td>
        ...
        <td colspan=\"6\" align=\"left\" bgcolor=\"#0059B5\"><font face=\"\" color=\"#ffffff\"
        size=\"1\"><font
        size=\"4\" face=\"".$Globals{'mainfonts'}."\">Setting up the PhotoPost database &nbsp;&nbsp;<font size=2 face=Arial >Nullified by CyKuH [WTN]</font>
        </font></td></tr>
        <Tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">";
...
if ($step == "3") {
    $output = "<Br><Br>
        ...
        <td colspan=\"6\" align=\"left\" bgcolor=\"#0059B5\"><font face=\"\" color=\"#ffffff\"
        size=\"1\"><font
        size=\"4\" face=\"".$Globals{'mainfonts'}."\">Configuring PhotoPost&nbsp;&nbsp;<font size=2 face=Arial >Nullified by CyKuH [WTN]</font>
        </font></td></tr>
        <Tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">
    ...
    if ($regtype == "internal") {
        $regtext = "<tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Admin Username:</font></td><Td bgcolor=\"#FFFFFF\"><input
            type=\"text\" size=\"50\" name=\"username\"></td></tr>
            <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Admin Password:</font></td><Td bgcolor=\"#FFFFFF\"><input
            type=\"password\" size=\"50\" name=\"password\"></td></tr>
            <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Enter Password Again:</font></td><Td bgcolor=\"#FFFFFF\"><input
            type=\"password\" size=\"50\" name=\"passwordconfirm\"></td></tr>
            <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Admin Email Address:</font></td><Td bgcolor=\"#FFFFFF\"><input
            type=\"text\" size=\"50\"
            name=\"adminemail\"></td></tr>
            <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Enter Email Again:</font></td><Td
            bgcolor=\"#FFFFFF\"><input type=\"text\" size=\"50\" name=\"emailconfirm\">
            <input type=\"hidden\" name=\"id41\" value=\"Internal\"></td></tr>";
    }
    if ($regtype == "external") {
        $regtext = "<tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Your Forum</font><br>
            <font size=\"1\" face=\"".$Globals{'mainfonts'}."\">Only vBulletin 2.0.3, 2.2.0 (and 2.2.1), UBBThreads (5, 6) and phpBB 1.4.4, are supported at this
    ...
    $output .= "<form method=\"POST\" action=\"install.php\">
        ...
        <table cellpadding=\"4\" cellspacing=\"1\" border=\"0\"  width=\"100%\">
        $regtext
        <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Your website name (i.e.: MyDomain.Com)</font></td><Td bgcolor=\"#FFFFFF\"><input type=\"text\" value=\"\" name=\"id2\"
        size=\"50\"></td></tr>
        <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Website URL to homepage</font></td><Td bgcolor=\"#FFFFFF\"><input type=\"text\" value=\"$website\" name=\"id3\"
        size=\"50\"></td></tr>
        <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">URL to PhotoPost scripts directory</font>
        </td><Td
        bgcolor=\"#FFFFFF\"><input type=\"text\" value=\"$photourl\" name=\"id11\"
        size=\"50\"></td></tr> ";

    if ($regtype != "internal") {
        $output .= "<tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">URL to Forum directory</font><br>
            <font size=\"1\" face=\"".$Globals{'mainfonts'}."\" color=\"red\">Please make sure this is correct!</font></td><Td bgcolor=\"#FFFFFF\"><input
            type=\"text\" value=\"$vb\" name=\"id7\" size=\"50\"></td></tr>
            <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Database table prefix for phpBB 2.0 (you may have chosen
    ...
    $output .= "<tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">URL to PhotoPost images directory</font></td><Td bgcolor=\"#FFFFFF\"><input type=\"text\" value=\"$imagesurl\" name=\"id49\" size=\"50\"></td></tr>
        <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">URL to PhotoPost data directory</font></td><Td bgcolor=\"#FFFFFF\"><input type=\"text\" value=\"$dataurl\" name=\"id5\"
        size=\"50\"></td></tr>
        <tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">Full path to PhotoPost data directory <b>(no spaces in path!)</b></font></td><Td bgcolor=\"#FFFFFF\"><input type=\"text\" value=\"$datapath\"
...
if ($step == "4") {
    if ($ppaction == "final") {
        ...
        $output = "<Br><Br>
            ...
            <tr align=\"center\">
            <td colspan=\"6\" align=\"left\" bgcolor=\"#0059B5\"><font face=\"\" color=\"#ffffff\"
            size=\"1\"><font size=\"4\" face=\"".$Globals{'mainfonts'}."\">PhotoPost nullified Installation is Complete</font>
            </font></td></tr><Tr><Td bgcolor=\"#FFFFFF\"><font size=\"2\" face=\"".$Globals{'mainfonts'}."\">";
