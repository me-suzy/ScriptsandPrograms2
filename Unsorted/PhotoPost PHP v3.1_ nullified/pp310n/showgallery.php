...
if ( isset($cat) ) {
    if ( $thumb != 0 ) {
        ...
        if ( ($incat < 990 || $incat > 2999) && empty($si) ) {
            if ( $Globals{'memformat'} == "no" && ($incat == "500" && $ppuser != "") ) {
                ...
                if ( $si == "" ) {
                    ...
                    $output .= "<center><font face=\"".$Globals{'mainfonts'}."\" size=\"".$Globals{'fontmedium'}."\"><b><A href=\"".$Globals{'maindir'}."/showgallery.php?thumb=1&amp;stype=2&amp;si=$tname&amp;cat=500&amp;perpage=12&amp;sort=1&amp;ppuser=$ppuser\">Click here to see all of $tname's photos</a></b></font></center><p>";
                }
            }
        ...
        $output .= "<tr><td bgcolor=\"".$Globals{'navbarcolor'}."\" colspan=\"$cols\">
            ...
            <option selected>$perpage</option><option>4</option><option>12</option><option>20</option><option>28</option></select>
            </td>
