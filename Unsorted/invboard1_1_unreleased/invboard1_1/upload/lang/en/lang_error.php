...
'search_word_short' => "One or all of your search keywords were below <#EXTRA#> characters, please go back and increase the length of these search keywords.",
...
'no_av_upload'  => "You do not have permission to upload avatars to this server",
'no_av_type'    => "You are not allowed to upload that type of file as an avatar",
...
'no_archive_messages'     => "Sorry, no private messages were found using that search critera. Try again and broaden the scope.",
...
'exp_text'                  =>  "Sorry, an error occured. If you are unsure on how to use a feature, or don't know why you got this error message, try looking through the help files for more information.",
...
'auth_key_wrong'            => "Sorry, the Validation Key is incorrect for this member. Please check the URL or the data you entered into the form. If the error persists, please contact a member of staff to assist you.",
'auth_no_key'               => "Sorry, that member does not have to validate their account. Please double check the data you entered.",
...
msg_blocked					=>	"This member has chosen not to be contactable by the IBForums Messenger",
...
referrer_fail					=>	"IBForums does not allow offsite posting.",
...
no_permission					=>	"Sorry, but you do not have permission to use this feature. If you are not logged in, you may do so using the form below.",
...
incorrect_use					=>	"Incorrect use of one of the IBForums files",
no_search_results					=>	"Sorry, but we did not find any matches. Try again and broaden your search criteria.",
