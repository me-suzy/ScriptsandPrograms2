...
'pm_email_subject' => "New Private Message",
...
'pme_title' => "ERROR",
'pme_none_sent' => "This private message has not been sent",
...
'pme_failed_nopm' => "Private Message to %s will fail because %s is not allowed to use the messanger",
'pme_failed_maxed' => "Private Message to %s will fail because %s has reached the maximum allowed stored messages",
'pme_failed_nomem' => "Private Message to %s will fail because %s does not exist!",
'pme_failed_block' => "Private Message to %s will fail because %s has blocked incoming messages",
...
'pmp_title'   => "You have a new private message!",
...
'arc_email_subject'  => "Private Message Archive Attached",
