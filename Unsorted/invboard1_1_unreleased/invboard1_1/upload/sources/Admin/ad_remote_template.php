...
class ad_settings {
	...
	function print_css_searchlinks()
	{
		...
		$DB->query("SELECT tmpl_id FROM ibf_skins WHERE css_id='".$IN['id']."'");
		...
		$DB->query("SELECT suid, set_id, group_name, func_name FROM ibf_skin_templates WHERE set_id='".$set['tmpl_id']."' AND section_content LIKE '%".$like."%' ORDER BY group_name");
