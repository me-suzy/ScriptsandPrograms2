...
include_once "sys/admin/TemplateGroup.inc";

$dataObject = new TemplateGroup ();
...
&nbsp;<font class=Locator><a href=./>template group</a></font></td><tr>
<?	
...
if (isset ($Add))
{
	...
	<td align=left valign=top>&nbsp;<font class=Locator>New template group addition</font></td></table>
...
else if (isset ($Update))
{
	?>
	<td width=100 align=left valign=top>&nbsp;<font class=Locator>Action:</font></td>
	<td align=left valign=top>&nbsp;<font class=Locator>The template group updating</font></td></table>
	<hr width=500 align=left noshadow size=1>
	<?
...
else if (isset ($Delete))
{
	?>
	<td width=100 align=left valign=top>&nbsp;<font class=Locator>Action:</font></td>
	<td align=left valign=top>&nbsp;<font class=Locator>The template group deleting</font></td></table>
	<hr width=500 align=left noshadow size=1>
	<?
		...
		if (sizeof ($id) > 0)
		{
			...
			<?
				for ($i = 0; $i < sizeof ($id); $i++)
				{
					...
					print "<td class=TableElement bgcolor=#D3D3D3><a href=./template/index.php?GroupID=".$id [$i].">".$dataObject->field ("Name", $id [$i])."</a></td>";
