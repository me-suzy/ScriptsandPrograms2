...
include_once "sys/admin/Template.inc";

$dataObject = new Template ();
...
&nbsp;<font class=Locator><a href=../>template group</a>&nbsp;/&nbsp;<a href=./index.php?GroupID=<?print $GroupID;?>>template</a></font></td><tr>
<?	
...
if (isset ($Add))
{
	...
	<td align=left valign=top>&nbsp;<font class=Locator>New template addition</font></td></table>
...
else if (isset ($Update))
{
	?>
	<td width=100 align=left valign=top>&nbsp;<font class=Locator>Action:</font></td>
	<td align=left valign=top>&nbsp;<font class=Locator>The template updating</font></td></table>
	<hr width=500 align=left noshadow size=1>
	<?
...
else if (isset ($Delete))
{
	?>
	<td width=100 align=left valign=top>&nbsp;<font class=Locator>Action:</font></td>
	<td align=left valign=top>&nbsp;<font class=Locator>The template deleting</font></td></table>
	<hr width=500 align=left noshadow size=1>
	<?
	
	$id = $dataObject->listByField ("GroupID", $GroupID*1);
	...
	else 
	{
		...
		if (sizeof ($id) > 0)
		{
			...
			<?
				for ($i = 0; $i < sizeof ($id); $i++)
				{
					print "<td class=TableElement bgcolor=#D3D3D3><a href=./index.php?Edit=yes&GroupID=$GroupID&ID=".$id [$i].">edit</a></td>";
					print "<td class=TableElement bgcolor=#D3D3D3><a href=./index.php?GroupID=$GroupID&FormID=".$id [$i].">".$dataObject->field ("Name", $id [$i])."</a></td>";
