...
/*
V2.43 25 Oct 2002  (c) 2000-2002 John Lim (jlim@natsoft.com.my). All rights reserved.
...
if (!empty($testmssql) && !empty($testado) ) { // ADO ACCESS MSSQL -- thru ODBC -- DSN-less
	...
	$myDSN="PROVIDER=MSDASQL;DRIVER={SQL Server};"
		. "SERVER=(local)\NetSDK;DATABASE=NorthWind;UID=sa;PWD=natsoft;Trusted_Connection=Yes"  ;
...
if (!empty($testmssql)) { // MS SQL Server -- the extension is buggy -- probably better to use ODBC
	...
	$db->PConnect('(local)\NetSDK','sa','natsoft','northwind');
