...
require_once(FS_PATH."/etc/locale/".LANG_PACK."/inc-palette.php");
...
<HEAD>
	...
	<TITLE><?php echo  PALT_HEADER ?></TITLE>
    <style type="text/css">
...
<BODY BGCOLOR='#<?php echo $NETJUKE_SESSION_VARS["bgcolor"]?>' TEXT='#<?php echo $NETJUKE_SESSION_VARS["text"]>' LINK='#<?php echo $NETJUKE_SESSION_VARS["link"]?>' ALINK='#<?php echo $NETJUKE_SESSION_VARS["alink"]?>' VLINK='#<?php echo $NETJUKE_SESSION_VARS["vlink"]?>' ONLOAD='self.focus();'>
	...
	<font color="#ffffff"><b>0000FF</b></font>
	</TD>
	</TR>
	<TR>
	...
	<font color="#000000"><b>00FF00</b></font>
	</TD>
	...
	<font color="#000000"><b>00FFFF</b></font>
	</TD>
	</TR>
	<TR>
	...
	<font color="#ffffff"><b>FF0000</b></font>
	</TD>
	...
	<font color="#ffffff"><b>FF00FF</b></font>
	</TD>
	</TR>
	<TR>
	...
	<font color="#000000"><b>FFFF00</b></font>
	</TD>
