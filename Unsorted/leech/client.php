...
@CHANGES
	...
	0.6 + Lock() method
		 ...
		 o fix POST call (duplicate content-length) - thanks Javier Sixto
...
<D:lockscope><D:$lockScope/></D:lockscope>\n<D:locktype><D:$lockType/></D:locktype>
	...
	function getStatus() 
	{
//		if( $this->debug & DBGTRACE ) echo "getStatus()\n";
		return $this->reply;
	}
	...
	{
		if( $this->debug & DBGTRACE ) echo "getStatusMessage()\n";
...
//		echo "processHeader()\n";
		$headers = array();
		$finished = false;
		echo '$this->debug & DBGINDATA :' . $this->debug & DBGINDATA;
