...
/* ---------------------------------------------------------------------- *\
  ...
  MOVED TO EDITOR.php FOR FONT NAME GENERATION
\* ---------------------------------------------------------------------- */
...
//    { name: "heading 1",     className: "headline",  classStyle: "font-family: arial black, arial; font-size: 28px; letter-spacing: -2px;" },
//    { name: "heading 2",    className: "headline2", classStyle: "font-family: arial black, arial; font-size: 12px; letter-spacing: -2px;" },
//    { name: "heading 3", className: "headline4", classStyle: "font-family: verdana; font-size: 18px; letter-spacing: -2px;" },
];
...
function editor_action(button_id) {
  ...
  // Custom2
  /*else if (cmdID == 'MediaLibrary') {  // insert some text from a popup window
    var myTitle = "Insert Image from Media Library";
    var myText = showModalDialog(_editor_url + "popups/insert_media.php",
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(_editor_url + "popups/select_color.php", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(_editor_url + "popups/insert_image.php", editdoc, "resizable: no; help: no; status: yes; scroll: yes; ");
    }

    // insert image
    else if (cmdID.toLowerCase() == 'medialibrary'){
      showModalDialog(_editor_url + "popups/insert_media.php", editdoc, "resizable: yes; help: no; status: yes; scroll=Yes; ");
    }

    // insert table
    else if (cmdID.toLowerCase() == 'inserttable'){
      showModalDialog(_editor_url + "popups/insert_table.php?"+objname,
                                 window,
                                 "resizable: yes; help: no; status: yes; scroll: yes; ");
    }
