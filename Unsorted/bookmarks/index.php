...
if ($redirect_id) {
    // This is here for legacy problems with old bookmark system redirects.
    header ("Location: ".$APB_SETTINGS['apb_url']."redirect.php?id=".$redirect_id);
    exit;
}
...
if (get_number_of_users() == 0) {
    include('account_setup.php');
}
elseif ($number_of_bookmarks == 0) {
    ...
    <tr>
      ...
      '<a href='setup.php'>Setup</a>' section.
