...
*/
        ...
        */
                ...
                $this->build_params['html_charset']  = $lang_char;
                $this->build_params['text_charset']  = $lang_char;
                $this->build_params['head_charset']  = $lang_char;
...
*/
        function _encodeHeader($input, $charset = 'windows-1251')
        {
                ...
                foreach ($matches[1] as $value) {
                        ...
                        $input = str_replace($value, '=?' . $lang_char . '?Q?' . $replacement . '?=', $input);
                }
