...
//  Popunder Exchange Client Code <br>
//  (C) 2002 NTM3K <br>
...
<?
	...
	q("insert into previews values('0','-3','$uid','".strtotime(date("d M Y H:i:s"))."','$REMOTE_ADDR','$campaign[id]')");
...
if(e(q("select id from clicks where ifrom='$REMOTE_ADDR' and cid='$cid' $sql_cur_period")))
{
	...
	q("insert into clicks values('0','$cid','$uid','-3','".strtotime(date("d M Y H:i:s"))."','$REMOTE_ADDR','$htref')");
