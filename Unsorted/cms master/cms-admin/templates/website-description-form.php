...
<!-- START MENU 2 -->
<?php include("$CFG->dir_admin_templates/website-menu.php") ?>
<!-- END MENU 2 -->
...
<h2>
<?php echo $Lang_website->header_edit_description ?>
</h2>
...
<form name=page_form action=website.php method=post>
<input type=hidden name=mode value="<?php echo $frm["mode"] ?>">
<tr valign=top>
<td bgcolor=#f3f3f3>
<textarea name=description style="width:100%; height:100px; border-width:1; border-color:#363636">
<?php echo $frm["description"] ?>
</textarea>
</td>
</tr>
<tr valign=top>
<td bgcolor=#f3f3f3>
<input type=submit value="<?php echo $frm["button"] ?>" style="width:100%; border-width:1; border-color:#363636">
</td>
</tr>
</form>
</table>
...
<p>
<?php echo $Lang_website->notes_edit_description ?>
</p>
<!-- END CONTENT -->
