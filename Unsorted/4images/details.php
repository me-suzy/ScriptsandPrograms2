...
if (!empty($next_prev_cache[$next_image_id])) {
  ...
  $next_image_file = (is_remote($next_prev_cache[$next_image_id]['image_media_file'])) ? $next_prev_cache[$next_image_id]['image_media_file'] : MEDIA_PATH."/".$cat_id."/".$next_prev_cache[$next_image_id]['image_media_file'];
...
if (!empty($next_prev_cache[$prev_image_id])) {
  ...
  $prev_image_file = (is_remote($next_prev_cache[$prev_image_id]['image_media_file'])) ? $next_prev_cache[$prev_image_id]['image_media_file'] : MEDIA_PATH."/".$cat_id."/".$next_prev_cache[$prev_image_id]['image_media_file'];
