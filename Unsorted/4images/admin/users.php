...
if ($action == "edituser") {
  ...
  show_input_row($lang['field_joindate'].$lang['date_desc'], "user_joindate", $user_row['user_joindate'], $textinput_size);
  show_input_row($lang['field_lastaction'].$lang['date_desc'], "user_lastaction", $user_row['user_lastaction'], $textinput_size);
...
if ($action == "modifyusers") {
  ...
  show_input_row($lang['field_joindate_after'].$lang['date_format'], "dateafter", "", $textinput_size);
  show_input_row($lang['field_joindate_before'].$lang['date_format'], "datebefore", "", $textinput_size);
  show_input_row($lang['field_lastaction_after'].$lang['date_format'], "lastactionafter", "", $textinput_size);
  show_input_row($lang['field_lastaction_before'].$lang['date_format'], "lastactionbefore", "", $textinput_size);
...
if ($action == "findusers") {
  ...
  if ($countusers['users'] > 0) {
    ...
    while ($user_row = $site_db->fetch_array($result)) {
      ...
      $show_user_name = htmlspecialchars($user_row[$user_table_fields['user_name']]);
