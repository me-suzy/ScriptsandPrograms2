...
include ($DIR."include/misc/echo.php");

$string  = "billing_ip_address=".urlencode(getenv("REMOTE_ADDR"))."&";
$string .= "product_description=". urlencode($x_Description)."&".
$string .= "cc_number=".         urlencode($x_Card_Num)."&";
list($ccexp_month,$ccexp_year) = explode("/",$x_Exp_Date);
$string .= "ccexp_month=".       urlencode($ccexp_month)."&";
$string .= "ccexp_year=".        urlencode($ccexp_year)."&";
$string .= "cnp_security=".      urlencode($x_Card_Code)."&";
$string .= "grand_total=".       urlencode($x_Amount)."&";
$string .= "billing_first_name=".urlencode($x_First_Name)."&";
$string .= "billing_last_name=". urlencode($x_Last_Name)."&";
$string .= "billing_company_name=".urlencode($x_Company)."&";
$string .= "billing_address1=".  urlencode($x_Address)."&";
$string .= "billing_address2=".  urlencode($x_Address_2)."&";
$string .= "billing_city=".      urlencode($x_City)."&";
$string .= "billing_state=".     urlencode($x_State)."&";
$string .= "billing_zip=".       urlencode($x_Zip)."&";
$string .= "billing_country=".   urlencode($x_Country)."&";
$string .= "billing_phone=".     urlencode($x_Phone)."&";
$string .= "billing_fax=".       urlencode($x_Fax)."&";
$string .= "billing_email=$x_Email&";
