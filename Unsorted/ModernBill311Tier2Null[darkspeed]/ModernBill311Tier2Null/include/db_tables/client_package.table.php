...
/* ----------------- CLIENT_PACKAGE ---------------------*/
      $title = PACKAGES;
      $parent = array(1=>"client_info",2=>"package_type",3=>"client_package",4=>"affiliate_config");
      $children = array("account_details","account_dbs","account_pops");
      $args = array(array("column"         => "cp_id",
                           "required"      => 0,
                           "title"         => ID,
                           "type"          => "HIDDEN"),
                    ...
                    array("column"         => "cp_start_stamp",
                           ...
                           "append"        => "("._DATE_FORMAT_.")"),
                    array("column"         => "cp_renew_stamp",
                           "required"      => 1,
                           "title"         => RENEWDATE,
                           "type"          => "FUNCTION_CALL",
                           "function_call" => date_input_generator($cp_renew_stamp,"cp_renew_stamp",stamp_to_date(mktime())),
                           "append"        => "("._DATE_FORMAT_.")"),
 ...
 $user_select_sql = "SELECT cp_id, pack_id, pack_price, cp_qty, cp_discount, cp_start_stamp, cp_renew_stamp, cp_renewed_on, cp_billing_cycle, cp_status FROM $db_table ";
      ...
      $insert_sql = "INSERT INTO client_package (cp_id,
                                            client_id,
                                            pack_id,
                                            pack_price,
                                            parent_cp_id,
