/* $Id: clseBayAppCategorizeUserPage.cpp,v 1.2.534.2 1999/08/05 20:42:11 nsacco Exp $ */
// Let's a user 'categorize' their user page (set where they want it displayed.)
