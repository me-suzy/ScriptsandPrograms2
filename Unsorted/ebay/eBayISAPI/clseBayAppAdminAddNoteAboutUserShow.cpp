/*	$Id: clseBayAppAdminAddNoteAboutUserShow.cpp,v 1.3.428.1 1999/08/01 02:51:39 barry Exp $	*/
//
...
//				about a user. It's a function (rather than a static
...
void clseBayApp::ShowAddNoteAboutUser(char *pUser,
									  char *pPass,
									  char *pAboutUser,
									  char *pSubject,
									  int type,
									  char *pText)
{
	*mpStream <<	"<form method=post action="
					"\""
			  <<	mpMarketPlace->GetCGIPath(PageAddNoteAboutUser)
			  <<	"eBayISAPI.dll"
					"\""
					">"
					"<INPUT TYPE=HIDDEN "
					"NAME=\"MfcISAPICommand\" "
					"VALUE=\"AdminAddNoteAboutUser\">";
	...
	*mpStream <<	">"
					...
					"</td>"
					"<td width=\"430\">" 
					"<input type=\"text\" name=\"aboutuser\" size=\"24\" maxlength=\""
				<<	EBAY_MAX_USERID_SIZE
				<<	"\"";
				
	if (pAboutUser != NULL					&&
		strcmp(pAboutUser, "default") != 0		)
	{
		*mpStream <<	" VALUE=\""
				  <<	pAboutUser
				  <<	"\"";
...
void clseBayApp::AdminAddNoteAboutUserShow(CEBayISAPIExtension *pThis, 
										   char *pUser,
										   eBayISAPIAuthEnum authLevel)
{
	...
	*mpStream <<	mpMarketPlace->GetHeader()
	...
	{
		ShowAddNoteAboutUser(NULL, NULL, pUser, NULL, 0, NULL);
	}
	else
	{
		ShowAddNoteAboutUser(NULL, NULL, NULL, NULL, 0, NULL);
	}
