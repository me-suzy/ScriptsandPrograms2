/*	$Id: ebay_feedback_detail.sql,v 1.3 1999/02/21 02:53:37 josh Exp $	*/
/*
...
commit;
 ...
 create index ebay_feedback_comment_id_index00
	on ebay_feedback_detail00
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index01
	on ebay_feedback_detail01
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index02
	on ebay_feedback_detail02
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index03
	on ebay_feedback_detail03
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index04
	on ebay_feedback_detail04
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index05
	on ebay_feedback_detail05
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index06
	on ebay_feedback_detail06
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index07
	on ebay_feedback_detail07
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index08
	on ebay_feedback_detail08
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
...
commit;
 ...
 create index ebay_feedback_comment_id_index09
	on ebay_feedback_detail09
	(commenting_id)
 storage(initial 65m next 20m)
 tablespace feedbacki02 unrecoverable parallel (degree 3);
