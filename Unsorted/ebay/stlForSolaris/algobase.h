/*	$Id: algobase.h,v 1.3 1998/12/17 04:13:28 josh Exp $	*/
/*
 *
 * Copyright (c) 1994
...
# if !( defined ( __NO_NAMESPACES ) && defined ( __MINMAX_DEFINED ) )
template <class T>
...
INLINE_LOOP void __distance(InputIterator first, InputIterator last, Distance& n, 
                       input_iterator_tag) {
...
INLINE_LOOP void __distance(BidirectionalIterator first, BidirectionalIterator last,
...
INLINE_LOOP ForwardIterator uninitialized_copy(InputIterator first, InputIterator last,
...
INLINE_LOOP void uninitialized_fill(ForwardIterator first, ForwardIterator last, 
			const T& x) {
...
template <class ForwardIterator, class T>
INLINE_LOOP void fill(ForwardIterator first, ForwardIterator last, const T& value) {
...
template <class InputIterator1, class InputIterator2>
INLINE_LOOP bool lexicographical_compare(InputIterator1 first1, InputIterator1 last1,
