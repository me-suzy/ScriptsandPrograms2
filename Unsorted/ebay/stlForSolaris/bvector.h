/*	$Id: bvector.h,v 1.3 1998/12/17 04:13:32 josh Exp $	*/
/*
 *
 * Copyright (c) 1994
...
// fbp : give a chance to overload allocator
# if ! defined ( Alloc )
...
public:
    ...
    typedef reverse_iterator<iterator, value_type, reference, difference_type>
        reverse_iterator;
public:
    // fbp: hints for poor compilers
#ifdef HAVE_BASE_MATCH_BUG
    friend random_access_iterator_tag iterator_category(const iterator&);
    friend random_access_iterator_tag iterator_category(const const_iterator&);
    friend difference_type* distance_type(const iterator&);
    friend difference_type* distance_type(const const_iterator&);
    friend value_type* value_type(const iterator&);
    friend value_type* value_type(const const_iterator&);
#endif
protected:
