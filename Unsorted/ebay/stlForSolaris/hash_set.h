/*	$Id: hash_set.h,v 1.3 1998/12/17 04:13:37 josh Exp $	*/
/*
 * Copyright (c) 1996
...
template <class Value, __DFL_TMPL_PARAM(HashFcn,hash<Key>),
...
{
private:
  typedef typename hashtable<Value, Value, HashFcn, identity<Value>, 
      EqualKey, Alloc> ht;
...
inline bool operator==(const __hash_multiset__<Val, HashFcn, EqualKey, Alloc>& hs1,
                       const __hash_multiset__<Val, HashFcn, EqualKey, Alloc>& hs2)
{
  return hs1.rep == hs2.rep;
}

# ifndef HAVE_DEFAULT_TYPE_PARAM
...
{
    typedef hash_set<Value, HashFcn,EqualKey>::super super;
    return (const super&)hs == (const super&)hs2; 
}
...
{
    typedef hash_multiset<Value, HashFcn,EqualKey>::super super;
    return (const super&)hs == (const super&)hs2; 
}
