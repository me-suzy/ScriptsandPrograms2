/*	$Id: pthread_alloc.h,v 1.3 1998/12/17 04:13:46 josh Exp $	*/
/*
 * Copyright (c) 1996
...
#  define __pthread_alloc_template   _pTHr_Al
# endif
...
#else 
__DECLARE_INSTANCE(pthread_alloc *, pthread_alloc::free_allocators,0);
__DECLARE_INSTANCE(pthread_key_t,  pthread_alloc::key,0);
__DECLARE_INSTANCE(bool, pthread_alloc::key_initialized, 0);
__DECLARE_INSTANCE(pthread_mutex_t, pthread_alloc::chunk_allocator_lock, 
                   PTHREAD_MUTEX_INITIALIZER);
__DECLARE_INSTANCE(char *, pthread_alloc::start_free,0);
__DECLARE_INSTANCE(char *, pthread_alloc::end_free,0);
__DECLARE_INSTANCE(size_t, pthread_alloc::heap_size, 0);
