/*	$Id: multiset.h,v 1.3 1998/12/17 04:13:44 josh Exp $	*/
/*
 *
 * Copyright (c) 1994
...
public:
    explicit multiset(const Compare& comp = Compare()) : t(comp) {}
...
public:
    ...
    explicit multiset(const Compare& comp = Compare()) : super(comp) {}
    multiset(const value_type* first, const value_type* last, 
