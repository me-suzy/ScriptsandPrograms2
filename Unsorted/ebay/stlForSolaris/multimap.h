/*	$Id: multimap.h,v 1.3 1998/12/17 04:13:43 josh Exp $	*/
/*
 *
 * Copyright (c) 1994
...
// allocation/deallocation
  explicit multimap(const Compare& comp = Compare()) : t(comp) { }
...
template <class Key, class T, class Compare, class Alloc, class Alloc2>
inline bool operator==(const __multimap__<Key, T, Compare, Alloc>& x, 
                       const __multimap__<Key, T, Compare, Alloc2>& y) {
  return x.t == y.t;
}
...
public:
    ...
    explicit multimap(const Compare& comp = Compare()) : super(comp) {}
    multimap(const value_type* first, const value_type* last, 
        const Compare& comp = Compare()) : super(first, last, comp) { }
    multimap(const_iterator first, const_iterator last, 
        const Compare& comp = Compare()) : super(first, last, comp) { }
};
