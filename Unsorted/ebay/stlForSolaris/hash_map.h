/*	$Id: hash_map.h,v 1.3 1998/12/17 04:13:36 josh Exp $	*/
/*
 * Copyright (c) 1996
...
{
private:
  typedef typename hashtable<pair<const Key, T>, Key, HashFcn,
...
inline bool operator==(const __hash_multimap__<Key, T, HF, EqKey, Alloc>& hm1,
                       const __hash_multimap__<Key, T, HF, EqKey, Alloc>& hm2)
{
  return hm1.rep == hm2.rep;
}
...
public:
  typedef typename __hash_multimap__<Key, T, HashFcn, EqualKey, alloc> super;
  __IMPORT_CONTAINER_TYPEDEFS(super)
  typedef typename super::key_type key_type;
  typedef typename super::hasher hasher;
  typedef typename super::key_equal key_equal;
