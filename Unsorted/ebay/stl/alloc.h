/* $Id: alloc.h,v 1.4 1998/09/30 03:00:48 josh Exp $ */
/*
...
# ifdef __STL_WIN32THREADS
    ...
    extern CRITICAL_SECTION __node_allocator_lock;
    extern bool __node_allocator_lock_initialized;
#   define __NODE_ALLOCATOR_LOCK \
...
# ifdef __STL_WIN32THREADS
  ...
  extern alloc __node_allocator_dummy_instance;
# endif
