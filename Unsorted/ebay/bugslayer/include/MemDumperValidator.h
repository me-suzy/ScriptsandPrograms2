//	$Id: MemDumperValidator.h,v 1.2 1999/03/22 00:09:30 josh Exp $
/*----------------------------------------------------------------------
John Robbins
...
----------------------------------------------------------------------*/
    int BUGSUTIL_DLLINTERFACE AddClientDV ( LPDVINFO lpDVInfo ) ;
...
RETURNS         :
    None.
----------------------------------------------------------------------*/
    void BUGSUTIL_DLLINTERFACE ValidateAllBlocks ( void * pContext ) ;
