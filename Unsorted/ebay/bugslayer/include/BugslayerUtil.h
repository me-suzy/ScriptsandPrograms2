//	$Id: BugslayerUtil.h,v 1.2 1999/03/22 00:09:30 josh Exp $
/*----------------------------------------------------------------------
...
APRIL '98   - Added the CSymbolEngine class in SymbolEngine.h
...
----------------------------------------------------------------------*/
BOOL BUGSUTIL_DLLINTERFACE GetLoadedModules ( DWORD     dwPID        ,
                                              UINT      uiCount      ,
                                              HMODULE * paModArray   ,
                                              LPUINT    puiRealCount  );
