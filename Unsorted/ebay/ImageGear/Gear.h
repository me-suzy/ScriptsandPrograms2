...
#define GEAR_REV_MINOR  6
#define GEAR_REV_UPDATE 30
...
#define POST_PROCESS_ABIC_GREY_LUT 1
#define POST_PROCESS_INVERT_BITONAL_RASTER 2

/* alpha channel  constants   */
#define  IG_ALPHA_CREATE_1       0
#define  IG_ALPHA_CREATE_8       1

#define  IG_BLEND_OVER           0
#define  IG_BLEND_IN             1
#define  IG_BLEND_HELD_OUT       2
#define  IG_BLEND_LINEAR         3

/* scan capabilities constants */
#define IG_SCAN_CAP_PIXELTYPE							0

#define IG_SCAN_CAP_XREFCOUNT							1
#define IG_SCAN_CAP_XFERCOUNT							1

#define IG_SCAN_CAP_PIXELFLAVOR						2
#define IG_SCAN_CAP_CONTRAST							3
#define IG_SCAN_CAP_BRIGHTNESS						4
#define IG_SCAN_CAP_XRES								5
#define IG_SCAN_CAP_YRES								6
#define IG_SCAN_CAP_BITSPERPIX						7
#define IG_SCAN_CAP_LAYOUT_LEFT						8
#define IG_SCAN_CAP_LAYOUT_RIGHT						9
#define IG_SCAN_CAP_LAYOUT_TOP						10
#define IG_SCAN_CAP_LAYOUT_BOTTOM					11

/* some pseudo-caps */
#define IG_SCAN_CONTROL_PAPER_SOURCE				12 /* see constants below IG_SCAN_PAPER_ */ 
#define IG_SCAN_CONTROL_FILE_APPEND					13	/* BOOL, default FALSE */
#define IG_SCAN_CONTROL_DISABLE_DISPLAY			14 /* BOOL, default FALSE */
#define IG_SCAN_CONTROL_SAVE_PAGES_SEPARATELY	15 /* BOOL, default FALSE */
#define IG_SCAN_CONTROL_SCAN_PAGES_MODELESS		16 /* BOOL, default FALSE */


#define IG_SCAN_CONTROL_APP_NAME						0x0011


#define IG_PIXEL_TYPE_BW         0
#define IG_PIXEL_TYPE_GRAY       1
#define IG_PIXEL_TYPE_RGB        2
#define IG_PIXEL_TYPE_PALETTE    3

#define IG_SCAN_PF_CHOCOLATE     0
#define IG_SCAN_PF_VANILLA       1

#define IG_SCAN_PAPER_AUTO			0	/* default */
#define IG_SCAN_PAPER_FLATBED		1
#define IG_SCAN_PAPER_ADF			2
...
#define IG_PALETTE_PRIORITY_DISABLE	  3
#define IG_PALETTE_PRIORITY_NOREALIZE 4 /* Same as IG_PALETTE_PRIORITY_DISABLE, */
...
#define IG_SHEAR_HORIZONTAL         0  
#define IG_SHEAR_VERTICAL           1  

#define IG_LOADDOC_DISPLAY_FIRST		0
#define IG_LOADDOC_DISPLAY_ALL		1
...
#define IG_DISPLAY_OPTION_DOWNSHIFT    1
#define IG_DISPLAY_OPTION_LUT          2
#define IG_ORIENTATION_SUPPORT			3
#define IG_PRINT_ADJUST						4
#define IG_DISPLAY_OPTION_USEMAPMODE	5
#define IG_DISPLAY_OPTION_DDB_OPTIMIZE	6
...
#define IG_FILL_MSB                 1
#define IG_FILL_LSB                 2
...
#define IG_ARITH_OVER               10 /* NOT   Img1 = Img2                */
...
#define IG_COLOR_SPACE_MONO			10	/*	8bit grayscale							*/
#define IG_COLOR_SPACE_ALPHA			11 /*	8bit alpha								*/
#define IG_COLOR_SPACE_MA				12 /*	16bit: mono + alpha					*/
#define IG_COLOR_SPACE_AM				13 /*	16bit: alpha + mono					*/
#define IG_COLOR_SPACE_RGBA			14 /*	32bit: RGB + alpha					*/
#define IG_COLOR_SPACE_ARGB			15 /*	32bit: alpha + RGB					*/
#define IG_COLOR_SPACE_YCC				16 /*	24bit: PhotoYCC						*/
#define IG_COLOR_SPACE_YCCA			17 /*	32bit: PhotoYCC + alpha				*/
#define IG_COLOR_SPACE_AYCC			18 /*	32bit: alpha + PhotoYCC				*/
#define IG_COLOR_SPACE_UNKNOWN		19 /*	unknown or invalid colorspace		*/
#define IG_COLOR_SPACE_NOCHANGE		20	/*	use current colorspace				*/
...
#define IG_WIPE_UP_TO_DOWN          22  /* upper edge to lower edge          */
#define IG_WIPE_DOWN_TO_UP          23  /* lower edge to upper edge          */
#define IG_WIPE_SPARKLE             2  /* replace random regions           */
#define IG_WIPE_ULTOLRDIAG          3  /* upper left to lower right        */
#define IG_WIPE_LRTOULDIAG          24  /* upper left to lower right        */
#define IG_WIPE_URTOLLDIAG          25  /* upper left to lower right        */
#define IG_WIPE_LLTOURDIAG          26  /* upper left to lower right        */
#define IG_WIPE_CLOCK               4 
#define IG_WIPE_SPARKLE_CLOCK       5  
#define IG_WIPE_DOUBLE_CLOCK        6 
#define IG_WIPE_SLIDE_RIGHT         7 
#define IG_WIPE_SLIDE_LEFT          8  
#define IG_WIPE_SLIDE_UP            27 
#define IG_WIPE_SLIDE_DOWN          28  
#define IG_WIPE_RANDOM_BARS_DOWN    9  
#define IG_WIPE_RAIN                10
#define IG_WIPE_BOOK                11
#define IG_WIPE_ROLL                12
#define IG_WIPE_UNROLL              13
#define IG_WIPE_EXPAND_PROPORTIONAL 14
#define IG_WIPE_EXPAND_HORIZONTAL   15
#define IG_WIPE_EXPAND_VERTICAL     16
#define IG_WIPE_STRIPS_HORIZONTAL   17
#define IG_WIPE_STRIPS_VERTICAL     18
#define IG_WIPE_CELLS               19
#define IG_WIPE_BALL                20
#define IG_WIPE_GEARS               21
...
#define IG_TAG_TYPE_UNICODE      15    /* data is a UNICODE string, 16 bit WCHARs term. by two NULLs */
#define IG_TAG_TYPE_FILETIME     16    /* data is a 64 bit FILETIME structure             */
#define IG_TAG_TYPE_DATE         17    /* data is a 64 bit DATE structure                 */
...
#define  IG_GUI_WINDOW_HANDLE_RESIZE   1
#define  IG_GUI_WINDOW_IMAGE_ADD       2
#define  IG_GUI_WINDOW_IMAGE_REMOVE    3
#define  IG_GUI_WINDOW_ZOOM_KEYS       4
#define	IG_GUI_WINDOW_ART_DISABLE		5


/* nAttributeID parameter of IG_GUI_thumbnail_attribute_set()           */
#define  IG_GUI_THUMBNAIL_WIDTH        0
#define  IG_GUI_THUMBNAIL_HEIGHT       1
#define  IG_GUI_THUMBNAIL_SHOW_TITLE   2
#define  IG_GUI_THUMBNAIL_X_SPACING    3
#define  IG_GUI_THUMBNAIL_Y_SPACING    4
#define  IG_GUI_THUMBNAIL_SHOW_FLAT    5
#define  IG_GUI_THUMBNAIL_BORDER_WIDTH 6
#define  IG_GUI_THUMBNAIL_SHADOW_WIDTH 7
#define  IG_GUI_THUMBNAIL_ZOOM_FACTOR  8
#define  IG_GUI_THUMBNAIL_INTERIOR     9
#define  IG_GUI_THUMBNAIL_MAGNIFY_FLAG 10
#define  IG_GUI_THUMBNAIL_TITLE_HEIGHT 11
#define  IG_GUI_THUMBNAIL_USE_EMBEDDED 12
#define  IG_GUI_THUMBNAIL_ALL_PAGES    13

/* nAttributeID parameter of IG_GUI_page_attribute_set()                */
#define  IG_GUI_PAGE_REALIZEPALETTETO			0 /* Type - HWND, realize the page		  */
															  /* thumbnails to this window's palette */
															  /* before realizing it's own palette	  */

/*GUI pixel dump window output mode*/
#define  IG_GUI_PIXDUMP_DIGITS_HEX		0x00000001
#define  IG_GUI_PIXDUMP_DATA_COLOR		0x00000002

#define  IG_GUI_PIXDUMP_COMPONENT_R		0x00000001
#define  IG_GUI_PIXDUMP_COMPONENT_G		0x00000002
#define  IG_GUI_PIXDUMP_COMPONENT_B		0x00000004
#define  IG_GUI_PIXDUMP_COMPONENT_RGB	0x00000008
#define  IG_GUI_PIXDUMP_COMPONENT_I		0x00000010
/*GUI pixel dump window data*/
#define  IG_GUI_PIXDUMP_FONT					100
#define  IG_GUI_PIXDUMP_MODE					101
#define  IG_GUI_PIXDUMP_COLOR_COMPONENT	102

/*ColorProfile*/
#define  IG_GUI_DATA_COLOR_COMPONENT	0x00000001
#define  IG_GUI_DATA_COLORPROFILE_STYLE		0x00000002

#define  IG_GUI_COLORPROFILE_STYLE_STACK		0x00000001
#define  IG_GUI_COLORPROFILE_STYLE_SEPARATE	0x00000002
#define  IG_GUI_COLORPROFILE_STYLE_OVERLAID	0x00000004
#define  IG_GUI_COLORPROFILE_STYLE_MASK		0xffffff00
#define  IG_GUI_COLORPROFILE_SET_STYLE(_dw_, _style_) \
						(((_dw_)&IG_GUI_COLORPROFILE_STYLE_MASK) | _style_)

#define  IG_GUI_COLORPROFILE_STYLE_TRACK		0x00000100
#define  IG_GUI_COLORPROFILE_STYLE_XY			0x00000200

#define  IG_GUI_COLOR_COMPONENT_R		0x00000001
#define  IG_GUI_COLOR_COMPONENT_G		0x00000002
#define  IG_GUI_COLOR_COMPONENT_B		0x00000004
#define  IG_GUI_COLOR_COMPONENT_RGB		0x00000008
#define  IG_GUI_COLOR_COMPONENT_I		0x00000010


/***************************************************************************/
/*GUI Magnify control options*/

#define	IG_GUI_MAGNIFY_POPUP_WIDTH					0x0000	/*Width of popup magnify window*/
#define	IG_GUI_MAGNIFY_POPUP_HEIGHT				0x0001	/*Height of popup magnify window*/
#define	IG_GUI_MAGNIFY_POPUP_ZOOM					0x0002	/*Zoom factor of popup magnify window*/
#define	IG_GUI_MAGNIFY_POPUP_CIRCLE				0x0003	/*Zoom factor of popup magnify window*/
...
#define  IG_EXTENSION_FLASHPIX   3
...
#define  IG_RESOLUTION_10_INCHES       5  /* Dots (Pixels) Per 10 Inch  */
#define  IG_RESOLUTION_10_CENTIMETERS  6  /* Pixles Per 10 CentiMeter   */


/* Interpolation methods                                                */
#define IG_INTERPOLATION_NONE					0
#define IG_INTERPOLATION_AVERAGE				1  /* this is for Pro Gold users only  */
#define IG_INTERPOLATION_BILINEAR			2  /* this is for Pro Gold users only  */
#define IG_INTERPOLATION_NEAREST_NEIGHBOR 3
#define IG_INTERPOLATION_PADDING				4
#define IG_INTERPOLATION_GRAYSCALE			5  /* this is for IG7 Pro Gold users only: 1 bit to 8g */

#define	IG_ORIENT_SUPPORT_NONE				0	/* orientation is not supported */
#define	IG_ORIENT_SUPPORT_1BIT_PROGOLD	1	/* only 1 bit rle compressed images is rotated before displaying */ 
#define	IG_ORIENT_SUPPORT_FULL				2	/* 1 bit rle compressed images rotated before displaying but all other images rotated during loading */ 

/* color space support level */
#define IG_CONVERT_TO_RGB						1
...
#define  IG_ORIENT_TOP_LEFT            1  /* Row0=Top    Col0=Left   Normal (Portrait) */
#define  IG_ORIENT_TOP_RIGHT           2  /* Row0=Top    Col0=Right  Flip-H            */
#define  IG_ORIENT_BOTTOM_RIGHT        3  /* Row0=Bottom Col0=Right  Rotate 180        */
#define  IG_ORIENT_BOTTOM_LEFT         4  /* Row0=Bottom Col0=Left   Flip-V            */
#define  IG_ORIENT_LEFT_TOP            5  /* Row0=Left   Col0=Top    Rotate 90 CC & Flip V   */
#define  IG_ORIENT_RIGHT_TOP           6  /* Row0=Right  Col0=Top    Rotate 90 C  (landscape)*/
#define  IG_ORIENT_RIGHT_BOTTOM        7  /* Row0=Right  Col0=Bottom Rotate 90 C & Flip V    */
#define  IG_ORIENT_LEFT_BOTTOM         8  /* Row0=Left   Col0=Bottom Rotate 90 CC (landscape)*/


/* constannts for threshold color reduction                                */
#define IG_REDUCE_BITONAL_GRAYSCALE    0
#define IG_REDUCE_BITONAL_AVE          1
#define IG_REDUCE_BITONAL_WEIGHTED     2


/* JPEG decimation constans                                                */
#define IG_JPG_DCM_1x1_1x1_1x1         0
#define IG_JPG_DCM_2x1_1x1_1x1         1
#define IG_JPG_DCM_1x2_1x1_1x1         2
#define IG_JPG_DCM_2x2_1x1_1x1         3
#define IG_JPG_DCM_2x2_2x1_2x1         4
#define IG_JPG_DCM_4x2_1x1_1x1         5
#define IG_JPG_DCM_2x4_1x1_1x1         6
#define IG_JPG_DCM_4x1_1x1_1x1         7
#define IG_JPG_DCM_1x4_1x1_1x1         8
#define IG_JPG_DCM_4x1_2x1_2x1         9
#define IG_JPG_DCM_1x4_1x2_1x2         10
#define IG_JPG_DCM_4x4_2x2_2x2         11

/* structure for Pogressive JPEG scan configuraion	*/
typedef struct	tagAT_PJPEG_SCANINFO{
	LONG		Ss;
	LONG		Se;
	LONG		HBit;
	LONG		LBit;
...
typedef LONG (LPACCUAPI LPFNIG_SEEK)(
...
typedef LONG (LPACCUAPI LPFNIG_READ)(
...
typedef LONG (LPACCUAPI LPFNIG_WRITE)(
...
typedef BOOL (LPACCUAPI LPFNIG_TAG_GET)(
...
typedef BOOL (LPACCUAPI LPFNIG_TAG_SET)(
...
typedef BOOL (LPACCUAPI LPFNIG_TAG_USER_GET)(

   LPVOID         lpPrivate,     /* Private data passed in        */
   LPAT_MODE      lpIGTag,       /* Tag ID from geartags.h        */
   LPAT_MODE      lpType,        /* Type of data lpTag points to  */
   LPVOID32 FAR   *lpTag,        /* Pointer to tag data           */
...
typedef AT_ERRCOUNT (LPACCUAPI LPFNIG_DIB_CREATE)( 
...
typedef AT_ERRCOUNT (LPACCUAPI LPFNIG_DIB_GET)( 
...
typedef AT_ERRCOUNT  (LPACCUAPI LPFNIG_RASTER_SET)( 
...
typedef AT_ERRCOUNT  (LPACCUAPI LPFNIG_RASTER_GET)(
...
typedef BOOL (LPACCUAPI LPFNIG_STATUS_BAR)( 
...
typedef LPBYTE (LPACCUAPI LPFNIG_MEM_ALLOC)( 

    DWORD   dwSize               /* number of bytes to alloc            */
   );
...
typedef LPBYTE (LPACCUAPI LPFNIG_MEM_REALLOC)( 

    LPBYTE  lpBuffer,            /* byte pointer to buffer to realloc   */
    DWORD   dwSize               /* new byte count for realloc buffer   */
   );
...
typedef LPBYTE (LPACCUAPI LPFNIG_MEM_FREE)( 

    LPBYTE  lpBuffer          /* byte pointer to buffer to freed     */
   );
...
typedef BOOL (LPACCUAPI LPFNIG_IMAGESPOOLED)(
...
typedef VOID (LPACCUAPI LPFNIG_LOAD_DISP)( 
...
typedef BOOL (LPACCUAPI LPFNIG_GUIPALETTE)(
...
typedef VOID (LPACCUAPI LPFNIG_GUISELECT)(

   LPVOID            lpPrivate,     /* Private data passed in        */
   const LPAT_RECT   lprcSelect     /* Selection rectangle           */
   );

typedef VOID (LPACCUAPI LPFNIG_GUIWINDESTROY)(
...
typedef VOID (LPACCUAPI LPFNIG_GUITHUMBSELECT)(
...
typedef INT (LPACCUAPI LPFNIG_GUITHUMBCOMP)(
...
typedef VOID (LPACCUAPI LPFNIG_GUIPANUPDATE)(
   ...
   LPVOID            lpPrivate,     /* Private data passed in        */
   HWND              hwndPan,       /* Pan window                    */
   const LPAT_RECT   lprcDevice     /* New device rect after panned  */
   );

typedef BOOL (LPACCUAPI LPFNIG_GUITHUMBTITLE)(
...
typedef VOID (LPACCUAPI LPFNIG_GUIPAGEORDERPROC)(

   LPVOID            lpPrivate,     /* Private data passed in        */
   HWND              hwndPage       /* Page sorter window handle     */
   );

typedef VOID (LPACCUAPI LPFNIG_GUIPAGESELECTPROC)(

   LPVOID            lpPrivate,     /* Private data passed in        */
   HWND              hwndPage,      /* Page sorter window handle     */
   HIGEAR            hIGear,        /* ImageGear image handle        */
   UINT              nPageNumber    /* Page number                   */
   );

typedef VOID (LPACCUAPI LPFNIG_GUIPAGEDELETEPROC)(

   LPVOID            lpPrivate,     /* Private data passed in        */
   HWND              hwndPage,      /* Page sorter window handle     */
   HIGEAR            hIGear,        /* ImageGear image handle        */
   UINT              nPageNumber,   /* Page number                   */
   BOOL              fDestroy       /* TRUE if window is destroyed   */
   );
...
/*                                                                         */
/* Keep list sorted and do not change numbering.  Add new formats between  */
/* existing ones.                                                          */
/*                                                                         */
/***************************************************************************/
...
#define IG_FORMAT_AFX            49
#define IG_FORMAT_FPX            50
#define IG_FORMAT_PJPEG          IG_FORMAT_JPG
#define IG_FORMAT_AVI            52
#define IG_FORMAT_G32D           53
#define IG_FORMAT_ABIC_BILEVEL   54
#define IG_FORMAT_ABIC_CONCAT    55
#define IG_FORMAT_PDF				56
#define IG_FORMAT_JBIG				57
#define IG_FORMAT_RAW				58
#define IG_FORMAT_IMR				59
#define IG_FORMAT_STX				60
/***************************************************************************/
...
#define IG_COMPRESSION_FPX_SINCOLOR 12    /* single color compression                  */
#define IG_COMPRESSION_FPX_NOCHANGE 13    /* save with the same compression as loaded  */

#define IG_COMPRESSION_DEFLATE		14

#define IG_COMPRESSION_IBM_MMR		15

#define IG_COMPRESSION_ABIC			16    /* IBM ABIC compression          */

#define IG_COMPRESSION_PROGRESSIVE	17		/* Progressive compression ( Progressive JPEG and may be PNG in future ) */

/***************************************************************************/
/* Format types used for saving image files                                */
/***************************************************************************/

#define IG_SAVE_UNKNOWN          (IG_FORMAT_UNKNOWN) /* Uses extension on the file name string to determine which format*/
...
#define IG_SAVE_ICA_IBM_MMR      (IG_FORMAT_ICA|((AT_LMODE)IG_COMPRESSION_IBM_MMR << 16))
...
#define IG_SAVE_PJPEG				(IG_FORMAT_PJPEG|((AT_LMODE)IG_COMPRESSION_PROGRESSIVE << 16))
#define IG_SAVE_MOD_G3           (IG_FORMAT_MOD|((AT_LMODE)IG_COMPRESSION_CCITT_G3 << 16))
#define IG_SAVE_MOD_G4           (IG_FORMAT_MOD|((AT_LMODE)IG_COMPRESSION_CCITT_G4 << 16))
#define IG_SAVE_MOD_IBM_MMR      (IG_FORMAT_MOD|((AT_LMODE)IG_COMPRESSION_IBM_MMR << 16))
#define IG_SAVE_NCR              (IG_FORMAT_NCR)
#define IG_SAVE_NCR_G4           (IG_FORMAT_NCR|((AT_LMODE)IG_COMPRESSION_CCITT_G4 << 16))
#define IG_SAVE_PBM_ASCII       (IG_FORMAT_PBM)
#define IG_SAVE_PBM_RAW         (IG_FORMAT_PBM|((AT_LMODE)IG_COMPRESSION_PACKED_BITS << 16))
...
#define IG_SAVE_RAW_G3           (IG_FORMAT_G3|((AT_LMODE)IG_COMPRESSION_CCITT_G3 << 16))
#define IG_SAVE_RAW_G4           (IG_FORMAT_G4|((AT_LMODE)IG_COMPRESSION_CCITT_G4 << 16))
#define IG_SAVE_RAW_G32D         (IG_FORMAT_G3|((AT_LMODE)IG_COMPRESSION_CCITT_G32D << 16))
...
#define IG_SAVE_WMF              (IG_FORMAT_WMF)

#define IG_SAVE_FPX_NOCHANGE     (IG_FORMAT_FPX|((AT_LMODE)IG_COMPRESSION_FPX_NOCHANGE << 16))
#define IG_SAVE_FPX_UNCOMP       (IG_FORMAT_FPX|((AT_LMODE)IG_COMPRESSION_NONE << 16))
#define IG_SAVE_FPX_JPG          (IG_FORMAT_FPX|((AT_LMODE)IG_COMPRESSION_JPEG << 16))
#define IG_SAVE_FPX_SINCOLOR     (IG_FORMAT_FPX|((AT_LMODE)IG_COMPRESSION_FPX_SINCOLOR << 16))

#define IG_SAVE_DCM					(IG_FORMAT_DCM)
#define IG_SAVE_JBIG					(IG_FORMAT_JBIG)
...
#define IG_CONTROL_JPG_KEEP_ALPHA            (IG_FORMAT_JPG|0x0600)  /* BOOL        */
#define IG_CONTROL_JPG_TYPE                  (IG_FORMAT_JPG|0x0700)  /* BOOL        */
#define IG_CONTROL_JPG_PREDICTOR					(IG_FORMAT_JPG|0x0800)  /* UINT        */



#define IG_CONTROL_JPG_SCAN_INFO					(IG_FORMAT_JPG|0x0900)	/*	LPAT_SCANINFO		*/
#define IG_CONTROL_JPG_SCAN_INFO_COUNT			(IG_FORMAT_JPG|0x0A00)	/*	UINT		*/
#define IG_CONTROL_JPG_LOAD_SCANS				(IG_FORMAT_JPG|0x0B00)	/*	UINT		*/

/* for compatibility with prev implementation */
#define IG_CONTROL_PJPEG_SCAN_INFO				(IG_CONTROL_JPG_SCAN_INFO)	/*	LPAT_SCANINFO		*/
#define IG_CONTROL_PJPEG_SCAN_INFO_COUNT		(IG_CONTROL_JPG_SCAN_INFO_COUNT)	/*	UINT		*/
#define IG_CONTROL_PJPEG_LOAD_SCANS				(IG_CONTROL_JPG_LOAD_SCANS)	/*	UINT		*/
...
#define IG_CONTROL_TXT_LINES_PER_PAGE        (IG_FORMAT_TXT|0x0E00)  /* UINT        */
#define IG_CONTROL_TXT_CHAR_PER_LINE         (IG_FORMAT_TXT|0x0F00)  /* UINT        */
#define IG_CONTROL_TXT_COMPATIBILITY_MODE    (IG_FORMAT_TXT|0x1000)  /* BOOL        */

#define IG_CONTROL_BMP_TYPE                  (IG_FORMAT_BMP|0x0100)  /* UINT        */
#define IG_CONTROL_BMP_UPSIDEDOWN            (IG_FORMAT_BMP|0x0200)  /* BOOL        */
#define IG_CONTROL_BMP_16GRAY_SCANNER			(IG_FORMAT_BMP|0x0300)  /* BOOL        */
#define IG_CONTROL_BMP_16GRAY_SCANNER_TYPE	(IG_FORMAT_BMP|0x0400)  /* UINT        */


#define IG_CONTROL_CCITT_FILL_ORDER				(IG_FORMAT_G3|0x0100)	/* UINT        */
#define IG_CONTROL_CCITT_KFACTOR					(IG_FORMAT_G3|0x0200)	/* UINT        */
...
#define IG_CONTROL_TIF_FORCE_SNGL_STRIP      (IG_FORMAT_TIF|0x0500)  /* BOOL        */
#define IG_CONTROL_TIF_BUFFER_SIZE				(IG_FORMAT_TIF|0x0600)  /* DWORD       */
#define IG_CONTROL_TIF_WRITE_FILL_ORDER		(IG_FORMAT_TIF|0x0700)	/*	SHORT			*/
#define IG_CONTROL_TIF_WRITE_CONFIG				(IG_FORMAT_TIF|0x0800)  /* SHORT       */
#define IG_CONTROL_TIF_PHOTOMETRIC           (IG_FORMAT_TIF|0x0900)  /* SHORT       */
#define IG_CONTROL_TIF_BIGENDIAN             (IG_FORMAT_TIF|0x0A00)  /* BOOL        */
#define IG_CONTROL_TIF_DOCUMENTNAME				(IG_FORMAT_TIF|0x0B00)  /* LPSTR (maxlen=256) */
#define IG_CONTROL_TIF_DATETIME					(IG_FORMAT_TIF|0x0C00)  /* LPSTR (maxlen=256) */
#define IG_CONTROL_TIF_IMAGE_BEFORE_IFD		(IG_FORMAT_TIF|0x0D00)  /* BOOL        */
#define IG_CONTROL_TIF_PLANAR						(IG_FORMAT_TIF|0x0E00)  /* BOOL        */
#define IG_CONTROL_TIF_NUMBER_OF_STRIPS      (IG_FORMAT_TIF|0x0F00)  /* LONG        */
#define IG_CONTROL_TIF_WRITE_CLASS_F			(IG_FORMAT_TIF|0x1000)	/* BOOL			*/
#define IG_CONTROL_TIF_16_UPDATE_LUT			(IG_FORMAT_TIF|0x1100)	/* BOOL			*/

#define IG_CONTROL_GIF_INTERLACE             (IG_FORMAT_GIF|0x0100)  /* BOOL        */
#define IG_CONTROL_GIF_ADD_IMAGE             (IG_FORMAT_GIF|0x0200)  /* BOOL        */
#define IG_CONTROL_GIF_VERSION               (IG_FORMAT_GIF|0x0300)  /* BYTE        */
#define IG_CONTROL_GIF_EXTBLOCKREADONLY      (IG_FORMAT_GIF|0x0400)  /* BOOL        */

#define IG_CONTROL_AVI_FILENAME              (IG_FORMAT_AVI|0x0100)  /* CHAR[262]	*/

#define IG_CONTROL_KFX_BIT_SEX               (IG_FORMAT_KFX|0x0100)  /* UINT        */

#define IG_CONTROL_PCT_VERSION1              (IG_FORMAT_PCT|0x0100)  /* BOOL        */

#define IG_CONTROL_TGA_SAVE_THUMBNAIL        (IG_FORMAT_TGA|0x0100)  /* BOOL        */
#define IG_CONTROL_TGA_THUMBNAIL_WIDTH       (IG_FORMAT_TGA|0x0200)  /* UINT        */
#define IG_CONTROL_TGA_THUMBNAIL_HEIGHT      (IG_FORMAT_TGA|0x0300)  /* UINT        */
#define IG_CONTROL_TGA_KEEP_ALPHA            (IG_FORMAT_TGA|0x0400)  /* BOOL        */
#define IG_CONTROL_TGA_CONVERT_TO_16			(IG_FORMAT_TGA|0x0500)  /* BOOL        */


#define IG_CONTROL_EPS_TIFF_PREVIEW          (IG_FORMAT_EPS|0x0100)  /* BOOL        */
#define IG_CONTROL_EPS_FIT_TO_PAGE           (IG_FORMAT_EPS|0x0200)  /* BOOL        */
#define IG_CONTROL_EPS_ACTUAL_SIZE           (IG_FORMAT_EPS|0x0300)  /* BOOL        */
#define IG_CONTROL_EPS_PIXEL_TO_PIXEL        (IG_FORMAT_EPS|0x0400)  /* BOOL        */
#define IG_CONTROL_EPS_PAGE_WIDTH            (IG_FORMAT_EPS|0x0500)  /* AT_DIMENSION*/
#define IG_CONTROL_EPS_PAGE_HEIGHT           (IG_FORMAT_EPS|0x0600)  /* AT_DIMENSION*/
#define IG_CONTROL_EPS_XDPI                  (IG_FORMAT_EPS|0x0700)  /* UINT        */
#define IG_CONTROL_EPS_YDPI                  (IG_FORMAT_EPS|0x0800)  /* UINT        */

#define IG_CONTROL_WMF_LOAD_METAFILE			(IG_FORMAT_WMF|0x0100)	/* BOOL			*/


#define IG_CONTROL_PNG_COMPRESSION				(IG_FORMAT_PNG|0x0100)	/*	UINT			*/	

#define IG_CONTROL_JBIG_STRIP_SIZE					(IG_FORMAT_JBIG|0x0300)	/*	DWORD			*/	
#define IG_CONTROL_JBIG_TYPICAL_PREDICTOR			(IG_FORMAT_JBIG|0x0400)	/*	INT			*/	
#define IG_CONTROL_JBIG_CONTEXT_SHAPE				(IG_FORMAT_JBIG|0x0500)	/*	INT			*/	
#define IG_CONTROL_JBIG_TAUX						(IG_FORMAT_JBIG|0x0600)	/*	INT			*/	

#define IG_CONTROL_SGI_SAVE_COMPRESSED			(IG_FORMAT_SGI|0x0100)	/* BOOL			*/


/*	additional	constants for TIFF filter	*/
#define	IG_TIF_STRIP_FIXED_COUNT		0
#define	IG_TIF_STRIP_FIXED_BUFFER		1
#define	IG_TIF_TILED_FIXED_SIZE			0x10
#define	IG_TIF_TILED_FIXED_COUNT		0x11

#define  IG_TIF_PHOTO_WHITEZERO			0
#define  IG_TIF_PHOTO_BLACKZERO			1
#define	IG_TIF_PHOTO_RGB					2
#define	IG_TIF_PHOTO_CMYK					5

#define	IG_PNG_MIN_COMPRESSION			0
#define	IG_PNG_MAX_COMPRESSION			9
#define	IG_PNG_DEFAULT_COMPRESSION		6


#define	IG_PNG_STRIP_FIXED_COUNT		0
#define	IG_PNG_STRIP_FIXED_BUFFER		1

#define	IG_JPG_LOSSY						0
#define	IG_JPG_LOSSLESS					1
#define	IG_JPG_PROGRESSIVE				2

/**************************************************************************/
/*				STANDARD PAGE SIZES 														  */
/**************************************************************************/

#define	IG_ASCIIXSIZELETTER		8500L			/* 8 1/2"  */
#define	IG_ASCIIYSIZELETTER		11000L		/* 11"	  */

#define	IG_ASCIIXSIZELEGAL		8500L			/* 8 1/2"  */
#define	IG_ASCIIYSIZELEGAL		14000L		/* 14"	  */

#define	IG_ASCIIXSIZEEXECUTIVE	7250L			/* 7 1/4"  */
#define	IG_ASCIIYSIZEEXECUTIVE	10500L		/* 10 1/2" */

#define	IG_ASCIIXSIZEENVELOPE	4125L			/* 4 1/8"  */
#define	IG_ASCIIYSIZEENVELOPE	9500L			/* 9 1/2"  */
...
/*Macintosh requires the import pragma for the following prototypes*/
...
/* BEGIN VIDAR */
AT_ERRCOUNT ACCUAPI IG_util_CutHeight_set(

   BOOL	bCutHeight
   );

AT_ERRCOUNT ACCUAPI IG_util_CutHeight_get(
...
AT_ERRCOUNT ACCUAPI IG_mem_CB_register(
   ...
   LPFNIG_MEM_ALLOC        lpfnAllocFunc,       /* Replacement Alloc, or NULL  */
   LPFNIG_MEM_REALLOC      lpfnReAllocFunc,     /* Replacement ReAlloc, or NULL   */
   LPFNIG_MEM_FREE         lpfnFreeFunc         /* Replacement Free, or NULL   */
   );
...
AT_ERRCOUNT ACCUAPI IG_save_FD_CB_direct(
   ...
   UINT              nReserved,     /* Always set to 0 (for now)     */
   AT_LMODE          lFormatType,   /* File format to save as        */
   LPFNIG_DIRECT_RASTER_GET lpfnRasterGet, /* Called for each raster line   */
   LPFNIG_DIB_GET    lpfnDIBGet,    /* Called when header is saved   */
   LPVOID            lpPrivateData  /* Callback data                 */
   );
...
AT_ERRCOUNT ACCUAPI IG_image_create_DIB_ex(
	...
	AT_DIMENSION		nHeight,				/* Height of DIB						*/
	UINT					nBitsPerPixel,		/* Depth of the image				*/
	AT_LMODE				lCompression,		/* Compression of the image		*/
	LPAT_DIB				lpDIB,				/* NULL to create an empty DIB	*/
	LPHIGEAR				lphIGear				/* Image handle returned			*/
	);
...
AT_ERRCOUNT ACCUAPI IG_display_option_set(
   ...
   HIGEAR            hIGear,     /* ImageGear handle or NULL   */
   AT_MODE           nOption,    /* Display option to set      */
   const LPVOID      lpOption,   /* Display option data        */
...
AT_ERRCOUNT ACCUAPI IG_display_option_get(
   ...
   HIGEAR            hIGear,     /* ImageGear handle or NULL   */
   AT_MODE           nOption,    /* Display option to get      */
   LPVOID            lpOption,   /* Display option data return */
   LPVOID            lpReserved  /* Reserved for future use    */
   );
...
AT_ERRCOUNT ACCUAPI IG_clipboard_cut(
   ...
   const LPAT_RECT   lprcRegion,       /* Rect. area of image to cut  */
   const LPAT_PIXEL  lpPixel           /* Color used to fill area     */
   );
...
AT_ERRCOUNT ACCUAPI IG_clipboard_paste_op_get(
   ...
   HIGEAR         hIGear,           /* ImageGear handle                 */
   LPAT_MODE      lpOperation       /* How to combine images on a merge */
   );

AT_ERRCOUNT ACCUAPI IG_clipboard_paste_op_set(

   HIGEAR         hIGear,           /* ImageGear handle                 */
   AT_MODE        nOperation        /* How to combine images on a merge */
   );
...
AT_ERRCOUNT ACCUAPI IG_scan_pages(
   ...
   AT_LMODE          nFileType,     /* File type to save images      */
   BOOL              bShowUI        /* TRUE - enable UI              */
   );
...
AT_ERRCOUNT ACCUAPI IG_scan_cap_set_int(

      AT_MODE           ScanCapType,
      LONG              ScanCapValue
      );

AT_ERRCOUNT ACCUAPI IG_scan_cap_set_float(

      AT_MODE           ScanCapType,
      DOUBLE            ScanCapValue
      );

AT_ERRCOUNT ACCUAPI IG_scan_driver_info_get(

   LPINT          lpTwain_major,    /* TWAIN major release number    */ 
   LPINT          lpTwain_minor     /* TWAIN minor release number    */
   );

BOOL ACCUAPI IG_scan_processTWmessage(

   LPVOID         lpMsg, 
   HWND           hWnd
   );

AT_ERRCOUNT ACCUAPI  IG_IP_RGB_to_hue( 
...
AT_ERRCOUNT ACCUAPI IG_error_set(
   ...
   const LPSTR szFileName,  /* __FILE__ The Module name from which the error was set */
   INT         iLineNumber, /* __LINE__ The line number that the error was set       */
   AT_ERRCODE  iCode,       /* User defined values are less then IGE_LAST_ERROR_NUMBER*/
   LONG        lValue1,     /* general purpose value that was involved with the error*/
   LONG        lValue2      /* general purpose value that was involved with the error*/
   );
...
AT_ERRCOUNT ACCUAPI IG_IP_color_reduce_octree(
   ...
   HIGEAR         hIGear,         /* Source Image */
   const BOOL     fast_remap,
   const UINT     max_colors,
...
AT_ERRCOUNT ACCUAPI IG_IP_color_reduce_to_bitonal( 
   ...
   HIGEAR      hImage,     /* Source Image   */
   AT_MODE     nOption,    /* IG_REDUCE_BITONAL_AVE,  IG_REDUCE_BITONAL_WEIGHTED */
   UINT        nThreshold, /* threshold      */
   UINT        nWeight1,   /* w1 */
   UINT        nWeight2,   /* w2 */
   UINT        nWeight3    /* w3 */
   );
...
AT_ERRCOUNT ACCUAPI IG_IP_rotate_compute_size(
   ...
   HIGEAR         hImage,
   DOUBLE         angle,         /* angle in the degrees */    
   AT_MODE        rotate_mode,   /* IG_ROTATE_CLIP, IG_ROTATE_EXPAND */
...
AT_ERRCOUNT ACCUAPI IG_GUI_histogram_window_create(
	...
	INT               nWidth,			/* Width of window             */
	INT               nHeight,			/* Height of window            */
	HWND FAR          *lphWnd		/* Histogram window handle retn  */
	);

AT_ERRCOUNT ACCUAPI IG_GUI_histogram_update(

	HIGEAR            hIGear,		/* Image handle			*/
	HWND              hWnd			/* Histogram window handle	*/
	);
...
AT_ERRCOUNT ACCUAPI IG_GUI_pan_CB_register(
   ...
   HWND                 hwndPan,       /* Pan window handle             */
   LPFNIG_GUIPANUPDATE  lpfnPanUpdate, /* Called when window is panned  */
   LPVOID               lpPrivateData  /* Private data for CB func.     */
   );
...
AT_ERRCOUNT ACCUAPI IG_GUI_magnify_attribute_get(

	HWND			hwndMag,			/* Magnify window handle	*/
	AT_MODE		nAttributeID,	/* ID of attribute to get	*/
	LPVOID		lpData			/* Attribute data 			*/
	);
...
AT_ERRCOUNT ACCUAPI IG_GUI_thumbnail_title_CB_register(
   ...
   HWND                  hwndThumbnail,   /* Thumbnail window handle        */
   LPFNIG_GUITHUMBTITLE  lpfnThumbTitle,  /* Gets title of thumbnail        */
   LPVOID                lpPrivateData    /* Private data for CB func.      */
   );
...
AT_ERRCOUNT ACCUAPI IG_GUI_page_window_create(
   ...
   INT                  x,             /* X Position of window             */
   INT                  y,             /* Y Position of window             */
   INT                  nPageWidth,    /* Width of window                  */
   INT                  nPageHeight,   /* Height of window                 */
   HWND FAR             *lphwndPage    /* Page sorter window handle return */
   );
...
AT_ERRCOUNT ACCUAPI IG_GUI_page_update(
...
AT_ERRCOUNT ACCUAPI IG_GUI_page_document_refresh(
   ...
   HWND                 hwndPage,      /* Page sorter window handle        */
   UINT                 nPage          /* Page number to update				*/
   );
...
AT_ERRCOUNT ACCUAPI IG_GUI_page_focus_set(
   ...
   HWND                 hwndPage,      /* Page sorter window handle        */
	UINT						nPage,			/* Page number to update				*/
	BOOL						fScrollToThumbnail /* Scroll to window the page		*/
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_thumbnail_size_set(

   HWND                 hwndPage,      /* Page sorter window handle        */
   INT                  nThumbWidth,   /* Width of thumbnail               */
   INT                  nThumbHeight   /* Height of thumbnail              */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_thumbnail_size_get(

   HWND                 hwndPage,      /* Page sorter window handle        */
   LPINT                lpThumbWidth,  /* Width of thumbnail               */
   LPINT                lpThumbHeight  /* Height of thumbnail              */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_thumbnail_get(

   HWND                 hwndPage,      /* Page sorter window handle        */
	UINT						nPage,			/* Return the bitmap from this page	*/
   HBITMAP FAR				*lpBitmap,		/* Bitmap representation of the page*/
   HPALETTE FAR			*lpPalette		/* Palette of the bitmap				*/
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_handle_get(

   HWND                 hwndPage,      /* Page sorter window handle        */
   UINT                 nPage,         /* Page number to retrieve hIGear   */
   LPHIGEAR             lphIGear       /* hIGear return                    */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_count_get(

   HWND                 hwndPage,      /* Page sorter window handle        */
   LPUINT               lpPageCount    /* Returns the number of pages      */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_remove(

   HWND                 hwndPage,      /* Page sorter window handle        */
   UINT                 nPage          /* Page to remove                   */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_insert(

   HWND                 hwndPage,      /* Page sorter window handle        */
   HIGEAR               hIGear,        /* ImageGear handle to image        */
   UINT                 nPage          /* Page to insert                   */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_file_append(

   HWND                 hwndPage,      /* Page sorter window handle        */
   const LPSTR          lpcszFileName  /* File name of image to append     */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_order_CB_register(

   HWND                    hwndPage,   /* Page sorter window handle        */
   LPFNIG_GUIPAGEORDERPROC lpfnPageOrderProc, /* User page order callback  */
   LPVOID                  lpPrivate   /* Private user data                */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_select_CB_register(

   HWND                     hwndPage,  /* Page sorter window handle        */
   LPFNIG_GUIPAGESELECTPROC lpfnPageSelectProc, /* User select callback    */
   LPVOID                   lpPrivate  /* Private user data                */
   );
...
AT_ERRCOUNT ACCUAPI IG_GUI_page_delete_CB_register(
   ...
   HWND                     hwndPage,  /* Page sorter window handle        */
   LPFNIG_GUIPAGEDELETEPROC lpfnPageDeleteProc, /* User delete callback    */
   LPVOID                   lpPrivate  /* Private user data                */
   );
...
AT_ERRCOUNT ACCUAPI IG_GUI_page_active_set(
   ...
   HWND                    hwndPage,   /* Page sorter window handle        */
   UINT                    nPage       /* Page to set active               */
   );

AT_ERRCOUNT ACCUAPI IG_GUI_page_active_get(

   HWND                    hwndPage,    /* Page sorter window handle       */
   LPUINT                  lpPageNumber /* Active page number return       */
   );
...
AT_ERRCOUNT ACCUAPI IG_GUI_pixdump_window_create(
	...
	INT               nWidth,        /* Width of window             */
	INT               nHeight,       /* Height of window            */
	HWND FAR          *lphwndDump		/* Dump window handle retn  */
	);

AT_ERRCOUNT ACCUAPI IG_GUI_pixdump_track_mouse(

	HIGEAR            hIGear,		/* Image handle					*/
	HWND              hwndDump,	/* Dump window handle			*/
	INT               x,				/* X position of mouse click	*/
	INT               y				/* Y position of mouse click	*/
	);
...
AT_ERRCOUNT ACCUAPI IG_GUI_pixdump_attribute_set(
...
AT_ERRCOUNT ACCUAPI IG_GUI_pixdump_attribute_get(
...
AT_ERRCOUNT ACCUAPI IG_GUI_color_profile_window_create(
	...
	INT               nWidth,		      /* Width of window             */
	INT               nHeight,				/* Height of window            */
	HWND FAR          *lphwndProfile		/* Profile window handle retn  */
	);

AT_ERRCOUNT ACCUAPI IG_GUI_color_profile_track_mouse(

	HIGEAR            hIGear,				/* Image handle					*/
	HWND              hwndProfile,		/* Profile window handle		*/
	INT               x,						/* X position of mouse click	*/
	INT               y						/* Y position of mouse click	*/
	);
...
AT_ERRCOUNT ACCUAPI IG_ascii_import(
	...
	const LPSTR						lpszFileName,	/* File name of text file to load */
	UINT								nPageNumber,	/* Page number to load				 */
	LPHIGEAR							lphIGear			/* HIGEAR return						 */
	);

AT_ERRCOUNT ACCUAPI IG_ascii_page_width_get(

	const LPSTR						lpszFileName,	/* File name of text file			 */
	LPUINT							lpPageWidth		/* Page width return					 */
	);
...
#ifdef macintosh
AT_ERRCOUNT ACCUAPI IG_load_file_fs(

   void        *fs,        /* File SPEC of image to load */
   LPHIGEAR    lphIGear       /* ImageGear handle           */
   );

AT_ERRCOUNT ACCUAPI IG_load_thumbnail_fs(

   void        *fs,        /* File SPEC of image to load */
   LPHIGEAR    lphIGear       /* ImageGear handle           */
   );

AT_ERRCOUNT ACCUAPI IG_load_file_display_fs(
...
AT_ERRCOUNT ACCUAPI IG_info_get_fs(

   void        *fs,        /* File spec of image            */ 
   LPAT_MODE   lpFileType,    /* File type return              */
   LPAT_MODE   lpCompression, /* Compression algorithm ret.    */
   LPAT_DIB    lpDIB          /* Image info return             */
   );

AT_ERRCOUNT ACCUAPI IG_page_count_get_fs(

   void        *fs,        /* File spec of image            */ 
   LPUINT      lpPageCount       /* Number of pages in an image   */
   );

AT_ERRCOUNT ACCUAPI IG_tile_count_get_fs(
...
AT_ERRCOUNT ACCUAPI IG_save_file_fs(
...
AT_ERRCOUNT ACCUAPI IG_palette_load_fs(
...
AT_ERRCOUNT ACCUAPI IG_palette_save_fs(
...
AT_ERRCOUNT ACCUAPI IG_Mac_finderinfo_get(LONG *creator, LONG *filetype);

AT_ERRCOUNT ACCUAPI IG_Mac_finderinfo_set(LONG creator, LONG filetype);
...
#if (defined(AM_STATIC) || (defined(_WINDOWS) && !(defined(WIN32)) && defined(AM_PROGOLD)))
/*if static or 16bit windows environment*/
AT_ERRCOUNT  ACCUAPI  IG_initialize(

   DWORD    hInstance
   );

AT_ERRCOUNT  ACCUAPI IG_close(

   DWORD    hInstance
   );

#endif  /*if static or 16bit windows environment*/
...
AT_ERRCOUNT ACCUAPI IG_display_image_wipe(
   ...
   LONG           lTime             /* wipe displaying time       */
   );
...
AT_ERRCOUNT ACCUAPI IG_runs_row_get(
	...
	HIGEAR			hIGear,		/* Image handle										*/
	AT_PIXPOS		yPos,			/* Y-Offset into the image							*/
	LPWORD			lpRunCount,	/* Number of run-ends in the lpRunEnd buffer	*/
	LPWORD FAR		*lpRunEnd	/* Run-end pointer return							*/
	);
...
AT_ERRCOUNT ACCUAPI IG_runs_row_set(
	...
	HIGEAR			hIGear,		/* Image handle										*/
	AT_PIXPOS		yPos,			/* Y-Offset into the image							*/
	WORD				wRunCount,	/* Number of run-ends in the lpRunEnd buffer	*/
	const LPWORD	lpRunEnd		/* Run-end pointer to copy into the image		*/
	);
...
AT_ERRCOUNT ACCUAPI  IG_IP_arithmetic_rect( 
   ...
   HIGEAR      hImage1,    /* Image 1 and destination                      */
   HIGEAR      hImage2,    /* Image 2  (images must be same width & height)*/
   LPAT_RECT   lpImageRect2,  /* Rect of higear to be merged, NULL for whole thing  */
   AT_MODE     operation   /* IG_ARITH_                                    */
   );
...
AT_ERRCOUNT ACCUAPI IG_IP_transform_with_LUT(
   ...
   HIGEAR            hImage,
   const LPAT_RECT   lpRect,
   const LPAT_LUT    lpLUT_Red,     /* Set to NULL for NOP  */
   const LPAT_LUT    lpLUT_Green,   /* Set to NULL for NOP  */
   const LPAT_LUT    lpLUT_Blue,    /* Set to NULL for NOP  */
   const AT_MODE     nColorMode     /*IG_COLOR_COMP_...     */
   );
...
AT_ERRCOUNT ACCUAPI  IG_IP_pseudocolor_limits( 
   ...
   AT_PIXEL    high           /* Values above thi are colored lpRGB_high  */
   );
...
/*********************************************************************************************/
/* DIB RESOLUTION UNITS API SUPPORT API ******************************************************/
/*********************************************************************************************/
...
AT_ERRCOUNT ACCUAPI IG_image_resolution_set(
   ...
   DWORD       xResNumerator,    /* Numerator of the X resolution value    */
   DWORD       xResDenominator,  /* Denominator of the X resolution value  */
   DWORD       yResNumerator,    /* Numerator of the Y resolution value    */
   DWORD       yResDenominator,  /* Denominator of the Y resolution value  */
   AT_MODE     nUnits               /* Units of resolution: IG_RESOLUTION_    */
   );

AT_ERRCOUNT ACCUAPI IG_image_resolution_get(

   HIGEAR      hIGear,              /* Image who's resolution is retrieved    */
   LPDWORD     lpXResNumerator,     /* Numerator of the X resolution value    */
   LPDWORD     lpXResDenominator,   /* Denominator of the X resolution value  */
   LPDWORD     lpYResNumerator,     /* Numerator of the Y resolution value    */
   LPDWORD     lpYResDenominator,   /* Denominator of the Y resolution value  */
   LPAT_MODE   lpUnits           /* Units of resolution: IG_RESOLUTION_    */
   );

AT_ERRCOUNT ACCUAPI IG_image_orientation_get(

   HIGEAR      hIGear,           /* Image who's orientation is to be set   */
   LPAT_MODE   lpOrientation     /* IG_ORIENT_                             */
   );

AT_ERRCOUNT ACCUAPI IG_display_logical_palette_override(
...
AT_ERRCOUNT ACCUAPI IG_image_orientation_set(
   ...
   HIGEAR   hIGear,           /* Image who's orientation is to be set   */
   AT_MODE  Orientation       /* IG_ORIENT_                             */
   );


AT_ERRCOUNT ACCUAPI IG_save_JPEG_quality_set(

   UINT              quality        /* Quality setting for JPEG 0-100   */
   );

AT_ERRCOUNT ACCUAPI IG_save_JPEG_quality_get(

   LPUINT            lpQuality      /* returns Quality setting for JPEG */
   );

AT_ERRCOUNT ACCUAPI IG_image_alpha_get(

   HIGEAR            hIGear,
   LPHIGEAR          lphIGearAlpha
   );

AT_ERRCOUNT ACCUAPI IG_image_alpha_set(
...
AT_ERRCOUNT ACCUAPI  IG_IP_blend_with_alpha(
   HIGEAR            hIFirst,
   HIGEAR            hISecond,
   HIGEAR            hIBackgrnd,
   LPAT_RECT         lpRect,
...
AT_ERRCODE IG_initialize(
   ...
   LPVOID            lpDisplay,           /* X Windows display pointer or NULL          */
   UINT              nColors,             /* # colors to alloc for PseudoColor displays */
   BOOL              fUsePrivateColormap  /* TRUE - use private colormaps               */
   );
...
AT_ERRCOUNT ACCUAPI IG_display_clip_rect_set(

   HIGEAR            hIGear,        /* ImageGear handle           */
   HDC               hDC,           /* Device context to clip     */
   const LPAT_RECT   lprcClip       /* Dirty area to repaint      */
   );

AT_ERRCOUNT ACCUAPI IG_display_clip_rect_get(

   HIGEAR            hIGear,        /* ImageGear handle           */
   HDC               hDC,           /* Device context to clip     */
   LPAT_RECT         lprcClip       /* Dirty area to repaint      */
   );
...
/***************************************************************************/
/* OS/2 specific API functions                                             */
/***************************************************************************/

#ifdef _OS2

AT_ERRCOUNT ACCUAPI IG_OS2_register_hab(
   DWORD hab
   );

AT_ERRCOUNT ACCUAPI IG_OS2_unregister_hab(
   DWORD hab
   );
AT_ERRCOUNT LACCUAPI OS_hab_get(
   HAB*  lpHab
   );
