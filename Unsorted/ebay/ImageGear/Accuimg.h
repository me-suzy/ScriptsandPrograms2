/***************************************************************************/
/*                                                                         */
/* MODULE:  HEADER:   AccuIMG.h -   AccuSoft public data types and macros  */   
/*                                                                         */
/*                                                                         */
/* Date created:        01/19/1996 DF                                      */
/*                                                                         */
/*    $Date: 1999/02/21 02:22:32 $                                             */
/*    $Revision: 1.2 $                                             */
/*                                                                         */
...
typedef struct tagAT_ELLIPSE
{
	AT_POINT				ptLeftTop;
	AT_POINT				ptRightBottom;

}	AT_ELLIPSE, FAR* LPAT_ELLIPSE;
...
typedef struct	tagAT_SRCINFO
{
   LPSTR              lpcszSrcDir;
   LPSTR              lpcszSrcFilter;
} AT_SRCINFO, FAR *LPAT_SRCINFO;

typedef struct	tagAT_DSTINFO
{
   LPSTR             lpcszDstDir;
   AT_LMODE				DstOptions;
   AT_LMODE				DstSaveType;
} AT_DSTINFO, FAR *LPAT_DSTINFO;


typedef struct tagAT_NR_ROI_MASK
{
