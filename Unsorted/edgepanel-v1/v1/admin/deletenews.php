...
+----------------------------------------------------------------------+
|                                                                      |
| deletenews.php :: Admin news removal script                          |
|                                                                      |
+----------------------------------------------------------------------+
| Author: Mark Carruth (mcarruth@totalfreelance.com)                   |
+---------------------------------------------------------------------*/

/*   $Id: deletenews.php,v 1.00.0.1 20/09/2002 21:00:00 mark Exp $    */
...
$result = $db->Query("DELETE FROM `$CONF[table_prefix]news` WHERE id = '$_SUBMIT[id]'");
