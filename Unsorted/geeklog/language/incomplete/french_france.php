...
$LANG02 = array(
	...
	2 => "Désolé il n'ya pas d'événement à afficher.",
	3 => "Quand",
	4 => "Où",
	5 => "Description",
	6 => "Ajouter un événement",
	7 => "Prochain événements",
	8 => 'En ajoutant cet événement au calendrier vous pouvez visionnez rapidement les événements qui vous intéressent en cliquant sur "Mon Calendrier" dans le cadre Fonctions utilisateurs.',
	9 => "Ajouter à mon calendrier",
	10 => "Retirer de mon calendrier",
	11 => "Ajouter l'événement au clendrier de {$_USER['username']}",
	12 => "Evénement",
	13 => "Commence",
	14 => "Fini",
...
$LANG06 = array(
	1 => "Références web",
	2 => "Il n'y a aucune référence à afficher",
	3 => "Ajouter un lien"
);
...
$LANG07 = array(
	1 => "Vote Enregistré",
	2 => "Votre vote a été comptabilisé",
	3 => "Voter",
...
$LANG08 = array(
	...
	23 => "Cette email vous a été envoyé de la part de $from at $fromemail car il pensait que vous pourriez être intéressé par {$_CONF["site_url"]}. Ce n'est pas un spam et l'adresse email utilisé n'est pas stokée dans une liste d'envoi.",
...
$LANG12 = array(
	...
	25 => "Vos propositions $type ont été sauvées avec succès.",
	26 => "Vitesse limite",
	27 => "utilisateur",
	28 => "Sujet",
	29 => "Article",
...
$LANG22 = array(
	...
	8 => "description",
	9 => "(http:// comprid)",
	10 => "vous devez sélectionner une date, une heure, une description et une localisation!",
	11 => "Contrôleur d'événement",
	12 => "Pour supprimer ou modifier un événement, cliquez sur le bouton ci-dessous. Pour créer un nouvel événement cliquez sur nouvel événement.",
	13 => "titre",
	14 => "début",
	15 => "fin",
	16 => "Accès interdit",
	17 => "vous essayez d'accéder à un événement auquel vous n'avez pas les droits. Cette tentative a été enregistrée. Retournez à <a href=\"{$_CONF["site_admin_url"]}/event.php\">la page d'aministration des événements</a>.",
	18 => 'Nouvel Evénement',
...
$LANG23 = array(
	...
	6 => "(http:// inclus)",
	7 => "Autre",
	8 => "Nombre de sélection",
	9 => "Description",
	10 => "Vous devez saisir un titre, une URL et une description.",
	11 => "Contrôleur de lien",
	12 => "Cliquez sur le lien ci-dessous pour modifier ou supprimer un lien.  Cliquez sur Nouveau Lien pour créer un lien.",
	13 => "Titre",
	14 => "Catégorie",
	15 => "URL",
	16 => "Accès interdit",
	17 => "Vous essayez d'accéder à un lien auquel vous n'avez pas les droits.  Cette tentative est enregistrée. Veuillez <a href=\"{$_CONF["site_admin_url"]}/link.php\">à la page de controle des liens</a>.",
	18 => 'Nouveau lien',
	19 => 'Accueil Admin',
...
$LANG25 = array(
	...
	9 => "Question",
	10 => "Réponses / Votes",
	11 => "Une erreur s'est produite lors de l'obtention des réponses du sondage $qid",
	...
	19 => "Cliquez sur un sondage pour le modifier ou le supprimer.  Cliquez sur Nouveau Sondage pour créer un sondage.",
	20 => "Votants",
	21 => "Accès interdit",
	22 => "vous essayez d'accéder à un sondage auquel vous n'avez pas droit.  Cette tentative est enregistrée. Veuillez <a href=\"{$_CONF["site_admin_url"]}/poll.php\">retourner à la page de contrôle des sondages</a>.",
	23 => 'Nouveau Sondage',
	24 => 'Accueil Admin',
	25 => 'Oui',
	26 => 'Non'
...
$LANG28 = array(
    ...
    32 => 'Traitement terminé. $successes utilisateurs ont été importés et $failures sont tombés en erreur',
    33 => 'envoyer',
...
$LANG30 = array(
    ...
    35 => "Ajout rapide",
    36 => "Envoyer",
    37 => "Désolé, le calendrier personnel n'est pas activé",
    38 => "Editeur d'événements personnels",
    39 => 'Jour',
    40 => 'Semaine',
    41 => 'Mois'
);
...
$LANG_ACCESS = array(
	...
	storydenialmsg => "vous n'avez pas le droit de lire cette article. Peut-être que vous n'êtes pas membre de {$_conf["site_name"]}.  Vous pouvez <a href=users.php?mode=new>vous enregistrer</a> sur {$_conf["site_name"]} pour obtenir un compte utilisateur!",
	eventdenialmsg => "vous n'avez pas accès à cet évènement. Peut-être que vous n'êtes pas membre de {$_conf["site_name"]}.  Vous pouvez <a href=users.php?mode=new>vous enregistrer</a> sur {$_conf["site_name"]} pour obtenir un compte utilisateur!",
...
$LANG_WORDS = array(
    ...
    wordid => "Numéro du mot",
    intro => "Cliquez sur un mot pour le modifier ou le supprimer.  Cliquez sur Nouveau Mot à gauche pour créer une substitution de mot.",
...
$LANG_DB_BACKUP = array(
    ...
    no_backups => 'Aucune sauvegarde dans le système',
