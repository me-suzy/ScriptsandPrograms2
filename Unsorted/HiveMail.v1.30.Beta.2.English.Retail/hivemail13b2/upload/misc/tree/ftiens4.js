...
{ 
  ...
  if (USEICONS)
  {
    ...
    docW = docW + auxEv + "<img id='folderIcon" + this.id + "' name='folderIcon" + this.id + "' src='" + this.iconImageSrc() + "' border=0></a>"
  }
  else
  {
...
function Item(itemDescription, itemLink, target, img) // Constructor 
{ 
  // constant data 
  ...
  this.iconSrc = ICONPATH + "ftv2doc_"+img+".gif" 
  this.isRendered = 0
  this.isLastNode = false
  this.level = 0
  this.leftSideCoded = ""
...
function blockStartHTML(idprefix) {
  ...
  docW = docW + "<table border=0 cellspacing=0 cellpadding=0 width=100% style='border-width: 0px;'>"
...
function gLnk(optionFlags, description, linkData, img) 
{ 
  var fullLink = "";
  var targetFlag = "";
  var target = "";
  ...
  linkItem = new Item(description, protocol+linkData, target, img)
  return linkItem 
} 
...
function preLoadIcons() {
	...
	auxImg.src = ICONPATH + "ftv2doc_orig.gif";
	auxImg.src = ICONPATH + "ftv2doc_cust.gif";
}
