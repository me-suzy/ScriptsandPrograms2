...
document.writeln('<iframe scrolling="no" class="ContextMenu" marginwidth="0" marginheight="0" frameborder="0" style="position:absolute; top:0px; width:400px; height:200px; z-index:50000000;" id="PopUp" name="PopUp"></iframe>');
...
{ 
	if (document.documentElement && document.documentElement.scrollTop){
		theTop = document.documentElement.scrollTop - 20;
	} else if (document.body){
		theTop = document.body.scrollTop;
	}
	return (typeof document.body.scrollTop == "undefined") ? window.pageYOffset : theTop;
}
