...
$tpl->load_file("AdminArticles.html", "main");
...
function Search_show()
{
  ...
  $tpl->set_var("ActionPage", "AdminArticles.php");
...
function Articles_show()
{
  ...
  $sSQL .= $sWhere . $sOrder;
  $tpl->set_var("FormAction", "EditArticle.php");
  ...
  {  
    ...
    do
    {
			...
			$flddate_posted = $db->f("a_date_posted");
      $fldarticle_id= "Edit";
      $tpl->set_var("article_id", tohtml($fldarticle_id));
      $tpl->set_var("article_id_URLLink", "EditArticle.php");
      $tpl->set_var("Prm_article_id", tourl($db->f("a_article_id"))); 
