...
case "delete":
	...
	if ($use_ljupdate) {
		$sql="DELETE FROM $tableljusers WHERE ID = $id";
		$result=mysql_query($sql) or die("Couldn't delete ljuser #$id.");

		$sql="DELETE FROM $tableljposts WHERE post_author = $id";
		$result=mysql_query($sql) or die("Couldn't delete user #$id's ljpost records.");
	}
