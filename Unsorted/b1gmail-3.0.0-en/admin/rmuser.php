...
<center>
 <table width="60%" bgcolor="#003366" cellspacing="1">
  ...
  <tr>
    <td bgcolor="#336699" width="100%" align="center"><font face="arial" size="2" color="#ffffff"><br>The user with the id <? echo($id); ?> has been deleted.
<br>
<?
...
$sql = "DELETE FROM b1gmail_users WHERE id='$id'";
