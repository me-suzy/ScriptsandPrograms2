...
//database settings
$hostname = "localhost";      // example $hostname = "db.host.sk";
$database = "database";      // example $database = "armin";
$db_login = "login";         // $db_login = "armin";
$db_pass = "password";       // $db_pass = "temp123";
...
$link_over_color = "#000000";     //link mouse over color
