...
for($x=0; $x<=24; $x++){
	...
	$sql = "
		...
		and
			$tb_comment_threads.timestamp < '$hours_ago[$x]'
		and
			$tb_comment_threads.timestamp >= '$hours_ago[$x2]'
	";
...
$graph = new Graph(640,480,"stats_im_user_comments_day_" . $_GET['i'] . ".png",60);
...
$graph->tabtitle->Set(' .: Comments Past Day :. ' );
