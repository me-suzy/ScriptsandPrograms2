...
<tr>
	<td class="bold">&nbsp;<a class="bold" href="$base_url/">$site_title</a> >> Stats for <a class="bold" href="$base_url/?i=$_GET[i]">$username</a> >> Points Past Week</td>
</tr>
</table>
<table cellpadding="5" cellspacing="0" border="0" width="100%">
<tr>
	<td class="regular"><img src="stats_im_user_points_week.php?i=$_GET[i]" border="0" width="640" height="480" alt="Stats for $username" title="Stats for $username"></td>
</tr>
<tr>
<td class="regular"></td>
</tr>
