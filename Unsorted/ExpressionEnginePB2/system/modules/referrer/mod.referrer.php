        ...
        if ($query->num_rows > 0)
        {
            foreach ($query->result as $row)
            {
                ...
                {               
                    ...
                    if ($key == "ref_from")
                    {
                        $from = '<a href="'.$row['ref_from'].'"'.$pop.'>'.$row['ref_from'].'</a>';
                    ...
                    {		
                        ...
                        $to  = '<a href="'.$row['ref_to'].'">'.$to_short.'</a>';
                    ...
                    if ($key == "ref_agent")
                    {
                       $agent = ( ! isset($row['ref_agent'])) ? '-' : $row['ref_agent'];
                    ...
                    if ($key == "ref_agent")
                    {
                       $agent = ( ! isset($row['ref_agent'])) ? '-' : preg_replace("/(.+?)\s+.*/", "\\1", $row['ref_agent']);
