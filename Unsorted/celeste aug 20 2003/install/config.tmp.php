...
define('SET_DATABASE_PASSWORD','111');
define('SET_DATABASE_DBNAME','b');
...
define('SET_BOARD_CLOSE_MESSAGE','We are updating');
...
define('SET_FORUM_URL','http://localhost/bbs/index.php');
define('SET_GZIP_LEVEL',0);
...
define('SET_TOPIC_CACHE_LEVEL',0);
// 0 : disabled
...
// 1 : account is set to guest. user need to activate it.
 ...
 * Email
 */
define('SET_BOARD_EMAIL','celeste@fastboard.org');
define('SET_ADMIN_EMAIL','celeste@fastboard.org');
define('SET_EMAIL_SENDER','Celeste 2003 Mailer');
define('SET_ENABLE_EMAIL',0);
...
//define('SET_ALLOW_GUEST_SEARCH',1);
 ...
 * Post
 */
define('SET_FLOOD_CONTROL_TIME',1);
 ...
 * Upload
 */
define('SET_ALLOW_UPLOAD_TYPE','gif jpg exe php sql zip rar png pdb');
define('SET_ALLOW_UPLOAD_SIZE',1048576);
define('SET_DIRECT_ATT',1);
define('SET_DIRECT_ATT_DISALLOW_TYPE','php');
...
define('SET_DISPLAY_FORUM_ONLINELIST',1);
