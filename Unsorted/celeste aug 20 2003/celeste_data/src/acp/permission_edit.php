...
if(!empty($_POST['delSubmit'])) {
  ...
  acp_success_redirect('The permission settings have been deleted successfully', $_SERVER['PHP_SELF'].'?prog=per::view');
  ...
  acp_success_redirect('The permission settings have been updated successfully', $_SERVER['PHP_SELF'].'?prog=per::view');
