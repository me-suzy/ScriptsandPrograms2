...
echo  <<<content
		<html>
			<head>
				...
				<title>$settings[product_name] $settings[version] (language: $lang[language]) - $lang[editing_content] "$title_entry" $lang[field]</title>
		...
		<html>
			<head>
				...
				function showDetail() {
					...
					var detailHTML = "";
						detailHTML += "<HTML>"
						detailHTML += "<HEAD><TITLE>Image detail</TITLE>"
						detailHTML += "<style>"
		...
		<form name="select" onSubmit="return false" style="margin: 0px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: 1px solid $settings[border_color];">
				<tr>
					...
					<td align="center" bgcolor="$settings[bgcolor]" style="border-right: 1px solid $settings[border_color]; border-bottom: 1px solid $settings[border_color];"><a href="javascript:uploadImage()" style="color: $settings[textcolor2]; font-weight: bold;">$lang[upload_new_image]</a></td>
				...
				<tr>
					<td colspan="3">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								<td colspan="2" bgcolor="#f8f8f8"><font style="font-weight: bold; color: $settings[textcolor3];">$lang[current_folder]:&nbsp;$show_path</font></td> 
							</tr>
							<tr>
								<td width="23%">$lang[locate_image]</td>
								<td> 
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>$lang[subfolders]:<br>
												<select name="subfolders" size="7" style="width=120px;" onChange="changeFolder(this.form)"> $subfolders
												</select></td>
											<td width="20"></td>
											<td>$lang[images]:<br>
												<select name="files" size="7" style="width=120px;" onChange="showimage();"> $subfiles
												</select>
											</td>
											<td width="20"></td>
											<td align="center" valign="middle" width="120"><img class="h" name="preview" src="$settings[app_dir]/img/pix.gif" height="106" width="120" border="1" alt="preview image" OnClick="showDetail();"></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								...
								<td><input type="text" name="filename" style="width: 400px;" size="64">
