<?php
require_once("admin_max_settings.php"); require_once("db.php"); $today_d = date("M d, Y");  $today_d2 = date("ymd")."0000";
if (check_user2()) {  $site_id = $s;
?>
...
?>
    ...
    <tr bgcolor="425B7E">
     ...
     <td class="main" align=center>IP</td>
     <td class="main" align=center>Productive</td>
     <td class="main" align=center>Proxy</td>
     <td class="main" align=center>Refer URL</td>
    </tr>
    
<?php
$stat_q = db_query("select sitename, siteurl, DATE_FORMAT(datev, '%H') dv, ipaddr, click, b.prox prox, refer from ttp_sites a, ttp_traffic b where a.siteid='$site_id' and a.siteid=b.siteid and datev>='$today_d2' and active=1 order by datev asc");
...
echo "     <td class=main align=center>".$myrow_t["dv"]."</td>\n";
echo "     <td class=main align=left>".urldecode($myrow_t["ipaddr"])."</td>\n";
echo "     <td class=main align=center>".$myrow_t["click"]."</td>\n";
echo "     <td class=main align=center>".$myrow_t["prox"]."</td>\n";
