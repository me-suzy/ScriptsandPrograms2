...
TBI.prototype.PHP			= new TBButton("PHP"			, lang["InsertPHP"]			, "insertPHP()"				, TBCMD_CUSTOM) ;
TBI.prototype.code			= new TBButton("code"			, lang["InsertCode"]		, "insertCode()"			, TBCMD_CUSTOM) ;
TBI.prototype.pagebreak		= new TBButton("pagebreak"		, lang["InsertPagebreak"]	, "insertPagebreak()"		, TBCMD_CUSTOM) ;
