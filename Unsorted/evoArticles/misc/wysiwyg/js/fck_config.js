...
config.ToolbarSets["Default"] = [
	['EditSource','-','Cut','Copy','Paste','-','Find','-','Undo','Redo','-','RemoveFormat','-','Table','Rule','SpecialChar','PHP','code','pagebreak','-','About'] ,
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','InsertOrderedList','InsertUnorderedList','-','Outdent','Indent','-','ShowTableBorders','-','TextColor','BGColor'] ,
