...
/*****************************************
*
* $Id: class.xmlparser.php,v 1.1 2003/10/20 16:54:53 jan Exp $
*
...
*
* Author    :   $Author: jan $
* Modified  :   $Date: 2003/10/20 16:54:53 $
*
 ...
 * {
 *     echo "<b>$name</b> element found. Content is: <b>$content</b><br/>";
 * }
 *
 * $parser = new XML_Parser; // Parser instance
...
class XML_Parser
{
	 ...
	 * @access private
	 */
	function _changeKeyCase($options = array(NULL))
	{
		$tmp = array();
