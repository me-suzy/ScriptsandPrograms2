...
class Table {
    ...
    function row() {
         ...
         $row = '<tr class="text_medium" style="background-color: ' . $bgColor . '">';
    ...
    function header_cell($content, $align="center", $valign="top", $additional=""){
         ...
         $header_cell = '<th valign="' . $valign . '" style="border: 0px; border-top:1px; border-right:1px; border-color: '. $this->border_color . '; border-style: ' . $this->border_style . '" align="' . $align . '"' . $additional . '>' . $content . '</th>';
     ...
     */
    function cell($content, $align="center", $valign="top", $additional = ""){

         if (strlen($content) == 0)
         {
            $content = "&nbsp;";
         }
         $cell = '<td '. $additional .' valign="' . $valign . '" style="border: 0px; border-top:1px; border-right:1px; border-color: '. $this->border_color . '; border-style: ' . $this->border_style . '" align="' . $align . '">' . $content . '</td>';
    ...
    function sumcell($content, $align="center", $valign="top"){
         ...
         $sumcell = '<td colspan="'.$this->table_cols.'" valign="' . $valign . '" style="border: 0px; border-top:1px; border-right:1px; border-color: '. $this->border_color . '; border-style: ' . $this->border_style . '" align="' . $align . '">' . $content . '</td>';
