 ...
 */
contenidoConfig.prototype.init = function( imgOnlineId, imgPublicId, imgSelectId ) {

    this.objRef = this.createRefs( imgOnlineId, imgPublicId, imgSelectId );

    if ( this.objRef.length == 3 ) {
        ...
        // HARDCODED STUFF
        this.objRef[1].setImgSrc( 'images/folder_setoffline.gif', 'images/folder_setonline.gif' );
        this.objRef[2].setImgSrc( 'images/folder_lock.gif', 'images/folder_delock.gif' );
 ...
 */
contenidoConfig.prototype.load = function( Idcat, Idtpl, Online, Public, RightTpl, RightOn, RightPublic, idString ) {
