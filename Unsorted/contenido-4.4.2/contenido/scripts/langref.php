...
i18n("Template configuration can't be displayed")
i18n("Editor can't be displayed")
i18n("Preview can't be displayed")
i18n("Error calling the calendar: no target control specified");
i18n("Error calling the calendar: parameter specified is not valid target control");
i18n("Confirm");
i18n("Cancel");
i18n("Close window");
i18n("Click to close");
