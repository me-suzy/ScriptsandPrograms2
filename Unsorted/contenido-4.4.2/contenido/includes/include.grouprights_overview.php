...
*               
* Created   :   30.05.2003
* Modified  :   $Date: 2003/11/07 11:52:46 $
*
* © four for business AG, www.4fb.de
*
* $Id: include.grouprights_overview.php,v 1.7.2.1 2003/11/07 11:52:46 timo.hummel Exp $
******************************************/
...
if ( !isset($groupid) )
{
    ...
    while ($db2->next_record())
    {
//            if($perm->have_perm_client_lang($client, $db2->f("idlang")in_array("lang[".$db2->f("idlang")."]",$groupperm) || in_array("sysadmin",$groupperm) || $perm->have_perm())
