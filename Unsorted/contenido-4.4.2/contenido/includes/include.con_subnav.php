...
if ( isset($HTTP_GET_VARS['idcat']) && $HTTP_GET_VARS['idcat'] != 0 ) {
    ...
    while ( $db->next_record() ) {
        ...
        $tpl->set("d", "CAPTION",   '<a class="white" href="javascript://" onclick="sub.click(this.offsetParent);artObj.doAction(\''.$tmp_area.'\')">'.$caption.'</a>');
        $tpl->next();
