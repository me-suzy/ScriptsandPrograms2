...
*               
* Created   :   30.05.2003
* Modified  :   $Date: 2003/08/18 10:06:49 $
*
* © four for business AG, www.4fb.de
*
* $Id: include.grouprights_menu.php,v 1.8 2003/08/18 10:06:49 timo.hummel Exp $
******************************************/
...
while ($db->next_record())
{
    ...
    if ($allow == true)
    {
        ...
        if ($perm->have_perm_area_action('groups',"groups_delete") ) { 
        	    $message = sprintf(i18n("Do you really want to delete the group %s?"),$groupname);
    	...
    	$delDescr = sprintf(i18n("Do you really want to delete the following group:<br><br>%s<br>"),$groupname);
