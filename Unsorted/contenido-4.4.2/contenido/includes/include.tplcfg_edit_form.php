...
$script = 'window.onerror = function(){ return true };
           ...
           try {
               obj = parent.frames["left_top"].cfg;
           ...
           if ( obj ) {
				...
				if ( changed ) {    				    				
					...
					parent.frames["left_bottom"].location.href = "'.$sess->url("main.php?area=con&force=1&frame=2").'";
					
				}         		

           }

           // parent.frames["right_top"].location.href = "main.php?area=con&frame=3&idcat=0&contenido='.$sess->id.'";
