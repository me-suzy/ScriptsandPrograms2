...
<html>
  ...
  <table cellpadding="0" cellspacing="5" border="0" width="400"><tr>
    <td width="160" valign="top">
      <fieldset><legend>Browser</legend>
      <table cellpadding="0" cellspacing="5" border="0"><tr>
        <td><?php echo $l->m('library')?></td></tr><tr>
        <td><select name="lib" size="1" class="input" style="width: 150px;" onChange="libbrowser.submit();">
        <?php echo $lib_Options?>
        </select></td>
      </tr><tr>
        <td><?php echo $l->m('images')?></td></tr><tr>
        <td><select name="img" size="15" class="input" style="width: 150px;" onchange="if (this.selectedIndex >=0) imgpreview.location.href ='<?php echo $www.$lib?>' + this.options[this.selectedIndex].value;" ondblclick="selectClick();">
        <?php echo $lib_Files?>
        </select></td>
      </tr></table>
      </fieldset>
    ...
    <td width="240" valign="top">
      ...
      <table cellpadding="0" cellspacing="5" border="0"><tr>
        <td><iframe name="imgpreview" src="" style="width: 100%; height: 200px;" scrolling="Auto" marginheight="0" marginwidth="0" frameborder="0"></iframe></td>
      </tr></table>
      </fieldset>
