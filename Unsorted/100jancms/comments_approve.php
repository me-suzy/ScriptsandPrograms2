...
{ 
    foreach($_POST["todelete"] as $name_element) 
    { 

		$query = "UPDATE ".$db_table_prefix."comments SET approval='1' WHERE idComm='".$todelete[$i]."'";
		mysql_query($query);
...
//print message
$message = '
		<span class="maintext"><strong>&nbsp;&nbsp;Status:</strong> Comment(s) has been approved!</span>&nbsp;&nbsp;<img src="images/app/all_good.jpg" width="16" height="16">
		';
		$action = "true";
...
<table width="100%" height="60" border="0" cellpadding="0" cellspacing="0" class="mainsectiopntable" >
  <tr> 
    <td class="titletext0">Comments: <span class="titletext0blue">Approve Comment(s)</span></td>
  </tr>
</table>
<br>
<br>
...
$text1='
<form name="delform" action="comments_approve.php" method="post">
...
$text3='<span class="maintext">Are you sure you want to approve the following comment(s)? <span class="maintext2"></span><br>
<span class="maintext"><img src="images/app/i16.gif" width="16" height="16" align="absbottom">&nbsp;<span class="maintext"><strong>Warning:</strong>&nbsp;&nbsp;This operation can not be reverted!</span>
...
for ($i=0;$i<count($todelete);$i++) {
			...
			$text4="<span class='maintext2'>-&nbsp;&nbsp;\"".$item_display_1."\"</span> <span class='maintext'>(".$item_display_2.")</span><br>".$text4;
			}
}
if ($id<>"")
{
...
<br>
<br>
<input name="approve_button" type="submit" class="formfields2" id="approve_button" style="width: 75px; height: 26px;" value="Approve ->">
&nbsp;&nbsp;
...
<script language="JavaScript" type="text/JavaScript">
document.all.approve_button.focus();
</script>
...
if ($action != "true")
{
	if ((count($_POST["todelete"]) > 0) OR ($id<>""))
	{
	echo "$text1";
	echo "$text2";
	echo "$text3";
