...
?>
	...
	<!-- articles start -->
		...
		<form name="register" method="post" action="test_register_exe.php" onSubmit="return checkform(register);">
          <tr>
              <td align="left" valign="top"> Full name:<br> 
                <input name="full_name" type="text" class="formfields" id="full_name" size="30" maxlength="255" alt="anything" emsg="Full Name">
                ...
                <img src="images/asterix.jpg" width="9" height="8" align="absmiddle"><br>
                Email:<br> 
                <input name="email" type="text" class="formfields" id="email" size="30" maxlength="255" alt="email" emsg="Email">
                <img src="images/asterix.jpg" width="9" height="8" align="absmiddle"><br>
                <br>
                <br>
                <input type="submit" name="submit" value="Register -&gt;" style="width: 70px; height: 24px;" class="formfields2">              
            </td>
          </tr>
		</form>
        </table>
