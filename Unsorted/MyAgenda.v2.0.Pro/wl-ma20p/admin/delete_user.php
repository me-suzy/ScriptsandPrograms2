...
if(!empty($UID)) {
	mysql_query("DELETE FROM ".$CFG->Tbl_Pfix."_USERS WHERE UID = '".$UID."' ") or die (mysql_error());
	if(mysql_affected_rows() != 0) {
		mysql_query("DELETE FROM ".$CFG->Tbl_Pfix."_REMINDERS WHERE UID = '".$UID."' ") or die (mysql_error());
