...
<td width=334 colspan=3><b>%%TIME%%</b></td>
...
<td width=20 align=center><a href="view.php" onclick="return false"><img width=14 height=14 src="%%RF%%style/%%STYLE%%/image/filter.gif" title="%%FILTER%%" border=0 onclick='FormFilter(view,"%%VNAME%%","%%VALUE%%")'></a></td>
<td width=431>%%VALUE%%</td>
...
<td align=center><a href="view.php" onclick="return false"><img width=14 height=14 src="%%RF%%style/%%STYLE%%/image/filter.gif" title="%%FILTER%%" border=0 onclick='FormFilter(view,"%%VNAME%%","%%VALUE2%%")'></a></td>
<td>%%VALUE%%</td>
...
<tr height=20 class=areacol onmouseover="this.className='sel'" onmouseout="this.className='usel'">
<td align=right colspan=2>%%NAME%%</td>
<td align=center><a href="view.php" onclick="return false"><img width=14 height=14 src="%%RF%%style/%%STYLE%%/image/filter.gif" title="%%FILTER%%" border=0 onclick='FormFilter(view,"%%VNAME%%","%%VALUE%%")'></a></td>
...
<tr height=20 class=areacol onmouseover="this.className='sel'" onmouseout="this.className='usel'">
<td align=right colspan=2>%%NAME%%</td>
<td align=center><a href="view.php" onclick="return false"><img width=14 height=14 src="%%RF%%style/%%STYLE%%/image/filter.gif" title="%%FILTER%%" border=0 onclick='FormFilter(view,"%%VNAME%%","%%REFERRER%%")'></a></td>
...
$empty=<<<EMPTY
<tr height=20 class=areacol onmouseover="this.className='sel'" onmouseout="this.className='usel'">
<td align=center colspan=7>%%TEXT%%</td>
</tr>
