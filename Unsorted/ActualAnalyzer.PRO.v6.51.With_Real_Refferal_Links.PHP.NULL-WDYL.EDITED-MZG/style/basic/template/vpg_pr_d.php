...
<td width="100%"><SPAN class=f11><b>%%GRPG%%</b>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td></tr></table></td>
<td width=94><table width="100%" border=0 cellspacing=0 cellpadding=0>
<tr valign=center align=center><td><div class=stabl><input name="%%STAB%%_2" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYIN%%" border=0></div></td>
<td width="100%"><SPAN class=f11><b>%%IN%%</b>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td></tr></table></td>
<td width=94><table width="100%" border=0 cellspacing=0 cellpadding=0>
<tr valign=center align=center><td><div class=stabl><input name="%%STAB%%_3" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYOUT%%" border=0></div></td>
<td width="100%"><SPAN class=f11><b>%%OUT%%</b>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td></tr></table></td>
<td width=75><table width="100%" border=0 cellspacing=0 cellpadding=0>
<tr valign=center align=center><td><div class=stabl><input name="%%STAB%%_4" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYP%%" border=0></div></td>
<td width="100%"><SPAN class=f11><b>%%PER%%</b>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td></tr></table></td>
<td width=133><SPAN class=f11><b>%%GRAPHIC%%</b></SPAN></td></tr>
...
<td width="100%"><div class=stabl><code class=f9>%%GRPG%%</code></div></td></tr></table></td><td><SPAN class=f11>%%IN%%</SPAN></td>
...
</tr></table></td><td><SPAN class=f11><b>-</b></SPAN></td><td><SPAN class=f11><b>-</b></SPAN></td><td><SPAN class=f11><b>-</b></SPAN></td><td><SPAN class=f11><b>-</b></SPAN></td></tr>
...
<td><SPAN class=f11>%%IN%%</SPAN></td><td><SPAN class=f11>%%OUT%%</SPAN></td><td><SPAN class=f11>%%PER%%</SPAN></td>
<td align=left><table border=0 cellspacing=0 cellpadding=0><tr valign=center><td><img border=0 height=16 width=3 src="%%RF%%style/%%STYLE%%/image/left.gif"></td>
<td><img border=0 height=16 width="%%GRAPHIC%%" src="%%RF%%style/%%STYLE%%/image/center.gif"></td><td><img border=0 height=16 width=7 src="%%RF%%style/%%STYLE%%/image/right.gif"></td></tr></table></td></tr>

FOOT;

$delimiter2=<<<DELIMITER2
<tr height=20 bgcolor="#CCCCCC" align=center><td colspan=2><SPAN class=f11><b>%%NAME%%</b></SPAN></td><td><SPAN class=f11><b>%%IN%%</b></SPAN></td>
<td><SPAN class=f11><b>%%OUT%%</b></SPAN></td><td><SPAN class=f11><b>%%PER%%</b></SPAN></td><td><SPAN class=f11><b>-</b></SPAN></td></tr>
