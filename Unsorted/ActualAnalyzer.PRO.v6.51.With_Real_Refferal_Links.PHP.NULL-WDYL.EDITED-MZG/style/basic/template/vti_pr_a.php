...
<td width=132><SPAN class=f11><a href="#visitors" style="color:#000000"><b>%%VISITORS%%</b></a><b>, %</b></SPAN></td><td width=132><SPAN class=f11><a href="#hosts" style="color:#000000"><b>%%HOSTS%%</b></a><b>, %</b></SPAN></td>
<td width=133><SPAN class=f11><a href="#hits" style="color:#000000"><b>%%HITS%%</b></a><b>, %</b></SPAN></td></tr>
...
<tr><td width="100%"><div class=tabl>%%PERIOD%%</div></td></tr></table></td><td><SPAN class=f11>%%VISITORS%%</SPAN></td>
...
$centerg=<<<CENTERG
<tr height=20 bgcolor="#EEEEEE" align=center onmouseover="this.className='sel'" onmouseout="this.className='usel'"><td><table width="100%" border=0 cellspacing=0 cellpadding=0>
<tr><td valign=center><div class=stabl><a href="view.php" onclick="return false"><img width=14 height=14 src="%%RF%%style/%%STYLE%%/image/info.gif" border=0 title="%%DETAIL%%" onclick='FormSubmit(view,"%%INTERVAL%%","%%REF%%","%%PERIOD%%")'></a></div></td>
