...
<td><div class=stabl><input name="%%STAB%%_2" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYV%%" border=0></div></td><td width="100%"><SPAN class=f11><a href="#visitors" style="color:#000000"><b>%%VISITORS%%</b></a>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td>
</tr></table></td><td width=99><table width="100%" border=0 cellspacing=0 cellpadding=0><tr valign=center align=center>
...
<td width="100%"><SPAN class=f11><a href="#hosts" style="color:#000000"><b>%%HOSTS%%</b></a>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td>
</tr></table></td><td width=99><table width="100%" border=0 cellspacing=0 cellpadding=0><tr valign=center align=center>
...
<td><div class=stabl><input name="%%STAB%%_5" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYHT%%" border=0></div></td><td width="100%"><SPAN class=f11><a href="#hits" style="color:#000000"><b>%%HITS%%</b></a>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td>
</tr></table></td></tr>
...
$icenter=<<<ICENTER
<tr height=20 bgColor="#EEEEEE" align=center onmouseover="this.className='sel'" onmouseout="this.className='usel'"><td align=center><table border=0 cellspacing=0 cellpadding=0><tr>
<td align=right><div class=stabl><a href="view.php" onclick="return false"><img width=14 height=14 src="%%RF%%style/%%STYLE%%/image/info.gif" title="%%DETAIL%%" border=0 onclick='FormSubmit(view,"%%INTERVAL%%","%%REF%%","%%PERIOD%%")'></a></div></td>
<td><div class=stabl>%%PERIOD%%</div></td></tr></table></td><td><SPAN class=f11>%%VISITORS%%</SPAN></td>
...
$delimiter=<<<DELIMITER
<tr bgcolor="#CCCCCC" height=20 align=center><td><SPAN class=f11><b>%%PERIOD%%</b></SPAN></td><td><SPAN class=f11><b>%%VISITORS%%</b></SPAN></td>
<td><SPAN class=f11><b>%%HOSTS%%</b></SPAN></td><td><SPAN class=f11><b>%%RELOADS%%</b></SPAN></td><td><SPAN class=f11><b>%%HITS%%</b></SPAN></td></tr>

DELIMITER;

$foot=<<<FOOT
<tr height=20 bgcolor="#EEEEEE" align=center onmouseover="this.className='sel'" onmouseout="this.className='usel'"><td><SPAN class=f11>%%NAME%%</SPAN></td><td><SPAN class=f11>%%VISITORS%%</SPAN></td>
<td><SPAN class=f11>%%HOSTS%%</SPAN></td><td><SPAN class=f11>%%RELOADS%%</SPAN></td><td><SPAN class=f11>%%HITS%%</SPAN></td></tr>
