...
<td align=right width=88><div class=tabl>%%PAGEN%%:</div></td><td width=320><table width="100%" border=0 cellspacing=0 cellpadding=0><tr valign=center>
...
<td width=20><div class=stabl><a href="view.php" onclick="return false"><img width=14 height=14 src="%%RF%%style/%%STYLE%%/image/visitor.gif" title="%%FILTER%%" border=0 onclick='FormFilter(view,"%%VNAME%%","%%VALUE%%")'></a></div></td>
<td width=130><div class=tabl>%%VALUE%%</div></td></tr></table></td></tr>
</tr>
