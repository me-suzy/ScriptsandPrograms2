...
<td><a href="#visitors"><b>%%VISITORS%%</b></a></td>
<td width=14>&nbsp;</td>
</tr>
</table>
</td>
...
<td><a href="#hosts"><b>%%HOSTS%%</b></a></td>
<td width=14>&nbsp;</td>
</tr>
</table>
</td>
...
<table border=0 cellspacing=0 cellpadding=0 align=center>
<tr class=vscellh valign=middle align=center>
<td width=14><input name="%%STAB%%_4" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYR%%" border=0></td>
<td><a href="#reloads"><b>%%RELOADS%%</b></a></td>
<td width=14>&nbsp;</td>
</tr>
</table>
</td>
...
<table border=0 cellspacing=0 cellpadding=0 align=center>
<tr class=vscellh valign=middle align=center>
<td width=14><input name="%%STAB%%_5" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYHT%%" border=0></td>
<td><a href="#hits"><b>%%HITS%%</b></a></td>
<td width=14>&nbsp;</td>
</tr>
</table>
</td>
...
<tr height=20 class=areacol align=center onmouseover="this.className='sel'" onmouseout="this.className='usel'">
<td>%%NUM%%</td>
<td align=left class=vspad><code>%%REFSHORT%%</code></td>
<td>%%VISITORS%%</td>
<td>%%HOSTS%%</td>
<td>%%RELOADS%%</td>
<td>%%HITS%%</td>
