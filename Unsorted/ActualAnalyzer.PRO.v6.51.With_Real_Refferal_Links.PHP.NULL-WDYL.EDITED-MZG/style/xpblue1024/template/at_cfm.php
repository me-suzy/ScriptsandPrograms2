...
<td background="%%RF%%style/%%STYLE%%/image/bcen.gif"><div class=tbutton><a TABINDEX=1 href="%%SCRIPT%%.php" onclick='return false'><span onclick='FormIdExtParam(admin,"%%PGID%%","back","%%ACT%%")'>%%BACK%%</span></a></div></td>
<td width=3><img width=3 height=21 border=0 src="%%RF%%style/%%STYLE%%/image/bright.gif"></td>
<td width=40>&nbsp;</td>
<td width=3><img width=3 height=21 border=0 src="%%RF%%style/%%STYLE%%/image/bleft.gif"></td>
<td background="%%RF%%style/%%STYLE%%/image/bcen.gif"><div class=tbutton><a TABINDEX=2 href="%%SCRIPT%%.php" onclick='return false'><span onclick='FormIdExtParam(admin,"%%PGID%%","confirm","%%PARAM%%")'>%%NEXT%%</span></a></div></td>
<td width=3><img width=3 height=21 border=0 src="%%RF%%style/%%STYLE%%/image/bright.gif"></td>
</tr>
</table>
</div>
...
<td height=3 width=961><img src="%%RF%%style/%%STYLE%%/image/tbot.gif" height=3 width=961></td>
...
<div class=tareawsubt>
<div class=tborder>
<div class=vstable>%%CONFIRM%%&nbsp;&nbsp;'<i>%%GROUP%%</i>'&nbsp;?</div>
</div>
</div>
</td>
<td width=7 background="%%RF%%style/%%STYLE%%/image/tcenr.gif"><img src="%%RF%%style/%%STYLE%%/image/0.gif" width=7></td>
...
<div class=tareawsubt>
<div class=tborder>
<div class=vstable>%%CONFIRM%%&nbsp;&nbsp;'<a href="%%URL%%" title="%%PAGE%%" target=_blank><code><i>%%PAGESHORT%%</i></code></a>'&nbsp;?</div>
</div>
</div>
</td>
<td width=7 background="%%RF%%style/%%STYLE%%/image/tcenr.gif"><img src="%%RF%%style/%%STYLE%%/image/0.gif" width=7></td>
