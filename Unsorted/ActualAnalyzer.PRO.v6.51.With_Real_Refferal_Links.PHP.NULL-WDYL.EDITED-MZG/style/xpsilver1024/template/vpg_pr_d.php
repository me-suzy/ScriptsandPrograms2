...
<td width=14><input name="%%STAB%%_2" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYIN%%" border=0></td>
<td><b>%%IN%%</b></td>
<td width=14>&nbsp;</td>
</tr>
</table>
...
<td width=14><input name="%%STAB%%_3" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYOUT%%" border=0></td>
<td><b>%%OUT%%</b></td>
<td width=14>&nbsp;</td>
</tr>
</table>
...
<table border=0 cellspacing=0 cellpadding=0 align=center>
<tr class=vscellh valign=center align=center>
<td width=14><input name="%%STAB%%_4" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYP%%" border=0></td>
<td><b>%</b></td>
<td width=14>&nbsp;</td>
</tr>
</table>
...
<td width=466><a href="%%PGURL%%" title="%%GRPG%%" target=_blank><code>%%GRPGSHORT%%</code></td>
</tr>
</table>
</td>
