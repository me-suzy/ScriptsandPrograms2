...
$query = "DELETE FROM demo_a__klicksp WHERE timefeld <= ".$nichtmehrgueltig;
mysql_query($query);
...
<font size="4" color="red" face="Verdana, Arial, Helvetica, sans-serif"><b><U>Stats</u></b></font><br><br><TABLE bgcolor="#FFFFFF" bordercolor="#000000" border="0" align="center">
<TR>
  <TD width="300"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Services started:</TD>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><? echo "$seitenstart"; ?></TD>
</TR>
<TR>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Last updated:</TD>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><? echo "$date $time"; ?></TD>
</TR>
<TR>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Registered User:</TD>
...
<TR>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Total amount of visits:</TD>
...
<TR>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Visits generated:</TD>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><? echo "$punkt"; ?></TD>
</TR>
<TR>
  <TD><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Actually surfing:</TD>
