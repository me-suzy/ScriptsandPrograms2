...
/** 
 * @version V1.31 20 August 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved.
...
*/
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	#else
	if($include_path)
		$ADODB_DIR="$include_path/adodb";
	else
		$ADODB_DIR="../includes/adodb";
	 ...
	 */
	$ADODB_vers = 'V1.31 20 August 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved. Released LGPL.';
	 ...
	 */ 
        function Insert_ID($tableName='',$keyName='')
        {		if($this->databaseType == 'postgres7') //for postGRES only
					return $this->_insertid($tableName,$keyName);
                elseif ($this->hasInsertID) return $this->_insertid();
   ...
   */
	...
	*/
	...
	{
	GLOBAL $ADODB_Database, $ADODB_DIR;
