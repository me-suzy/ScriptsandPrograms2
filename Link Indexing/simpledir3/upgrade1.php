...
mysql_query("ALTER TABLE $tbconfig ADD adminemail text NOT NULL") or die(mysql_error());
mysql_query("ALTER TABLE $tbconfig ADD emailnotify text NOT NULL") or die(mysql_error());
mysql_query("ALTER TABLE $tbconfig ADD siteurl text NOT NULL") or die(mysql_error());
mysql_query("ALTER TABLE $tbconfig ADD numperpage text NOT NULL") or die(mysql_error());
