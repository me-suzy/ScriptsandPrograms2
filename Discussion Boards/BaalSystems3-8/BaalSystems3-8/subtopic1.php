...
<table align="center" border="0" width="600">
  ...
  <tr>
    ...
    ?></td>
            <td align="middle" class="s"><b>User Section</b></td>
          </tr>
        </table>
      </div></td>
  </tr>
  <tr>
          ...
          <td class="q"><table border="0" cellPadding="5" cellSpacing="1" width="100%">
              ...
              <tr class="c">
                <td colSpan="6"><table cellPadding="2" cellSpacing="0" width="100%">
                    <tbody>
                      <tr>
                        <td noWrap><span class="c"><a href="user.php" id="lnk" style="COLOR: #ffffff; TEXT-DECORATION: none" title="Click here to refresh the latest topics...">Index</a></span></td>
                        ...
                        <td align="right" noWrap width=50%><form action="search.php" method="POST" style="margin: 0px; padding: 0px; text-align: right">
                                  <table cellpadding=0 cellspacing=0>
                                    <tr>
                                      ...
                                      <td><input type="submit" title="test" value="test" class="searchbut">
                                      </td>
                                    </tr>
                                  </table>
                          </form></td>
    ...
    ?>" style="COLOR: #ffffff" title="Add Post">Add&nbsp;Test</a></b></td>
                      </tr>
                    </tbody>
                  </table></td>
              </tr>
...
&nbsp;Subject&nbsp;</td>
    ...
    while ($row = db_fetch_row($result)) {
        if (is_integer($i / 2)) {
            ...
            ?>
              <tr class="a">
                 <td><p><b><img alt border="0" hspace="2" src="pics/user2.gif" width="11" height="14"> <a href=newmsg.php?to=<?=$row['authorname']?> >
                    <?=$row["authorname"]?>
                    </a></b></p>
                  <p><?php $result4 = db_query("select * from {$tableprefix}tbluser where username='" . $row["authorname"] . "'"); 
		$row4 = db_fetch_row($result4);
		echo($row4["level"]); ?><br><a href="userprofile.php?username=<?php print($row["authorname"]); ?>" title="Profile">Profile</a>                      </p>
				  <p></p>
                  <p>
                    <?=$image;
            ...
            ?></td>
				<td class="s">
                	...
                	?>&author=<?php echo($row["authorname"]); ?>" title="reply">reply</a>
				</td>
                <td class="s">
                    <? if ($_SESSION["username"] == $row["authorname"]) { ?>
                    <a href="edittopic1.php?sfid=<?php echo($row["subforumid"]);?>&fid1=<?php echo($row["forumid"]);?>" title="delete">edit</a>
                    <? } ?>
                </td>
