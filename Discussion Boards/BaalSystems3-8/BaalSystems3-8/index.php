...
<table align="center" border="0" width="600">
  <tbody>
    <tr>
      <td><table align="right" border="0">
          <tr>
            <td align="right" class="s"><li><a href="join.php" title="RegisterUserName" style="COLOR:#ffffff">register</a></li></td>
            <td align="right" class="s"><li><a href="adminlogin.php" style="COLOR: #ffffff" title="AdminLogin">admin</a></li></td>
            <td align="right" class="s"><li><a href="modlogin.php" style="COLOR: #ffffff" title="ModLogin">moderator</a></li></td>
            <td align="right" class="s"><li><a href="userlogin.php" style="COLOR: #ffffff" title="UserLogin">user</a></li></td>
                      ...
                      <td colSpan="5"><table cellPadding="2" cellSpacing="0" width="100%">
                          <tbody>
                            <tr>
                              ...
                              <td align="right" noWrap><b><a href="newtopic.php" style="COLOR: #ffffff">New Topic</a></b></td>
                            </tr>
                          </tbody>
                        </table></td>
                    </tr>
                    <tr class="z">
                      <td class="f" noWrap width="70%">&nbsp;<a style="color: #ffffff; font-size: 10px; text-decoration: none" href="index.php?sort=sj&order=<?=(($sort == "sj" && $order == "as") ? "de" : "as");
...
?>
&nbsp;</td>
                      <td class="f" noWrap width="10%">&nbsp;<a style="color: #ffffff; font-size: 10px; text-decoration: none" href="index.php?sort=au&order=<?=(($sort == "au" && $order == "as") ? "de" : "as");
...
?>
&nbsp;</td>
                      <td class="f" noWrap width="10%">&nbsp;<a style="color: #ffffff; font-size: 10px; text-decoration: none" href="index.php?sort=lp&order=<?=(($sort == "lp" && $order == "as") ? "de" : "as");
...
?>
&nbsp;</td>
                      <td class="f" noWrap width="5%">&nbsp;<a style="color: #ffffff; font-size: 10px; text-decoration: none" href="index.php?sort=tp&order=<?=(($sort == "tp" && $order == "as") ? "de" : "as");
...
?>
&nbsp;</td>
                      <td class="f" noWrap width="5%">&nbsp;<a style="color: #ffffff; font-size: 10px; text-decoration: none" href="index.php?sort=vs&order=<?=(($sort == "vs" && $order == "as") ? "de" : "as");
...
foreach ($unposes as $key => $row) {
    if (is_integer($i / 2)) {
        ...
        ?>
                    <tr class="a">
                      <td><a class="v" onfocus="blur();" href="subtopic2.php?fid=<?php echo($row["forumid"]);
        ...
        ?></b></a>
                        <div class="s"> <a class="v" onfocus="blur();" href="subtopic2.php?fid=<?php echo($row["forumid"]);
...
<div align="center">
  ...
  <p><a href="http://baalsystems.com">CopyRight 2005 Baal Systems Discussion Form</a></p>
</div>
</body>
</html>
<?php
