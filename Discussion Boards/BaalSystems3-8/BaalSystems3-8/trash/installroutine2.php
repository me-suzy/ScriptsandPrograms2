...
else
{
  ...
  $strcontent1 .= "\$tableprefix = $_POST['tableprefix']; ?>";
...
$querys = " CREATE TABLE tblgroup (
groupid INT NOT NULL AUTO_INCREMENT ,
groupname VARCHAR( 80 ) NOT NULL ,
PRIMARY KEY ( groupid ) )";
$results = mysql_query($querys) ;
if ( $_force == "Y" )
mysql_query( "DROP TABLE tblforum" ) ;
$queryas= " CREATE TABLE tblforum (
...
mysql_query( "DROP TABLE tblsubforum" ) ;
