...
{
include "header.php";
echo "<h3>Edit Ad Settings</h3><br>";
//connection to database
include "../config.php";
$db = mysql_connect($db_host,$db_user,$db_pass); 
mysql_select_db ($db_name) or die ("Cannot connect to database"); 
$query = "SELECT adenable, adcode, adlocation FROM prefs LIMIT 0,1"; 
$result = mysql_query($query); 
while($r=mysql_fetch_array($result)) 
{ 
...
?>
<form action="ad_edit.php?a=save" method="post">
<table cellpadding="2" cellspacing="2" border="0"><tr><td valign="top">
Enable ads: </td><td><input type="radio" name="adenable" value="yes"> >> Yes<br><input type="radio" name="adenable" value="no" checked> >> No</td></tr><tr><td valign="top">
Location of ads: </td><td><input type="radio" name="adlocation" value="top"> >> Topmost<br><input type="radio" name="adlocation" value="below" checked> >> Below Site Logo/Banner ( Recommended for best results )<br><input type="radio" value="bottom" name="adlocation"> >> Bottom</td></tr><tr><td valign="top">
Ad code: </td><td><textarea rows="10" cols="45" name="adcode"><?=$adcode;?></textarea></td></tr><tr><td></td><td>
<input type="submit" value="Save Changes"></td></tr></table>
</form>
<? }
if ($_GET['a'] == "save") {
$query2 = "UPDATE prefs SET adenable='$_POST[adenable]', adcode='$_POST[adcode]', adlocation='$_POST[adlocation]'"; 
mysql_query($query2); 
echo "Site Updated";
