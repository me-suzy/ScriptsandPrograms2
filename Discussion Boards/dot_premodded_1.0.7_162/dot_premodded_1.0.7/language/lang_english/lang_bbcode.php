...
/* CONTRIBUTORS
	...
	2005-01-14  abcde (bbcodefaq@premodded.nl)
		Add a part for the .premodded project and changed sometimes the phpbb.com url into the .premodded url.
*/
...
$faq[] = array("Adding an image to a post", "phpBB BBCode incorporates a tag for including images in your posts. Two very important things to remember when using this tag are: many users do not appreciate lots of images being shown in posts and second, the image you display must already be available on the Internet (it cannot exist only on your computer, for example, unless you run a webserver!). There is currently no way of storing images locally with phpBB (all these issues are expected to be addressed in the next release of phpBB). To display an image, you must surround the URL pointing to the image with <b>[img][/img]</b> tags. For example:<br /><br /><b>[img]</b>http://www.premodded.nl/images/phplogo.gif<b>[/img]</b><br /><br />As noted in the URL section above you can wrap an image in a <b>[url][/url]</b> tag if you wish, eg.<br /><br /><b>[url=http://www.premodded.nl/][img]</b>http://www.premodded.nl/images/phplogo.gif<b>[/img][/url]</b><br /><br />would generate:<br /><br /><a href=\"http://www.premodded.nl/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");

//
// Begin of the .premodded BB-code faq edit. The enteries below are made by the .premodded project.
//

$faq[] = array("--", "Other BB-codes - not shown in posting windows related things.");
$faq[] = array("What codes are there that are not showed in posting window?", "You can use the following extra BB-codes (Basic BBcodes mod by 0racle) en the Syntax highlighting mod by 0racle (I copied and pasted the text from the Basic BBcodes mod) [br], [hr], [h1] - [h6], [rainbow], [sub], [sup], [serif], [sans], [mono], [md5] and [reverse](now my own text coming...(also conserning the Syntax Highlighting Mod by 0racle)) and the [syntax]-BB-code(example: [syntax=\"php\"] and [syntax=sql]), this mod supports 29 program-languages.");

//
// End of the .premodded BB-code faq edit. Back to the phpBB BB-codes.
//
