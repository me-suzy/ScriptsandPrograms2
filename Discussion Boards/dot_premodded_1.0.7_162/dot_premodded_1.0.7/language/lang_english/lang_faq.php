...
/* CONTRIBUTORS:
	2002-12-15	Philip M. White (pwhite@mailhaven.com)
      ...
      2004-12-30  abcde (faq@premodded.nl)
            Added the enteries for .premodded.
*/
...
//
// These enteries are made by: abcde from .premodded (http://www.premodded.nl), ans should remain in all languages(translations) and for all modifications. (These enteries have nothing to do with the phpBB Group!))
//

$faq[] = array("--",".premodded?");
$faq[] = array("What is .premodded?", ".Premodded (read: dot-premodded -> the dot is no typing mistake) is a moddified phpBB from www.premodded.nl. Premodded means that al lot of mods were installed, so the user(s)(read: administrator(s)) don't have to moddifie (a lot).");
$faq[] = array("Who should I contact when I discover a bug?", "That depends, first the administrator(s), if it's a modding bug(from .premodded) you should contact <a href=\"http://www.premodded.nl\">the .premodded project</a>, if it a bug in phpBB you should contact the phpBB group.");
