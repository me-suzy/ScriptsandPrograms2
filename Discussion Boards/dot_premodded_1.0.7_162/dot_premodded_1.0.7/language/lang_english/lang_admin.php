...
$lang['Welcome_phpBB'] = 'Welcome to .premodded';
$lang['Admin_intro'] = 'Thank you for choosing .premodded as your forum solution. This screen will give you a quick overview of all the various statistics of your board. You can get back to this page by clicking on the <u>Admin Index</u> link in the left pane. To return to the index of your board, click the .premodded logo also in the left pane. The other links on the left hand side of this screen will allow you to control every aspect of your forum experience. Each screen will have instructions on how to use the tools.';
...
$lang['Backup'] = 'Backup';
$lang['Restore_explain'] = 'This will perform a full restore of all .premodded tables from a saved file. If your server supports it, you may upload a gzip-compressed text file and it will automatically be decompressed. <b>WARNING</b>: This will overwrite any existing data. The restore may take a long time to process, so please do not move from this page until it is complete.';
$lang['Backup_explain'] = 'Here you can back up all your .premodded-related data. If you have any additional custom tables in the same database with .premodded that you would like to back up as well, please enter their names, separated by commas, in the Additional Tables textbox below. If your server supports it you may also gzip-compress the file to reduce its size before download.';
...
$lang['phpBB_only'] = 'Only .premodded-related tables';
...
$lang['Script_path_explain'] = 'The path where .premodded is located relative to the domain name';
...
$lang['Smilies_path_explain'] = 'Path under your .premodded root dir, e.g. images/smiles';
...
$lang['Avatar_storage_path_explain'] = 'Path under your .premodded root dir, e.g. images/avatars';
$lang['Avatar_gallery_path'] = 'Avatar Gallery Path';
$lang['Avatar_gallery_path_explain'] = 'Path under your .premodded root dir for pre-loaded images, e.g. images/avatars/gallery';
...
$lang['User_allowavatar'] = 'Approve avatar';
...
// Mass Email
//
$lang['Mass_email_explain'] = 'Here you can email a message to either all of your users or all users of a specific group.  To do this, an email will be sent out to the administrative email address supplied, with a blind carbon copy sent to all recipients. When you click the \'E-mail\' button, another screen will come up allowing you to designate the groups you want to include in the email. If you are emailing a large group of people please be patient after submitting and do not stop the page halfway through. It is normal for a mass emailing to take a long time and you will be notified when the script has completed';
...
$lang['Rank_image'] = 'Rank Image (Relative to the .premodded root path)';
...
$lang['Styles_addnew_explain'] = 'The following list contains all the themes that are available for the templates you currently have. The items on this list have not yet been installed into the .premodded database. To install a theme, simply click the install link beside an entry.';
...
// Install Process
//
$lang['Welcome_install'] = 'Welcome to the .premodded Installation';
...
$lang['Re_install'] = 'Your previous installation is still active.<br /><br />If you would like to re-install .premodded you should click the Yes button below. Please be aware that doing so will destroy all existing data and no backups will be made! The administrator username and password you have used to login in to the board will be re-created after the re-installation and no other settings will be retained.<br /><br />Think carefully before pressing Yes!';

$lang['Inst_Step_0'] = 'Thank you for choosing .premodded. In order to complete this install please fill out the details requested below. Please note that the database you install into should already exist.';
...
$lang['Inst_Step_2'] = 'Your admin username has been created.  At this point your basic installation is complete. You will now be taken to a screen which will allow you to administer your new installation. Please be sure to check the General Configuration details and make any required changes. Thank you for choosing .premodded.';

$lang['Unwriteable_config'] = 'Your config file is un-writeable at present. A copy of the config file will be downloaded to your computer when you click the button below. You should upload this file to the same directory as .premodded. Once this is done you should log in using the administrator name and password you provided on the previous form and visit the admin control center (a link will appear at the bottom of each screen once logged in) to check the general configuration. Thank you for choosing .premodded.';
...
$lang['ftp_instructs'] = 'You have chosen to FTP the file to the account containing .premodded automatically.  Please enter the information below to facilitate this process. Note that the FTP path should be the exact path via FTP to your .premodded installation as if you were FTPing to it using any normal client.';
$lang['ftp_info'] = 'Enter Your FTP Information';
$lang['Attempt_ftp'] = 'Attempt to FTP config file into place';
$lang['Send_file'] = 'Just send the file to me and I\'ll FTP it manually';
$lang['ftp_path'] = 'FTP path to .premodded';
...
$lang['Install_No_PCRE'] = 'phpBB2/.premodded Requires the Perl-Compatible Regular Expressions Module for PHP which your PHP configuration doesn\'t appear to support!';
...
$lang['Syntax_highlighting_advanced_mode'] = 'Syntax Highlighting is in <span style="color: green;">advanced</span> mode.';
...
$lang['se_log_admin'] = 'Search-Engine Watch';
$lang['se_log_admin_explain'] = 'Here you can see what search-engines are doing on your website';
$lang['se_log_name'] = 'SE-Bot';
$lang['se_log_url'] = 'Visited Site';
$lang['se_log_time'] = 'Date of Visit';
$lang['se_log_delete'] = 'Delete all logs';
$lang['se_log_delete_successful'] = 'Logs deleted successfully';
...
$lang['faq_admin_ad_explain'] = 'From this panel you can install FAQs and BBCode from language pack\'s downloaded from <a href="http://www.premodded.com">.premodded</a>.';
$lang['no_language_in_db'] = 'No language installed';
$lang['no_language_on_hd'] = 'No language to install';
// END-faq_admin_mod

// Avatar Approve mod
$lang['Disable_avatar_approve'] = 'Disable avatar approve system';
$lang['Avatar_posts'] = 'Minimal postcount for an avatar';
$lang['Avatar_posts_explain'] = 'This has no effect on gallery avatars. Choose 0 to turn this off';

// Gallery Page Numbers
$lang['Avatars_per_page'] = 'Avatars Per Page';

//
// Refer A Friend
//
$lang['Thanks_Message'] = 'Thanks Message';
$lang['Site_Name'] = 'Site Name';
...
$lang['auto_lang_not_exist'] = 'The language <strong>%s</strong> does not exist on this .premodded Board.';
