...
$template->assign_vars(array(
    ...
    "L_MINIMUM_PAS" => $lang['minimum_pas_size'],
    "L_MINIMUM_PAS_EXPLAIN" => $lang['minimum_pas_size_explain'],
    "L_MAXIMUM_PAS" => $lang['maximum_pas_size'],
    "L_MAXIMUM_PAS_EXPLAIN" => $lang['maximum_pas_size_explain'],
