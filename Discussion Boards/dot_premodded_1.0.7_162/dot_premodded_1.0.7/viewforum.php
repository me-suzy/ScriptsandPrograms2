...
logSearchEngines("../viewforum.php?forum_id=" . $forum_id);
...
if( $total_topics )
{
	for($i = 0; $i < $total_topics; $i++)
	{
		...
		$topic_title = (empty($topic_rowset[$i]['title_compl_infos'])) ? $topic_title : $topic_rowset[$i]['title_compl_infos'].$topic_title;
