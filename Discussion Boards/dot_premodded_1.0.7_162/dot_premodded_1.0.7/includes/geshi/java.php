 ...
 * Last Modified: $Date: 2004/10/26 01:30:38 $
 *
...
$language_data = array (
	...
	'KEYWORDS' => array(
		...
		3 => array(
			...
			'EmptyStackException', 'EncodedKeySpec',
			'Entity', 'EnumControl',
			'EnumControl.Type','Enumeration',
			'Environment', 'EOFException',
			'Error', 'EtchedBorder',
			'Event', 'EventContext',
			...
			'Externalizable', 'FeatureDescriptor',
			'Field', 'FieldNameHelper',
			'FieldPosition', 'FieldView',
			'File', 'FileChooserUI',
			'FileDescriptor',
			'FileDialog',
			'FileFilter',
