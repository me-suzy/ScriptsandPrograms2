	...
	$mode == 'register' )
{
  ...
  // End Account Self-Delete MOD
	...
	$strip_var_list = array('username' => 'username', 'email' => 'email', 'email_confirm' => 'email_confirm', 'icq' => 'icq', 'aim' => 'aim', 'msn' => 'msn', 'yim' => 'yim', 'website' => 'website', 'location' => 'location', 'occupation' => 'occupation', 'interests' => 'interests');
...
if ( isset($HTTP_POST_VARS['submit']) )
{
	...
	if ( !$error )
	{
      ...
      //
      // BEGIN - Registration IP Hack (Woody)
      //
      if (isSet($_SERVER)) 
			{
...
if( isset($HTTP_POST_VARS['avatargallery']) || isset($HTTP_GET_VARS['avatargallery']) && !$error )
{
	...
	display_avatar_gallery($mode, $avatar_category, $user_id, $email, $current_email, $email_confirm, $coppa, $username, $email, $email_confirm, $new_password, $cur_password, $password_confirm, $icq, $aim, $msn, $yim, $website, $location, $occupation, $interests, $signature, $viewemail, $notifypm, $popup_pm, $notifyreply, $attachsig, $allowhtml, $allowbbcode, $allowsmilies, $allowviewonline, $user_style, $user_lang, $user_timezone, $user_dateformat, $userdata['session_id']);
}
else
{
