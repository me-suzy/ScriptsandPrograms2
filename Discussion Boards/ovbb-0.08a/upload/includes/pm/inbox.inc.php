...
<TR>
	...
	<TD width="100%" align=left valign=top class=medium><B><A href="index.php"><?php echo(htmlspecialchars($CFG['general']['name'])); ?></A> &gt; <A href="usercp.php">User Control Panel</A> &gt; <A href="private.php">Private Messages</A> &gt; Inbox</B></TD>
</TR>
</TABLE><BR>
...
<TR><TD bgcolor="<?php echo($CFG['style']['table']['heading']['bgcolor']); ?>" class=smaller colspan=6>
	...
	<TR>
		<TD align=right class=smaller width="100%"><FONT color="<?php echo($CFG['style']['table']['heading']['txtcolor']); ?>"><B>Selected message(s)</B>:</FONT>&nbsp;</TD>
		<TD class=smaller>
			<SELECT name=dest>
				<OPTION value="1">Sent Items</OPTION>
<?php
