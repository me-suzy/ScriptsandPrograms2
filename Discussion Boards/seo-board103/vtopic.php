...
if (!isset($_POST["postreply"]) || isset($preview))
{
  ...
  {
    list($p_id, $author_name, $author_id, $author_ip, $post_message, $post_status, $post_time, $post_edited, $post_edited_by, $post_edited_time, $author_num_posts, $author_reg_date, $author_allowviewonline, $author_lasttimereadpost) = $row;
