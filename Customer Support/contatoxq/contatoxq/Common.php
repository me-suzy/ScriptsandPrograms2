...
//Connection Settings @0-B691B97C
...
//Initialize Common Variables @0-7CE4B59B
...
$CCSLocales->AddLocale("en-US", Array("en", "US", array("Yes", "No", ""), 2, ".", ",", array("Janeiro", "Fevereiro", "Marco", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"), array("Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"), array("Domingo", "Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sabado"), array("Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"), array("D", "S", "T", "Q", "Q", "S", "S"), array("d", "/", "m", "/", "yyyy"), array("dddd", ", ", "dd", " ", "mmmm", ", ", "yyyy"), array("h", ":", "nn", " ", "tt"), array("h", ":", "nn", ":", "ss", " ", "tt"), "AM", "PM", 0, false, "", "windows-1252", "CP1252"));
$CCSLocales->DefaultLocale = strtolower("en-US");
$CCSLocales->Init();
...
//contatoxq Connection Class @-4B881471
class clsDBcontatoxq extends DB_MySQL
{
    ...
    function Initialize()
    {
        ...
        $Configuration = $CCConnectionSettings["contatoxq"];
...
//End contatoxq Connection Class
...
//CCLoginUser @0-0A41D64C
function CCLoginUser($login, $password)
{
    $db = new clsDBcontatoxq();
