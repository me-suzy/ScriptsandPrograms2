...
if (empty($UNTRUSTED['usertyping'])){ 
   $UNTRUSTED['usertyping'] = "ON";
}
...
function pingchat() {
   ...
   pingcontrol = new Image;      	 
	 var u = 'image.php?randu=' + pingcsID + '&cmd=pingchat'
	 pingcontrol.src = u;
...
{	 
   ...
   cscontrol = new Image;
	 ...
	 var u = 'image.php?randu=' + randu + '&cmd=talkative'
...
<?php 
  if ($UNTRUSTED['usertyping'] == "ON"){ 
  	print "<td><a href=javascript:showsmile()><img src=images/icon_smile.gif border=0>&nbsp;".$lang['view']."</a></td></tr><tr><td><font color=009900><b>".$lang['ON']."</b></font> / <a href=user_bot.php?usertyping=1&department=$department>".$lang['OFF']."</a></td></tr></table>";
  } else { 
  	print "<td><img src=images/icon_nosmile.gif border=0>&nbsp;<s>".$lang['view']."</s></td></tr><tr><td><a href=user_bot.php?department=$department>".$lang['ON'] ."</a> / <font color=990000><b>".$lang['OFF']."</b></font></td></tr></table>";  }?>
</td>
...
<?php 
if ($UNTRUSTED['usertyping'] == "ON")
  	print "<input type=hidden name=usertyping value=ON>";
   else
    print "<input type=hidden name=usertyping value=OFF>";
?>	
</td></tr></table>
</FORM>
</td></tr></table>
