...
<body bgcolor=<?php echo $color_background; ?> marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>
<form action=admin_rooms.php method=post name=mine>
<table width=100% cellpadding=0 cellspacing=0 border=0>
<tr>
<td NOWRAP valign=top><b><?php echo $lang['status']; ?>:</b><select name=status onchange=document.mine.submit()>
<option value=Y <?php echo $online; ?> ><?php echo $lang['online']; ?></option>
<option value=N <?php echo $offline; ?>><?php echo $lang['offline']; ?></option>
</select></td>
<td NOWRAP valign=top><input type=checkbox value=Y name=auto_invite <?php echo $auto_invite; ?> onclick="javascript:my_auto_invite();"><b><font color=007777><?php echo $lang['txt134']; ?></font></b></td>
<td NOWRAP valign=top><input type=checkbox value=Y name=show_arrival_new <?php echo $show_arrival; ?> onclick=document.mine.submit() ><b><?php echo $lang['txt135']; ?></b> </td>
<td NOWRAP valign=top><input type=checkbox value=N name=user_alert_new  <?php echo $user_alert; ?> onclick=document.mine.submit() ><b><?php echo $lang['txt136']; ?></b></td>
<td NOWRAP valign=top><input type=checkbox value=Y name=auto_focus  <?php echo $auto_focus; ?> ><b><?php echo $lang['txt169']; ?></b></td>
</tr>
</table>
