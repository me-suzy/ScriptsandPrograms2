...
<b><?php echo $lang['txt54']; ?></b><?php echo $lang['YES']; ?> <input type=radio name=requirename value=Y  <?php echo $needname_s_y; ?>  > <?php echo $lang['NO']; ?> <input type=radio name=requirename value=N <?php echo $needname_s_n; ?> ><br>
 ...
 ?>
  <tr>
   ...
   <td><textarea cols=23 rows=4 name=questions_<?php echo $row['recno']; ?>_<?php echo $row_questions['id']; ?>_headertext><?php echo $row_questions['headertext']; ?></textarea></td>
   <td><textarea cols=23 rows=4 name=questions_<?php echo $row['recno']; ?>_<?php echo $row_questions['id']; ?>_options><?php echo $row_questions['options']; ?></textarea></td>
   <td>  
...
<textarea name=whilewait rows=7 cols=40><?php echo $row['whilewait']; ?></textarea><br>
...
<textarea name=opening rows=7 cols=40><?php echo $row['opening']; ?></textarea><br>
...
<textarea name=busymess rows=7 cols=40><?php echo $row['busymess']; ?></textarea><br>
...
<textarea name=offline rows=7 cols=40><?php echo $row['offline']; ?></textarea><br>
...
<textarea name=leavetxt rows=7 cols=40><?php echo $row['leavetxt']; ?></textarea><br>
...
<b><?php echo $lang['email']; ?></b><input type=text size=25 name=messageemail value="<?php echo $row['messageemail']; ?>"><br>
 ...
 ?>
  <tr>
   ...
   <td><textarea cols=23 rows=4 name=leavemessage_<?php echo $row['recno']; ?>_<?php echo $row_questions['id']; ?>_headertext><?php echo $row_questions['headertext']; ?></textarea></td>
   <td><textarea cols=23 rows=4 name=leavemessage_<?php echo $row['recno']; ?>_<?php echo $row_questions['id']; ?>_options><?php echo $row_questions['options']; ?></textarea></td>
   <td>  
   <?php if ( ($update==1) && ($row_questions['fieldtype'] != "username") ){ ?>   
...
<?php echo $lang['txt165']; ?>
 <br>
 <ul>
 <li><a href=javascript:topgraphic(1)>Default </a>  
