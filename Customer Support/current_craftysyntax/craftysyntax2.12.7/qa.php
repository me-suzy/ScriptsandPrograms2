...
function questions(){
  ...
  if($children->numrows() == 0){
   print "<tr><td> ".$lang['user_choose']." </td></tr>";	
  }
}
...
<td colspan=2><b>Question:</b> <?php echo $question['question']; ?></b></td></tr>
<tr bgcolor=<?php echo $color_background;?>>
<td colspan=2>
<img src=images/help_a.gif width=18 height=16><b><?php echo $lang['answer']; ?>:</b><br>
<table width=90%><tr><td bgcolor=<?php echo $color_alt1;?>>
...
<textarea cols=65 rows=9 name=question><?php echo $question_a['question']; ?></textarea><br>
...
<table width=100%>
<tr bgcolor=<?php echo $color_alt2; ?>>
<td><b><?php echo $lang['help']; ?>:</b></td>
<td><b><?php echo $lang['help2']; ?>:</b></td>
</tr>
<tr><td>
<a href=qa.php>top</a>
<FORM action=qa.php method=POST>
