...
if($UNTRUSTED['action'] == "update"){
   ...
   $query = "UPDATE livehelp_config 
    ...
    print "<SCRIPT> window.parent.location=\"admin.php?page=mastersettings.php&tab=settings\"; </SCRIPT>";
...
<option value="xmlhttp-flush-refresh" <?php if ($CSLH_Config['chatmode'] == "xmlhttp-flush-refresh") print " SELECTED "; ?> > XML HTTP -&gt; Flush() -&gt; Refresh </option>
<option value="xmlhttp-refresh" <?php if ($CSLH_Config['chatmode'] == "xmlhttp-refresh") print " SELECTED "; ?> > XML HTTP -&gt; Refresh </option>
<option value="flush-xmlhttp-refresh" <?php if ($CSLH_Config['chatmode'] == "flush-xmlhttp-refresh") print " SELECTED "; ?> > Flush() -&gt; XML HTTP -&gt; Refresh </option>
...
<input type=hidden value=N name=newshow_typing>
<table width=100% bgcolor=<?php echo $color_alt1;?>><tr><td>
...
<textarea cols=45 rows=5 name=ignoreips><?php echo $CSLH_Config['ignoreips']; ?></textarea><br>
