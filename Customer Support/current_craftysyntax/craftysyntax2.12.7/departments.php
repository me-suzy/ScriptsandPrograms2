...
//===========================================================================
//           URL:   http://www.craftysyntax.com/    EMAIL: eric@craftysyntax.com
...
if($UNTRUSTED['createit'] != ""){
  ...
  (nameof,offline,opening,messageemail,leaveamessage,requirename,onlineimage,offlineimage,whilewait,timeout,leavetxt,topframeheight,topbackground,colorscheme,speaklanguage,busymess) 
  VALUES ('".filter_sql($UNTRUSTED['nameof'])."','".filter_sql($UNTRUSTED['offline'])."',
  ...
  '".filter_sql($UNTRUSTED['dep_speaklanguage']) . "','". filter_sql($UNTRUSTED['busymess'])."')";
...
if($UNTRUSTED['whattodo'] == "reorder"){
 ...
 while ($row = $data->fetchRow(DB_FETCHMODE_ASSOC)){
	 ...
	 $sql = "UPDATE livehelp_departments SET ordering=".intval($UNTRUSTED[$ordernumber_val])." WHERE recno=$recno";
...
while ($row = $data->fetchRow(DB_FETCHMODE_ASSOC)){
  ...
  if( ($isadminsetting == "Y") && (empty($UNTRUSTED['edit'])) )
     print "<td><input type=text size=4 name=order_$recno value=\"$ordering\"></td>";
     print "<td><b>" . $nameof . "</b></td><td NOWRAP> ";
     if($isadminsetting == "Y")
      print "<a href=javascript:notpartof()>".$lang['settings']."</a> | ";
     print " <a href=javascript:notpartof()>".$lang['txt109']."</a>  ";
    } else {
     print "<tr bgcolor=$bgcolor>";
  if( ($isadminsetting == "Y") && (empty($UNTRUSTED['edit'])) )
     print "<td><input type=text size=4 name=order_$recno value=\"$ordering\"></td>";
     print "<td><b>" . $nameof . "</b></td><td NOWRAP> ";
     if($isadminsetting == "Y")
       print " <a href=departments.php?edit=" . $recno . ">".$lang['settings']."</a> |";
     print " <a href=htmltags.php?department=" . $recno . ">".$lang['txt109']."</a> ";
    }   
 if( ($isadminsetting == "Y") && ($data->numrows() != 1) ){
 	  print " | <a href=departments.php?removeit=" . $recno . " onClick=\"return confirm('".$lang['areyousure']."')\"><font color=990000>".$lang['REMOVE']."</font>";
 } 
 print "</td></tr>";
...
&lt;!-- copyright 2003 - 2005 by Eric Gerdes --&gt;<br><br>
</b></td></tr></table><br><br>
...
<b>
&lt;!-- Powered by: Crafty Syntax Live Help        http://www.craftysyntax.com/ --&gt;<br>
&lt;a href="<?php echo $CSLH_Config['webpath']; ?>livehelp.php?department=<?php echo $recno; ?>"&gt;&lt;img src=<?php echo $CSLH_Config['webpath']; ?>image.php?cmd=getstate&department=<?php echo $recno; ?> border=0&gt;&lt;/a&gt;&lt;br&lt; <br>
&lt;a name=byRef href=http://www.CSLH.com &gt;&lt;img name=myIcon src=<?php echo $CSLH_Config['webpath']; ?>image.php?cmd=getcredit&department=<?php echo $recno; ?>&gt;&lt;/a&gt;<br>
&lt;!-- copyright 2003 - 2005 by Eric Gerdes --&gt;<br><br>
</b></td></tr></table><br><br>
...
&lt;!-- copyright 2003 - 2005 by Eric Gerdes --&gt;<br>
</b><br><br>
...
<b>
&lt;!-- Powered by: Crafty Syntax Live Help        http://www.craftysyntax.com/ --&gt;<br>
&lt;script language="javascript" src="<?php echo $CSLH_Config['webpath']; ?>livehelp_js.php?cmd=hidden&department=<?php echo $recno; ?>"&gt;&lt;/script&gt;<br>
&lt;!-- copyright 2003 - 2005 by Eric Gerdes --&gt;<br>
</b><br><br>
</td></tr></table><br><br><bR>
<?php
