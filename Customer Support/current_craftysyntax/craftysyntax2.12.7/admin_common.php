...
$serversession=false;   // I have no idea why so many hosts can not handle PHP server sessions.. 
                        // I had this to true in the last version and got 3 people the first week
                        // with session handling errors.. I will stick with the cookies..
if($CSLH_Config['adminsession']=='Y')
  $serversession=true;
 else
  $serversession=false;    
