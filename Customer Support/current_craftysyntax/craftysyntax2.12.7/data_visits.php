...
if($UNTRUSTED['typeofview']== "levelvisits"){
  ...
  $bgcolor="F0F1E1"; 
   while($visits = $visits_a->fetchRow(DB_FETCHMODE_ASSOC)){ 
    ...
    print "<tr bgcolor=".$bgcolor."><td><a href=" . $visits['pageurl'] . " target=_blank>" . $visits['pageurl'] . "</a></td><td>" . $visits['directvisits'] . "</td><td> <a href=graph.php?item=" . $visits['recno'] . "&type=visit&typeof=directvisits target=_blank>" . $lang['graph'] . "</a></td></tr>";
   }
  print "</table>";
}  
