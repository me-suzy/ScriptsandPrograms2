<?php
/*! \class ChartColum
 *  \brief Colum chart implementaion of the ChartCommon class

    Creates a Colum chart from the data in the supplied Poll object
*/
class ChartColum extends ChartCommon{
	
	var $poll 	= null;
	var $titles = array();
	var $votes 	= array();
	
	function ChartColum($poll){
		if(!is_a($poll, 'Poll')){
