...
elseif( $_GET['cat'] == 'downloads_and_hyperlinks' )
{
	...
	$monat = ( isset( $_GET['d_month'] ) && !empty( $_GET['d_month'] ) && isset( $liste[$_GET['d_month']] ) ) ?  $_GET['d_month'] : 'all_months';
	...
	$monat = ( isset( $_GET['h_month'] ) && !empty( $_GET['h_month'] ) && isset( $liste[$_GET['h_month']] ) ) ?  $_GET['h_month'] : 'all_months';
