...
'sev_loc'=>'-70 stock location',
'hun_loc'=>'-135 stock location',
...
if ($row["sev_loc"] != '')
echo ('-70&deg; - '.$row["sev_loc"]);
if ($row["hun_loc"] != '')
echo ('<br />-135&deg; - '.$row["hun_loc"]);
if ($row["nit_loc"] != '')
echo ('<br />N<sub>2</sub> - '.$row["nit_loc"]);
  //---------------------------------------------------
...
echo ('Updated '.$row["modified_on"].'<br />');
   ...
   // start - edit, detail, update links
    // detail link
echo ('<a href="../interface_creator/index_short.php?table_name=cell-lines&amp;function=details&amp;where_field=id&amp;where_value='.$row["id"].'" onclick="return popitup(\'../interface_creator/index_short.php?table_name=cell-lines&amp;function=details&amp;where_field=id&amp;where_value='.$row["id"].'\')">Details</a>');
    // edit and delete link
if (!($all_affect_items == "no" and $client == "not_allowed"))
{ echo (' | <a href="../interface_creator/index_short.php?table_name=cell-lines&amp;function=edit&amp;where_field=id&amp;where_value='.$row["id"].'" onclick="return popitup(\'../interface_creator/index_short.php?table_name=cell-lines&amp;function=edit&amp;where_field=id&amp;where_value='.$row["id"].'\')"> Edit</a> | <a href="../interface_creator/index_short.php?table_name=cell-lines&amp;function=delete&amp;where_field=id&amp;where_value='.$row["id"].'" onclick="return confipop(\'../interface_creator/index_short.php?table_name=cell-lines&amp;function=delete&amp;where_field=id&amp;where_value='.$row["id"].'\')"> Delete</a>');}
