...
die("Could not connect to database labstock"); 
$selected = mysql_select_db($databaseName, $connection) or die("Could not select
database labstock");
...
if ($type  == "Excel")
{
 $header = "Downloaded ".$date." from Labstock MySQL database. More up-to-date data is available on the website. Refer to 'help' on the site for understanding the column headings.\n";
 // the column headings -------------------------------------
...
if ($type  == "CSV")
{
 $csv = "Downloaded ".$date." from Labstock MySQL database. More up-to-date data is available on the website. Refer to 'help' on the site for understanding the column headings.\n";
 // heading -------------------------------------------------
 for ($i = 0; $i < $count_cols; $i++) 
 {
