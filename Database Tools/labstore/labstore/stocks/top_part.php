...
{$order_condition = $_GET['order_condition'];}
 // default sort condition - note that the tables for all modules should have this field
else{$order_condition = "name ASC";}
...
if ($num_tot !== 0)
 ...
 {
 echo ('<p>The table is empty! <br />If you would like to add an entry, choose the "add..." link provided below.</p>');
 }
}
// end upper table
echo ('</td></tr></table>');
...
// table start
echo ('<table summary="list" width="750" style="background-color:#dcdcdc; border:0;" cellpadding="5" cellspacing="1">');
}
?>