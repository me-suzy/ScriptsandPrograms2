...
<div id='Layer5' style='position:absolute; width:520px; height:37px; z-index:4; left: 265; top: 10'>
	<div align="right">
		<table>
        	<tr>
            	<td><input type="button" id="style1" value="<?php echo "$txt_fichier" ?>" onClick="affichemenu(1)"></td>
  ...
  <div id="Layer10" style="position:absolute; width:76px; height:15px; z-index:16; left: 466px; top: 35px; background-color: #FFFFFF; border: 1px none #000000; visibility: hidden; overflow: hidden">
    <a href="add.php?fich=1" onClick="affichemenu(1)" onMouseOver="this.style.background='#336699'; this.style.color='#FFFFFF'" onMouseOut="this.style.background='#FFFFFF'; this.style.color='#0000FF'"><b>&nbsp;<? echo "$txt_ajouter" ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
  </div>
