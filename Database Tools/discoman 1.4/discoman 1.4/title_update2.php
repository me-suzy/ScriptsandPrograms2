...
if (mysql_num_rows($query) == 0) {
	...
	echo "
			<script language='javascript'>
				window.alert(\"Aucune modif des titres\");
			</script>";
...
//    if ($titre1 != $titre2) {//s'il y a modif des titres
	...
	echo "
			<script language='javascript'>
				window.alert(\"cas 1 : row1 : ".$row1[id]." - row2 : ".$row2[id]."\");
			</script>";
	...
	echo "
			<script language='javascript'>
				window.alert(\"cas 2 : row1 : ".$row1[id]." - row2 : ".$row2[id]."\");
			</script>";
	...
	echo "
			<script language='javascript'>
				window.alert(\"cas 3 : row1 : ".$row1[id]." - row2 : ".$row2[id]."\");
			</script>";
...
$id_titre2 = mysql_insert_id();//Je récupére l'id du nouveau titre
	...
	echo "
			<script language='javascript'>
				window.alert(\"cas 4 : row1 : ".$row1[id]." - row2 : ".$row2[id]."\");
			</script>";
...
LAYERS2();
	...
	if ($update) echo "
    	...
    	<table class=\"Stable\" border=\"0\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\">
			<tr>
            <td>titre 1 : ".$titre1."</td>
            </tr>
			<tr>
            <td>titre 2 : ".$titre2."</td>
            </tr>
            <tr>
...
LAYERS4();
	...
	echo "   	</td>
    		...
    		<tr>
        		...
        		<input name=\"form_id_titre\" type=\"hidden\" value=".stripslashes($row4['id_titre']).">
    		</tr>
    		<tr>
