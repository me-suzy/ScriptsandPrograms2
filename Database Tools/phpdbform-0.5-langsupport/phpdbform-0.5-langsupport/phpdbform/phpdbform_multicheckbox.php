...
class phpdbform_listbox extends phpdbform_field {
    ...
    function phpdbform_listbox( &$form, $field, $title, &$db, $table, $key, $value, $order, $wheresrcfield, $wheresrcvalue )
    {
        ...
        $this->order = $order;
        $this->wheresrcfield = $wheresrcfield;
        $this->wheresrcvalue = $wheresrcvalue;
