...
<?php
if($htmllisttype==0)
	$list_url=$url_faqengine."/all_html.php";
else
	$list_url=$url_faqengine."/all_html2.php";
$link="$list_url?prog=$prog&amp;$langvar=$act_lang";
if(isset($layout))
	$link.="&amp;layout=$layout";
...
?>
<span style="font-face: <?php echo $FontFace?>; font-size: <?php echo $FontSize1?>; color: <?php echo $FontColor?>;">
<a href="<?php echo $link?>"><?php echo $l_htmllist?></a></span></td></tr>
<tr BGCOLOR="<?php echo $group_bgcolor?>" ALIGN="CENTER">
<?php
if($htmllisttype==0)
	$list_url=$url_faqengine."/all_print.php";
else
	$list_url=$url_faqengine."/all_print2.php";
$link="$list_url?prog=$prog&amp;$langvar=$act_lang";
if(isset($layout))
	$link.="&amp;layout=$layout";
echo "<td align=\"center\" valign=\"middle\" bgcolor=\"$group_bgcolor\" class=\"rowlink\"";
...
?>
<span style="font-face: <?php echo $FontFace?>; font-size: <?php echo $FontSize1?>; color: <?php echo $FontColor?>;">
<a href="<?php echo $link?>"><?php echo $l_printlist?></a>
</span></td></tr>
<?php
if($disableasclist==0)
{
	echo "<tr BGCOLOR=\"$group_bgcolor\" ALIGN=\"CENTER\">";
	$link=$url_faqengine."/all_ascii.php?prog=$prog&amp;$langvar=$act_lang";
	if(isset($layout))
		$link.="&amp;layout=$layout";
	echo "<td align=\"center\" valign=\"middle\" bgcolor=\"$group_bgcolor\" class=\"rowlink\"";
	if($hovercells==1)
...
?>
<span style="font-face: <?php echo $FontFace?>; font-size: <?php echo $FontSize1?>; color: <?php echo $FontColor?>;">
<a href="<?php echo $link?>"><?php echo $l_asciilist?></a></span></td></tr>
<?php
}
if($allowemail==1)
{
	echo "<tr BGCOLOR=\"$group_bgcolor\" ALIGN=\"CENTER\">";
	$link=$url_faqengine."/all_email.php?prog=$prog&amp;$langvar=$act_lang";
	if(isset($layout))
		$link.="&amp;layout=$layout";
	echo "<td align=\"center\" valign=\"middle\" bgcolor=\"$group_bgcolor\" class=\"rowlink\"";
	if($hovercells==1)
...
?>
<span style="font-face: <?php echo $FontFace?>; font-size: <?php echo $FontSize1?>; color: <?php echo $FontColor?>;">
<a href="<?php echo $link?>"><?php echo $l_maillist?></a></span></td></tr>
<?php
}
