...
function choosecolor()
{
	...
	var fieldname=mywin.document.myform.colorfield.value;
...
<tr><td align="center" colspan="2" class="displayrow"><input class=sgbinput type=text name=hexval size=10 readonly></td></tr>
<tr><td align="center" colspan="2" class="actionrow"><input onclick="choosecolor();" type="button" class="faqebutton" value="<?php echo $l_transfer?>"></td></tr>
</form>
</table></body></html>
