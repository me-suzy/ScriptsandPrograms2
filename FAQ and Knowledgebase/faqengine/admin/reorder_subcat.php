...
<tr class="rowheadings"><td align="right" width="30%"><?php echo $l_selectcat?>:</td>
...
?>
<tr class="inforow">
<td align="center" colspan="3"><b><?php echo $l_category?>: <?php echo display_encoded($myrow["categoryname"]).": $progname [$proglang]"?></b></td></tr>
<?php
...
echo "<div class=\"bottombox\" align=\"center\"><a href=\"".do_url_session("subcategories.php?$langvar=$act_lang")."\">$l_subcatlist</a></div>";
include('./trailer.php');
?>