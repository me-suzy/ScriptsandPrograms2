...
<TR BGCOLOR="#ffffff" ALIGN="CENTER"><TD ALIGN="CENTER" VALIGN="MIDDLE">
<span style="font-face: <?php echo $FontFace?>; font-size: <?php echo $FontSize3?>; color: #000000; font-weight: bold;">
...
<?php echo display_encoded($myrow["categoryname"])?></span></td></tr>
<?php
...
<?php echo display_encoded($myrow2["categoryname"])?></span></td></tr>
<TR BGCOLOR="<?php echo $row_bgcolor?>" ALIGN="CENTER"><TD ALIGN="left" VALIGN="MIDDLE">
<span style="font-face: <?php echo $FontFace?>; font-size: <?php echo $FontSize1?>; color: <?php echo $FontColor?>;">
<?php
...
else
{
	do{
		...
		$answertext = str_replace("{bbc_quote}",$l_bbcquote,$answertext);
		$answertext = undo_htmlspecialchars($answertext);
		echo "$faqcount. <b>".undo_html_ampersand(stripslashes($myrow3["heading"]))."</b><br>";
		echo "<i>$l_question:</i><br>";
		echo $questiontext."<br>";
		echo "<i>$l_answer:</i><br>";
		echo $answertext."<br><br>";
