...
function SiteMenu() {
	...
	foreach ($menu as $key => $val)
		//$menu[$key] = '<td><a href="display.php?action=search&by=' . $val . '" class="menu_link">' . $val . '</a></td>';
		$menu[$key] = '<td><a href="' . $val . '" class="menu_link">' . $val . '</a></td>';
...
<br /><br />
					...
					<table align="center" cellpadding="0" cellspacing="0" border="0">
						<tr>
							...
							<td width="10"></td>
							<td><input type="radio" name="type" value=""' . (($_GET['type'] != 'full')?' checked':'') . ' /></td>
	...
	';
	if ($GLOBALS['admin']) {
		$c.= '<div align="center"><b><a href="admin.php?action=edit&from=' . $GLOBALS['from'] . '">Add new word definition</a> | <a href="admin.php?action=change">Change pass</a> | <a href="admin.php?action=logout">Admin logout</a></b></div><br />';
	}
