...
// user database settings
  ...
  define("EZSQL_DB_NAME", "faq");
  define("EZSQL_DB_HOST", "");
// end of user database settings
  ...
  class stp_db {
    ...
    function vardump($mixed)
    {
      ...
      echo "</font></pre></font></blockquote><font size=1 face=arial color=aaaaaa>If ezSQL has helped you why not <a href=\"https://www.paypal.com/xclick/business=justin%40justinvincent.com&item_name=ezSQL&no_note=1&tax=0\" style=\"color: aaaaaa;\">make a donation!?</a></font>";
    ...
    function debug()
    {
      ...
      echo "</blockquote></blockquote><font size=1 face=arial color=aaaaaa>If ezSQL has helped you why not <a href=\"https://www.paypal.com/xclick/business=justin%40justinvincent.com&item_name=ezSQL&no_note=1&tax=0\" style=\"color: aaaaaa;\">make a donation!?</a></font><hr noshade color=dddddd size=1>";
  ...
  function get_cache($query = '', $refresh_rate = 600) {
    ...
    if ($no_file || $query && ($timediff > $refresh_rate)) {
      ...
      $cache_log[] = "<font color=\"red\">$fname<br>".htmlspecialchars($query)."</font>";
      ...
      $cache_log[] = "<font color=\"green\">$fname<br>".htmlspecialchars($query)."</font>";
