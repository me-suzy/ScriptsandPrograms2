...
/// VERSION V1.2.1 (31/12/2003) - 31 december 2003 - french format
...
$var_title="AX v1.3 : free, flexible mini CMS without Database, working with XML, last updated 01/20/03 - a pierre jean duvivier CMS";
...
$var_admin_password="clamart2105pjd"; // PASSWORD OF THE ADMIN SECTION (CHANGE IT OFTEN)
...
function characterData($parser, $data) {
  ...
  else
  {
      ...
      {
        if ($write) { Echo stripslashes($data);}
      }
  }
...
function parsing_xml($where)    // CLASSICAL PARSER XML
 ...
 function foot()                 // THE FOOTER OF THE PAGE
 {
  ...
  Echo"<a href=http://ax.agora-fr.org target=1>[ || Powered by {Ax} v1.3 || ]</a>";
  Echo"<br>";
  include('xiti.htm');
  Echo"</center>";
 }
 ...
 {
    global $var_no_limit,$var_in_side,$url,$var_title,$var_width_table,$var_cellpadding,$var_cellspacing,$var_border,$var_wleft,$var_wright,$var_background_color;
 ...
 function admin_manager()         // WHERE YOU POST A NEW ARTICLE  & MANAGE THE WEBSITE
 {
  ...
  <table width=\"800\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
    <tr>
      ...
      <td> <div align=\"center\">
          <input name=\"title\" type=\"text\" id=\"title\" size=\"40\" maxlength=\"40\" value=\"$e_title\">
        </div></td>
    </tr>
    <tr>
