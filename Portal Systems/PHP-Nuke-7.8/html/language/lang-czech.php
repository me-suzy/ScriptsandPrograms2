...
define("_OLDERARTICLES","Starí èlánky");
define("_BY","podle");
define("_ON","v");
...
define("_ONEDAY","Den jako kadý jiný...");
define("_ASREGISTERED","Jetì nemáte svùj úèet? Mùete si jej <a href=\"modules.php?name=Your_Account\">vytvoøit zde</a>. Jako registrovaný uivatel získáte øadu výhod. Napøíklad posílání komentáøu pod jménem, nastavení komentáøù, manaer témat atd.");
define("_MENUFOR","Menu pro");
define("_NOBIGSTORY","Dosud není èlánek dne.");
define("_BIGSTORY","Nejètenìjí èlánek dnes je:");
...
define("_GUESTS","návtìvník(ù) a");
define("_MEMBERS","uivatel(ù) online.");
define("_YOUARELOGGED","Jste pøihláen jako");
define("_YOUHAVE","Máte");
define("_PRIVATEMSG","osobních zpráv.");
define("_YOUAREANON","Jste anonymní uivatel. Mùete se zdarma registrovat kliknutím <a href=\"modules.php?name=Your_Account\">zde</a>");
define("_NOTE","Poznámka:");
define("_ADMIN","Admin:");
define("_WERECEIVED","Zaznamenali jsme");
define("_PAGESVIEWS","pøístupù od");
define("_TOPIC","Téma");
define("_UDOWNLOADS","Staení");
define("_VOTE","Hlasovat");
define("_VOTES","Hlasù");
define("_MVIEWADMIN","Zobrazit: Pouze administrátorùm");
define("_MVIEWUSERS","Zobrazit: Pouze pøihláeným uivatelùm");
define("_MVIEWANON","Zobrazit: Pouze anonymùm");
define("_MVIEWALL","Zobrazit: Vem návtìvníkùm");
define("_EXPIRELESSHOUR","Konec zobrazování: ménì ne 1 hodina");
define("_EXPIREIN","Konec zobrazování za");
define("_HTTPREFERERS","Odkud pøili");
