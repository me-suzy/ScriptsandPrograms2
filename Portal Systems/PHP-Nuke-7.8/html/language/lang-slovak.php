...
define("_NICKNAME","Uívate¾ské meno");
...
define("_OLDERARTICLES","Starie èlánky");
define("_BY","kým:");
define("_ON","v");
...
define("_ONEDAY","Deò ako kadý iný...");
define("_ASREGISTERED","Ete nemáte konto? Môete si ho <a href=\"modules.php?name=Your_Account\">vytvori?</a>. Registrovaný uívate¾ má niektoré výhody, napr. manaér tém, nastavenie komentárov a posielanie komentárov s vlastným menom.");
define("_MENUFOR","Menu pre");
define("_NOBIGSTORY","Dnes tu ete nie je iadny ve¾ký èlánok.");
define("_BIGSTORY","Najèítanejí èlánok dnes je:");
...
define("_YOUAREANON","Ste anonymný uívate¾. Zaregistrova? sa môete <a href=\"modules.php?name=Your_Account\">tu</a>");
...
define("_MVIEWUSERS","Zobrazi?: len registrovaní uívate¾ia");
define("_MVIEWANON","Zobrazi?: len anonymní uívate¾ia");
...
define("_BROADCASTFROM","Hromadná správa od uívate¾a");
...
define("_THISISAUTOMATED","Toto je automaticky generovaný email. Informujeme Vás, e Vaa bannerová inzercia na naej stránke bola v tomto momente ukonèená. ");
define("_THERESULTS","Výsledky Vaej reklamnej kampane sú nasledovné:");
...
define("_HOPEYOULIKED","Dúfame, e ste boli spokojný s naou slubou. Teíme sa, e v blízkej budúcnosti budete opä? naím inzerujúcim klientom.");
define("_THANKSUPPORT","Ïakujeme za Vau podporu");
define("_TEAM","Tím");
