...
define("_NICK2LONG","Pøezdívka je pøíli dlouhá. Nesmí být delí ne 25 znakù");
define("_NAMERESERVED","CHYBA: Toto jméno je ji zadané");
define("_NICKNOSPACES","CHYBA: Nemùete pouít mezery v pøezdívce");
define("_NICKTAKEN","CHYBA: Tato pøezdívka je ji zadaná");
define("_EMAILREGISTERED","CHYBA: E-mailová adresa je ji registrována");
define("_UUSERNAME","Uivatelské jméno");
define("_FINISH","Konec");
define("_YOUUSEDEMAIL","Vy nebo nìkdo jiný pouil vai e-mailovou adresu");
...
define("_USERPASS4","Uivatelské heslo pro");
define("_YOUAREREGISTERED","Nyní máte zaloen úèet. Heslo obdríte na e-mailovou adresu, kterou jste zadal(a) pøi registraci.");
define("_THISISYOURPAGE","Vae osobní stránka");
define("_AVATAR","Avatar-ikonka");
define("_WEBSITE","Vá web");
define("_ICQ","ICQ");
define("_AIM","AIM");
define("_YIM","YIM");
define("_MSNM","MSNM");
...
define("_NOINFOFOR","Nejsou dostupné informace o uivateli");
...
define("_LOGININCOR","Chyba pøi pøihláování! Zkuste to, prosím, znovu...");
define("_USERLOGIN","Pøihláení");
define("_USERREGLOGIN","Nová registrace/Pøihláení");
define("_REGNEWUSER","Registrace nového uivatele");
define("_LIST","Seznam");
...
define("_COOKIEWARNING","Poznámka: Pro uívání výhod registrace je tøeba mít povoleny cookies.");
define("_ASREGUSER","Jako registrovaný uivatel mùete:");
define("_ASREG1","Poslat komentáø s vaim jménem(pøezdívkou)");
define("_ASREG2","Poslat pøíspìvek s vaim jménem(pøezdívkou)");
...
define("_ASREG7","a spoustu dalích pìkných malièkostí...");
define("_REGISTERNOW","Registrujte se ihned! Je to zdarma!");
define("_WEDONTGIVE","Vae osobní informace nebudou v ádném pøípadì pøedány tøetím osobám.");
define("_ALLOWEMAILVIEW","Povoluji zobrazení mé e-mail adresy ostatním uivatelùm");
define("_OPTION","Volby");
define("_PASSWORDLOST","Zapomìl(a) jste heslo?");
define("_NOPROBLEM","To není ádný problém. Zadejte vai pøezdívku a kliknìte na tlaèítko Poslat heslo. Na e-mailovou adresu, kterou jste zadal(a) pøi registraci, vám okamitì poleme potvrzovací kód. Znovu zadáte vai pøezdívku a potvrzovací kód a my vám ihned poleme nové heslo.");
define("_CONFIRMATIONCODE","Potvrzovací kód");
define("_SENDPASSWORD","Poslat heslo");
define("_YOUARELOGGEDOUT","Vae odhláení probìhlo úspìnì!");
define("_SORRYNOUSERINFO","Lituji, nebyly nalezeny odpovídající informace");
define("_USERACCOUNT","Uivatelský úèet");
define("_AT","na");
define("_HASTHISEMAIL","bylo spojeno s touto e-mailovou adresou.");
define("_AWEBUSERFROM","Uivatel");
define("_HASREQUESTED","poádal(a) o poslání heslat.");
define("_YOURNEWPASSWORD","Vae nové heslo je:");
define("_YOUCANCHANGE","Mùete jej zmìnit po pøihláení na");
define("_IFYOUDIDNOTASK","Pokud jste o toto nepoádal, nebuïte smutný. Vidíte tuto zprávu, nikoli 'je'. Pokud se jedná o chybu, zalogujte se znovu - s novým heslem.");
define("_UPDATEFAILED","Nemohu aktualizovat uivatele. Kontaktujte, prosím administrátora.");
define("_PASSWORD4","Heslo pro");
define("_MAILED","Odesláno.");
define("_CODEREQUESTED","poádal(a) o poslání potvrzovacího kódu ke zmìnì hesla.");
define("_YOURCODEIS","Vá potvrzovací kód je:");
define("_WITHTHISCODE","S tímto kódem mùete poádat o pøidìlení nového hesla na");
define("_IFYOUDIDNOTASK2","Pokud jste o nic neádal(a), smate prosím tento e-mail.");
define("_CODEFOR","Potvrzovací kód pro");
define("_USERPASSWORD4","Uivatelské heslo pro");
define("_UREALNAME","Pravé jméno");
define("_UREALEMAIL","Pravý e-mail");
define("_EMAILNOTPUBLIC","(Tato e-mailová adresa nebude zveøejnìna, je vak vyadovaná. Pokud zapomenete(stratíte) heslo, poleme vám na tuto adresu nové)");
define("_UFAKEMAIL","Falený e-mail");
define("_EMAILPUBLIC","(Tato adresa bude zveøejnìna. Prostì zadejte co chcete.)");
define("_YOURHOMEPAGE","Vae domovská stránka");
define("_YOURAVATAR","Vae Avatar-ikonka");
define("_YICQ","ICQ");
define("_YAIM","AIM");
define("_YYIM","YIM");
define("_YMSNM","MSNM");
define("_YLOCATION","Bydlitì");
define("_YOCCUPATION","Zamìstnání");
define("_YINTERESTS","Zájmy");
define("_255CHARMAX","(max. 255 znakù. Zadejte vá podpis, múete i s pouitím HTML)");
...
define("_CHECKTHISOPTION","(Zatrhnìte tuto monost a na úvodní stránce budete mít zobrazen box, ve kterém mùete mít text nebo vlastní menu)");
define("_YOUCANUSEHTML","(Mùete pouít HTML kód)");
...
define("_THEMETEXT3","Vichni uivatelé mohou mít nastaven rozdílný vzhled webu.");
define("_DISPLAYMODE","Zobrazit jako");
define("_SORTORDER","Seøadit");
define("_COMMENTSWILLIGNORED","Komentáøe s niím hodnocením ne nastavíte budou ignorovány.");
define("_UNCUT","Nefiltrovat");
define("_EVERYTHING","Skoro vechno");
define("_FILTERMOSTANON","Filtrovat-vìtinou anonymy");
define("_USCORE","Hodnocení");
define("_SCORENOTE","Anonymní pøíspìvky zaèínají na 0, pøíspìvky pøihláených uivatelù na 1. Moderátoøi mohou pøidávat a odebírat body.");
define("_NOSCORES","Nezobrazovat hodnocení");
define("_HIDDESCORES","(Skryté hodnocení: Pokud je zatrhnete, neuvidíte ádné hodnocení.)");
...
define("_USENDPRIVATEMSG","Poslat osobní zprávu uivateli:");
...
define("_LOGOUTEXIT","Odhláení/Konec");
