...
define("_DLETSDECIDE","Komentarji uporabnikov kot ste Vi bodo pomagali drugim da se laje odloèijo na kateri download naj kliknejo.");
...
define("_ALLOWTORATE","Omogoèite ostalim obiskovalcem da ocenjujejo Vao povezavo na Vae strani!");
...
define("_WEIGHNOTE","* Opomba: Ocene registriranih uporabnikov imajo drugaèno teo od ocen neregistriranih uporabnikov");
define("_NOUNREGUSERSVOTES","Ni ocen neregistriranih uporabnikov");
define("_WEIGHOUTNOTE","* Opomba: Ocene registriranih uporabnikov imaju drugaèno teo od ocen zunajnih ocenjevalcev.");
...
define("_PROMOTE01","Morda Vas interesira nekaj remote 'Oceni stran' opcij ki jih imamo. To Vam dopuèa postavljanje slik (ali celo obrazca za ocenjevanje) na Vao stran z namenom veèanja tevila glasov. Izberite eno od spodaj navedenih opcij:");
...
define("_PROMOTE03","Èe ièete nekaj veè od obièjane tekstovne povezave, Vas morda zanima uporaba malega gumba za povezavo:");
...
define("_PROMOTE04","Èe boste pri tem varali bo Vaa povezava takoj izbrisana. Sedaj ko se razumemo, lahko pogledate kako trenutni remote obrazec izgleda.");
define("_VOTE4THISSITE","Glasujte za to stran!");
define("_HTMLCODE3","Preko tega obrazca je omogoèeno uporabnikom da ocenjujejo Vao stran direktno iz nje. Zgornji obrazec je onemogoèen, vendar pa bo sledeèa koda delovala èe jo postavite na vao stran. Source koda je prikazana spodaj:");
...
define("_SECURITYBROKEN","Iz sigurnostnih razlogov je Vae uporabniko ime in IP naslov zaèasno zabeleen.");
