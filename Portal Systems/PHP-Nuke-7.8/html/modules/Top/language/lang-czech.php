...
define("_READSTORIES","nejètenìjích èlánkù");
define("_COMMENTEDSTORIES","èlánkù s nejvíce komentáøi");
define("_ACTIVECAT","nejvyhledávanìjích kategorií");
define("_READSECTION","nejètenìjích èlánkù ve speciální sekci");
define("_NEWSSUBMITTERS","nejaktivnìjích dopisovatelù");
define("_NEWSSENT","poslaných zpráv");
define("_VOTEDPOLLS","anket s nejvíce hlasy");
define("_MOSTACTIVEAUTHORS","nejaktivnìjích autorù");
define("_NEWSPUBLISHED","èlánky(ù)");
define("_READREVIEWS","nejètenìjích recenzí");
define("_DOWNLOADEDFILES","nejstahovanìjích souborù");
