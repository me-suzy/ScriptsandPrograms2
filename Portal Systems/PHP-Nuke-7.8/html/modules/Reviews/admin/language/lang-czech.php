...
define("_REVIMGINFO","Ulote vá obrázek o velikosti 150*150 do adresáøe images/reviews");
define("_TEXT","Text");
define("_IMAGE","Obrázek");
define("_NOREVIEW2ADD","Nejsou recenze k pøidání");
define("_ADDREVIEW","Pøidat recenzi");
define("_CLICK2ADDREVIEW","Kliknìte a napite recenzi");
define("_DELMODREVIEW","Smazat / Upravit recenzi");
define("_MODREVINFO","Mùete jednodue mazat/upravovat recenze pøi prohlíení stránky <a href=\"modules.php?name=Reviews\">Reviews</a> jako administrátor.");
