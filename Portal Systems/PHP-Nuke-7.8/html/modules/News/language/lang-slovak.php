...
define("_MOSTREAD","Najèítanejie èlánky");
...
define("_HIGHEST","Najprv s vyím skóre");
define("_COMMENTSWARNING","Za obsah komentárov je zodpovedný uívate¾, nie prevádzkovate¾ týchto stránok.");
define("_SCORE","Skóre:");
define("_USERINFO","O uívate¾ovi");
define("_READREST","Èíta? zvyok komentára...");
define("_REPLY","odpoveda?");
define("_REPLYMAIN","posla? komentár");
define("_NOSUBJECT","Chýba predmet");
define("_NOANONCOMMENTS","Ako anonymný uívate¾ nemôete posiela? komentáre, prosím <a href=\"modules.php?name=Your_Account\">zaregistrujte sa</a>");
...
define("_TOAFRIEND","Vámu priate¾ovi, známemu:");
define("_FYOURNAME","Vae meno:");
define("_FYOUREMAIL","Vá e-mail:");
define("_FFRIENDNAME","Meno váho priate¾a:");
define("_FFRIENDEMAIL","E-mail váho priate¾a:");
define("_INTERESTING","Zaujimavy èlánok na");
define("_HELLO","Ahoj,");
define("_YOURFRIEND","Vá priate¾");
define("_CONSIDERED","sa domnieva, e by Vás tento èlánok mohol zaujíma? a tak vám ho posiela.");
define("_FDATE","Dátum:");
define("_FTOPIC","Téma:");
define("_YOUCANREAD","Aj ïalie zaujímavé èlánky sú na");
...
define("_THANKSVOTEARTICLE","Ïakujeme za Vae ohodnotenie.");
define("_ALREADYVOTEDARTICLE","Prepáète, ale v nedávnej minulosti ste u ohodnotili tento èlánok!");
define("_BACKTOARTICLEPAGE","Spä? na stránku s èlánkom");
define("_DIDNTRATE","Nevybrali ste iadne skóre pre tento èlánok");
define("_NOINFO4TOPIC","Prepáète, k zadanej téme neexistuje iadna ïalia informácia");
