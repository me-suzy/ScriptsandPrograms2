...
echo "<img border='0' src='themes/" . $_SESSION["App_Theme"] . "/ico-puce01.gif' />&nbsp;<strong>$Mod_Membres_Rub_File_Cat</strong><br /><br />" ;

// BUGFIX : affichage de la catégorie ajoutée
if ($action == "Cat-File-Add")
{
    $res_catfile2 = sql_query("INSERT INTO $BD_Tab_file_cat (FIC_nom) VALUES ('" . AuAddSlashes($categorie) . "')", $sql_id) or
                    die("$Err_Insert") ;
    echo "<strong>$Mod_Membres_Rub_File_Cat_OK</strong><br /><br />" ;
}


$res_catfile1 = sql_query("SELECT * FROM `$BD_Tab_file_cat` ORDER BY FIC_nom ASC", $sql_id) ;
?>
...
<?php
while($row = mysql_fetch_object($res_catfile1))
{
    echo "<img border='0' src='themes/" . $_SESSION["App_Theme"] . "/ico-cat01.gif' /> " . $row->FIC_nom . "<br />" ;
}
?> 

<form name='formcatfile' method='post' onSubmit='return valider_formulaire(this)' 
      action='<?php echo $chemin ; ?>/index.php?<?php echo $sid ; ?>affiche=Admin&admin=Cat-File&action=Cat-File-Add'>
<div align='left'>
  <table border='0' cellpadding='0' cellspacing='0' width='600'>
    <tr>
      <td width='200'><?php echo $Mod_Membres_Rub_File_Form_Categorie ; ?> : (30)</td>
